# Section brief — `assembly` (Xterra wave X2: bikes, ellipticals, climber)

Read `$S/briefs-x2/COMMON.md` first. Your section facet is `section: assembly`.

Yours: the owner's manuals' **hardware kit / pack list / parts included** (bolt
sizes, tools, quantities exact — one card per kit, grouped where identical: the
FB150/FB350 and FB160/FB360 pairs, the FS2.5/FS3.5 pair), **assembly step by
step** (stabilisers, seat post and seat, handlebar, pedals — left pedal is
...
service facts from the AB900 book (chain / belt, fan, crank, console) as Xterra
cards.
...
step and hardware match; a book whose bolt count or size differs gets its own
card with the figure in the title.

...
4
Important Safety Instructions                                             or plug, if it is not working properly, if it has been
                                                                          dropped or damaged, or dropped into water. Return
     WARNING                                                              the appliance to a service center for examination and
When using an electrical appliance, basic precautions should              repair.
always be followed, including the following:                          •   Do not carry this appliance by supply cord or use cord
Read all instructions before using this appliance.                        as a handle.
DANGER - To reduce the risk of electric shock:                        •   Keep the cord away from heated surfaces.
Always unplug this appliance from the electrical outlet               •   Never operate the appliance with the air openings
immediately after using and before cleaning.                              blocked. Keep the air openings free of lint, hair, and the
WARNING - To reduce the risk of burns, fire, electric                     like.
shock, or injury to persons, install the elliptical on a flat level   •   Never drop or insert any object into any opening.
surface with access to a 115-volt, 15-amp grounded outlet             •   Do not use outdoors.
with only the elliptical plugged into the circuit.                    •   Do not operate where aerosol (spray) products are
                                                                          being use or where oxygen is being administered.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 18AWG OR
BETTER, WITH ONLY ONE OUTLET ON THE END:                              •   Connect this appliance to a properly grounded outlet
...
•    Use this appliance only for its intended use as
     ...
     recommended by the manufacturer.
                                                                      SAVE THESE INSTRUCTIONS - THINK SAFETY!                          5
...
Z\WAR NIN G the appliance to a service center for examination and
...
DANGER - To reduce the risk of electric shock: * Keep the cord away from heated surfaces.
Always unplug this appliance from the electrical outlet * Never operate the appliance with the alr OPENINES
immediately after using and before cleaning, blocked. Keep the air openings free of lint, hair and the
WARNING - To reduce the risk of burns, fire, electric like. a

shock, or injury to persons, install the elliptical on a flat level * — Never drop or insert any object into any opening,
surface with access to a | |5-volt, |5-amp grounded outlet * Do not use outdoors.

with only the elliptical plugged into the circuit. * Do not operate where aerosol (spray) products are

being use or where oxygen is being administered.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A |8AWG OR

BETTER WITH ONLY ONE OUTLET ON THE END: * Connect this appliance to a properly grounded outlet
* To reduce the risk of burns, fire electric shock, or injury only. _
to persons: ¢ The appliance is intended for household use.

e This exercise equipment is not intended for use by
persons with reduced physical, sensory or mental
capabilities, or lack of experience and knowledge.

¢ Keep children under the age of |3 away from this
machine.
...
SAVE THESE INSTRUCTIONS - THINK SAFETY!
    ...
    any other high humidity environment. The operating temperature specification is 40 to 120 degrees Fahrenheit, and humidity
...
elliptical is first turned on or even during use. If your elliptical is tripping the house circuit breaker (even though it is the
...
proper current rating) but the circuit breaker on the elliptical itself does not trip, you will need to replace the home breaker
with a high inrush type. This is not a warranty defect. This is a condition we as a manufacture have no ability to control. This
part is available through most electrical supply stores. Examples: Grainger part # |D237, or available online at www.squared.
com part #QO 1 20HM. The electrical outlet used should have a dedicated 15 amp circuit breaker.
...
This product is for use on a nominal | |0-volt/15 amp dedicated circuit, and has a grounding plug that looks like the plug
illustrated below. A temporary adapter that looks like the adapter illustrated below may be used to connect this plug to a
2-pole receptacle as shown below if a properly grounded outlet is not available. The temporary adapter should be used
only until a properly grounded outlet, (shown below) can

be installed by a qualified electrician. The green colored Grounded Outlet Adapter

rigid ear-lug, or the like, extending from the adapter, must (") N

be connected to a permanent ground such as a properly 7 oN cab ot
grounded outlet box cover Whenever the adapter is used, it oo) Metal Screw ane
...
3. Locate the hardware package. Remove the tools first. Remove the             PARTS INCLUDED:
   ...
   the instructions that are in parenthesis (#) are the item number from the    1 Console Mast
...
hardware for each step as needed to avoid confusion. The numbers in Q) | Main Frame

the instructions that are in parenthesis (#) are the item number from the Q) | Console Mast
...
12
                   HARDWARE FOR STEP 1                                           CONSOLE MAST COVER (72) is facing the correct way.
 PART           TYPE                DESCRIPTION            QTY               6. At the top opening of the MAIN FRAME (1), there is a COMPUTER
  103           BOLT                     3/8”X3/4”          2                   CABLE (53) tied to a twist tie wire. Feed the twist tie wire and
  104           BOLT             3/8” X UNC16 X 1-1/2”      2                   COMPUTER CABLE (53) into the bottom of the CONSOLE
  105           BOLT                   3/8” X 2-1/4”        1                   MAST (12) and out of the opening at the top.
  116    PHILLIPS HEAD SCREW           M5 X 10mm            4                7. Install the CONSOLE MAST (12) into the receiving bracket on the
  120    SHEET METAL SCREW              3.5 X16mm           3                   top of the MAIN FRAME (1). Be extremely careful not to pinch the
  130        NYLOC NUT                   3/8” X 7T          2                   cables between the tubing. If the cable gets pinched, this may affect the
  137        FLAT WASHER           3/8” × Ø19 × 1.5T        2                   electrical functions of the console.
  142        FLAT WASHER            5/16” X 20 X 1.5T       4                   NOTE: There is one bolt already installed in the receiving bracket that
  151       SPLIT WASHER         8 X 1.5T (5/16” X 1.5T)    4                   will engage with the slot at the bottom of the Console Mast. This needs
  152       SPLIT WASHER                Ø10 × 2T            1                   to be tightened last, after the three other Console Mast bolts.
  153      CURVED WASHER            Ø3/8” × 23 × 2T         2
                                                                             8. Place a SPLIT WASHER (152) onto the HEX HEAD BOLT (105)
  154       STAR WASHER                    5/16”            4                   and hand tighten through the left side of the Console Mast. Place a
  185           BOLT                 5/16” X 2 - 1/4”       4                   CURVED WASHER (153) onto each HEX HEAD BOLT (103)
                                                                                and thread both into the front of the Console Mast tube. Fasten these
1. Gather HARDWARE FOR STEP 1.                                                  front bolts as tight as possible with the WRENCH (155). Next firmly
                                                                                tighten the two left side bolts with the same wrench.
2. Slide the INCLINE RAIL ASSEMBLY (2) into the U channel of the
   MAIN FRAME (1).Be very careful not to damage the wires that exit          9. Connect the 2 HAND PULSE CABLES (47), RESISTANCE
   each part.                                                                   CABLE (49), and COMPUTER CABLE (53) to the back of the
                                                                                CONSOLE (43). Do not force the connectors; they will only fit one
3. Connect the INCLINE RAIL ASSEMBLY (2) horizontally to the U
   ...
   vertically with 4 HEX HEAD BOLTS (185), 4 SPLIT WASHERS                   10. Attach the CONSOLE (43) to the bracket of the Console Mast tube
   (142), 4 FLAT WASHERS (151), and 4 STAR WASHERS (154).                        with 4 PHILLIPS HEAD SCREWS (116). Tighten the screws with the
   Tighten using the WRENCHES provided (155 & 158).                              PHILLIPS HEAD SCREW DRIVER (157).
...
HARDWARE FOR STEP | CONSOLE MAST COVER (72) is facing the correct Way.

PART TYPE DESCRIPTION QTY 6. At the top opening of the MAIN FRAME (1), there isa COMPUTER
103 BOLT 3/8"X3/4" 2 CABLE (53) tied to a twist tie wire. Feed the twist tie wire and
104 BOLT 3/8" X UNC16 X 1-1/2” 2 COMPUTER CABLE (53) into the bottom of the CONSOLE
105 BOLT 3/8” X 2-1/4” MAST (12) and out of the opening at the top.
[16 | PHILLIPS HEAD SCREW. M5 X 10mm 4 7. Install the CONSOLE MAST (12) into the receiving bracket on the
120 | SHEET METAL SCREW 3.5 X16mm 3 top of the MAIN FRAME (1). Be extremely careful not to pinch the
130 NYLOC NUT 3/8" X77 2 cables between the tubing. If the cable gets pinched, this may affect the
137 FLAT WASHER 3/8" x O19 x 1ST 2 electrical functions of the console.
142 FLAT WASHER 5/16" X 20 X 1.5T 4 NOTE: There is one bolt already installed in the receiving bracket that
15 SPLIT WASHER 8X I.5T (5/16"X 1.57) 4 will engage with the slot at the bottom of the Console Mast. This needs
152 SPLIT WASHER @|0x 27 | to be tightened last, after the three other Console Mast bolts.
153 |__ CURVED WASHER 93/8" * 23 x IT 2 8. Place a SPLIT WASHER (152) onto the HEX HEAD BOLT (105)
54 STAR WASHER 5/16 4 and hand tighten through the left side of the Console Mast. Place a
185 BOLT S/16"X 2 - 1/4" 4 CURVED WASHER (153) onto each HEX HEAD BOLT (103)

and thread both into the front of the Console Mast tube. Fasten these

Gather HARDWARE FOR STEP I. front bolts as tight as possible with the WRENCH (155). Next firmly

Slide the INCLINE RAIL ASSEMBLY (2) into the U channel of the tighten the two left side bolts with the same wrench.
MAIN FRAME (1).Be very careful not to damage the wires that exit 9. Connect the 2 HAND PULSE CABLES (47), RESISTANCE
each part. CABLE (49), and COMPUTER CABLE (53) to the back of the

Connect the INCLINE RAIL ASSEMBLY (2) horizontally to the U way and are diferent secs to prevent confusion. Stare the encessve
channel of the MAIN FRAME (1) with 2 HEX HEAD BOLTS (104), ee the CONSOLE MAST TUBE (12).
2 FLAT WASHERS (137), and 2 NYLOC NUTS (130). Secure it ;
...
Connect the INCLINE MOTOR WIRES (46 & 47) to the wiring
harness & black wire that exits the INCLINE RAIL ASSEMBLY (2).
Push the excess cable inside the U channel.

Locate the CONSOLE MAST (12) and CONSOLE MAST COVER
(72); slide the Cover onto the mast as far as it will go. Make sure the

     XE395 STEP TWO
                                       HARDWARE FOR STEP 2
                        PART         TYPE             DESCRIPTION         QTY
                         141      FLAT WASHER        5/16” X 23 X 1.5T      2
                         142      FLAT WASHER        5/16” X 20 X 1.5T      2
                         196     WAVE WASHER                Ø17             2
                         184         BOLT               5/16” X 15L         2
                         186         BOLT             5/16” X 1 - 1/4”      2
                         192      NYLOC NUT             5/16” X 9T          2


          196    196   1. Gather HARDWARE FOR STEP 2.
...
PART TYPE DESCRIPTION QTY
141 FLAT WASHER 5/16" X 23 X 15ST 2
142 FLAT WASHER 5/16" X 20 X I.5T 2
196 WAVE WASHER O1\7 2
184 BOLT 5/16" X 15L 2
186 BOLT 5/16" X | - 1/4" 2
192 NYLOC NUT 5/16" X 9T 2
...
2. Slide 2 WAVE WASHERS (196) onto each side
of the Swing Arm Axle. Slide the LOWER SWING
ARMS (10 LEFT,I | RIGHT) onto the axles
and secure with the 2 BOLTS (184) and FLAT
WASHERS (141). Do not force the Swing Arms
onto the axle. They should slide on, but you may
need to jiggle them to get them lined up properly.
...
XE395 STEP THREE
                                   HARDWARE FOR STEP 3
                    PART          TYPE            DESCRIPTION       QTY
                     127       NYLOC NUT             5/16” X 7T      6
                     159          BOLT             5/16” X 1-3/4”    6
                     160     CURVED WASHER         8 X 23 X1.5T      4
...
     XE395 STEP FOUR
                                        HARDWARE FOR STEP 4
                         PART           TYPE             DESCRIPTION        QTY
                          115    PHILLIPS HEAD SCREW       M5 X12MM          12
                          119    SHEET METAL SCREW         3.5 X 12MM         8
                          122    PHILLIPS HEAD SCREW       M6 X 10MM          4
...
16
5. Attach a STEEL BRACKET (180) to the Rear Stabilizer Tube on the
...
6. Attach the front REAR STABILIZER COVER (87) to the REAR
   ...
   PHILLIPS HEAD SCREW DRIVER (157).
7. Look closely at the four floor levelers underneath the middle and
   rear of the elliptical. If any of these aren’t in contact with the floor, use
   ...
   with the floor. Retighten the top nut to prevent it from moving.
8. Return the elevation to the flat position using the Incline down key.




                                                                                   17
     XE395 CONSOLE OPERATION
             ...
             Activation Profile
                ...
                Large LCD with
        scrolling feedback and    Heart Rate % Profile
     scrolling message center
                ...
                keep you cool
                                  ...
                                  Ten innovative
                                  programs offer a
           Convenient cargo       variety of work-outs
...
XMES9SS CONSOLE OPERATION

Muscle
Activation Profile 99000 =e me 860000 6 CMPRORLE.
6665 90.00 oo He
...
. I _=
scrolling feedback and MUSCLE PROFILE 5 fg Heart Rate % Profile
scrolling message center
...
Convenient cargo
compartment for keys, |
phone, or MP3 player GezAaASoVM iW 2L_YSPY ®

MANUAL HILL. FATBURN CARDIO STRENGTH INTERVAL USER1 USER-2 HRI -HR-2

\ ele
‘ ee | FAN J START LEVEL sTO ) : Easy-Touch

Control Keys


MUSCLE ACTIVATION FIGURE
There is an anatomical figure located at the top of the console. This figure will light all areas that are activated when using
...
any of the 10 programs. The significance of the bar graph colors are as follows:
...
This program follows a triangle or pyramid type ee oe
of gradual progression from approximately 10% of ee
maximum effort (the level that you chose before
starting this program) up to a maximum effort
which lasts for 10% of the total workout time, then a
gradual regression of resistance back to approximately 10% of maximum effort.
...
This program follows a quick progression up to the maximum resistance level (default or user input
level) that is sustained for 2/3 of the workout. This program will challenge your ability to sustain your
energy output for an extended period of time. AR FATHORN ia
Incline: The pedal elevation is a quick and sustained
...
‘CARDIO Work Profile ‘CARDIO Incline Profil

TT

STRENGTH

This program has a gradual progression of STRENGTI No al STRENGT in Pie
resistance up to 100% of maximum effort that is = FAFA
sustained for 25% of workout duration. This will i:
...
INTERVAL Work Profile INTERVAL Incline Profile
...
Incline: This program will spike similar to the resistance profile, but in different segments (columns); this
...
     two programs, User 1 and User 2, operate exactly the same way so there is no reason to describe
     ...
     2.   If you have already saved a program to either U1 or U2, it will be displayed and you are ready to begin. If not, you will
          ...
          Down buttons to select the appropriate first letter of your name (pressing the up button will switch to the letter
          “B”; pressing the Down button will switch to letter “Z”). Press Enter when the desired letter is displayed. Repeat this
          process until all of the characters of your name have been programmed (maximum 7 characters). When finished press
          Stop.
...
28        process as the last segment then press Enter. Continue this process until all twenty segments have been set.
10. Now you are asked to adjust the Max Incline Level of the program, press Enter when incline has been selected.
11. Now the first column will be blinking and you are asked to adjust the incline level for the first segment (SEGMENT >
...
overpowered by the benefits of exercising comfortably. A
great deal of this success has been promoted by the use of
heart rate monitors. With the proper use of a heart rate
monitor, many people find that their usual choice of exercise
...
you must first determine your Maximum Heart Rate. This can
be accomplished by using the following formula: 220 minus your age. This will give you the Maximum
Heart Rate (MHR)for someone of your age. To determine the effective heart rate range for specific
...
| 1. Now the first column will be blinking and you are asked to adjust the incline level for the first segment (SEGMENT >
|) of the workout by using the Level Up key.When you finish adjusting the first segment, or if you don't want to change,
then press Enter to continue to the next segment.
...
Heart Rate Programs 120 TRAINING CHART
The old motto, "no pain, no gain”, is a myth that has been g - oe
overpowered by the benefits of exercising comfortably. A % aso Pate
great deal of this success has been promoted by the use of H 140
heart rate monitors. With the proper use of a heart rate = 130
monitor, many people find that their usual choice of exercise | § 17°
intensity was either too high or too low and exercise is much ° .
more enjoyable by maintaining their heart rate in the desired 90
benefit range. a tad
...
goals you simply calculate a percentage of your MHR. Your Heart rate training zone is 50% to 90%
     ...
     of your maximum heart rate. 60% of your MHR is the recommended for burning fat while 80% is
...
6Rating Perception of Effort10 Very light +
   Minimal                                                         14 Somewhat hard +                18 Very hard +
...
earlier. That is the major benefit of this type of training. If your body is strong and rested, you will feel strong and your pace
                                                                                                                                     31
...
BdtlingrRerception of Effort|O Very light + |4 Somewhat hard + 18 Very hard +
...
You can get an approximate heart rate level for each rating by simply adding a zero to each rating. For example a rating of
|2 will result in an approximate heart rate of |20 beats per minute. Your RPE will vary depending up the factors discussed
earlier That is the major benefit of this type of training. If your body is strong and rested, you will feel strong and your pace
will feel easier When your body is in this condition, you are able to train harder and the RPE will support this. If you are
     ...
     3.   Position the transmitter with the logo centered in the middle of your torso facing away
          ...
          the final end of the elastic strap by inserting the round end and, using the locking parts, secure the transmitter and strap
          around your chest.
     ...
     5.   Sweat is the best conductor to measure very minute heart beat electrical signals. However, plain water can also be used
          ...
          body chemistry, have a more difficult time in achieving a strong, steady signal at the beginning. After “warming up”, this
          problem lessens.
...
34   After selecting your heart rate target the program will attempt to keep you at or within 3-5 heart
...
     GENERAL MAINTENANCE
     ...
     2.   If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of several reasons:
          ...
          II. Dirt build-up on the rear rails and polyurethane wheels are also a source of noise. Noise from build-up on the rails
                ...
                noise travels, and is amplified, in the tubing of the frame. Clean the rails and wheels with a lint free cloth and rub-
                bing alcohol. Stubborn build-up can be removed with your thumbnail or a nonmetallic scraper, like the back edge of
                a plastic knife. After cleaning, apply a small amount of lubricant on the rails with your fingers or a lint free cloth. You

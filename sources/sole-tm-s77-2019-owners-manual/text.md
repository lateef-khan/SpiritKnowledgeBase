...
A | IF N TI O . Before returning your Sole product to any retailer, or if you require any assistance with assembly or
...
m~ Keep children under the age of 13 away from this machine. There are obvious pinch
...
m= Use caution while participating in other activities while walking on your treadmill; such as
...
$77 ASSEMBLY PACK CHECKLIST
HARDWARE STEP 3

() O

#79, O3/8"xX O19 X 1.5T_ #86. 010 x 1.5T_ #124. O8 x 23 X 1.5T_
Flat Washer (6 pcs) Split Washer (6 pcs) Curved Washer (4 pcs)

cc

Wi ( mn

#100. 5/16" x 3/4"_Button #123. 3/8" X 2-1/2"_Button
Head Socket Bolt (4 pcs) Head Socket Bolt (6 pcs)

HARDWARE STEP 5

O (coum
#86. 010 x 1.5T_ #91. 3/8" x 1-3/4"_
...
#100. 5/16" x 3/4"_
Button Head Socket Bolt (4 pcs) #62. Safety Key
...
#103. Combination M5 Allen Wrench #104. M6 L Allen Wrench
...
1. Remove four Flat Head Socket Bolts (102) by Allen Wrench (103)
and then remove two Fixing Plate Stabilizer (101).

2. Slide the lower handlebar covers (52 & 53) onto the console masts
(notice orientation).

3. Slide the Frame Base Caps (98 & 99) over the Upright tubes (4 & 5).
Connect the Lower Computer Cable (33) to the Middle Computer
Cable (32) on the right side of the unit.
...
#100. 5/16" x 3/4"_Button
Head Socket Bolt (4 pcs)
#123. 3/8" x 2-1/2"_Buttom
Head Socket Bolt (6 pcs)
#124. 8 x 23 x 1.5T_
Curved Washer (4 pcs)

1. Attach the Upright Tubes (4 & 5) onto the Main Frame (1) and use
Combination Allen Wrench & Phillips Head Screw Driver (103) to
tighten four Button Head Socket Bolts (100) and four Curved
Washers(124) and then use Allen Wrench (104) to tighten six
Button Head Socket Bolts (123), six Flat Washers(79) and six Split
Washers (86) going through Left and Right Gussets (7 & 8).Do not
tighten the bolts completely until Step 7 is finished.

To complete this step, it is recommended that you find something to

rest the console on at the appropriate height or have someone hold

the console while you connect the cables

1. Connect the Speed Adjustment Switch Cable (37) to the Speed
Cable, Upper (34). Connect the Incline Adjustment Switch Cable
(38) to the Incline Cable, Upper (35). Connect the Computer Cable,
Middle (32) and Computer Cable, Upper (31). Tuck the excess
cable into the hand rail tubing to prevent it from getting pinched.
...
1. Attach the Console Assembly (36) onto the Upright Tubes (4 & 5)
and attach with four Button Head Socket Bolts (91) and four
Split Washers (86). Tighten using the M6 Allen Wrench (104).
Tighten completely.
...
1. Attach the Left (52) and Right (53) Lower Handlebar Covers to
the console with four Sheet Metal Screws (125). Tighten with
the Combination M5 Allen Wrench & Phillips Head Screw Driver
(103).
...
with four Button Head Socket Bolts (100). Tighten bolts firmly.

2. Place the Beverage Holder (118) on top of the Support tube (3)
as shown in the illustration.

3. Place the magnet of the safety key (62) in between the Start
...
2. Attach the Console mast covers (98 & 99) to the Frame Base (2)
with four Phillips Head Screws (134). Tighten screws using the
...
1. Insert Tablet Holder (177) into the Console Assembly (36) and use
Combination M5 Allen Wrench & Phillips Head Screw Drive (103)
to tighten four of Sheet Metal Screw (125).
...
m Press and hold the Incline A/V keys (console or handgrip) to achieve desired level of effort.
...
m= The Incline Window display will indicate incline position as adjustments are made.
...
Eighteen columns of dots, 8 high for the $77 indicate
...
There is an Audio Input Jack (42) on the front of the console and built-in speakers. You may plug
...
<!-- render-vs-extraction: 188 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
PULSE FEATURE
...
The S77 have ten built-in programs: one Manual program, five preset profiles, two user defined
...
2. Inthe setting, the menu will display Age at first item. You may use any of the Incline 4/¥ or
Speed a/¥ keys to adjust your age. After adjusting press the Enter key.
...
Entering the correct body weight will affect the calorie count. Use the Incline 4/¥ keys or the
Speed A/V to adjust, then press Enter.
™ Calorie Display Note: No exercise machine can give you an exact calorie count because there are
too many factors which determine exact calorie burn for a particular person. Even if someone is the
exact same body weight, age and height, their calorie burn may be very different than yours.
...
Incline 4/¥ keys or the Speed A/V keys to adjust, and then press Enter. After adjusting, press
the Enter key.
...
MAX SPEED Age weiont me MAX SPEED
...
<!-- render-vs-extraction: 138 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
USER PROGRAMS

1. Select User 1 or User 2 via the Program keys. Meco ty cco
Note that the dot matrix display portion will haveasinglerow }|UILEN 1 7 UAIEN |
of dots at the bottom (Unless there is a previously stored
program).
...
then “B” will be displayed; if the any V_ key is pressed, the
...
Speed A/V or keys, adjust the speed level to your desired
...
. = 170 Ninny
target heart rate zone is calculated: 5 by,
= 160 Sarg
= Rate
. 2 150
...
<!-- render-vs-extraction: 340 words the text layer does not have; tesseract --psm 4 at 300 dpi -->

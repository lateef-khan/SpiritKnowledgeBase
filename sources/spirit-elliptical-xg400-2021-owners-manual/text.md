...
    Congratulations on your new E•Glide Trainer and welcome to the Spirit Fitness family!
    ...
    for many years to come. If not purchased direct from Spirit Fitness, the local dealership where you purchased this E•Glide
    Trainer is your administrator for all Spirit Fitness warranty and service needs. Their responsibility is to provide you with
...
shock, or injury to persons, install the E•Glide on a flat
                                                                  the like.
level surface with access to a 115-volt, 15-amp grounded
                                                              •   Never drop or insert any object into any opening.
outlet with only the E•Glide plugged into the circuit.
                                                              •   Do not use outdoors.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 18AWG OR          •   Do not operate where aerosol (spray) products are
...
•   Close supervision is necessary when this appliance
    ...
    persons.                                                  SAVE THESE INSTRUCTIONS - THINK SAFETY!
•   Use this appliance only for its intended use as
    described in this manual. Do not use attachments not                                                                   5
    Fitness Equipment Safety
    Instructions                                                 Failure to follow all guidelines may compromise the
    ...
    •   Do not operate equipment on deeply padded, plush
        or shag carpet. Damage to both carpet and equipment      Important Electrical Instructions
        may result.
    •   Before beginning this or any exercise program, consult       WARNING
        a physician. This is especially important for persons    NEVER remove any cover without first disconnecting
        over the age of 35 or persons with pre-existing health   AC power. If voltage varies by ten percent (10%) or
        conditions.                                              more, the performance of your E•Glide may be affected.
    •   Do not attempt to use your equipment for any             Such conditions are not covered under your warranty. If
        purpose other than for the purpose it is intended.       you suspect the voltage is low, contact your local power
    •   Keep hands away from all moving parts.                   company or a licensed electrician for proper testing.
    •   The pulse sensors are not medical devices. Their
        purpose is to provide you with an approximate            NEVER expose this E•Glide to rain or moisture. This
        measurement in relation to your target heart rate.       product is NOT designed for use outdoors, near a pool
        Use of a chest transmitter strap (sold separately) is    or spa, or in any other high humidity environment. The
        a much more accurate method of heart rate analysis       operating temperature specification is 40 to 120 degrees
        .Various factors, including the user’s movement,         Fahrenheit, and humidity is 95% non-condensing (no water
        may affect the accuracy of heart rate readings. The      drops forming on surfaces).
        pulse sensors are intended only as exercise aids in
        determining heart rate trends in general.                Circuit Breakers: Some circuit breakers used in homes
    •   Wear proper shoes. High heels, dress shoes, sandals      are not rated for high inrush currents that can occur
        or bare feet are not suitable for use on your            when a E•Glide is first turned on or even during use. If
        equipment. Quality athletic shoes are recommended        your E•Glide is tripping the house circuit breaker (even
        to avoid leg fatigue.                                    though it is the proper current rating) but the circuit
6
breaker on the E•Glide itself does not trip, you will need     This product is for use on a nominal 110-volt/15 amp
to replace the home breaker with a high inrush type.           dedicated circuit, and has a grounding plug that looks
This is not a warranty defect. This is a condition we          like the plug illustrated below. A temporary adapter that
as a manufacture have no ability to control. This part is      looks like the adapter illustrated below may be used
available through most electrical supply stores. Examples:     to connect this plug to a 2-pole receptacle as shown
Grainger part # 1D237, or available online at www.squared.     below if a properly grounded outlet is not available. The
com part #QO120HM.The electrical outlet used should have a     temporary adapter should be used only until a properly
dedicated 15 amp circuit breaker.                              grounded outlet, (shown below) can be installed by a
                                                               qualified electrician. The green colored rigid ear-lug, or the
Grounding Instructions                                         like, extending from the adapter, must be connected to a
                                                               permanent ground such as a properly grounded outlet box
This product must be grounded. If the your                     cover. Whenever the adapter is used, it must be held in
equipment should malfunction or breakdown, grounding           place by a metal screw.
...
Check with a qualified electrician or serviceman if you are         WARNING: This product can expose you to
in doubt as to whether the product is properly grounded.       chemicals including Toluene and Acrylamide which are
Do not modify the plug provided with the product if it         known to the State of California to cause cancer and birth
will not fit the outlet; have a proper outlet installed by a   defects or other reproductive harm.
qualified electrician.                                         For more information go to www.P65Warnings.ca.gov
...
      SPEAKERS
     ...
     LEVELERS
       ...
       REAR STABILIZER
10
XG400 STEP ONE                       HARDWARE FOR STEP 1
                 ...
                 8. Place the hand brake bracket around the front of the right handlebar
                    ...
                    SCREW DRIVER (107)
                                                                                               ...
                                                                                               11
     XG400 STEP TWO                  HARDWARE FOR STEP 2
                       PART         TYPE       DESCRIPTION               QTY
                         24      CUP WASHER                                2
                      ...
                      3. Slide the TWO SWING ARMS (8 RIGHT & 9
                         ...
                         previously installed at the factory and should fit properly,
...
12                       with the PHILLIPS HEAD SCREW DRIVER (107).
XG400 STEP THREE                HARDWARE FOR STEP 3
                    PART        TYPE      DESCRIPTION             QTY
                   ...
                   3. Snap the 4 END CAPS (67) onto the
                      ...
                      assemblies.
                                                                        ...
                                                                        13
     XG400 STEP FOUR                 HARDWARE FOR STEP 4
                        PART          TYPE      DESCRIPTION          QTY
...
14
XG400 STEP FIVE                 HARDWARE FOR STEP 5
                   PART          TYPE      DESCRIPTION            QTY
                    71        ROUND CAP                             6
                    83          LEVELERS                            6
                  ...
                  2. Tilt the e•Glide Trainer to one side and put
                     ...
                     using only the front and rear levelers first, then
                     adjust the middle levelers so they touch the floor.
...
The E•Glide Trainer has a built in heart rate monitoring system. Simply grasping the hand pulse          19
...
22
Preset Programs
The E•Glide has five different programs that have been designed for a variety of workouts. These
...
     STRENGTH
     ...
     fibers which are used when performing tasks that are intense and short
...
2.   If you have already saved a program to either U1 or U2, it will be displayed and you are ready to begin. If not, you
     ...
     Up/Down buttons to select the appropriate first letter of your name (pressing the up button will switch to the
     letter “B”; pressing the Down button will switch to letter “Z”). Press Enter when the desired letter is displayed.
     Repeat this process until all of the characters of your name have been programmed (maximum 7 characters). When              25
     finished press Stop.
...
26   in the desired benefit range.
...
discussed earlier. That is the major benefit of this type of training. If your body is strong and rested, you will feel strong
...
     GENERAL MAINTENANCE
     ...
     2.   If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of several reasons:
          I. The hardware was not sufficiently tightened during assembly. All bolts that were installed during assembly need
                ...
                cannot tighten the bolts sufficiently. I cannot stress this point enough; 90% of calls to the service department for
...
4.   Security (Allows the keypad to be locked to prevent unauthorized use)
                                                                                                                       ...
                                                                                                                       35
     E•Glide Trainer Warranty - Effective November 30, 2021
...
36   4.   Products with original serial numbers that have been removed or altered.

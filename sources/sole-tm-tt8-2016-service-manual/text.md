...
11. Disassembling and assembling of Parts
    ...
    11.7 Running Deck/ Belt/ Cushion and running deck wax replacement
    ...
    11.9 Incline Motor Replacement
                                  ...
                                  3                                     Service Manual
Special Note on ST925 CE version:
...
DECLINE MOTOR
 The function is the same as incline motor narrative.
                                                                        ...
                                                                        13                               Service Manual
4. ST925 Treadmill Product Operation
...
Function Button Locations
     ...
     GRADE quick keys
   -4 / -2 / 2 / 4 / 6 / 9 / 12                                                    SPEED quick keys
                                                                                  2 / 3 / 4 / 5 / 7 /9 / 12
...
RUN MODE
  ...
  Press DISPLAY key to switch the exercise data shown on the message window when you are workout. The information as below,
      ...
      MAX SPEED XX.X
                                                                  ...
                                                                  20                                                        Service Manual
5.ST925 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          22   Service Manual
6. ST925 Treadmill Basic Connections and Wiring
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           35                                                              Service Manual
8.ST925 Treadmill Error Messages /
         Troubleshooting
...
11. Disassembling and assembling
            of Parts
               ...
               73             Service Manual
11-1. Lower Controller Replacement
     1. Use a Phillips Head Screw Driver to loosen the 2 Phillips Head Screw and 2 tapping screws on motor cover, then
     ...
     2. Disconnect all lower controller wirings, Use Phillips head Screwdriver to remove, replace with new lower controller and
         reconnect all wirings.
                                                             ...
                                                             74                                                 Service Manual
11-2. Console Replacement
     1.   Use L Allen wrench to remove 6 button head socket bolts from the upright cover.
     ...
     3.   Disconnect console wirings and replace with new console.
                                                             ...
                                                             75                               Service Manual
11-3. Motor Replacement
     1. Use Phillips head screwdriver to remove 2 Phillips Head Screws and 2 Tapping Screws securing the motor cover.
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
   70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws. Connect grounding wires
   and motor wires (red M+, black M-)
...
11-6. Front/ Rear Roller Replacement
     ...
     3.   Remove motor cover, use 14mm T-shaped socket wrench to loosen 4 screws. Use 14mm open end wrench to loosen
          ...
          rollers, and replace with new. Reassemble in reverse orderof disassembly. When reassembled, running belt tension
...
11-7. Running Deck/ Belt/ Cushion and running deck wax                           replacement
     ...
     2. Use a Phillips head screwdriver to loosen 6 screws, remove the top step cover in the direction of the indicating arrows
        and remove 8 screws on the front and back of the foot rail then remove the front and back of foot rail in the direction of
        the indicating arrows.
                                                              ...
                                                              81                                                   Service Manual
3. User Combination M5 Allen Wrench to remove the 8 screws securing the running board. Remove the running board
   and replace running board or running belt. If cushions need to be replaced, remove 6 cushions and replace.
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
   70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws.
                                                     ...
                                                     82                                              Service Manual
5. After changing the running deck, need to walk S type for 1km and square type for 3km around 10 minutes, so that the
   wax will evenly on the running deck.
...
11-9. Incline Motor Replacement
        1.   First adjust treadmill to folded position, then proceed with old incline motor replacement.
                                                                   ...
                                                                   84                                         Service Manual
2.   Incline Range must be adjusted to 235 mm minimum prior to installation.

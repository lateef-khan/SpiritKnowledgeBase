...
" OWNER’S MANUAL
a Please carefully read this entire manual
...
E55 ASSEMBLY PACK CHECKLIST
7 HARDWARE STEP 1

O © &

#171. 3/8"x 19 x 1.5T #166. 5/16"x 20x 1.5T Nr. Nutow
Flat Washer (6 pcs) Flat Washer (4 pcs) ylon NUL \< pcs
#175, 3/8"x 2T #140. M5 x 10mm #129. 3/8”x 3/4”
Split Washer (4 pc) Phillips Head Screw (6 pcs) Hex Head Bolt (4 pc)
...
#166. 5/16" Soc). OT #170. 85x26 x2) #155.5/16" x 7T

HARDWARE STEP 3

(ey i

#65. Switch Wire Cap #155. 5/16" X 7T #178. 8 x 23 X 1.5T
(2 pcs) Nyloc Nut (6 pcs) Curved Washer (4 pcs)
...
#138. M5 x 15mm #146. M6 x 10mm #145. @3.5 x 12mm
...
#186. 13/14mm Wrench #189. 12/14mm Wrench #187. Short Phillips
(160mm) (160mm) Head Screwdriver
#188. Phillips Head Screwdriver #197. L Allen Wrench

E55 ASSEMBLY INSTRUCTIONS
PRE-ASSEMBLY
...
E55 ASSEMBLY INSTRUCTIONS
INCLINE BASE & MAST ASSEMBLY

See Page 9 for Illustration HAR pee STE. 1
1. Install the Incline Rail Assembly (2) into the U-channel bracket of the Main Washer (6 pcs)
Frame (1). Secure with the six bolts & associated hardware as follows: From the }|#166. 5/16" x 20 x 1.5T Flat
sides install two Hex Head Bolts (128) with two Flat Washers (171) and two pelea ee
Nylon Nuts (158). From the top install four Hex Head Bolts (124), four Split Split Washer (4 pc)
Washers (176), four Flat Washers (166), and four Star Washers (177), as shown |#140. M5 x 10mm
in figure1 and tighten with the Wrenches provided (186 & 189) Phillips Head Screw (6 pcs)

2. Connect the 3 wire harness (43) to the female receiver cable coming from the |#158. 3/8" x 7T
Incline rail assembly (2). Connect the Three pin position Sensor connector (44) ne lee er
to the female receiver coming from the Incline rail assembly (2). Split Washer (4 cs)

3. Locate the Console Mast (12) and Console Mast Cover (95) and slide the #177. 5/16"
Cover onto the Mast as far as it will go. Make sure the Console Mast Cover is Star Washer (4 pcs)
facing the correct way. At the top opening of the Main Frame of the elliptical is |#124. 5/16” x 2-1/4" Hex
a Computer Cable (45). Secure the free end of the twist tie that exits the Head Bolt (4 pcs)
bottom of the console mast (12) to this cable. Pull the opposite end of this #128. 3/8" x 1-1/2
twist tie up through the console mast (12) until the cable exits the top. Install Hex Head Bolt (2 pes)

: - - #129, 3/8” x3/4"
the Console Mast (12) into the receiving bracket on the top of the Main Frame = |Hex Head Bolt (4 pc)

(1). Pull slightly on the computer cable at the top of the mast while installing.
This will ensure the cable does not get pinched and shorted during console
mast assembly.

4. Install four Socket Head Cap Bolts (129) with four Split Washer(175) , four Flat
Washers (171) and tighten with the provided L Allen Wrench (197). Pull
slightly on the computer cable at the top of the mast while installing. This will
ensure the cable does not get pinched and shorted during console mast
assembly.

5. Plug all of the connectors into the back of the console; Computer Cable (45),
two Hand pulse Cables (52), Resistance switch wire (55) and Incline switch
wire (56). Secure the Console (40) on the console mounting plate with four
Phillips Head Screws (140).

6. Install the Bottle Holder (105) to the Console Mast (12) with two Phillips Head
Screws (140) and tighten with the provided Phillips Head Screw Driver (188)
+ Please note the bottle holder must be assembled before console assembly.

HANDLE BAR ASSEMBLY

: HARDWARE STEP 2

See Page 9 for Illustration #166. 5/16" x 20x 1.5T
1. Place left and right Lower Handle Bars (10) (11) onto left side and right Flat Washer (2 pcs)

side of Console mast shafts, respectively and secure with Hex Head Bolts #170. 8.5 x 26 x 2T

(120) together with Flat Washers (170) by using Wrench (189). Flat Washer (2 pcs)

; . . #155.5/16" x 7T

2. Untie the rod end bearing on left Connecting Arm (8). Insert Hex Head Nyloc Nut (2 pcs)

bolt (122) through the rod end bearing bracket on Swing Arm (10) and #122. 5/16" x 1-1/4"

use 13/14mm wrench (186) and wrench (189) to tighten together with Hex Head Bolt (2 pcs)

flat washer (166) and nyloc nut (155) in the rod end bearing bracket on #120. 5/16" x 15 m/m

left Swing Arm. Fix right Swing Arm (11) and right Connecting Arm (9) Hex Head Bolt (2 pcs)

with the same way and hardware.
...
CONNECTING ARM ASSEMBLY “y65-Suitch Wire Cap

: (2 pcs)
See Page 11 for Illustration #155, 5/16"x7T
1. Insert left Top Handle Bar (19) onto left Lower Handle Bar and secure Nyloc Nut (6 pcs)
with three Hex Head Bolts (123), two Curved Washers (178) and three a 78. ow “a eo
Nyloc Nuts (155) by using Wrench (186). Secure the right Top Handle Bar 4123. se" ais
(20) onto the right Lower Handle Bar the same way. Hex Head Bolt (6 pcs)

2. Connect Upper Resistance Handle Wire (55) with Lower
Resistance/Incline Handle Wire (57) and store it in the frame tube and
snap in Switch Wire Cap (65) on the console mast. Again, connect Upper
Incline Handle Wire (56) with Lower Resistance/Incline Handle Wire (57)
and store it in the frame tube. Snap in Switch Wire Cap (65) on the
console mast.
...
PLASTIC PARTS Philips Head Screw

(20 pcs)

See Page 11 for Illustration #146. M6 x 10mm
Use either screw driver (187 or 188) to secure the following plastic parts. th Oy Head Screw
1. Match right and left Connecting Arm Covers (92, 93) on left Connecting #145. 3.5 x 12mm

Arm and fix with two Phillips Head Screws (138) and one Sheet Metal Sheet Metal Screw

Screw (145) by using Short Phillips Head Screw Driver (187). Secure the (14 pcs)

left Connecting Arm Covers (92, 93) onto the right Connecting Arm the

same way.

2. Install Sliding Wheel Covers (94) on each side and secure with four
Phillips Head Screws (138).

3. Install the two Stabilizer Covers (115 and 116) on the middle stabilizer
bar with two Phillips Head Screws (138).

4. Install the Front Stabilizer Cover (110) on the front stabilizer with two
Phillips Head Screws (138)

5. _ Install the two incline Cover brackets (21), with the hole for mounting
the plastic cover on the bent tab facing rearward, and secure them on
the Incline Rail Assembly (2) with four Phillips Head Screws (146). Install
the Rear incline bar cover (113) on the rail base with two Screws (138).

6. Install the Rear Stabilizer Cover (114) on the Rear Stabilizer with two
Phillips Head Screws (138).

7. Plug in the power cord. Raise the incline 3~8 levels by using the Incline
A button on the console. Attach the Incline Bottom Cover (111) on both
sides of Incline Rail Assembly with two Phillips Head Screws(138) by
using Phillips head screw driver (188).

8. Match up the console covers (95 & 95-1) and secure with four sheet
metal screws (145).

9. Install the Handle Bar Covers (106 & 107, 108 & 109) over the Handle Bar
axle connections and secure with the four Sheet Metal Screws (145).

10. Install the Tablet Holder (104) to back of the console with four Sheet
Metal Screws (145).
...
The E55 has an incline feature that will further increase the variety of your workouts. When the
...
The E55 has a computer controlled power incline. The power incline is controlled by buttons on

the console and swing arms and will automatically adjust via the incline motor
during the built-in workout program.
...
DATA WINDOWS
(Pulse, Time, Level, Pace,
Distance, Calories)

MESSAGE WINDOW

(Program name, Lap, Rpm,
Watts, Segment time)

= A OO
Hd WU B=
ie. he
OR ARR BR OR OR Be OR BO DO
...
MANUAL wn FATBURN CARDIO. —«STRENGTH

CONTROL KEYS oa “~

nur USER 1 USER 2 ver vue

— INCLINE. = LEVEL —

ne) & OB = HEADPHONE JACK

AUDIO IN JACK
(MP3, CD, OR S ormetay == stop FAN ~~
SMARTPHONE) fi a

POWER UP

When power is connected to the elliptical the console will automatically power up. These models are connected
directly to 115 VAC and there is a power switch located where the line cord plugs into the unit on the left side near
...
startup display. The dot matrix display will be scrolling through the different workout profiles and the
...
this will initiate the Start key mode. In Start key, the time
will count up from zero. The resistance level and incline
can be adjusted manually by pressing the Level a/v &
incline 4/¥ buttons. The dot matrix display will be
...
Pressing the Stop key once during a program will
Pause the program for 5 minutes. If you need to get a se
drink, answer the phone or any of the many things that [assesses
could interrupt your workout, this is a great feature. To | ie ole 2.
resume your workout during Pause just press the Start —s a

key. If the Stop button is pressed twice during a

workout the program will end and a Workout .
...
There is an Audio In Jack (£2) on the front of the console and built-in speakers. You may plug
any low-level audio source signal into this port. Audio sources include MP3, iPod, portable radio,
CD player or even aTV or computer audio signal. There is also a Headphone Jack (4 )for
private listening.
...
will be saved as the new default settings. If you enter Age and Weight the first time you use the elliptical you will not have
to enter it every time you work out unless either Age or Weight has changed or someone else enters a different Age and
Weight.
...
***The USB port on the console is capable of powering USB devices. It provides up to 5Vdc/0.5
...
the App is already in use. In order to do such a functional switch, you need to use the heart rate key
on the key board. Take the following steps to achieve this:
...
<!-- render-vs-extraction: 167 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
1. In idle mode, the heart rate Bluetooth LED on the keypad will not be lit if the Bluetooth function
is currently connected with the App.
...
rate chest strap. You can wear the Bluetooth wireless heart rate chest strap first then commence
connection. While in connection, the console will show heart rate value via Bluetooth.
...
pressing the 4/¥ Level keys, then press Enter to continue.

5. Now you are finished editing the settings and can begin
your workout by pressing the Start key. You can also go back
and modify your settings by pressing the Stop key to go
back one level of the programming screen.

6. Once the program starts the elliptical will be set to level one.
This is the easiest level and it is a good idea to stay at level one for a while to warm up. If you
want to increase the work load at any time press the Level « key; the Levelv key will
...
6 BS 69 68 68 68 0 8 BO 68 68 OS 69 BES BS
...
achieved by incorporating a higher level of exertion with slight fluctuations in resistance.
...
2. The Message Window will ask you to enter your Age. You may adjust the age setting,
...
4. Nextis Time. You may adjust the Time and press Enter to continue.

5. Now you are asked to adjust the Max Level. This is the peak exertion level you will experience during the program
(the highest colored segment/box of the program profile). Adjust the level and then press Enter.

6. You can now choose to turn on the incline profile for this program. If you choose to turn off incline, you can still
control the incline manually during your workout, but the automated incline changes will be off. Press the Enter key
when you are finished selecting.

7. Now you are finished editing the settings and can begin your workout by pressing the Start key. You can also go
back and modify your settings by pressing the Stop key to go back one level, or screen.

8. If you want to increase or decrease the resistance or incline at any time during the program press the Incline or Level
A/¥ keys.

9. During the program you will be able to scroll through the data in the Message Window by pressing the Display key.
...
1. Select the User program (U1 or U2) then press Enter. If you have already saved a program to either U1 or U2, it will
be displayed and you are ready to begin. If not, you will have the option of inputing a username. In the Message
Window, the letter “A” will be blinking. Use the 4/¥ Level buttons to select the appropriate first letter of your
name (pressing the Level 4/¥ button will switch to the letter “B”; pressing the Down button will switch to letter
“Z"). Press Enter when the desired letter is displayed. Repeat this process until all of the characters of your name
have been programmed (maximum 7 characters). When finished press Stop.

2. If there is a program already stored in User when you press the key, you will have an option to run the program as it
is or delete the program and build a new one. At the welcome message screen, when pressing Start or Enter you
will be prompted: Run Program? Use the Level 4/¥ to select Yes or No. If you select No, you will then be asked if
you want to delete the currently saved program. It is necessary to delete the current program if you want to build a
new one.

3. The Message Window will ask you to enter your Age. You may enter your age using the Level 4/¥ keys, then
press the Enter key to accept the new number and proceed on to the next screen.

4. You are now asked to enter your Weight. You may adjust the weight number using the Level 4/¥ keys, then press
Enter to continue.

5. Nextis Time. You may adjust the Time using the Level 4/V keys and press Enter to continue.
...
7. Now the first column will be blinking again and you are asked to adjust the Incline level for the first segment of the
workout. Follow the same procedure for building the Incline profile as you did for the resistance profile.

8. The Message Window will then tell you to start to begin (and save the program) or Enter to modify the program.
Pressing Stop will exit to the start up screen.

9. If you want to increase or decrease the workload at any time during the program press the Incline or Level 4/V
key. This will only affect the Incline or Level for the present column in the profile. When the profile changes to the
...
<!-- render-vs-extraction: 211 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
HEART RATE PROGRAMS
...
of your body facing away from your chest (some people must rn

position the transmitter slightly left of center). Attach the final end 4 .
...
Level a/v keys or the numeric key pad, then press the Enter key to accept the new
number and proceed on to the next screen.

3. You are now asked to enter your Weight. You may adjust the Weight number using the
Level 4/v keys or the numeric key pad, then press Enter to continue.
...
sufficiently. | cannot stress this point enough; 90% of calls to the service department for
noise issues can be traced to loose hardware or the rear rails being dirty.
...
Mode”. Press the Enter button to access the menu below. Press the Level 4/v keys to
...
C. Functions - Press Enter to access settings, use Level A/V keys to scroll
|. ODO Reset - Resets the odometer
ll. Units - Choose from English (Imperial) or Metric display readings
Ill. Display Mode - Turn off to have the console power down automatically after 30 minutes of inactivity
...
A key and the Start key at the same time. Hold them down for 5 seconds and the Incline calibration will
...
<!-- render-vs-extraction: 333 words the text layer does not have; tesseract --psm 4 at 300 dpi -->

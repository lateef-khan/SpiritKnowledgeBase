...
mM Keep children under the age of 13 away from this machine. There are obvious pinch
points and other caution areas that can cause harm.

mM Keep hands away from all moving parts.
...
m= Use handrails provided; they are for your safety.
...
plastic wrap and Styrofoam from beneath
...
1. Connect 9P Computer Cable (Upper) (52-10) with 9P Computer
...
6 ASSEMBLY STEP 6 HARDWARE STEP 6

177 #175. 3.5 x 16m/m_
Sheet Metal Screw
(4 pcs)
...
1. Install Frame Base Cover left (61) and right (62) in Frame Base (2)
and use M5_ Allen Wrench Head Screw Wrench (131) to tighten
4 pcs of Phillips Head Screw (127) and 2 pcs of Phillips Head
Screw (74) into Frame Base (2).
...
m@ *At the rear roller area to relieve pressure on the
locking system.
...
(“Timer”), and up to 6 programs that you have marked as your favorites are arranged on this page for
your quick access.
...
switch between categories using the tabs on the top of the screen: Programs, Fitness Tests,
Templates and Favorites.

: :

Home | Programs Fitness Tests Templates Favorites ot

Manual Hill Fatburn Cardio Strength Air Force Army Coast Guard Gerkin

PEB
015 miles © 20 mies © 15 mies . 15 mites

HIIT 5K Run 10K Run Heart Rate Custom Marine Corps Navy
© 2.0 miles

FH training FH training
...
[cc RR ES =] w23am @ [co RR ES =] w23am @

€ Programs = < uw > € Programs = < 3/10 >

Manual © totaitime - 30 + Fatburn © totaitime - 30 +
‘Speed and incline are controlled Challenge your ability to sustain
by the user. energy output for an extended
@ Speed = @ Incline
Pe
...
Hill, Fatburn, Cardio, Strength and HIIT follow preset speed and incline changing patterns. The
Total Time and Max Speed settings define the duration and overall intensity of your workout.
...
Incine | O | O} 0} O0/;/0)4)]6/0;/0);,0}]0);6);,6)-4)/-4]6)0}]0;]0);0)-3} 0] 0);0}0) 0

Speed | 40 | 40 | 50 | 66 | 66 | 66 | 75 | 75 | 88 | 88 | 75 | 75 | 88 | 66 | 88 | 75 |100| 100} 88 | 75 | 75 | 66 | 66 | 50 | 40 | 40
Cardio

Incline | 0 | O | O} O} 0} 4}]4 {14 4]-3} 4) 4] -2 }-2) 3 | 3 | 3 | -2]-2)} 3} 0;)]0/0;]0);)0);0+4)0
...
groms < 710 > € Programs Set Manually | @S%ofMax | 80% of Max

5K Run ® target speed - 5.8 + Heart Rate © totattime - 30 +

| Follow speed guideline to keep |
within 5 bpm of your target
heart rate.

At the selected speed, s ~ Based on your age, the set percentage
. you will complete this run in of your maximum heart rate equats:
~32 min ~145
...
be adjusted proportionally. Elevation values are absolute and vary from -6 to +15. Elevation pattern is
optional.
...
<!-- render-vs-extraction: 197 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
= —_s 2 Ea Templates Choose Base

Tempo Slow Ten Hill O1
Manual Fatburn Cardio Strength

HUT 5K Run 10K Run Custom

FH train ing Next >

A program can be labeled as a Favorite. Up to 6 favorite programs will appear right on the Home
screen, So you can access them easier. To “like” a program, open the program setup page and tap on
the “ribbon” icon in the upper left corner of the screen. You can find all of the labeled programs under
the Favorites tab: to remove the label, press “Edit Favorites”, or go to the program setup page directly
and un-tap the “ribbon” icon.
...
Choose from 7 options under the Fitness Tests tab. Tap on the test card to open the test setup page.
Please make sure that the physical parameters displayed on this page are correct: this data may affect
the course of the test and its results; if the data is not accurate, press “Edit Parameters” to adjust the
numbers.

Before the test,

e make sure you are in good health; check with your physician before performing any exercise if
...
alternately until you reach 85% of your max heart rate (a heart rate monitor is required for this test).
The time it takes for you to reach 85% determines the test score (VO2 Max). The test starts with a 3-
minute warm-up at a lower speed.

Air Force, Army, Navy, Coast Guard, PEB and Marine Corps are US military tests that measure the
time required for you to cover a certain distance. The speed is controlled manually.
...
To see your latest workout records, press “History” on the main screen of the Training section. Up to
10 records can be stored locally on the console, but you can access your full workout history if you
link your profile to the SOLE+ mobile app. Tap on the record preview to see the full summary. Each
user can only see his or her workouts.

er" 910.54 2% 7.0 Lads
9280. tn * ata “a Te
wre 9445, oe” a
0:30:06 55
an 08:54... 8
...
Tap on the right tab of the bottom panel to access the Media section. Choose from a variety of pre-
installed third party Apps, or use the Mirroring function to cast the content from your smartphone
directly to the console screen. For detailed instructions, press the ? icon.

15 0 4.00~ ©0:30:00 155 © 9.0mm Gar «+ coc te ot Eo oes
...
Once the content is on, use the floating panel for navigation and operating full screen mode. Touch
the panel's top edge and drag the panel around the screen to find the perfect place for it, where it
will not prevent you from interacting with the content. Press Hide Panels to enter the full screen
mode without stats on the top and tabs on the bottom, and Show Panels to bring them back. Use
the arrow button on the right side of the panel to hide & show the text labels: it allows to further
minimize the panel's size. Press “Apps” to go back to the content sources selection.

19 F85 TREADMILL


=== OCR SUPPLEMENT, PDF PAGE 22 ===
<!-- render-vs-extraction: 182 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
Workout Mode
...
15 4.00 wi 0:30:00 155 9.0 mon
...
equipment (shown right). ¥ [D> Google Play | | O Rp Sire |
...
180 x 0.6 = 108 beats per minute © +0
(60% of maximum) a
...
<!-- render-vs-extraction: 108 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
3. Checkif speed sensor is defective. OK [ Nel

4.Check if the cable connecting the OK [ nel |
...
‘s activat : 2. Any bearing damage? ok L nel]
is activated.
3. Motor overheated? OK [ nel |
...
Console showing E4_ | Abnormal motor Motor is not connected properly or even | OK [ |ne[_ |
...
<!-- render-vs-extraction: 369 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
4. _ If no local service is available, SOLE will repair or replace the parts, at SOLE’s option, within the warranty period at no charge for parts. All

<!-- Source: XT385 (385815) Service Manual.pdf. Text is pdftotext -layout; pages a 300 dpi render knows more about than the text layer are appended below under '=== OCR SUPPLEMENT, PDF PAGE n ===' headers. -->
...
12. Disassembling and assembling of Parts
    ...
    12.9 Incline Motor Replacement
                                    ...
                                    3                           Service Manual
Special Note on XT385 CE version:
Besides normal version, XT385 treadmill is with a CE version. Both versions are with exactly the same in functions and outlines except that
the power input is 110AC for normal version versus 230VAC for CE version and an additional Filter Choke circuit is added for CE version as
...
INCLINE MOTOR
 ...
 The green wire is ground.
                                                                        ...
                                                                        13                               Service Manual
4. XT385 Treadmill Product Operation
...
RUN MODE
  ...
  HANDRAIL CONTROL BUTTON：It can turn the handrail switch off.
                                                                      ...
                                                                      20                                                            Service Manual
5.XT385 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          22   Service Manual
6. XT385 Treadmill Basic Connections and Wiring
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           34                                                              Service Manual
8.XT385 Treadmill Error Messages /
         Troubleshooting
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area
   between 70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws. Connect grounding
   wires and motor wires (red M+, black M-)
...
3.   User Phillips head screwdriver to remove the 8 Tapping Screw the running board. Remove the running board and
     replace running board or running belt. If cushions need to be replaced, remove 6 cushions and replace. Reassemble in
     the reverse order as disassembly. When reassembled, center and adjust running belt tension. Belt tension also needs
     to be adjusted.
...
SS > uw
saddn Nid 9 CC apewwNiag i]
O a1dvo HaLNAWOO 318V9 YALNdIWNOD ; @
Zz
Us
=<
£5
...
‘
4 re ‘ as * bien p je ee - ot eek
Sea Vesdssdseeeeee Soe 3 Seok Geek Gees . - ee yuubee be eee
7M * : . p ; c é¢ e oe - 7 a
yo & ;
i
J
...
SUOI}E907] JUBUOdWIOY g4dd pieog Aejdsig 2'9
...
Send and receive speed } |
signal via TX/RX of PM SENSOR MOTOR SPEED
. oo, SIGNAL SIGNAL
...
C9 nmoise-v1.0-151223 , | Te CR ee
> | ¢ a @»
...
ww 5 ~ Pius ~- ~ Ss = -
br B z {z=2 \ {232 \ : {24 \ /=® \ z
= j= 2\ < f/ =F2 \ f iy+ \ = fiz \ f=usz \ a
= oz 6 / 25% \ / x = / == \ } 2 \ t.
- i> 2 j =~ 3 \ / = 3 {/ = \ / oar \. Je
> {2 , ~ 4 22% an 2: re —- \ ~— an -- — > 7
$ gx! ~ \ g=3 / \ #22 / zZ \ &4 / \ =-F / x
Pa ise 2 \ g2: / \ z=? = Lec / \ Ze / =
~ —— s~ J * a ~ aad
Z EA} - \xz-2/ \ 722 / 7 \ + #i \Zs/ s
a = \r £2 J \ 23, - \~ 77 \x £/ Zz
\ } \ x / \ Fi —-~/
\; \ / / \ / \ / |
\ / \ \/ \ / \/ \/ \ }
...
>> Sy w
sede) Nid 9 CC apoww Nida = CC A 2
A1eV9 HALNdWOD S189 431LNdNO5S 5 fF
=
[jz
a =
@

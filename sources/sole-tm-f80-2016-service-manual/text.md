...
12. Disassembling and assembling of Parts
    ...
    12.9 Incline Motor Replacement
                                    ...
                                    3                           Service Manual
Special Note on ST525 CE version:
Besides normal version, ST525 treadmill is with a CE version. Both versions are with exactly the same in functions and outlines except that
...
Console
          ...
          button
                        ...
                        6                               Service Manual
Lower Controller   Incline Motor       Driving Motor
...
INCLINE MOTOR
 ...
 The green wire is ground.
                                                                        ...
                                                                        13                               Service Manual
4. ST525 Treadmill Product Operation
...
RUN MODE
  ...
  DISPLAY KEY：
  Press DISPLAY key to switch the exercise data shown on the message window when you are workout. During SCAN MODE, the data will to
  display automatically every four seconds. The information as below,
       ...
       DATA SCAN
      During DATA SCAN, the system will scan and display automatically every four seconds.




                                                                  20                                                        Service Manual
5.ST525 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          22   Service Manual
6. ST525 Treadmill Basic Connections and Wiring
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           34                                                              Service Manual
8.ST525 Treadmill Error Messages /
         Troubleshooting
...
Incline motor    2. Inspect whether the incline gears are cracked.
...
12-1 Lower Controller Replacement
    ...
    2.   Disconnect all lower controller wirings, Use Phillips head Screwdriver to remove, replace with new lower controller and
         reconnect all wirings.
                                                              ...
                                                              75                                                  Service Manual
12-2 Console Replacement
    1. Upright Cover Use M5 L Allen wrench to remove 6 sheet metal screws from the upright cover.
...
12-3 Motor Replacement
    ...
    3. Use 14mm T-shaped socket wrench to loosen 4 screws, use 14mm T-shaped socket wrench to loosen a side tension
       screw as well as a rear drive belt tension screw , remove motor and replace with new. Reassemble in reverse order of
       disassembly, re-hook belt (readjust belt to be parallel with main frame after re-hooking). Do not tighten 4 securing
       screws yet.
...
3. Use Phillips head Screwdriver to remove screws. Disassemble left and right upright bracket cover. Remove the motor
   cover. Use 14mm T-shaped socket wrench to loosen 4 securing screws. Use 14mm wrench to loosen a side tension
   screw as well as a rear drive belt tension screw in order to loosening the drive belt.
...
12-7 Running Deck/ Belt & Cushion Replacement (※Be sure to disassemble the cylinder prior
to this replacement procedure)
     1. Step 1: After folding the treadmill, use M5L Allen wrench and 12mm wrench to release the screw which secure the cylinder and take it apart.
                Perform item (F), procedures to replace front and rear rollers.
                                                                      ...
                                                                      81                                                          Service Manual
2. Remove the left and right foot rail cap. Use a Phillips head screwdriver to remove 6 screws and bracket from back of foot rail. Remove the
   foot rail in the direction of the indicating arrows.




3. Use M5 L Allen wrench to remove the 8 screws securing the running board. Remove the running board and replace
   running board or running belt. If cushions need to be replaced, remove 6 cushions and replace. Reassemble in the

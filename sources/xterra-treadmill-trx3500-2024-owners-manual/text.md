<!-- Source: TRX3500_OM_20240607.pdf. Text is pdftotext -layout; pages a 300 dpi render knows more about than the text layer are appended below under '=== OCR SUPPLEMENT, PDF PAGE n ===' headers. -->
...
Table Of Contents
 ...
 TRX3500 Assembly Instructions                              5
...
Important Electrical Instructions
 ...
 spa, or in any other high humidity environment. The temperature specification is 40 degrees C, and humidity is 95%,
 ...
 because of the high inrush currents of the treadmill drive electronics and motor. This is an issue that affects all
 treadmill brands. New laws in your area may require these breakers. If you do have these breakers and outlets in
 your home, and are experiencing nuisance tripping, you should check if there are any other devices plugged into the
 same circuit. Some examples of devices that may also cause tripping are fluorescent lights with electronic ballasts,
 coffee maker, space heater, hair drier. Optimally the treadmill should be the only device plugged into the circuit. Our
 treadmills have surge suppressors built in to help avoid nuisance tripping. We have tested several AFCI/GFCI breakers
 and outlets with our products. Brands we have tested are: Eaton (Cutler Hammer Series), Leviton (Smart lock pro)
 and Schneider Electric (Canadian home series). These breakers do not trip in our testing, when connected to our
 ...
 path of least resistance for electric current, reducing the risk of electric shock. This product is equipped with a
 cord having an equipment-grounding plug. The plug must be plugged into an appropriate outlet that is properly
 installed and grounded in accordance with all local codes and ordinances.
 DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock.
 Check with a qualified electrician or serviceman if you are in doubt as to whether the product is properly ground-
 ed. Do not modify the plug provided with the product if it will not fit the outlet; have a proper outlet installed by a
 qualified electrician.
 This product is for use on a nominal 110-volt circuit, and has a grounding plug that looks like the plug illustrat-
 ed below. A temporary adapter that looks like the adapter illustrated below may be used to connect this plug
 to a 2-pole receptacle as shown below if a properly grounded outlet is not available. The temporary adapter
 should be used only until a properly grounded outlet, (shown below) can be installed by a qualified electrician.
...
TRX3500 Assembly Pack Checklist
  ...
  # 80. Ø8 × 1.5T_             #99. 5/16" × 1/2"_       #100. Ø5/16" × Ø18 × 1.5T_   #125. 5/16" × 3/4"_
  Split Washer (4pcs)          Hex Head Bolt (8pcs)     Flat Washer (8pcs)            BoltHex Head Bolt (8pcs)




                              # 102. Combination M5 Allen Wrench &                # 103. M6_
  # 90. 13L_Wrench (1pc)
...
1    Remove Deck From Box
     ...
     1. Take Treadmill deck out of the carton and place it on level
     and clean ground.




2    Left and Right Uprights                                               Hardware Step 2
                                                                            #90. 13mm Wrench
                                                                            #99. 5/16”x1/2” Hex Head
                                                                            Bolts (8pcs)
                                                                            #100. Ø 5/16” × Ø 18 ×
                                                                            1.5T Flat Washers (8pcs)
...
3   Console Attachment                                                     Hardware Step 3
                                                                            #102. Combination M5
...
5   Finishing Assembly
    ...
    please follow the steps on page 19 to lubricate your treadmill belt using approved
...
2. Press the Start/Stop key to begin belt movement. Adjust to the desired speed using the
   speed ▲ and ▼ keys (console or handgrip). You may also use the Speed Keys 1 - 10 to
   adjust the speed.
3. To adjust deck incline, press the ▲/▼ incline key (console or handgip) to the desired
   incline level. You may also press the Incline Keys 0 - 12 to adjust.
...
2. Press and hold the adjust Incline ▲/▼ keys on the left side (console or handgrip) to
   ...
   selecting a Incline Key 0 - 12 on left hand side of console (incline).
...
You may change the Dot Matrix profile view that you desire by pressing the PROGRAM
...
button switches to 1/4-mile track in mile. The flashing dot indicates your progress. Once the
1/4-mile is complete this feature will begin again.

                                            11                              TRX3500 Treadmill
Pulse Grip Feature
...
1. Select Manual Program via the Program key then press Enter. The display will prompt
   you through the programming or you can just press Start to begin the program with default
   values.
...
3. The Message window will now be displaying a Weight value. Entering the correct body
   weight will affect the calorie count. Use Speed ▲ / ▼ keys to adjust then press Enter.
...
4. If Enter was pressed, the Message window will display with the default Time value of 30
   ...
   to accept the default value, press Enter. (Note: You may press Start at any time during the
...
5. The first column (segment) will now be blinking. Use speed ▲ / ▼ to adjust then press
   Enter. The second column will now be blinking. Repeat the above process until all
   segments have been programmed. Then press ENTER to confirm and enter incline
...
5. The console displays “Adjust target heart rate”. The console will console will calculate
   ...
   heart rate is adjusted, press Enter.
                                           ...
                                           13                              TRX3500 Treadmill
6. If the user presses START without wearing HR stripe, MC will display “This program must
   wear HR strap”.
...
key. The treadmill’s console will enter to Calibration mode. DO NOT STAND ON THE BELT DURING
CALIBRATION
...
4. Set the maximum speed of 12. Press the Enter key to confirm and move to the next item.
5. Set the maximum incline value of 12, then press the Start/Stop key to confirm. It will automatically
...
Engineering Mode
Before entering the Engineering Mode, please turn the power off. Then hold down the Program
key, plus the Speed Up and Down keys. Then power on while holding all three keys. The treadmill’s
console will enter Engineering mode.
...
fitness cloud sites we support: iHealth, MapMyFitness, Record or Fitbit, with more to come. Syncing
...
5. When you workout is finished, the data is automatically saved and you will be prompted to sync
     ...
     applicable compatible fitness App, such as iHealth, MapMyFitness, Record, Fitbit, etc, in order for
...
TRX3500 Treadmill                               22
User Notes:




              23   TRX3500 Treadmill
Manufacturer’s Limited Warranty
Effective June 07, 2024- Treadmill LIMITED WARRANTY
...
Fitness directly to a consumer. The warranty period applies to the following components:
     ...
     Residential                     Lifetime         Lifetime       2 Years           2 Years         1 Year
...
TRX3500 Treadmill                                                24
25   TRX3500 Treadmill
3000 Nestle Road Jonesboro, AR 72401 - Phone:870-336-4286 - Fax:870-935-7611

www.xterrafitness.com                           ©2024 All Rights Reserved. TRX3500 Owner’s Manual

...
7. Ifthe user presses START and the heart rate signal is detected, the manual control
begins.
...
-EECEEEEEEEEEEH ATT Seseeeeenedeneteae
...
TT TTT TT ttt ty tet et yt TTT TTT TTT ttt ot
TT TT tty tt ot TTT Trt im
...
TT TTT TT ttt ttt ot TT {Tf
[TTT tte ret yt tt tf
...
P18 Speed Incline P26 Speed Incline
rT
P19 Speed Incline Incline
me ees TTT T ae P28 Speed Incline
| im CoC]

Incline _ = P29 Speed Incline
CoCo TTT Ty
...
The two most popular reasons for, or goals, of ex- 50 25 30 35 40 45 50 55 60 65
ercise are cardiovascular fitness (training for the cccccccos mE EE EEE mm Age of User
heart and lungs) and weight control. The black Weight boss _ Cardiovascular

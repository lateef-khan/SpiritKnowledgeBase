...
-------------------------------------------Table of Contents----------------------------
                       ...
                       4. ST125 Treadmill Operation
                       5. ST125 Treadmill Unit Block Diagrams
                       6. ST125 Treadmill Basic Connections and Wiring
                       ...
                       8. ST125 Treadmill Error Messages / Troubleshooting for Electronic Issues
...
12. Disassembling and Assembling of Parts
   ...
   12.9 Incline Motor Replacement
                                       ...
                                       3           Service Manual
Special Note on ST125 CEGS version:
Besides normal version, ST125 treadmill is with a CE/GS version. Both versions are with exactly the same in functions and outlines except that
...
Function Button Locations Function Button Locations
           ...
           Speaker                    Incline               Program                                               Speaker
                                      Up                    Up               Enter          Speed
                                                                                            Fast
                                                Incline           Program
                                                Down                               Speed
              ...
              1, 3, 5, 7, 9, 12, 15                                                                  2, 3, 4, 5, 7, 9, 12
                           ...
                           Hand Pulse                                                           Hand Pulse
                                          ...
                                          Audio Hole              Safety           Headphone Hole
                                                                   Key
...
6.1 Display Board wire Connections
 ...
 with FAN
    ...
    Bluetooth Module
                                                                                                       ...
                                                                                                       Connection with 4-pin of
                                                                                                       the amplifier wire

                           Connection with
                           6-pin Main control wire

Connection with                                                                        Connection with
Quick speed                                          Connection with                   Quick incline key
handrail buttons                                     KEY BOARD                         board




         Connection with                                                  Connection with                      Connection with
                           Connection with                                                                     Quick incline
         Quick speed key   Safety key                                     Wireless heart
         board                                                            receiver                             handrail buttons
                                                              24                                                      Service Manual
6.2 Display Board PCB Component Locations
  PCB Board Top
  ...
  - This product must be grounded. If the treadmill should malfunction or breakdown, grounding provides a path of least resistance for electric current,
    ...
    - DANGER – Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified
      ...
      must be held in place by a metal screw.
                                                                                 ...
                                                                                 34                                                                 Service Manual
  8.ST125 Treadmill Error Messages /

...
-------------------------------------------Table of Contents-------------------------------------------
                        ...
                        6. Basic Connections and Wiring
                            ...
                            6.4 Decline driver Board Component Locations
                            6.5 Power Board Component Locations
                            6.6 Driver Board Component Locations
                        ...
                        8. Treadmill Error Messages / Troubleshooting
                            ...
                            8.4 Troubleshooting Procedure Matrix for Electronic Issues
...
11.7 Running Deck/ Belt & Cushion Replacement
11.8 Speed Sensor Replacement
11.9 Incline Motor Replacement
11.10 Rear Incline Motor Replacement




                               3                Service Manual
Special Note on ST928A CE version:
     Besides normal version, ST928A treadmill is with a CE version. Both versions are with exactly the same in functions and outlines except
...
6   Service Manual
                                   Driving Motor
Lower Controller   Incline Motor
...
MAIN CONTROLLER:
The circuit board consists of the DC power supply for console、incline driver and AC motor driver, link the console to output appropriate voltages
for motor that control the treadmill functions.

TREADMILL MOTOR:
This is a variable speed for AC motor. It can to increase or decrease speed of running belt.

INCLINE MOTOR:
This is an AC motor. User can control variable elevation by console within main controller.

Decline motor:
This is an AC motor. User can control variable elevation by console within decline control board.
...
GENERAL INFORMATION
CONSOLE
 The console comprised of key controls and TFT LCD display.
 Main controller Include power supply 、motor driver control circuit and incline control circuit.

TREADMILL MOTOR
 It’s a variable speed on AC motor.
 There are three wires red, white and black for power to drive motor.
 The green wire is grounding.

INCLINE MOTOR
 This is a 230 volt AC motor.
...
DECLINE MOTOR
 The function is the same as incline motor narrative.




                                                                        13                         Service Manual
4. ST928A Treadmill Product Operation
...
Function
   SPEED
      ...
      WORK range is 1.0~22.0 kmph (0.5 ~ 13.0 mph)
   ...
   GRADE (INCLINE & DECLINE)
      ...
      WORK range is -6 to 15.
      GRADE preset value is -6 to 15.
      Press “UP” or ”DOWN” to adjust incline/decline, each increment and decrement is 1.
   TIME
...
Function Button In Main Mode
  READY MODE
     ...
     BLE button: When use the BLE wireless chest strap，in ready mode press one time and it will be turn on. Press second time, it will be turn off.
     Control the BLE on/off only in ready mode.
     SPEED RAPID button: 5 preset buttons for rapid speed:     3，6，9，12，15，18，22
     GRADE RAPID button: 5preset buttons for rapid incline:    -4，-2，2，4，6，9，12
     FAN button: It can to control ON/OFF for the fan.
     DISPLAY button： After choice a program, press this key will to show speed or incline profile in dot-matrix
     ENTER button： Before running a program, press this button that can to setting personal profile. (ex. Age …)
...
RUN MODE
  ...
  BLE button: non-functional.
  SPEED RAPID button: Speed will set to 3，6，9，12，15，18，22 speed quickly .
  GRADE RAPID button: Incline will set to -4，-2，2，4，6，9，12 position quickly.
  FAN button: It can to control ON/OFF the fan.
  DISPLAY button：
  Press DISPLAY key to switch the exercise data shown on the message window when you are workout. The information as below,
      ...
      MAX SPEED XX.X
                                                                  ...
                                                                  20                                                        Service Manual
5.ST928A Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          22   Service Manual
6. ST928A Treadmill Basic Connections and Wiring
...
6.4 Decline Driver Board Component Locations
                                           ...
                                           28   Service Manual
6.5 Power Driver Board (STANDBY BOARD) Component Locations
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           32                                                              Service Manual
8.ST928A Treadmill Error Messages /
         Troubleshooting
...
VR Test Procedure：
  ...
  8.   If there is voltage at the output connector to the console then check the voltage at the console. If there is no voltage there, but is there at the incline board then
       check the entire cable from incline board to console for cuts or bad connection at the wire connector.
...
Error code         Error code description                                                  Troubleshooting

E-01H        Low voltage jump, confirm input   1. Check the power supply is normal
             power is too low                  2. Replace the inverter
E-02H                                          1. Check if the motor current is too high
             Temperature sensing anomaly
                                               2. Replace the inverter
                                               1. Check if the motor is working properly
E-04H                                          2. Check the running belt is normal
             OC output overcurrent             3. Replace the inverter
                                               1. Check the power supply is normal
E-06H        OE inverter Overvoltage
                                               2. Replace the inverter
E-07H        PFC failure                       1. Replace the inverter
E-08H        GF grounding failure              1. Replace the inverter
                                               1. Check if the motor current is too high
...
E-0CH        OLO System overload anomaly
                                               2. Replace the inverter
E-21H        PrEr Flash Program failure        1. Replace the inverter
E-22H        EEPROM EEPROM failure             1. Replace the inverter
...
E-25H   Emergency shutdown display
                                              2. Replace the inverter
E-26H   drvF Driver set error                 1. Replace the inverter
                                              1. Check the power supply is normal
...
E-28H   HP input high voltage
                                              2. Replace the inverter
E-29H   Ht High temperature display           1. Replace the inverter
                                              1. Check if the motor current is too high
...
E-42H   Ht High Temperature warning
                                              2. Replace the inverter
                                              1. Check whether the control wire is bad connection or damaged
        Error in communication between
E-50H                                         2. Replace the inverter
        the console and inverter
                                              3. Replace the console
                                              1. Check if the wire in the console is off or bad in contact
        The console (internal) upper and
E-51H                                         2. Replace the console
        lower communication error

                                              1. Check whether the VR wire of the incline motor is connected or bad in contact
                                              2. Check if the power cord of the incline motor is properly connected/connected or poorly
E-52H   Error in calibration of the incline   exposed
...
                                            1. Check whether the VR wire of the incline motor is connected or bad in contact
                                            2. Check if the power cord of the incline motor is properly connected/connected or poorly
                                              exposed
E-53H   Machine (front) incline motor Error 3. Check if the incline motor is lock dead or bad in contact
                                            4. re-calibration
                                            5. replace the incline motor
                                            6. replace the inverter
                                            1. Check whether the VR wire of the incline motor is connected or bad in contact with the
                                               incline motor transfer board.
                                           2. Check whether the power wire of the incline motor is connected or bad in contact with
E3      Machine (rear) incline motor error    the incline motor transfer board.
                                           3. Check if the incline motor is lock dead or bad in contact
...
2. Press and hold down the START and FAST (Speed ▲) buttons and replace the Safety Key. Continue to hold the START and FAST key until the
   window displays “CALIBRATION MODE”.
3. You will now be able to set the display to show Metric or English settings (Miles vs. Kilometers). To do this, First press ENTER and press the
   UP/DOWN (▲/▼) key to show which you want, then press ENTER.
...
2. You can now scroll through the menu using the Speed ▲/▼ keys. Use the STOP key to exit to engineering mode. The menu selections are:
...
When insert safe key, no display on monitor.       1 Haven’t switch ON/OFF switch.            1 Switch the AC switch.
                                                   ...
                                                   3 Computer cable is broken.                3 Please check the wire and connect again.
                                                   4 Safety device is broken. (open)          4 Replace safety key.
                                                   5 Other components are faulty.             5 Replace console.
...
Treadmill stops or shuts off by itself.            1 House breaker tripped.                   1. Reset it.
                                                   2 Treadmill’s breaker tripped.             2. Reset treadmill breaker.
                                                   3 Treadmill’s controller shut down and
                                                     LED would be ON.                         3. Belt / deck lubrication.
...
After removing safety key, treadmill can’t stop.   1. The safety key device is broken.        1. Replace with new safety key device.
                                                                                              2. Replace controller or power board.
                                                                                              3. Replace console.
...
GRADE window displays “E53H”.                      1. The connector fall off.                  2 Calibrate the console.
                                                   2. Position sensor value of incline/decline 3.Replace with the new incline motor or the decline
                                                      motor is wrong.                            motor
After pressing “START” button, the treadmill stops 1 Controller is broken.                   1 Turn off the AC switch and turn on power again.
immediately.                                       2.check belt liberation.                  2 Replace controller and calibrate it.
...
Erratic pulse display.                   1. Another chest belt in use around      1. Check for other chest belt use around treadmill.
                                         ...
                                         1 The connector of speed cable and       1. Connect cables again.
FAST/SLOW button of SPEED ADJUSTMENT        console not connected properly.       2. Check the wire of speed adjustment switch.
SWITCH can’t be used.                    2 The connector of speed cable and
                                           speed adjustment switch w/cable not    2. Replace with new cable.
                                           connected properly.                    3. Replace new speed adjustment switch.
UP/DOWN button of
INCLINE ADJUSTMENT SWITCH can’t be used. 3. Button of speed adjustment switch is
                                            broken.
...
(No pulse displayed on monitor)                       or only one hand on sensor.
                                                   ...
                                                   3. The wires got damaged when
                                                      connecting the handpulse w/wire and 4. Replace console or Hand pulse board.
                                                      Console.
...
Treadmill walking belt does not work in the center. Tread belt tension not even across tread See treadmill belt adjustment
                                                    belt.

While being stepped on, and treadmill belt have   Insufficient lubricant on tread belt.        See treadmill belt lubrication.
hesitating on working.                            Tread belt tension insufficient              To adjust treadmill belt tension.
Black particles collecting under treadmill.       Drive belt is breaking in.                   Use vacuum cleaner under treadmill periodically to
                                                                                               clean.
...
235mm minimum prior to installation.
...
11. Disassembling and assembling
            of Parts
               ...
               52             Service Manual
11-1. Lower Controller Replacement
1. Use a Phillips Head Screw Driver to loosen the 5 tapping screws on motor cover, and then remove the motor cover
...
reconnect all wirings.
                                                                ...
                                                                53                                                  Service Manual
11-2. Console Replacement
     1. Use a M5 L Allen Wrench to loosen the 4 Sheet Metal Screw then remove the console mast cover.
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
   70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws. Connect grounding wires and
   motor wires (red M+, black M-)
...
3. Remove motor cover, use 14mm T-shaped socket wrench to loosen 4 screws. Use 14mm open end wrench to loosen
   1 belt tension screw and loosen drive belt. Use 13mm wrench to loosen front roller screws, remove front and back
   rollers, and replace with new. Reassemble in reverse order of disassembly. When reassembled, running belt tension
   needs to be adjusted and centered. Belt tension also needs to be adjusted
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
   70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws.
                                                     ...
                                                     60                                               Service Manual
11-7. Running Deck/ Belt & Cushion Replacement
1. Follow procedures 12-6 to Front/ Rear Roller Replacement
...
11-8. Speed Sensor Replacement(including the wire)
     1. First remove motor top cover. Remove speed sensor wiring and proceed with parts replacement. After replacement, a
        test to check if the sensor registers the magnet is required.
...
11-9. Incline Motor Replacement
     1. First adjust treadmill to folded position, then proceed with old incline motor replacement.
                                                              ...
                                                              64                                      Service Manual
2. Incline Range must be adjusted to 235mm minimum prior to installation.
...
4. Connect incline motor wiring with controller.
                                               ...
                                               “DOWN”
                                                         ...
                                                         66            Service Manual
11-10 Rear Incline Motor Replacement
(※Zeroing the incline motor before take it apart from the machine or assemble it onto the frame. The zeroing

distance is 210mm.)

   1. Flip the treadmill on its side, cut wiring tie-wraps and disconnect wires from controller board, remove the

     motor mounting bolts and remove the motor. (Use M8 L-shape Allen wrench and open end wrench)




                                                         67                                            Service Manual
2. Mark sure the incline motor distance is 210mm.
...
3. Connect rear incline motor wiring with controller.

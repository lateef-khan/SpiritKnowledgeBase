...
    Congratulations on your new elliptical trainer and welcome to the Spirit Fitness family!
    ...
    trainer was manufactured by one of the leading fitness manufacturers in the world and is backed
...
4                                              PURCHASE DATE______________________________________
...
can also go to http://www.spiritfitness.com/warranty under the Support tab to register online.
                                                                                                             ...
                                                                                                             5
                                               www.spiritfitness.com
    IMPORTANT SAFETY                                               •       Keep children away from the elliptical. There are
    ...
    When using an electrical appliance, basic                              or plug. If the elliptical is not working properly, call
    precautions should always be followed, including                       your dealer.
    the following:
    ...
    elliptical on a flat level surface with access to a                    then remove the plug from the outlet.
    110-volt, 5-amp grounded outlet with only the
    elliptical plugged into the circuit.                           •       Do not attempt to use your elliptical for any purpose
    ...
    OUTLET ON THE END:                                                     measurement in relation to your target heart rate. Use
                                                                           of a chest transmitter strap (sold separately) is a much
    •   Do not operate elliptical on deeply padded, plush or               more accurate method of heart rate analysis. Various
        shag carpet. Damage to both carpet and elliptical                  factors, including the user’s movement, may affect the
        may result.
6
                                                          Spirit Fitness
    accuracy of heart rate readings. The pulse sensors        NEVER remove any cover without first disconnecting AC
    are intended only as exercise aids in determining         power. If voltage varies by ten percent (10%) or more,
    heart rate trends in general.                             the performance of your Elliptical may be affected.
...
•   This appliance is not intended for use by persons         pool or spa, or in any other high humidity environment.
    with reduced physical, sensory or metal capabilities,     The operating temperature specification is 40 to 120
    or lack of experience and knowledge, unless               degrees Fahrenheit, and humidity is 95% non-condensing
    they have been given supervision or instruction           (no water drops forming on surfaces).
    concerning use of the appliance by a person
    responsible for their safety.                             Circuit Breakers: Some circuit breakers used in homes
                                                              are not rated for high inrush currents that can occur
•   Keep children under the age of 13 away from
                                                              when a elliptical is first turned on or even during use. If
    this machine.
                                                              your elliptical is tripping the house circuit breaker (even
•   User Weight Limit: 450 lb                                 though it is the proper current rating) but the circuit
                                                              breaker on the elliptical itself does not trip, you will need
SAVE THESE INSTRUCTIONS - THINK SAFETY!                       to replace the home breaker with a high inrush type.
                                                              This is not a warranty defect. This is a condition we
                                                              as a manufacture have no ability to control. This part is
IMPORTANT ELECTRICAL                                          available through most electrical supply stores. Examples:
                                                              Grainger part # 1D237, or available online at www.squared.
INSTRUCTIONS
    WARNING
                                                                                                                              7
                                                  www.spiritfitness.com
    com part #QO120HM. The electrical outlet used should have
    ...
    installed and grounded in accordance with all local
                                                                   below) can be installed by a qualified electrician.
    codes and ordinances.
                                                                   The green colored rigid ear-lug, or the like, extending
    DANGER – Improper connection of the equipment-                 from the adapter, must be connected to a permanent
    grounding conductor can result in a risk of electric           ground such as a properly grounded outlet box cover.
    shock. Check with a qualified electrician or                   Whenever the adapter is used, it must be held in
    serviceman if you are in doubt as to whether the               place by a metal screw.
    product is properly grounded. Do not modify the
    plug provided with the product if it will not fit the          IMPORTANT OPERATION
    outlet; have a proper outlet installed by a qualified
    electrician.                                                   INSTRUCTIONS
                                                                   •       NEVER operate this elliptical trainer without reading
    This product is for use on a nominal 110-volt/5                        and completely understanding the results of any
    amp dedicated circuit, and has a grounding plug                        operational change you request from the computer.
                                                                   •       Understand that changes in resistance do not occur
8
                                                          Spirit Fitness
    immediately. Set your desired resistance level on the computer console and release the adjustment key. The
...
     CE850 PRE-ASSEMBLY
     ...
     2. Carefully remove all parts from the carton and inspect for any dam-         12/14mm Wrench
        age or missing parts. If parts are damaged or missing, contact your         Phillips Screwdriver
        dealer immediately.                                                         8mm L Allen Wrench
...
     CE850 STEP ZERO
              ...
              145                    attached to the Main Frame for securing the
...
CE850 STEP ONE
                                                                      ...
                                                                      137       HEX HEAD BOLT          3/8” X 2-1/4”     2
                                                                      139       HEX HEAD BOLT          3/8” X 3-3/4”     4
                                                                      145    SOCKET HEAD CAP BOLT        3/8”X3/4”       4
                                                                      150          SCREW                  M5X10          4
                                                                      176        FLAT WASHER           3/8”X19X1.5T      6
                                                                      186      SPRING WASHER              3/8”X2T        4
                                                                      187      CURVED WASHERS          3/8” X 23 X 2T    4

                                                                 1.      Place 2 Flat Washers (No.176) against 2
...
     CE850 STEP TWO
                                                    HARDWARE FOR STEP 2
                                        PART        TYPE         DESCRIPTION      QTY
                                         134    HEX HEAD BOLT     M10 x 1.5        2
                                         136    HEX HEAD BOLT    3/8” x 3/4”       2
                                         163     NYLOC NUT         M10 x 8T        2
                                         175     FLAT WASHER    3/8”x 30 x 2.0T    2
                                         183    WAVE WASHER          ø25           4


                                       1. Locate Left and Right Lower Swing Arms
...
CE850 STEP THREE
                                            ...
                                            138     HEX HEAD BOLT       3/8”X2-1/4”     6
                                            165      NYLOC NUT            3/8”X7T       6
                                            176      FLAT WASHER        3/8”X19X1.5T    8
                                            187    CURVED WASHER        3/8”X23X2T      4

                                           1. Insert Left Upper Swing Arm (No.10) onto Left
...
CE850 STEP FOUR
                        HARDWARE FOR STEP 4
 PART          TYPE           DESCRIPTION     QTY
 152    PHILLIPS HEAD SCREW    M5 x 15L       14
 153    SHEET METAL SCREW      3.5 x 12L       8
 154    SHEET METAL SCREW      4 x 15mm        2


1. Secure the Left Connecting Arm Cover B (No.121) onto the Left Connecting Arm with Phillips Head
...
     POWER
     ...
     Message Center will be scrolling through the different profiles of the programs and will be scrolling the start
     ...
     Matrix Message Center will show a ¼ mile (0.4km) track display or just the bottom row lit at first, depending
     ...
     There are 20 levels of resistance – displayed as 10 rows of lights - available for plenty of variety. The first
...
The Program Key is used to preview each program. When you first turn the console on, you may press
...
     1/4 MILE TRACK
     ...
     and it is perfectly fine to leave the main power switch on in sleep mode. Of course you may also remove
...
seven programs have factory preset work level profiles for achieving different goals.
...
FAT BURN
This program follows a quick progression                                                                       Hill
                                        FatupBurn
...
                                            Hill
     ...
     of recovery and heart rate drop to replenish oxygen. Your cardiovascular system gets programmed to useCardio
...
7. If you want to increase or decrease the workload at any time during the program press the Up or Down key. This
   will change the workload settings of the entire profile, although the profile picture on the screen will not change.
   ...
   distorted and not a true representation of the actual profile. When you make a change to the workload, the
...
HIIT PROGRAM
The HIIT, or High Intensity Interval Training, program takes advantage of the latest trend in fitness. During
...
Sprint and Rest periods and the work intensity of the levels.
                                                                                                                                27
                                                     www.spiritfitness.com
     1. Using the Program button choose the HIIT program then press Enter. The Dot Matrix Message Center will ask you to Fat Bu
     ...
     3. Next you are asked for the number of Intervals you want to do. The default is 10 and the range available is 3 to
        15. One interval equals 1 Sprint and 1 Rest segment.                                                                    Cardio
     ...
     6. Next is entering the Interval time. The Dot Matrix Message Center shows: Sprint Time:30 and Rest Time:30. The
        Sprint Time will be blinking. You may use the Up and Down keys to adjust the Sprint time from 20 to 60 seconds          Interv
     ...
     7. The LED Data Display Window will now display the total time for the HIIT workout; now press Start to begin. There
        is a 3-minute warm-up period before the first Sprint begins. The resistance level during warm-up is set to 5 but can be
        adjusted manually.
     8. The Dot Matrix Message Center in the HIIT program is a speed indication display, not a power or resistance display.
        During the Sprint the Dot Matrix Message Center will show a blinking LED at the first Sprint segment. That is the       Streng
...
32   above
     ...
     average     38-41   35-38    31-33   28-30    25-27    22-24 Spirit Fitness
...
2. Enter your name in the Dot Matrix Message Center, the letter “A” will be blinking. Use the Up/Down buttons to
    select the appropriate first letter of your name (pressing the Up button will switch to the letter “B”; pressing the
    Down button will switch to letter “Z”). Press Enter when the desired letter is displayed. Repeat this process until all
    of the characters of your name have been programmed (maximum 7 characters). When finished press Stop.
...
8. Now the first column will be blinking and you are asked to adjust the resistance level for the first segment
    (SEGMENT > 1) of the workout by using the Up button. When you finish adjusting the first segment, or if you
...
     HEART RATE PROGRAMS
     ...
     too high or too low and exercise is much more enjoyable by maintaining their heart rate in the desired benefit
     range.
     ...
     strengthening the cardio vascular system. This 60% to 85% is the zone to stay in for maximum benefit.
...
cardiovascular fitness (training for the heart and lungs) and
weight control. The black columns on the chart represent the
MHR for a person whose age is listed at the bottom of each
column. The training heart rate, for either cardiovascular fitness
or weight loss, is represented by two different lines that cut
diagonally through the chart. A definition of the lines’ goal
is in the bottom left-hand corner of the chart. If your goal is
cardiovascular fitness or if it is weight loss, it can be achieved by training at 85% or 60%, respectively, of
...
2. If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of two reasons:
     a.   The hardware was not sufficiently tightened during assembly. All bolts that were installed
          ...
          one provided if you cannot tighten the bolts sufficiently. I cannot stress this point enough; 90% of calls to the service
...
performed, it is in your best interest to obtain and keep all receipts. This written warranty gives you specific legal rights. You
...
5                           45
    www.spiritfitness.com
     CE850-XE898D-SE028-01_Part List_SPIRIT                              42      Aluminum Track                                   4
     1      Main Frame                              1                    43      6005_Bearing                                     9
     2      Rear Rail Assembly                      1                    43-1    6005-2RS_Bearing                                 1
     3      Idler Wheel Assembly                    1                    44      6003_Bearing                                     8
     4      Crank Arm Assembly                      2                    45      608ZZ_Bearing                                    12
     5      Bushing Housing, Pedal Arm              2                    46      6203-C3_Bearing                                  2
     6      Pedal Arm (L)                           1                    47      Rod End Bearing                                  2
     7      Pedal Arm (R)                           1                    48      Drive Belt                                       1
     8      Connecting Arm (L)                      1                    49      Flywheel                                         1
     9      Connecting Arm (R)                      1                    50      Magnet                                           1
     10     Seat Handle Bar (L)                     1                    51      Steel Cable(250L)                                1
     11     Swing Arm (R)                           1                    52      Handgrip Resistance Label (STRIDE)               1
     12     Console Mast                            1                    53      Handgrip Resistance Label (LEVEL)                1
     13     Lower Handle Bar (L)                    1                    55      Console Assembly                                 1
     14     Lower Handle Bar (R)                    1                    55~1    Console Top Cover                                1
     15     Crank Axle                              1                    55~2    Console Bottom Cover                             1
     16     Swing Assembly                          2                    55~3    Console Inner Cover                              1
     17     Slider Adjustment (L)                   1                    55~4    Key Board                                        1
     18     Slider Adjustment (R)                   1                    55~5    Deflector Fan Grill                              1
     20     Joint Assembly                          2                    55~6    Wind Duct                                        1
     21     Adjusting Lever                         2                    55~7    End Cap                                          1
     22     Left Driving Assembly                   1                    55~8    Fan Grill Anchor                                 2
     23     Right Driving Assembly                  1                    55~9    500m/m_Fan Assembly                              1
     24     Left Pedal Base                         1                    55~10   Console Display Board                            1
     25     Right Pedal Base                        1                    55~11   Main Key Board                                   1
     26     Moving Range Adjusting Assembly         1                    55~12   Interface Board                                  1
     27     connecting Component                    2                    55~13   Bluetooth                                        1
     28     Side Back                               1                    55~14   USB charging module                              1
     29     Fixing Piece                            2                    55~15   W/Receiver, HR                                   1
     30     Adjustment Wheel Fixing Plate(L)        2                    55~16   CASFE Board                                      1
     31     Adjustment Wheel Fixing Plate(R)        2                    56      Gear Motor                                       1
     32     Wheel Base                              2                    57      850m/m_Sensor W/Cable                            1
     33     Control Fixing Plate                    1                    58      850m/m_Handpulse W/Cable Assembly                2
     34     Incline Rotate Axle                     1                    59      Power Cord                                       1
     35     Ø17 × 34L_Rotate Axle A                 2                    61      450m/m_Handle Wire (Upper), Resistance(White)    1
     36     Ø17 × 41L_Rotate Axle B                 2                    62      450m/m_Handle Wire (Upper), Incline(Red)         1
     37     Pedal Axle                              2                    63      900m/m_Handle Wire (Lower), Resistance/Incline   2
     38     Ø11.9 × Ø8.5 × 15m/m_Rod End Sleeve     8                    64      Incline Controller                               1
     40     Spring                                  2                    65      Adaptor                                          1
46   41     32 × 11 × 2.5T × 625m/m_Aluminum Rail   4


                                                        Spirit Fitness
66    Resistance Button W/Cable                  2                  110   Pedal Foam (R)                           1
67    1250m/m_Connecting Wire, Controller(Red)   2                  111   Console Mast Cover(L)                    1
68    2250m/m_Computer Cable                     1                  112   Console Mast Cover(R)                    1
69    AC Electronic Module                       1                  113   Side Case(L)                             1
70    650m/m_Computer Cable                      1                  114   Side Case(R)                             1
71    80m/m_Connecting Wire (White)              2                  115   Side Case Plate(L)                       1
72    200m/m_Ground Wire                         1                  116   Side Case Plate(R)                       1
73    Incline Motor                              1                  117   Side Case Rear Shroud                    1
74    Conductive Terminal                        2                  118   Circuit Cover                            1
77    Ø65_Transportation Wheel                   2                  119   Connecting Arm Cover (L)(A)              1
78    Ø78_Slide Wheel , Urethane                 4                  120   Connecting Arm Cover (R)(A)              1
79    Ø40_Adjustment Transportation Wheel        6                  121   Connecting Arm Cover (L)(B)              1
80    Ø38_Slide Wheel , Urethane                 12                 122   Connecting Arm Cover (R)(B)              1
81    Ø35 × 10m/m_Rubber Foot                    6                  123   Frame Cover                              2
83    WFM-1719-12_Bushing                        30                 124   Aluminum Axle End Cap                    4
84    J4FM-1719-09_Bushing                       4                  125   Left Slider Cover                        1
85    Ø330_Drive Pulley                          1                  126   Right Slider Cover                       1
86    Ø32(1.8T)_Button Head Plug                 2                  129    7 × 7 × 19L_Woodruff Key                2
87    Ø38 × 2.5T_Pedal End Cover                 2                  130   3/8" × 2"_Flat Head Socket Bolt          6
89    Ø40 × Ø80_Oval End Cap                     2                  131   1/4" × 3/4"_Hex Head Bolt                4
90    Spacer Bushing                             1                  132   1/4" × 1/2"_Hex Head Bolt                4
91    Ø25 × Ø10 × 3T_Nylon Washer (A)            2                  133   5/16" × 1/2"_Hex Head Bolt               34
93    Ø45 × Ø35 × Ø26 × 10T_Isolator             2                  134   M10 × P1.5 × 14L_Bolt                    2
94    Handle Switch Bracket                      2                  136   3/8" × 3/4"_Hex Head Bolt                2
95    Speaker Grill Anchor                       8                  137   3/8" × 2-1/4"_Hex Head Bolt              2
96    Oval End Cap                               2                  138   3/8" × 2-1/4"_Hex Head Bolt              6
97    Switch Wire Cap                            2                  139   3/8" × 3-3/4"_Hex Head Bolt              4
99    Slide Wheel Cover                          2                  140   Ø10 × 40L_Incline Set Screws             1
100   Front Handle Bar Cover (L)                 1                  141   Ø10 × 62L_Incline Set Screws             1
101   Rear Handle Bar Cover (L)                  1                  142   M8 × 20L_Socket Head Cap Bolt            2
102   Front Handle Bar Cover (R)                 1                  143   M8 × 40L_Socket Head Cap Bolt            4
103   Rear Handle Bar Cover (R)                  1                  144   3/8" × 2-1/4"_Socket Head Cap Bolt       2
104   Rear Stabilizer Cover (A)                  2                  145   3/8" × 3/4"_ Socket Head Cap Bolt        6
105   Rear Stabilizer Cover (B)                  2                  146   5/16" × 1/2"_Button Head Socket Bolt     12
106   End Cap Stopper                            4                  147   5/16" × 1-3/4"_Button Head Socket Bolt   10
107   Pedal (L)                                  1                  148   M4 × 12L_Phillips Head Screw             2
108   Pedal (R)                                  1                  149   M5 × 6L_Phillips Head Screw              12
109   Pedal Foam (L)                             1                  150   M5 × 10L_Phillips Head Screw             4

                                                                                                                        47
                                                  www.spiritfitness.com
     151   M5 × 10L_Phillips Head Screw      16                    186    Ø10 × 2T_Spring Washer                4
     152   M5 × 15L_Phillips Head Screw      22                    187    Ø3/8" × 23 × 2T_Curved Washer         8
     153   Ø3.5 × 12L_Sheet Metal Screw      20                    188    Ø5/16" × 23 × 1.5T_Curved Washer      6
     154   Ø4 × 15L_Sheet Metal Screw        10                    189    3/8'' × 19L_Hex Head Bolt             4
     155   5 × 19L_Tapping Screw             23                    190    5/16" × 15L_Hex Head Bolt             16
     156   Ø3 × 20L_Tapping Screw            4                     192    Phillips Head Screw Driver            1
     157   M5 × 20L_Flat Head Socket Screw   4                     193    L Allen Wrench                        1
     158   Ø25_C Ring                        2                     194    13/14m/m_Double Open-End Wrench       1
     159   Ø17_C Ring                        5                     195    12/14m/m_Double Open-End Wrench       1
     160   M4 × 5T_Nyloc Nut                 2                     196    38 × 38L_Square End Cap               1
     161   M8 × 7T_ Nyloc Nut                1                     198    M14 × 7m/m_Luck Nut                   2
     162   M8 × 9T_Nyloc Nut                 1                     199    Rubber Pad                            2
     163   M10 × 8T_Nyloc Nut                4                     200    M12_L Allen Wrench                    1
     164   3/8" × 11T_Nyloc Nut              2                     201    Open End Combination Spanner Wrench   1
     165   3/8" × 7T_Nyloc Nut               10                    203    Bolt Access Cap                       1
     166   1/4" × 8T_Nyloc Nut               4                     204    100m/m_Connecting Wire (White)        1
     167   5/16" × 7T_Nyloc Nut              10                    205    100m/m_Connecting Wire (Black)        1
     169   3/8" × UNF26 × 4T_                2                     206    100m/m_Connecting Wire (Green)        1
     170   3/8" × UNF26 × 11T_               2                     207    TV Adapter                            1
     171   3/8" × 7T_Nut                     12                    208    Ø5/16" × Ø23 × 3T_Flat Washer         8
     172   M8 × 6.3T_Nut                     6                     200304
...
= 800.258.4555 Spirit Fitness
/ 33% spiritservice@spiritfitness.com °] 3000 Nestle Road

www. spiritfitness.com Jonesboro, AR 72401

© 2021 All Rights Reserved

COMMERCIAL Revision 4: 11.08.2021

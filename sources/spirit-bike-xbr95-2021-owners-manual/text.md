...
    Congratulations on your new semi-recumbent bike and welcome to the Spirit Fitness family!
    ...
    pleasant as possible for many years to come. If not purchased direct from Spirit Fitness, the local dealership where
    you purchased this semi-recumbent bike is your administrator for all Spirit Fitness warranty and service needs. Their
    responsibility is to provide you with the technical knowledge and service personnel to make your experience more
...
Important Safety Instructions                                       described in this manual. Do not use attachments not
     ...
     WARNING                                                    •   Never operate this appliance if it has a damaged cord
...
Always unplug this appliance from the electrical outlet         •   Do not carry this appliance by supply cord or use
immediately after using and before cleaning.                        cord as a handle.
WARNING - To reduce the risk of burns, fire, electric           •   Keep the cord away from heated surfaces.
shock, or injury to persons, install the bike on a flat level   •   Never operate the appliance with the air openings
surface with access to a 115-volt, 15-amp grounded outlet           blocked. Keep the air openings free of lint, hair, and
with only the bike plugged into the circuit.                        the like.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 18AWG OR
                                                                •   Never drop or insert any object into any opening.
BETTER, WITH ONLY ONE OUTLET ON THE END:                        •   Do not use outdoors.
                                                                •   Do not operate where aerosol (spray) products are
•   To reduce the risk of burns, fire electric shock, or            being use or where oxygen is being administered.
    injury to persons:                                          •   Connect this appliance to a properly grounded outlet
•   An appliance should never be left unattended when               only.
    plugged in. Unplug from outlet when not in use, and         •   The appliance is intended for household use.
    before putting on or taking off parts.                      •   This exercise equipment is not intended for use by
•   Do not operate under blanket or pillow. Excessive               persons with reduced physical, sensory or mental
    heating can occur and cause fire, electric shock, or            capabilities, or lack of experience and knowledge.
    injury to persons.                                          •   Keep children under the age of 13 away from this
•   Close super vision is necessary when this appliance             machine.
    is used by, on, or near children, invalids, or disabled         SAVE THESE INSTRUCTIONS - THINK
    persons.                                                        SAFETY!
...
Z\WARNING ¢ Never operate this appliance if it has a damaged cord
When using an electrical appliance, basic precautions or plug, if it is not working properly, if it has been
should always be followed, including the following: dropped or damaged, or dropped into water. Return
Read all instructions before using this appliance. the appliance to a service center for examination and
DANGER -To reduce the risk of electric shock: repair.
...
WARNING - To reduce the risk of burns, fire, electric * Keep the cord away from heated surfaces.
shock, or injury to persons, install the bike on a flat level ¢ Never operate the appliance with the air openings
surface with access to a | 15-volt, |5-amp grounded outlet blocked. Keep the air openings free of lint, hair, and
with only the bike plugged into the circuit. the like.
DO NOT USEAN EXTENSION CORD UNLESS ITISA I8AWGOR *_—‘Never drop or insert any object into any opening.
BETTER, WITH ONLY ONE OUTLET ONTHE END: ° Do not use outdoors.
* Do not operate where aerosol (spray) products are
* To reduce the risk of burns, fire electric shock, or being use or where oxygen is being administered.
injury to persons: * Connect this appliance to a properly grounded outlet
¢ An appliance should never be left unattended when only.
...
e — Use this appliance only for its intended use as
    ...
    Fitness Equipment Safety Instructions                        effectiveness of the exercise experience, expose yourself
    To disconnect turn all controls to the off position,         (and possibly others) to injury, and reduce the longevity of
    then remove the plug from the outlet.                        the equipment.
    •   Do not operate equipment on deeply padded, plush
        or shag carpet. Damage to both carpet and equipment
        may result.                                                   WARNING: This product can expose you to
    •   Before beginning this or any exercise program, consult   chemicals including Toluene and Acrylamide which are
        a physician. This is especially important for persons    known to the State of California to cause cancer and birth
        over the age of 35 or persons with pre-existing health   defects or other reproductive harm.
        conditions.                                              For more information go to www.P65Warnings.ca.gov
    •   Do not attempt to use your equipment for any
        purpose other than for the purpose it is intended.       Important Electrical Instructions
    •   Keep hands away from all moving parts.
    •   The pulse sensors are not medical devices. Their             WARNING
        purpose is to provide you with an approximate            NEVER expose this Semi-Recumbent Bike to rain or
        measurement in relation to your target heart rate.
                                                                 moisture. This product is NOT designed for use outdoors,
        ...
        a much more accurate method of heart rate analysis
                                                                 environment. The operating temperature specification is
        .Various factors, including the user’s movement,
                                                                 40 to 120 degrees Fahrenheit, and humidity is 95% non-
...
    XBR95 PRE ASSEMBLY
    ...
    1. Cut the straps, then along the dotted line on the bottom of the box;    12/14mm Wrench
       lift the box over the unit and unpack.                                  14/15mm Wrench
                                                                               Phillips Screwdriver
    2. Locate the hardware package. The hardware is separated into four
       steps. Remove the tools first. Remove the hardware for each step as    PARTS INCLUDED:
       needed to avoid confusion. The numbers in the instructions that are     1 Main Frame
       in parenthesis (#) are the item number from the assembly drawing for    1 Console Mast
       reference.                                                              1 Rear Stabilizer
                                                                               1 Seat Back Frame
                                                                               1 Front Handle Bar
                                                                               1 Handle Bar
                                                                               1 Seat Back Cover
...
UNPACKING TOOLS INCLUDED:
|. Cut the straps, then along the dotted line on the bottom of the box; Q) 12/14mm Wrench
lift the box over the unit and unpack. Q) 14/15mm Wrench

2. Locate the hardware package. The hardware is separated into four U1 Phillips Screwdriver

steps. Remove the tools first. Remove the hardware for each step as PARTS INCLUDED:
needed to avoid confusion. The numbers in the instructions that are QO) | Main Frame

in parenthesis (#) are the item number from the assembly drawing for QO) | Console Mast
reference. QO) | Rear Stabilizer
...
U | Console Mast Cover

U | Front Stabilizer Cover
U | Rear Stabilizer Cover
U | Console
...
REAR STABILIZER
    ...
    XBR95 STEP ONE                 HARDWARE FOR STEP 1
                      PART         TYPE      DESCRIPTION            QTY
                        65          BOLT             3/8”X53mm         2
                        67          BOLT          3/8”XUNC16X4”        2
                     ...
                     3. Attach the SEAT BACK (5) to the SEAT
                        ...
                        BOLT (67) through each side, then attach
                        a NYLOC NUT (89) to each bolt. Tighten
                        the bolts just enough so there is no side to
                        side play, but freedom of movement front to
                        back. Use the WRENCHES provided (112
                        & 130).
                     4. Insert an END CAP (32) into each opening
                        of the Front Stabilizer Tube.You may need
                        to tap them in with a rubber mallet if they
                        are tight.
...
65 BOLT 3/8”X53mm 2
67 BOLT 3/8” XUNC16X4” 2
84 FLAT WASHER @3/8” x O25 x 2T 2
89 NYLOC NUT 3/8°X7T 2
191 CAP NUT 3/8”°XUNCI16X12.5T 2
...
3. Attach the SEAT BACK (5) to the SEAT
CARRIAGE (4) of the main frame. Slide |
BOLT (67) through each side, then attach
a NYLOC NUT (89) to each bolt. Tighten
the bolts just enough so there is no side to
side play, but freedom of movement front to
...
XBR95 STEP TWO                 HARDWARE FOR STEP 2
                 PART          TYPE       DESCRIPTION                QTY
                   68           BOLT           5/16”XUNC18X5/8”       8
                 ...
                 3. Install the CONSOLE MAST (2) into the
                    ...
                    bolts firmly with the WRENCH (112).

                    Continued on next page...

                                                                           9
     4. Remove the white styrofoam pad (factory installed to prevent
...
10
XBR95 STEP THREE                 HARDWARE FOR STEP 3
                   PART          TYPE       DESCRIPTION             QTY
                     71           BOLT            3/8” X 1-3/4”      4
...
     XBR95 STEP FOUR
                                     HARDWARE FOR STEP 4
                       PART          TYPE       DESCRIPTION              QTY
                         70          BOLT          5/16”XUNC18X1-1/4”     1
                         76       FLAT WASHER      Ø5/16” × Ø18 × 1.5T    1
                         91       NYLOC NUT              5/16”X6T         1
                         105   SHEET METAL SCREW         4X16MM           4

                       1. Gather HARDWARE FOR STEP 4.
                       2. Install the GAS CYLINDER (57) on the
                          SEAT BACK FRAME (5) with 1 BOLT (70),
                          1 FLAT WASHER (76) and 1 NYLOC NUT
                          (91) by using the WRENCHES provided (112
                          & 113).
                       3. Attach the PEDALS (116) to the CRANK
                          ARMS (51L, 51R). Tighten with the
                          WRENCH (113). Remember that the
                          LEFT PEDAL has a reverse thread and
                          will be threaded onto the Crank arm in a
                          COUNTERCLOCKWISE motion. There is
                          an “L” stamped in the end of the threaded post
                          of the left pedal and an “R” in the right. Make
                          sure to tighten the pedals as firmly as you can.
                          It may be necessary to re-tighten the pedals if
                          you feel a thumping while pedaling the bike. A
                          thumping or clicking noise is usually caused by
                          loose pedals.
                       4. Attach the DRINK BOTTLE HOLDERS
                          (39L & 38R) to the sides of the SEAT
...
x SB R S 5 STEP FO UJ R PART TYPE DESCRIPTION QTY

70 BOLT 5/16”>XUNC18X1-1/4” |
76 FLAT WASHER @5/16” x O18 x 1.5T |
91 NYLOC NUT 5/16”°X6T I
105 SHEET METAL SCREW 4X16MM 4

|. Gather HARDWARE FOR STEP 4.

2. Install the GAS CYLINDER (57) on the
SEAT BACK FRAME (5) with | BOLT (70),
| FLAT WASHER (76) and | NYLOC NUT
(91) by using the WRENCHES provided (112
& 113).
...
WRENCH (113). Remember that the
LEFT PEDAL has a reverse thread and
will be threaded onto the Crank arm ina
COUNTERCLOCKWISE motion. There is
an “L” stamped in the end of the threaded post
of the left pedal and an “R” in the right. Make
sure to tighten the pedals as firmly as you can.
...
114. 112 113
105 4. Attach the DRINK BOTTLE HOLDERS
(39L & 38R) to the sides of the SEAT
HANDLE BAR (6) with 4 SHEET METAL
SCREWS (105).Tighten with the PHILLIPS
HEAD SCREW DRIVER (114)
...
XBR95 CONSOLE OPERATION
    ...
    Matrix Window
       ...
       Message Center
                          ...
                          Fan to keep
   Convenient cargo       you cool
   compartment for
     keys, phone, or      Ten innovative
        MP3 player        programs offer a
...
XBRS5 CONSOLE OPERATION

L CALORIES | L_OISTANCE |
Ce
88) 8888
...
compartment for
keys, phone, or Ten innovative
MP8 player programs offer a

variety of work-outs

BAaAev il X¥ &¢ 2 ©

MANUAL HILL FATBURN CARDIO STRENGTH INTERVAL CALORIES FUSION USERI-2 HR1-2
...
Control! Buttons
     ...
     the lights will turn on for a short time. When the lights go off the dot matrix display will show a
     software version (i.e.VER 1.0) and the Message center will display an odometer reading. The
     odometer reading displays how many hours the Semi - Recumbent Bike has been used and how
     many virtual miles the Semi - Recumbent Bike has gone. The display shows: ODO 123 MI 123 HRS.
     ...
     and the Message center will be scrolling the start up message.You may now begin your workout
     program.
...
center for monitoring your distance.
...
     are activated when using the bike. These will light up during any of the programs.You can control
     ...
     your projected maximum hear t rate, which is determined by your age that you entered during
...
and the workload may be adjusted manually by pressing the Level Up/ Down buttons. The dot
matrix display will have only the bottom row lit at first. As you increase the work load more rows
will light indicating a harder workout. The fitness bike will get harder to pedal as the rows increase.
...
users. Levels 11-20 are more challenging, but the increases in resistance from one level to the next
remain small. Levels 21-30 start getting tough as the levels jump more dramatically. Levels 31-40 are
...
     Pause, just press the Start key. If the Stop button is pressed twice during a workout, the program
     ...
     The fitness bike has a built in hear t rate monitoring system. Simply grasping the hand pulse
     sensors on the stationary handle bars or wearing the hear t rate transmitter (see Using Heart
...
18   needs. Some of the information asked for is necessary to ensure the readouts are correct.You will
...
will be saved as the new default settings. If you enter your Age and Weight the first time you use the fitness bike, you
will not have to enter it ever y time you work out unless either your Age or Weight changes, or someone else enters a
...
     Programmable Features
     ...
     yourself and not the computer. To start the Manual program follow the instructions below or just
     press the Manual button then the Enter button and follow the directions in the Message center.
     1.   Press the Manual key, then press the Enter key.
     2.   The Message Center will ask you to enter your Age.You may enter your age, using the LEVEL Up/Down keys,
     ...
     6.   Once the program starts you will be at level one. This is the easiest level and it is a good idea to stay at level one
          for a while to warm up. If you want to increase the work load at any time press the LEVEL Up key; the LEVEL
          Down key will decrease the work-load.
...
3.   The Message Center will now be blinking a value, indicating your Body Weight. Entering the correct body weight
     will affect the calorie count. Use the Level Up/Down keys to adjust, then press Enter.
     A note about the Calorie display: No exercise machine can give you an exact calorie count because there are too many factors which deter-
     mine exact calorie burn for a particular person. Even if someone is the exact same body weight, age and height, their calorie burn may be
...
7.   The Message Center displays the Program Time (a value that was determined by the data you entered in steps 3-6);
     ...
     recalculate the Program Time.
          • When the Start key is pressed, the program begins with a 3:00 warm up (1:00 @ Level 1, 1:00 @ Level
               2, and 1:00 @ Level 3) or you have the option of pressing the Enter key again to bypass and begin the
               workout.
          ...
          • After the program has ended, there will be a 3:00 cool down (1:00 @ Level 3, 1:00 @ Level 2, and 1:00 @                              21
               Level 1) or you have the option of pressing the Enter key to end the workout.
     Fusion Program
     In this interval program you will alternate between mid-high intensity cardiovascular intervals on
     the bike, strength exercises off of the bike, and low intensity recovery intervals on the bike.You will
     need a pair of objects that can be comfortably held in your hands (dumbbells, water jugs, soup cans,
     etc.) for 4 of the 5 strength exercises performed in this program
     ...
     3.   The Message Center will now be blinking a value, indicating your Body Weight. Entering the correct body weight
          will affect the calorie count. Use the Level Up/Down keys to adjust, then press Enter. A note about the Calorie display:
          No exercise machine can give you an exact calorie count because there are too many factors which determine exact calorie burn for a
     ...
     4.   The Message Center will now be blinking the preset top Resistance level of the selected program (default/mini-
          mum resistance is Level 5). Use the Level Up/Down keys to adjust, then press Enter. This value will be the Level
          for all cardio intervals. The resistance level can be adjusted at any time during the program.
     ...
     6.   The Message Center will be blinking the desired Interval time (default is 2:00).The time you select will be the
          duration of each cardio interval. Note: As a general rule, the longer the interval, the less resistance (fitness bike) is required
22
     and the more repetitions you perform, the less weight (dumbbells) you need to use; use the Level Up/Down keys to
...
CAUTION: The shorter the recovery time, the longer your heart rate will stay elevated; if you are new
to exercise or have recently resumed an exercise program after a considerable amount of time off,
it is recommended that your recovery interval length either matches or exceeds the length of the
cardio interval.
...
muscle fibers which are used when performing tasks that are intense and short in
duration. These deplete your oxygen level and spike your heart rate, followed by
periods of recovery and heart rate drop to replenish oxygen.Your cardiovascular
...
followed by periods of recovery and heart rate drop to replenish oxygen.Your              25
...
This program takes you through high levels of intensity followed by recovery
periods of low intensity. This program utilizes and develops your “Fast Twitch” INTERVAL Work Profile
muscle fibers which are used when performing tasks that are intense and short in
duration. These deplete your oxygen level and spike your heart rate, followed by
periods of recovery and heart rate drop to replenish oxygen. Your cardiovascular
system gets programmed to use oxygen more efficiently.

CALO R | ES CALORIES Work Profile
i=
...
FU S | O N FUSION Work Profile

This program takes you through high levels of cardio & strength intensity followed

by recovery periods of low intensity. This program utilizes and develops your “Fast
Twitch” muscle fibers which are used when performing tasks that are intense a
and short in duration. These deplete your oxygen level and spike your heart rate, | 25
...
cardiovascular system gets programmed to use oxygen more efficiently.
     ...
     2.   The Message Center will ask you to enter your Age.You may adjust the age setting, using the Level Up/Down
     ...
     7.   If you want to increase or decrease the resistance at any time during the program, press the Level Up/Down keys
          ...
          settings of the entire profile, although the profile picture on the screen will not change. The reason for this is so
          that you can see the entire profile at all times. If the profile picture is changed, it also would be distorted and not a
          true representation of the actual profile. When you make a change to the resistance, the Message Center will show
...
1.   Select the User program (U1 or U2) then press Enter. If you have already saved a program to either U1 or U2, it
     ...
     Window, the letter “A” will be blinking. Use the Level Up/Down buttons to select the appropriate first letter
     of your name (pressing the LEVEL Up/Down button will switch to the letter “B”; pressing the Down button
     will switch to letter “Z”). Press Enter when the desired letter is displayed. Repeat this process until all of the
...
2.   If there is a program already stored in User when you press the key, you will have an option to run the program as
     ...
     you will be prompted: Run Program? Use the Level Up/Down to select Yes or No. If you select No, you will then
     be asked if you want to delete the currently saved program. It is necessary to delete the current program if you
     want to build a new one. The Message Center will ask you to enter your Age.You may enter your age, using the
     Level Up/Down keys, then press the Enter key to accept the new value and proceed on to the next screen.
...
5.   You are now asked to enter your Weight.You may adjust the weight value using the Up/ Down keys then press
     Enter to continue.                                                                                                      27
...
oy | i i 190 TARGET HEART RATE
80% is the zone to stay in for maximum benefit. ‘e REET HEART RAY

For someone who is 40 years old their 3 170 "imp
target heart rate zone is calculated: = 160 1° Rag
220 — 40 = 180 (maximum heart rate) 150
180 x .6 = 108 beats per minute (60% of maximum) a 14
180 X .8 = 144 beats per minute (80% of maximum) e 1
we — 120
So for a 40 year old the training zone would &
; = 110
be 108 to 144 beats per minute. 100
90
...
     then the Enter button and follow the directions in the Message Center.
     ...
     6.   Now you are finished editing the settings and can begin your workout by pressing the Start key.You can also go
          back and modify your settings by pressing the Enter key. Note: At any time during the editing of Data you can press
          the Enter key to go back one screen.
...
2.   If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of two reasons:
     ...
     III. If squeaks or other noises persist, check that the unit is properly leveled. There are 2 leveling pads on the bot-
...
4.   Security (Allows the keypad to be locked to prevent unauthorized use)                                                     35
     Semi - Recumbent Bike Warranty - Effective March 16, 2021
     ...
     Light Commercial                         Lifetime          5 Years          3 Years           1 Year
...
5.   Products that do not have a warranty registration card on file at Spirit Fitness. Spirit Fitness reserves the right to request proof of purchase if no

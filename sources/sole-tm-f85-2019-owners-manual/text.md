...
#113.0 10x 2T #133. 3/8”x 1-3/4” Button Head
...
1. Install the two Speed Nut Clips (128) on the Frame Base left and
right side.

2. Slide the lower handlebar covers (63 & 65) onto the console masts
(notice orientation).
...
the console with four Sheet Metal Screws (168). Tighten with
...
Screws (94). Tighten screws using the Combination M5 Allen
...
#168. 3.5 x 16mm_
177 Sheet Metal Screw (4 pcs)

1. Insert Tablet Holder (177) into the Console Assembly (52) and use
...
INCLINE KEYS
AUDIO IN JACK (MP3,
(D,ORSMARTPHONE) $ (A, Ysa SPEED KEYS
CONTACT HEART RATE
SENSORS
...
radio, CD player or even aTV or computer audio signal. There is an audio patch cable included
to and also a headphone jack () for private listening.

Charge Portable Devices with USB
...
2. You can now scroll through the menu using the Speed a/v keys. Use the Stop key to

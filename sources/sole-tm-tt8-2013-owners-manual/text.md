...
TABLE OF CONTENTS
 ...
 Using Heart Rate Transmitter                   23
...
3   HARDWARE STEP 3
              ...
              #85. 3/8” x 2T         #99. 5/16” x 3/4”          #100. 3/8” x 2-1/4”
           Split Washer (6 pcs)   Flat Head Socket Bolt   Button Head Socket Bolt (6 pcs)
                                          (4 pcs)




     #131. Ø8mm × Ø23mm × 1.5T            #102. Ø10mm × Ø19mm × 1.5T
...
3     ASSEMBLY STEP 3
      ...
      102
               ...
               85
      100
       1.   Attach the left and right Upright Tubes (5 & 4) to the Main Frame (1). Be
            ...
            (5 & 4) and into the frame. Partially tighten with the M6 L Allen Wrench (105).
...
6   ASSEMBLY STEP 6
    ...
    118                   117                                                        4
     ...
     1.       Attach the two halves of each Handrail Cover (117 & 118; 119 & 120) with
...
8     ASSEMBLY STEP 8
      ...
      126
       1.   Completely tighten the bolts that secure the Console Mast Tubes to the frame
            with the M6 Allen Wrench (105).
       2.   Attach the console mast covers (40R & 41L) to each mast (5 & 4) with two
...
QUICK-START OPERATION
 ...
 2. Press the Start key to begin belt movement then adjust to the desired speed using the
    Speed 5/6 keys. You may also use the Quick speed keys 2, 3, 4, 5, 6, 9, or 12 to adjust the
    speed.
...
INCLINE FEATURE
 ...
  Press and hold the Incline 5/6 keys to achieve desired level of incline. You may also
 ...
  The space above the Incline heading on the LCD will indicate deck elevation as adjustments
    are made.
...
3. The Message window will now be showing a value, indicating your Body Weight. Entering the
   ...
   press Enter. * A note about the Calorie display: No exercise machine can give you an exact calorie count because
    there are too many factors which determine exact calorie burn for a particular person. Even if someone is the exact same
    body weight, age and height, their calorie burn may be very different than yours. The Calorie display is to be used as a
...
   CUSTOM PROGRAM
   1. Select Custom on the Program keypad, then press Enter. Note that the dot matrix
      ...
      retrieved. If not, you have the option of programming in your first name. The Message
...
TREAD-BELT TRACKING ADJUSTMENT
   ...
   key is dislodged or the 15 amp fuse continues to blow, you may have an issue with the wax
   between the belt and the deck. Follow this procedure in order:
...
   CALIBRATION PROCEDURE
   ...
   3. You will now be able to set the display to show Metric or English settings (Miles vs.
      Kilometers). To do this, press the Up/Down key to show which you want, then press Enter.
   ...
   2. You can now scroll through the menu using the Fast/Slow keys. Use the Stop key to return
      to previous menu selection. The menu selections are:
      A. Key Test
      B. Display Test
      C. Functions - Press Enter to access settings, use Fast/Slow keys to scroll

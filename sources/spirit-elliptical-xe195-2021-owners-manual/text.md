...
4
Important Safety Instructions                                       recommended by the manufacturer.
                                                                •   Never operate this appliance if it has a damaged cord
     WARNING                                                        or plug, if it is not working properly, if it has been
When using an electrical appliance, basic precautions               dropped or damaged, or dropped into water. Return
should always be followed, including the following:                 the appliance to a service center for examination and
Read all instructions before using this appliance.                  repair.
DANGER - To reduce the risk of electric shock:                  •   Do not carry this appliance by supply cord or use
Always unplug this appliance from the electrical outlet             cord as a handle.
immediately after using and before cleaning.                    •   Keep the cord away from heated surfaces.
WARNING - To reduce the risk of burns, fire, electric           •   Never operate the appliance with the air openings
shock, or injury to persons, install the elliptical on a flat       blocked. Keep the air openings free of lint, hair, and
level surface with access to a 115-volt, 15-amp grounded            the like.
outlet with only the elliptical plugged into the circuit.       •   Never drop or insert any object into any opening.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 18AWG OR
                                                                •   Do not use outdoors.
BETTER, WITH ONLY ONE OUTLET ON THE END:                        •   Do not operate where aerosol (spray) products are
...
•   Close supervision is necessary when this appliance              machine.
    is used by, on, or near children, invalids, or disabled     •   Recommended Weight Limit: 350 lb
    persons.
•   Use this appliance only for its intended use as             SAVE THESE INSTRUCTIONS - THINK SAFETY!
...
    Fitness Equipment Safety Instructions
    ...
    •   The pulse sensors are not medical devices. Their purpose is to provide you with an approximate measurement
        in relation to your target hear t rate. Use of a chest transmitter strap (sold separately) is a much more accurate
        method of hear t rate analysis .Various factors, including the user’s movement, may affect the accuracy of hear t rate
        readings. The pulse sensors are intended only as exercise aids in determining hear t rate trends in general.
...
6   humidity is 95% non-condensing (no water drops forming on surfaces).
Circuit Breakers: Some circuit breakers used in homes are not rated for high inrush currents that can occur when
a elliptical is first turned on or even during use. If your elliptical is tripping the house circuit breaker (even though it is
...
    Important Operation Instructions
    ...
    •    NEVER use your elliptical during an electrical storm. Surges may occur in your household power supply that
        could damage elliptical components. Unplug the elliptical during an electrical storm as a precaution.
    ...
    Fitness.You can also go to https://www.spiritfitness.com/warranty under the Support tab to register
8   online.
XE195 PRE ASSEMBLY
...
12
                                                                        of the Console Mast. This needs to be tightened last, after the
                                                                        three other console mast bolts.
                HARDWARE FOR STEP 1
PART          TYPE         DESCRIPTION              QTY              5. Place a SPLIT WASHER (152) onto the BOLT (105) and
  103          BOLT                3/8”X3/4”          2                 hand tighten through the left side of the console mast. Place
  105          BOLT              3/8” X 2-1/4         1                 a CURVED WASHER (153) onto each BOLT (103) and
  116   PHILLIPS HEAD SCREW      M5 X 10mm            4                 thread both into the front of the console mast tube. Fasten
  120   SHEET METAL SCREW         3.5 X16mm           3                 these front bolts as tight as possible with the WRENCH
  130       NYLOC NUT              3/8” X 7T          2                 (155). Next firmly tighten the two left side bolts with the
  137      FLAT WASHER        Ø3/8” × Ø19 × 1.5T      2                 same wrench.
  152      SPLIT WASHER           Ø10 × 2T            1
                                                                     6. Connect the 2 HAND PULSE CABLES (48),
  153     CURVED WASHER        Ø3/8” × 23 × 2T        6
                                                                        RESISTANCE CABLE (44), and COMPUTER CABLE
  176          BOLT              3/8” X 2-1/4”        6
                                                                        (50) to the back of the CONSOLE (43). Do not force
                                                                        the connectors; they will only fit one way and are different
1. Gather HARDWARE FOR STEP 1.
                                                                        sizes to prevent confusion. Store the excessive cable in the
2. Locate the CONSOLE MAST (12) and CONSOLE                             CONSOLE MAST TUBE (12).
   MAST COVER (72); slide the Cover onto the Mast as far
                                                                     7. Attach the CONSOLE (43) to the bracket of the Console
   as it will go. Make sure the CONSOLE MAST COVER
                                                                        Mast tube with 4 PHILLIPS HEAD SCREWS (116).
   (72) is facing the correct way.
                                                                        Tighten the screws with the PHILLIPS HEAD SCREW
3. At the top opening of the MAIN FRAME (1), there is a                 DRIVER (157).
   COMPUTER CABLE (50) tied to a twist tie wire. Feed
                                                                     8. Attach the REAR FLOOR SUPPORT (15) to the
   the twist tie wire and COMPUTER CABLE (50) into
                                                                        RAILS (2 & 3) with 2 Bolts (176) and Curved Washers
   the bottom of the CONSOLE MAST (12) and out of the
                                                                        (153) on each side. Tighten using the COMBINATION
   opening at the top.
                                                                        M5 ALLEN WRENCH & PHILLIPS HEAD SCREW
4. Install the CONSOLE MAST (12) into the receiving                     DRIVER (177).
   bracket on the top of the MAIN FRAME (1). Be extremely
                                                                     9. Slide the Rail Assembly into the MAIN FRAME (1). Insert
   careful not to pinch the cables between the tubing. If the
                                                                        1 BOLT (176) through each side and attach a FLAT
   cable gets pinched, this may affect the electrical functions of
                                                                        WASHER (137) and a NYLOC NUT (130) to each joint
   the console. NOTE: There is one bolt already installed in the
                                                                        on the inside.
   receiving bracket that will engage with the slot at the bottom
                                                                                                                                          13
     XE195 STEP TWO               HARDWARE FOR STEP 2
                      PART       TYPE       DESCRIPTION             QTY
                        99        BOLT          5/16” X UNC18        2
                                                    X15mm
                       141     FLAT WASHER    Ø5/16” × Ø23 × 1.5T    2
...
14
XE195 STEP THREE               HARDWARE FOR STEP 3
                   PART        TYPE      DESCRIPTION             QTY
                     101        BOLT          5/16”X1-1/4”        2
                     142     FLAT WASHER   Ø5/16” × Ø20 × 1.5T    2
                     192     NYLOC NUT          5/16”X9T          2


                   1. Gather HARDWARE FOR STEP 3.
                   2. Untie the twist tie that holds each bushing
                      to the Connecting Arm end. Align the hole in
                      the end of the CONNECTING ARMS (L
                      & R) (8 & 9) with the hole in the bracket
                      of the SWING ARMS (L) AND (R), (10
                      & 11). The CONNECTING ARM ends
                      should be inside of the SWING ARM (L)
                      AND (R), (10 & 11) brackets. Slide a HEX
                      HEAD BOLT (101) through each SWING
                      ARM (L) AND (R), (10 &11) bracket and
                      each Connecting Arm end.
                   3. Slide a FLAT WASHER (142) onto each
                      bolt, then fasten the arms together by
                      tightening a NYLOC NUT (127) to each
                      bolt using the WRENCHES provided (109
                      & 106).
...
     XE195 STEP FOUR
                                      HARDWARE FOR STEP 4
                         PART          TYPE      DESCRIPTION          QTY
                          116   PHILLIPS HEAD SCREW    M5 X10MM         8
                          119    SHEET METAL SCREW     3.5 X 12MM       6
                       1. Gather HARDWARE FOR STEP 4.
                       2. Fasten the two WHEEL COVERS (79) to the
                          rollers with 4 PHILLIPS HEAD SCREWS
                          (116). Tighten with the PHILLIPS HEAD
                          SCREW DRIVER (157).
                       3. Attach the LEFT AND RIGHT SIDE
                          COVER (80) to the mid-stabilizer tube with 2
                          PHILLIPS HEAD SCREWS (116). Attach the
                          RIGHT SIDE COVER (85) and LEFT SIDE
                          COVER (86) to the rear stabilizer tube with 2
                          PHILLIPS HEAD SCREWS (116). Tighten all
                          4 screws with the PHILLIPS HEAD SCREW
                          DRIVER (177).
                       4. Install the LEFT HANDLE BAR COVERS
                          (81 & 82) and RIGHT HANDLE BAR
                          COVERS (83 & 84) over the Handle Bar axle
                          connections with 3 SHEET METAL SCREWS
                          (119) on each side. Tighten with the PHILLIPS
                          HEAD SCREW DRIVER (157).
                       5. Look closely at the four floor levelers
                          underneath the middle and rear of the elliptical. If
                          any of these aren’t in contact with the floor, use
                          the WRENCH (109) to loosen the bottom nut.
                          Once the nut has been loosened, turn the rubber
                          caster clockwise until it makes solid contact with
16                        the floor. Retighten the bottom nut to prevent it
                          from moving.
XE195 CONSOLE OPERATION
...
     POWER
     ...
     turn on. When the lights go off, the Message Center will show the software version (i.e.:VER 1.0).
     The distance window shows the distance total and the time window shows the total hours of use.
...
The elliptical trainer has a built in heart rate monitoring system. Simply grasping the hand pulse       19
...
first time you use the elliptical trainer, you will not have to enter it every time you work out unless
...
22
Preset Programs
The elliptical has four different programs that have been designed for a variety of workouts. These
...
starting this program) up to a maximum effort which lasts for 10% of the
total workout time, then a gradual regression of resistance back to approximately 10% of maximum
effort.
...
increase blood flow and lung capacity.                                                                23
     INTERVAL
     ...
     that are intense and short in duration. These deplete your oxygen level
     and spike your heart rate, followed by periods of recovery and heart rate
     drop to replenish oxygen.Your cardiovascular system gets programmed
...
give you the Maximum Heart Rate (MHR)for someone
of your age. To determine the effective heart rate range
for specific goals you simply calculate a percentage of
your MHR.Your Heart rate training zone is 50% to 90%
of your maximum heart rate. 60% of your MHR is the
recommended for burning fat while 80% is recommended
for strengthening the cardio vascular system. This 60% to
...
conditioning goals and high intensity interval training.
                                                                                                                           ...
                                                                                                                           29
     To start an HR program follow the instructions below or just select the HR key, then the Enter
     key and follow the directions in the Message Center.
     ...
     8.   During the HR program you will be able to scroll through the data in the Message Center by pressing the Enter
          key.
...
2.   If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of several reasons:
     ...
     II. Dirt build-up on the rear rails and polyurethane wheels are also a source of noise. Noise from build-up on the
           ...
           the back edge of a plastic knife. After cleaning, apply a small amount of lubricant on the rails with your fingers or
...
32
Elliptical Trainer Warranty - Effective November 30, 2021
...
Residential               Lifetime              Lifetime                  5 Years                      1 Year
...
2.   Damages caused by services performed by persons other than authorized Spirit Fitness service companies; use of parts other than original Spirit
     ...
     maintenance, inadequate power supply, or acts of God.                                                                                                              33

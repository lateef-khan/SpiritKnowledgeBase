...
--------------------------------------------Table of Contents-------------------------------------------
      ...
      6. Elliptical Basic Connections and Wiring
         ...
         6.4 Tension Motor Connector Definition Function
...
11. Disassembling and Assembling of Parts
   ...
   11.6 Flywheel & Poly-V Belt Replacement
...
Plastic parts
                                ...
                                Pedal Arm Cover(L)
                                         ...
                                         Side Case (L)
                                             ...
                                             Pedal (L)          Round Disk Cover

                                                                 Front Stabilizer Cover
                        Incline Cover

                 Inclinable Rail Cover                        Pedal Arm Cover (R)
...
Steel parts
              ...
              Console Holder Assembly
                 ...
                 Right Handle Bar (Top)
                                                 Main Frame
                  Lower Handle Bar (L)


                           Drive Pulley            Cross Bar


                                                     Bushing Housing,
                           Idler Bracket             Pedal Arm
...
The green wire is ground.
                                                                         ...
                                                                         12                    Service Manual
4. SE685S-YE030 Product Operation
...
Window Display Mode
  ...
  2.3 Use quick key to set sleep mode. In IDLE MODE press and hold ENTER+STOP+DISPLAY keys 2 seconds. use UP/DOWN key change sleep
      mode OFF or ON. Press ENTER key confirm then back to IDLE MODE.
...
4.2 You could chose the program by pressing the key: MANUAL、PROGRAM、USER1、USER2 、HRC1、HRC2. And then, press “START” key to start
    the workout. All parameter will be the present value.
...
5.4 The ramp incline level should back to “1” when the resistance level is “1”. The position of tension motor and ramp incline should back to the
    present level before it pause when press “START” key.


END MODE
5.5 The message window will display “WORKOUT SUMMARY” after end workout.


6.1 END MODE workout information:


     6.1.1 Display exercise data in message window each three seconds display.


6.2 When the time counting is end, and END MODE display is finished without pressing any key in 3 minutes. The system will enter IDLE MODE.
...
RUN MODE
  ...
  Fan button: It can to control ON/OFF for the fan.
  DISPLAY KEY：
      1.   Press DISPLAY key to switch the exercise data when you are workout. If the display information is the latest data, press DISPLAY key
           the message window will change to auto display every four seconds. The information as below,
           『LAPS XX』
           『SPEED XX.XMPH』
           『RPM XXX』
           『LEVEL XX』
           ...
           『SEG TIME X：XX』
                                                                    ...
                                                                    22                                                          Service Manual
5. SE685S-YE030 Unit Block Diagrams
...
Elliptical Configuration
                           ...
                           24   Service Manual
6. SE685S-YE030 Basic Connections and Wiring
...
9-2        Side case & Round Disk Problem
      ...
      2.     If the round disk is off center, take it apart and resume according to the procedures for replacing chain covers. (Refer to
            Disassembly Procedure, Step 4)
      3.     If the round disk swings with too much displacement, take apart chain covers and the round disk, and use Phillips head
            ...
            disk is within 3 mm prior to shipping.
                                                                    ...
                                                                    54                                                   Service Manual
9-3        Flywheel Problem
      1.   The problem with this part is rare. If there is problem, the most case will be improper steel cable adjustment that causes
           noise or shifting which caused by improperly assembled. Follow procedures for replacing flywheel for steel cable
           adjustment.




      2. If there is noise with the flywheel, check if there is foreign material or abnormal rubbing. Replace with new flywheel if the
...
9-4    Poly-V Belt Problem
      1. If the Poly-V Belt falls off, first remove the right chain cover and Idler Wheel Plate, and then reinstall the Poly-V Belt.
         ...
         belt pulley is offset or if the belt, Drive Pulley, Magnetic flywheel is not aligned in a straight line. Lastly, rotate at high
...
3. If the Poly-V Belt is slipping, simply adjust the cap the on hook-type screw with the #13 wrench to adjust. Refer to the
   disassembly procedures for adjustment. (Refer to Disassembly Procedure, Step 6)
                                                         ...
                                                         57                                                  Service Manual
9-5   Swing Arm Problem
      1. To make assembly easier for consumers, there will be minor difference in size (0.05mm~0.07mm). Therefore, it is
         normal for a little shake/wobble to exist, but after prolonged use, small parts due to friction wear will generate noise.
         The solution is to add thick lubricant into the top of Swing Arm Axle.
      ...
      2. If the plastic Bushing has been worn out, replace it with a new one.
                                                               ...
                                                               58                                                   Service Manual
9-6    Bushing Housing, Pedal Arm
      1. The problem with Bushing Housing is rare. However, a few units might have noise problem as time lasts. Applying
         some grease on Ø 25 x 111.5 L shaft on Cross Bar Assembly, may be helpful for solving this problem.
      ...
      2. If the plastic Bushing has been worn out, replace it with a new one.
                                                              ...
                                                              59                                              Service Manual
9-7   Connecting Arm and Rail Tube Problem
      ...
      2. There are many causes for un-smoothness. Slide wheels moving parallel and freely on the rail is the key factor which is
         affected by the pedal arm parallel to the rail and perpendicular to the bearing housing.
      3. Check to see if left/Right connecting arm and left/right step is connected properly, if sliding wheel has the correct
         rotation degrees, slipping occurrences or bearing damages, unsecured connections causing noises.
...
9-8   Controller & Incline Motor Problem
      1. If the incline motor does not function, first check the proper connection of the cables then the damage of the incline
         controller, the transformer and the console. Replace the part which is damaged, as shown in figures 1, 2.
...
10-2 Slip Problem
     ...
     3. Bushing housing: 3/8" x2-1/4" Socket Head Cap Screw and 3/8" x11T nut on top must be tight enough, as shown in
        figure 2, with 500~600 lbs of force suggested.
                                                         ...
                                                         64                                             Service Manual
4. Cross Bar: CAP Socket Head Cap Bolt M8x40m/m on top of the Cross Bar on the must be tightened to recommend
   550~600Lbs.
...
5. Belt: This issue appears quite often, because after a period of time, most belts will become loose from use depending
   ...
   references.
                                                       ...
                                                       65                                                Service Manual
10-3 Shaking Problem
    1. Shaking is mainly due to loosen screws, so check and tighten loose screws first. Check connection points to see if
       gaps have been created after prolong use causing wear and tear or improper assembly. For example, shaking of the
       foot pedal is caused by loose Carriage Bolts, from improper assembly.
...
11-1. Console Replacement
    ...
    4. Use Phillips head screwdriver to remove Phillips Head Screws M5x10mm (2pcs) then move out the Drink Bottle Holder.
...
11-2. Connecting Arm Replacement
     ...
     2. Use 12 and #13 open end wrenches to release Hex Head Bolt 5/16" x1-1/4", flat washer 5/16" x 20 x 1.5T and nut
        5/16" x 9T which secure the Rod End Bearing.




                                                             69                                                 Service Manual
3. Use 12mm open end wrench to remove hex socket screw     5/16”x15mm and flat washer 5/16”x20. Pull out the pedal
...
11-4. Side Case Replacement
    ...
    2. Follow the assembly instructions by owner’s manual of reverse steps, Use the Phillips Head Screw Driver to remove
       the console mast cover. (As shown in Figure 1)




    3. Use Phillips head screwdriver to release 9pcs of 3.5x16 self tapping screws and 3pcs of 5x16 x 3 tapping screws to
       take Right Side Case apart.




    4.   To take the Left Side Case apart, release 3.5x16 self tapping screws with 1/4"x19 flat washers on the main frame and
         3pcs of 5x16 Tapping Screws. Then disconnect two red jumpers and white grounding (remember to mark for red
         jumpers) to release left Side Case. (As shown in Figure 4 and 5 and 6)

                                                            73                                                 Service Manual
 5. Install back this part, connect the red jumpers and the grounding back on the AC Electronic Module.
 6. Return Left Side Case (with one 5/16" x 23 x 1.5T flat washer on it) onto the main frame and use3.5x16self tapping
     screw with 1/4"x19 flat washer to hold it (not too tight temporarily) then tighten with 3pcs of 5x16 tapping screws (make
     sure Side Case matches with Round Disk). Tighten 4x15 self tapping screws. (As shown in Figure 7)




7.   Match both Side Cases with each other and use 9pcs of 3.5x16 self tapping screws and 3pcs of 5x16 tapping screws to
     secure them.
...
11-5. Cross Bar Replacement
    ...
    2.    Use 13 mm wrench and loosen the outer bolt M8x6.3T (steel lvl 10). Use #13 wrench and hex wrench (M6) to loosen
         the inner bolt and remove the cross bar.
...
11-6. Poly-V Belt Replacement
     1. Follow procedures 11-2, 11-3, 11-4 and 11-5 to take apart Connecting Arm, Pedal Arm, both Chain Covers and the
        Cross Bar.
     2. Use 13 mm wrench to loosen M8 x 9T nut on M8x170mm J-bolt and on Idler Wheel, and another M8 x 7T nut and the
        Belt can thus be released, as shown in figures 1, 2 and 3.




     3. To resume, return the Belt on the Drive Pulley and Flywheel then tighten M8 x 9T nut until the acoustic gauge reads
        190 Hz (+/- 10 Hz) when it is played with finger, then tighten M8 x 7T nut , as shown in figure 4.
     ...
     4. Reassemble in the reverse order as disassembly
                                                            ...
                                                            77                                                Service Manual
11-7. Idler Wheel Replacement
    1. Follow procedures 11-2, 11-3, 11-4, 11-5 and 6 to take apart Connecting Arm, Pedal Arm, both left and right Side
       Cases, Cross Bar and the Belt.
    2. Use 13 mm wrench to loosen M8 x 9T nut on M8x170mm J-bolt together with 5/16" x 23 x 1.5T flat washer until J-bolt is
       released. Use the same wrench to release M8 x 20 carriage bolt, which secures Idler Wheel Assembly, together with
       5/16" x 20 x 1.5T flat washer and M8 x 7T nut to take Idler Wheel Assembly apart, as shown in figures 1 and 2.




    3. To resume, tighten M8x20 carriage bolt, 5/16" x 20 x 1.5T flat washer and M8 x7T nut to secure Idler Wheel Assembly
       (to be tighten after the belt has been adjusted) and return the J-bolt and other parts.
                                                           ...
                                                           78                                                Service Manual
11-8. Flywheel Replacement
     1. Follow procedures 11-2, 11-3, 11-4, 11-5, 11-6 and 11-7 to take apart Connecting Arm, Pedal Arm, both Side Covers,
        Cross Bar, the Belt and Idler Wheel Assembly.
     ...
     5. Tighten both 3/8" -UNF26 x 9T nuts
     6. Return the steel cable onto the Flywheel (with 45 degree) and then return the Idler Wheel Assembly, as shown in
        figure 5.

                                                           79                                                Service Manual
7. Turn the Drive Pulley and check if the belt is secured. Adjust both 3/8"-UNF26 x 4T nuts to position the belt in the
   middle on the Drive Pulley and then tighten all other screws. Adjust the Belt to a proper tension, as shown in figure 6.




8. Follow procedures 11-7,11-6,11-5,11-4,11-3 and 11-2 to return other parts.
...
11-9. Drive Pulley Replacement
        1. Follow procedures 11-2 and11-3 to take apart Connecting Arm, Pedal Arm, left and right Side Cases, Cross Bar
           and the Belt.
        2. Use 12 mm wrench to release 5/16" x 15m/m hex head bolt with 5/16" x 35 x 1.5T flat washer and the Bushing
           Housing can be released, as shown in figure 1.




        3. To resume, be sure that Ø 25 wave washer is returned onto the shaft then return the Bushing Housing onto the
           shaft and tighten with 5/16" x15m/m hex head bolt with 5/16" x 35 x 1.5T flat washer, as shown in figures 2.
        ...
        4. Follow procedures 11-3 ~ 11-4 and 11-2 ~ 11-5 to return Pedal   Arm and Connecting Arm.
                                                          ...
                                                          81                                                Service Manual
11-10.   Slide Wheel Replacement
         1. To take the slide wheel apart, use Phillips head screw driver to release two Phillips head screws M5x15mm and
            take the slide wheel cover first.




         2. Use circlip pliers to remove circlip Ø 17 and remove sliding wheels
...
11-11.   Incline Motor Replacement
         ...
         3. Use two 14mm wrenches to release 3/8"x2-1/2" Hex Head Bolts, 3/8"x19x1.5T Flat Washers and 3/8"x7T Nyloc
            Nuts which secure Rear Rail Assembly and Incline Motor Holder.




                                                          83                                               Service Manual
4. Use two 17mm wrenches to release M10x130m/m" Hex Head Bolts, 3/8"x19x1.5T Flat Washers and M10 x 8T
   Nyloc Nuts which secure Incline Motor and Incline Device.
...
6. Use 12mm wrench to release 5/16"x1 Hex Head Bolt and 5/16"x 35x2T flat washer which secure Rail Assembly.
   Pull out Locking Tube Assembly and take apart Rail Assembly.

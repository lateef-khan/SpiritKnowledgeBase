...
A TE N T| O , Before returning your Sole product to any retailer, or if you require any assistance with assembly or
...
Service Checklist - Diagnosis Guide 30
...
#120.5x 16mm #94. M5 x 20m/m_
Tapping Screw (2 pcs) Phillips Head Screw (2 pcs)
...
#131. Combination M5 Allen Wrench #132. M6 L Allen Wrench
...
1. Install two Speed Nut Clips (128)
Frame Base.

2. Slide the lower handlebar covers (64 & 65) onto the console masts.
Take note of the orientation.

3. Slide the Frame Base Caps (62L & 63R) over the Upright tubes (4 &
...
rest the console on at an appropriate height or have someone hold
...
of the Upright Tubes (4 & 5) with four Sheet Metal Screws (175).
...
ZG \ Button Head Socket
Cg = Bolts (4 pcs)
StS —_ eS aN #75. Safety Key
...
(94). Tighten screws using the Combination M5 Allen Wrench &
Phillips Head Screw Driver (131).
...
use Combination M5 Allen Wrench & Phillips Head Screw Drive
...
the desired position. _
@ TOFOLDTHE TREADMILL ’ —_—_
Make certain that the treadmill is at minimum incline. Lift te &
the treadmill’s running deck until it is secured by the — 7 a
locking telescoping tube assembly in the center back of iy => >
...
*/- 8 10-00 m-
CONTROL KEYS “_
AUDIO IN JACK (MP3, CD, OR ee fee eked ke oe HEADPHONE JACK
SMARTPHONE)
...
the treadmill will not power on without it (see assembly step 7 for reference).
...
3. To slow down the tread-belt, press and hold the Speed W key on the console or handgrip to the
...
the second time, the program will end and a workout summary will be displayed. If the Stop
button is pressed for the third time, the console will return to the idle mode (start up) screen.
...
= Press and hold the Incline a/v _ keys on the console or handgrip to achieve your desired level
...
Eighteen columns of dots — each 8 units high - indicate
each segment of a workout for the F65 and eighteen
columns of dots - each 8 units high - indicate each =< FA

n-
— rai

segment of a workout for the . The dots are only to show
an approximate level of effort in speed or incline. They do
not necessarily indicate a specific value - only an
approximate percent to compare levels of intensity. In
operation, the speed/incline dot matrix window will build
a profile “picture” as values are changed during a workout.
When the word “Speed” is lit above the dot matrix, it
indicates that the Speed profile is being displayed. When
the word “Incline” is lit above the dot matrix, it indicates
the Incline profile is being displayed.

You may change the Dot Matrix profile view between Speed and Incline by pressing the Enter button.
After pressing Enter to view the two profiles, pressing it for the third time will automatically alternate
the Speed and Incline displays, showing each one for five seconds.
...
There is an Audio Input Jack (44) on the front of the console and built-in speakers. You may plug any
low-level audio source signal into this port. Audio sources include MP3, iPod, portable radio, CD
player or even aTV or computer audio signal. There is an audio patch cable included anda

headphone jack ( £3) for private listening.
...
show: Display mode - On. Use any of the Program, Incline or Speed A keys to change the setting to
...
6. Press Start to begin the program. The program will begin with a 3 minute warm-up. If youwant
to bypass this and go directly to the — of the program, press Start again.

“ BL UW i “ = eth UU fa

non ee Ge ~ th) ann ST (~ oi Dp JIOOOOOL’
AGE 3S HET 1 ist 4 H 155
= MMI a=\ 1] [= “i fin a
im ~ > a ~
TIME eudg MAX SPEED 4 MPH
...
1. Select User 1 or User 2 via the Program 4/V¥ keys then press Moe K { i
...
that is pressed, it will be retrieved. If not, you have the option
of programming in your first name. The Message Window will
display and flash the letter “A”. To change it, press the any A
key, then “B” will be displayed; if the any V_ key is pressed, the
letter “Z” will be displayed. After selecting the appropriate

letter, press Enter. The letter “A” will again be displayed and ~ q Til rin: nf ,

blinking. Repeat the procedure until all letters of your first “

name are programmed (7 characters maximum). When your setae =i An [I LL [ “Tas bans

name is displayed, press Stop and it will be stored under either ail od ae

User 1 or User 2. UU vu A
2. Next the Message Window is flashing Age. Use the Incline NAME A

A/V keys to adjust. Press Enter. This is a must to continue even
if age is not adjusted.
...
<!-- render-vs-extraction: 266 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
3. Position the transmitter with the SOLE logo centered in the middle of enieniame itis
...
oo. . Check that the treadmill is the only appliance in the
House circuit breaker trips, but not circuit. See “Important Electrical Information” in the
the treadmill circuit breaker front of this manual for more details.
...
external causes such as corrosion, discoloration of paint or plastic, alterations, modifications, abuse, misuse, accident, improper maintenance,

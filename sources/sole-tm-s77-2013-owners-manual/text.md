...
IMPORTANT SAFETY INSTRUCTIONS
   ...
   tread-belt movement.
     ...
     1. Place the safety key into position on the console control head. Your treadmill will not start
        and operate without this. Removing the safety key also secures the treadmill from
        unauthorized use.
...
Motor Cover & Clean & Inspect Deck        Lubricate Deck      Inspect Belt Tracking
 ...
 (Every Other (Every Other Month)         or sooner if dry)        necessary
    Month)
                                              ...
                                              5                                       S77 TREADMILL
     S77 ASSEMBLY PACK CHECKLIST
3     HARDWARE STEP 3


          #79. Ø10mm × Ø19mm × 1.5T                #86. 3/8” x 2T       #100. 5/16” x 3/4”
                Flat Washer (6 pcs)             Split Washer (6 pcs)   Button Head Socket
                                                                           Bolt (4 pcs)




               #123. 3/8” x 2-1/2”             #124. Ø8mm × Ø23mm × 1.5T
         Button Head Socket Bolt (6 pcs)          Curved Washer (4 pcs)
    ...
    ASSEMBLY TOOLS
      ...
      #103. Combination M5 Allen Wrench
         & Phillips Head Screw Driver
           ...
           #104. M6 L Allen Wrench




                                        7   S77 TREADMILL
         S77 ASSEMBLY INSTRUCTIONS
         ...
         1        ASSEMBLY STEP 1
                  ...
                  1.        Remove the treadmill from the carton and position it aside on a smooth, level
                            ...
                            the unit to fold up and cause serious injury!
         ...
         2  114
                  ASSEMBLY STEP 2
                       ...
                       99
                                                                                                  ...
                                                                                                  32
                                                                                                                32
                  1.        Slide the Console Mast Tube Covers (99 & 112 onto 5 and 98 & 114 onto 4)
                            onto the left and right Console Mast Tubes. Make sure the holes of 99 & 98
                            face the outside on each side.
                  2.        Connect the Lower Computer Cable (32) with the Middle Computer Cable
...
3       ASSEMBLY STEP 3
                  ...
                  86 79
                                                                                                #124. Ø8mm × Ø23mm
                            7                                                                   × 1.5T Curved Washer
                  123
                                                                                                (4 pcs)
         1.   Attach the left (5) and right (4) Console Mast Tubes and accompanying
              brackets (7 Left Side & 8 Right Side) to the base frame with three Flat Washers
              (79), three Split Washers (86), and three Button Head Socket Bolts (123) from
              each side and two Button Head Socket Bolts (100) & Curved Washers (124) at
              the front of each side. Partially tighten using the M6 Allen Wrench (104) & M5
              Allen Wrench & Phillips Head Screw Driver (103).
              Note: Don’t tighten the bolts completely until after Step 7.
...
4       ASSEMBLY STEP 4
         ...
         1. Connect the Speed Switch Cable (37) to the upper Speed Cable (34).
         2. Connect the Computer Cable (33) to the upper Computer Cable (31).
         3. Connect the Incline Switch Cable (38) to the upper Incline Cable (35).
...
5     ASSEMBLY STEP 5                                                                     HARDWARE STEP 5
            ...
            91
                            5
       1.   Attach the Console Assembly (36) onto the uprights (5 & 4) with two Button
            Head Socket Bolts (91) and two Split Washers (86) on each side. Completely
            tighten using the M6 Allen Wrench (104).
...
6    ASSEMBLY STEP 6
     ...
     112                          114                                               125
      ...
      1.    Attach the Left Handgrip Side Cap (111 & 112) and Right Handgrip Side Cap
            (113 & 114) on the uprights (5,4) and Console Assembly (36) with six Sheet
            Metal Screws (125). Tighten using the Combination M5 Allen Wrench and
...
7   ASSEMBLY STEP 7                                                                        HARDWARE STEP 7
    ...
    5             100   3   100
     ...
     1.   Install Handrail Support (3) between right and left Uprights (4) and (5) and
          use the Combination M5 L Allen Wrench & Phillips Head Screw Driver (103) to
          tighten the four Button Head Socket Bolts (100). Then install the Left & Right
          Beverage Holder Covers (129 & 130) at each end of the Beverage Holder
          (120) and put it on Handrail Support (3).
          Important: Completely tighten the four bolts that connect the console mast
          tubes to the base frame on each side.
...
8   ASSEMBLY STEP 8
    ...
    127                                                          127
     ...
     1.   Slide the Console Mast Tube Covers (99 & 98) all the way to the bottom of
          each tube and attach with two Phillips Head Screws (127) on each side.
          Tighten using the Combination M5 Allen Wrench and Phillips Head Screw
          Driver (103).
...
QUICK-START OPERATION
   ...
   2. Press the Start key to begin belt movement then adjust to the desired speed using the
      Speed 5/6 keys (console or handgrip). You may also use the Quick speed keys 2, 3, 4, 5, 6,
   ...
   INCLINE FEATURE
      ...
       Press and hold the Incline5/6 keys (console or handgrip) to achieve desired level of
         effort. You may also choose a more rapid increase / decrease by selecting desired key,
         1, 3, 6, 9, 12, 14 and 15 on the left side of the console (incline).
...
DOT MATRIX CENTER DISPLAY
 Twenty four columns of dots (10 high) indicate each segment
 ...
 Matrix window will show either speed or incline. When Speed
 is lit the Dot matrix displays the Speed profile and when
 Incline is lit the Dot Matrix displays the Incline profile.
 ...
 to and also a headphone jack ( ) for private listening.
                                             ...
                                             15                                       S77 TREADMILL
   PULSE FEATURE
   The Pulse (Heart Rate) Window will display your current heart rate in beats per minute dur-
   ing the workout. You must use both stainless steel sensors on the front cross bar to display your
   ...
   **ATTENTION**
   ...
   display will show: Display mode - On. Use the Incline 5 key or the Speed 5 key to change the
...
PROGRAMMABLE FEATURES
 The S77 has ten built-in programs: one Manual program, five preset profiles, two user defined
...
2. If Enter was pressed, the Message Window will display Age. You may use any of the Incline
   5/6 or Speed 5/6 keys to adjust your age. After adjusting press the Enter key.
...
3. The Message Window will now be displaying a value, which is your Body Weight.
   Entering the correct body weight will affect the calorie count. Use the Incline 5/6 keys or
   the Speed 5/6 to adjust, then press Enter.
...
4. The Time Window will now be displaying a value, which is total workout time desired. Use
   the Incline 5/6 keys or the Speed 5/6 keys to adjust, and then press Enter. After
   adjusting, press the Enter key.
5. The Speed Window will display the preset top speed of the selected program. Use the
   Incline 5/6 keys or the Speed 5/6 keys to adjust, and then press Enter. Each program
   has various speed changes throughout; this allows you to limit the highest speed the
   program will reach at its peak.
...
1. Select User 1 or User 2 via the Program keys then press
   ...
   press the any 5 key, then “B” will be displayed; if the any 6
   key is pressed, the letter “Z” will be displayed. After
...
2. Next the Message Window is flashing Age. Use the Incline
   5/6 keys keys to adjust. Press Enter. This is a must to continue even if age is not adjusted.
...
5. The first column (segment) will now be blinking. Using the Speed 5/6 or Quick keys,
...
bar for Heart Rate. You must receive a strong/steady value in the Heart Rate Window
...
4. Now you are asked to adjust the HR1 or HR2 value. The default is 60% (HR1); (220 - age x
   ...
   the number by pressing the Speed 5/6 keys (console or handrails) and press Enter to
   continue.
...
7. If you want to increase or decrease the speed at any time during the program press the
   Speed 5/6 (console or handrail) keys.
...
GENERAL MAINTENANCE
   ...
   Adjustment must be made from the rear roller with the M6 L Allen wrench (104) provided in the
...
TREAD-BELT TRACKING ADJUSTMENT
 ...
 A 6 mm Allen wrench (104) is provided for this
     ...
     6. If the “Lube” message appears on the console, perform the following procedure to reset
        the message:
         1. To enter the Engineering Mode Menu press and hold down the Start, Stop and Enter
            ...
            access
         2. Press the Speed 5 button (or Speed 6 button to go backwards) until “Functions”
            appears; press Enter.
         3. Press the Speed 5 button until “Maintenance” message appears; press Enter to reset
            lube message.
...
   CALIBRATION PROCEDURE
   ...
   2. Press and hold down the Start and Speed 5 buttons and replace the Safety Key.
      Continue to hold the Start and Speed 5 key until the window displays “Factory settings”,
      then press the Enter key.
   3. You will now be able to set the display to show Metric or English settings (Miles vs. Kilome-
      ters). To do this, press the Incline 5/6 key to show which you want, then press Enter.
   4. Make sure the wheel size diameter is 2.85 then press Enter.
   ...
   2. You can now scroll through the menu using the Speed 5/6keys. Use the Stop key to
     ...
     C. Functions - Press Enter to access settings, use Speed 5/6 keys to scroll

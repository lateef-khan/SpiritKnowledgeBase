...
1                Service Manual
-------------------------------------------Table of Contents-------------------------------------------
                        1. ST928 Treadmill Outlines
                        2. Electronic Parts
                            2.1 Upper Controllers
                            2.2 Lower Controller and driver
                        3. Electrical Configuration
                        4. ST928 Treadmill Operation
                        5. ST928 Unit Block Diagrams
                        6. ST928 Basic Connections and Wiring
                        ...
                        8. ST928 Treadmill Error Messages / Troubleshooting
...
2.2 Lower Controller and Driver
         ...
         SPEED SENSOR
                         ...
                         CONTROLLER
                                  ...
                                  Driver system (Motor/Controller/Incline
                                                          9
                                                                          Motor)
                                                                                                   Service Manual
...
DECLINE MOTOR
 The function is the same as incline motor narrative.
                                                                        ...
                                                                        12                               Service Manual
4. ST928 Treadmill Product Operation
...
Function
   SPEED
      ...
      WORK range is 0.5 ~ 12.0 mph (1.0~18.0 kmph) Note: Specific spec has 22.0kph of maximum speed.
   ...
   GRADE (INCLINE & DECLINE)
      ...
      INCLINE preset value is -6 to 15.
   ...
   TIME
      ...
      In RUN Mode, press “STOP” button to save value of time and enter “RUN Mode” again that value will continue count up time.
                                                                     ...
                                                                     15                                                      Service Manual
LAPS
    Display the total working lap’s quantity.
    DISPLAY range is 0 to 99.
...
Function Button In Main Mode
  READY MODE
     ...
     SPEED RAPID button: 5 preset buttons for rapid speed: 2，3，4，5，7，9，12 (Note: On 22.0kph spec is 3, 6, 9, 12, 15, 18, 22)
...
RUN MODE
  ...
  SPEED RAPID button: Speed will set to 2，3，4，5，7，9，12 speed quickly . (Note: On 22.0kph spec is 3, 6, 9, 12, 15, 18, 22)
  ...
  Press DISPLAY key to switch the exercise data shown on the message window when you are workout. The information as below,
      ...
      MAX SPEED XX.X
                                                                 ...
                                                                 19                                                         Service Manual
5.ST928 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          21   Service Manual
6. ST928 Treadmill Basic Connections and Wiring
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           33                                                              Service Manual
8.ST928 Treadmill Error Messages /
         Troubleshooting
...
Note: Before check hardware, first check software setting.
 Remove safety key, press STOP & START & ENTER keys, and at the same time insert the safety key. The display into “ENGINEERING MODE”, Press
FAST/SLOW or UP/DOWN keys, to find “functions”, and press Enter key into “DISPLAY MODE”, and then press Enter key into choosing on or off.
...
E1 issue troubleshooting form
 ...
 The motor
 cannot       The speed sensor didn't   Check the gap            To keep the gap-distance

 move         detect signal completely. between speed sensor less than 3 mm.
                                        and magnet.
...
Explanation
        When press incline key, the display board CPU reads the incline VR value. If there is no VR value change to the CPU, the incline is not operating, and then
appear E3 appears on the display.
 Action flow chart：
...
Cause of E4:
 ...
 Display board               Replace upper control board.
                                                            ...
                                                            53   Service Manual
 8.6 Error Message：E5
        Definition: it is a Poor communication, between the console and lower controller is poor communication, almost it is bad on a main control wire, but also
        possible bad at console board or lower controller.
        Configuration：
...
Cause of E7:
        The wall outlet possibly unstable, cause to treadmill working power does not stable. Another problem possibly power part of lower controller board is broken.
...
GRADE window displays “E3”.                       1. connector fall off.                      2 Calibrate the console.

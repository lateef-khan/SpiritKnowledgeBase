...
Important Electrical lnstructions 3
Important Operation Instructions 44
CT800 Assembly Instructions a)
Operation of Your Console 10
Programmable Features 13
Using Heart Rate Transmitter 19
General Maintenance 21
Service Checklist - Diagnosis Guide | 23
...
Fitness. You can also go to https://wwwspiritfitness,com/residentialwarrantyregistration,html
...
||. Do not operate where aerosol (spray) products are being use or where oxygen is being ad
ministered.
...
when a treadmill is first turned on or even during use. If your treadmill is tripping the house circuit breaker (even
...
part # |D237, or available online at www.squared.com part #QO120HM. The electrical outlet used should have a
...
with a qualified electrician or serviceman if you are in doubt as to whether the product is properly grounded, Do not a
modify the plug provided with the product if it will not fit the outlet, have a proper outlet installed by a qualified
electrician.

This product is for use on a nominal | |0-volt/15 amp dedicated circuit, and has a grounding plug that looks like the
...
should be used only until a properly grounded outlet, (shown below) can be installed by a qualified electrician. The
...
|, Place the magnet into position on the round metal portion of the console control head.
...
2, Locate the hardware package. Remove the tools first. Remove the hardware for each step as needed to avoid
...
7,
3/8" Allen Wrench ; 10mm Allen Wrench Phillip Head Screwdriver
...
|. The right side console mast tube (19) has computer cable A (87) pre-installed, Lift the tube off the walking
...
one bolt (104), split washer (58) and flat washer (59) through the top hole in the retaining plate (21), and
...
HARDWARE
© © ¢ NN
#58. 3/8" #59. 3/8" #104, 3/8" x 3-3/4" #73. M5 x | 2mm Self
Split Washer Flat Washer Stainless Steel Bolt Tapping Screw
(6 pcs) (6 pcs) (6 pcs) (4 pes)
...
Connect computer cables G (86) & C (120), hand pulse cables D (122) & F (88), on the right and B (28) &
...
#110. M5 xlOmm #73. M5 x [2mm #125. M5 #112. M5 x 30mm
Machine Screw Sheet Metal Screw Star Washer Machine Screw
(2 pes) (1 pc) (I pc) (2 pcs)
...
When assembling the console mounting interface brackets (3 & 4) please be sure to slide the
...
=== PAGE 13 ===
STEP 3: Console Io Console Mast Tubes

1, Attach the two interface mounts (3 left & 4 right) to the console assembly frame with six bolts (108).

2, Connect console computer cable € (120) to cable A (87) from the console mast tube,

3. Attach the console assembly to the top of the console mast tubes with six bolts (105), split washers (58) and
flat washers (59). Be careful not to pinch the computer cable.

#58. 3/8" #59, 3/8" #105. 3/8" x 3/4" #108. M8 x [2mm
Split Washer Flat Washer Button Head Socket Bolt Socket Cap Bolt
...
Fan to keep Heart Rate
you cool 2% Profile

Convenient water bottle
holder and cargo

Contact Heart 20-Character Large Blue-LED compartment for keys,
Rate Grips Message Genter ) Matrix Window phone, or MPS player
...
with the Virtual Reality Fitness system by WebRacing™ LTD. See your
Spirit Fitness dealer for more information on how your members can
race against a computer controlled figure or real life exercisers.
...
6 to set to a specific speed directly,
...
Ifthe Stop button is pressed a third time, the console will return to the idle mode (start up)
screen.
...
are twenty-four columns, indicating time. The 24 columns are divided into |/24th of the total time
...
profile view by pressing the Display button. After scrolling through the three profiles the Dot
matrix will automatically scroll through the three displays showing each one for four seconds. The
LED associated with each profile will blink while that view is displayed. One more press of the
...
The Spirit Fitness CT8Q0O offers five preset programs, a Custom User defined program, two
...
time during the programming to begin with only settings you have modified at that point).
...
chart indicate a percentage of the top speed of the program, For instance, the first Speed setting for P| (Program
|, HILL) shows the number 20,This means that this segment of the program will have a speed that is 20% of the top
speed for the program (The user sets the top speed in the procedure above), If the user sets the top speed to 10
mph, then the first segment will be 2 mph. You will notice that segment 12 shows 100 which means, the speed will
be set to 100% of 10 mph or simply 10 mph,

P1l= Hill; P2= Fatburn; P3= Cardio; P5= Interval

P| Speed 20 | 30 | 40 | 50} 60} 60:]70:] 70 ].:70 | 80°}°80°| 70: |:80:] 80:}. 100} 100] 70 80.) 80:| 70:|.70. | 80.4 80 | 70} 60 | 60} 50] 404.30} 20

incinelo}ofojolif2{3]}3;4}3]}3}4}4]s]3]3}4]3}3}4latstalalrlifololol}o

100] 80 | 70|.60. 0 40 | 30 | 20

|00} 100| 100} 100] 100} 100 100| 100] 100] 100| 100] 100} 100]

3 [Speed | 20430 40 | 50 60.1.60.1.70 70. 70 80 70. 70: 80; 80 60°} 70 80 2707 20.) 70 1100 70 80.].60 |'60 |.50 | 40 | 30} 20

Custom Program

|, Select the Custom program then press Enter, Note that the dot matrix display portion
will light a single row of dots at the bottom (Unless there is a previously saved program).

2. The clock (Time) window will be flashing. Use the up and down adjustment keys to set the
...
5. The first speed setting column (segment) will now be blinking. Using the Up/Down keys,
...
The fitness test is based on the Gerkin protocol, also known as the fireman’s protocol, and is a submax Vo2 (volume
...
4.4 3:15 5.0mph 4% 44.4
4.2 3:30 5.O0mph 4% 45.15
...
410.2 9:30 6.5mph 10% 73.1
10.3 9:45 6.5mph 10% 73.8
10.4 10:00 6.5mph 10% 74.9
41.1 10:15 7.0mph 10% 76.3
41.2 10:30 7.0mph 10% 77.7
11.3 10:45 7.O0mph 10% 79.1
11.4 14:00 7.0mph 10% 80
...
4
excellent | 760 | 756 | >5) | 45 | oat | 937 good | 47-56 | 45-52 | 38-45 | 34-40 | 32-37 | 28-32
...
average | 37-41 | 35-39 | 31-34 | 29-31 | 26-29 | 22-25 poor 28°32 | 2630 | 2226 | 20-24 | 1821 | 17-18

poor 30-36 | 30-34 | 26-30 | 25-28 | 22-25 | 20-21 verypoor | <28 | <26 | <22 | <20 | <18 | <I”
...
For someone who is 40 years old their 190 rae iN GHACT
target heart rate zone is calculated: 180 i
gz 170 Hn 5
220 — 40 = 180 (maximum heart rate) = 160 "rt Rate
180 x .6 = 108 beats per minute A 150
(60% of maximum) & 140
180 X .8 = 144 beats per minute ‘ 2 130
(80% of maximum) = 120
= 10
So for a 40 year old the training zone would be 108 4100

to 144 beats per minute. 90

20 25 30 35 40 45 50 55 60 65
If you enter your age during programming the Weightloss Cardiovascular Age of User
...
ing. For example a rating of 12 will result in an approximate heart rate of |20 beats per minute.
...
Heart Rate Control (HRC) uses your treadmills incline system to control your heart rate. In-
creases and decreases in elevation affect heart rate much more efficiently than changes in speed
...
Continue to make |/4 turns until the belt
stabilizes in the center of the running deck,

If the belt is too close to the right side, turn the {f"
bolt counterclockwise. The belt may require
...
Tread-belt does not stay centered The user may be walking while favoring or putting more
Treadmill belt hesitates when weight on either the left or right foot. If this
...
Motor is not responsive after press- |. If the belt moves, but stops after a short time and
ing start thedisplay shows “LS”, run calibration.
2. If you press start and the belt never moves, then the
display shows LS, contact service.

Treadmill will only achieve This indicates motor should be receiving power to oper
approximately 7 mph but shows higher ate..Low AC voltage to treadmill. Do not use an extension
speed on display cord. If an extension cord is required it should be as short
...
tether cord is pulled section on cleaning the deck, If cleaning doesn’t prevent
...
Treadmill trips on board |5 amp circuit High belt/deck friction. See General Maintenance. If
...
Circuit breaker trips, but not the Need to replace the breaker with a ‘High In-rush current”
treadmill circuit breaker type breaker (see page 3 for details)
...
|. Remove the motor cover hood by loosening the 8 screws that hold it
...
loosened to adjust the senson Re-tighten the screws when finished.
...
i. Beep (Turns off the speaker so no beeping sound is heard)
ii, Grade Return - Returns the elevation to lowest setting when pause is pressedUnits (Sets the display to
...
vii Pause Mode (Turn on allow 5 minutes of pause, turn off to have the console pause indefinitely)
d. Display Test (Tests all the display functions)

CT800 Treadmill 24

=== PAGE 29 ===
Treadmill Warranty - Effective March 1,2012
...
Commercial Lifetime 5 Years 5 Years 2 Years
Residential Lifetime Lifetime 10 Years 2 Years

NORMAL RESPONSIBILITIES OF THE CONSUMER

The consumer or non-dues paying facility is responsible for the items listed below:

|, The warranty registration card must be completed and returned to the address listed on the card within 10 days of the original purchase, or
completed online to validate the manufacturer's limited warranty,
...
5. Expenses for making the fitness equipment accessible for servicing, including any item that was not part of the fitness equipment at the time
...
I, CONSEQUENTIAL, COLLATERAL, OR INCIDENTAL DAMAGES SUCH AS PROPERTY DAMAGE AND INCIDENTAL EXPENSES
...
fitness equipment not requiring component replacement, or fitness equipment not in non-dues paying facility or household use.
...
6. — Products that do not have a warranty registration card on file at Spirit Fitness, Spirit Fitness reserves the right to request proof of purchase if
no warranty record exists for the product. ;

7, THISWARRANTY IS EXPRESSLY IN LIEU OF ALL OTHER WARRANTIES EXPRESSED OR IMPLIED, INCLUDING THE WARRANTIES
OF MERCHANTABILITY AND/OR FITNESS FOR A PARTICULAR PURPOSE,

8. 8, Product used in a dues paying facility (YMCA, Health Club, Etc.)

9. 9, Product used in prisons and correctional facilities

!0, 10,Warranties outside of the United States may vary. Please contact your local dealer for details.
...
I. Contact your selling authorized Spirit Fitness dealer, OR

...
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 14AWG OR            •   Do not use outdoors.
...
ZA\WARNING ¢ Never operate this appliance if it has a damaged cord
or plug, if it is not working properly, if it has been
dropped or damaged, or dropped into water. Return
the appliance to a service center for examination and
repair.
...
WARNING - To reduce the risk of burns, fire, electric
shock, or injury to persons, install the bike on a flat level
surface with access to a | 15-volt, |5-amp grounded outlet
with only the bike plugged into the circuit.

DO NOT USEAN EXTENSION CORD UNLESS IT ISA |4AWG OR
BETTER, WITH ONLY ONE OUTLET ONTHE END:
...
4   Fahrenheit, and humidity is 95% non-condensing (no water drops forming on surfaces).
...
    Important Operation Instructions
    ...
    •   NEVER use your fitness bike during an electrical storm. Surges may occur in your household power supply that
        could damage fitness bike components. Unplug the fitness bike during an electrical storm as a precaution.
...
1. Cut the straps, then along the dotted line on the bottom of the box;    12/14mm Wrench
   lift the box over the unit and unpack.                                  13/15mm Wrench
...
lift the box over the unit and unpack. Q) 13/15mm Wrench

UO) Phillips Screwdriver

2. Locate the hardware package. The hardware is separated into four O 13/l4mm Wrench

steps. Remove the tools first. Remove the hardware for each step as

needed to avoid confusion. The numbers in the instructions that are PARTS INCLUDED:
in parenthesis (#) are the item number from the assembly drawing for Q) | Main Frame
reference. U | Console Mast
...
XBR55 STEP ONE                HARDWARE FOR STEP 1
...
89 NYLOC NUT 3/8°X7T. 2
191 CAP NUT 3/8” XUNCI6X12.5T 2
...
are tight..
     ...
     XBR55 STEP TWO                 HARDWARE FOR STEP 2
                       PART         TYPE       DESCRIPTION                QTY
...
10
4. Remove the white Styrofoam pad (factory installed to
...
5. Attach the HANDLE BAR ASSEMBLY (3) onto the
   ...
   SCREW DRIVER (114).
                                                            ...
                                                            11
     XBR55 STEP THREE                 HARDWARE FOR STEP 3
                         PART         TYPE       DESCRIPTION             QTY
...
12
XBR55 STEP FOUR                 HARDWARE FOR STEP 4
                  PART          TYPE       DESCRIPTION              QTY
                  ...
                  3. Attach the PEDALS (116) to the CRANK
                     ...
                     as you can. It may be necessary to re-tighten the
                     pedals if you feel a thumping while pedaling the
                     bike. A thumping or clicking noise is usually caused
                     by loose pedals.
...
S—79 as you can. It may be necessary to re-tighten the
...
105 & 38R) to the sides of the SEAT HANDLE
BAR (6) with 4 SHEET METAL SCREWS
(105). Tighten with the PHILLIPS HEAD
SCREW DRIVER (114)
...
Ccatonies eae P caaraate
68aa oo0.00 688a ie! ROFILE
vag YOUU  gag-
...
MUSCLE PROFILE SS Le Heart Rate % Profile
...
Wen * > = . @ Easy-Touch
\ Na FAN START LEVEL STOP Control Buttons
...
16   into the jack on the right side of console. There is no volume control on the console. The volume
...
needs. Some of the information asked for is necessary to ensure the readouts are correct.You will        19
...
20   your Age or Weight changes or someone else enters a different Age and Weight.
...
8.   When the program ends you may press Start to begin the same program again or Stop to exit the program or
     ...
     instructions in the Message Center
                                                                                                                                  ...
                                                                                                                                  21
     Preset Programs
     The Semi - Recumbent Bike has five different programs that have been designed for a variety of
     workouts. These five programs have factory preset work level profiles for achieving different goals.
...
2.   The Message Center will ask you to enter your Age.You may adjust the age setting, using the Up and Down
...
| N T E RVA LL INTERVAL Work Profile

This program takes you through high levels of intensity followed by recovery
periods of low intensity. This program utilizes and develops your “Fast Twitch”
muscle fibers which are used when performing tasks that are intense and {4 a
short in duration. These deplete your oxygen level and spike your heart rate,
...
5. Now you are asked to adjust the Max Resistance Level. This is the peak exertion level you will
experience during the program (at the top of the hill). Adjust the level and then press Enter.
6. Now you are finished editing the settings and can begin your workout by pressing the Start key. You can also go EZ

          back and modify your settings by pressing the Enter key to go back one level, or screen.
     7.   If you want to increase or decrease the workload at any time during the program press the Up or Down key. This
          will change the resistance settings of the entire profile, although the profile picture on the screen will not change.
          The reason for this is so that you can see the entire profile at all times. If the profile picture is changed, it also
          would be distorted and not a true representation of the actual profile. When you make a change to the resistance,
...
6.   Now you are asked to adjust the Max Resistance Level of the program, press Enter when resistance has been
     selected.
7.   Now the first column will be blinking and you are asked to adjust the resistance level for the first segment
     (SEGMENT > 1) of the workout by using the Level Up/Down key. When you finish adjusting the first segment, or
     if you don’t want to change, then press Enter to continue to the next segment.
8.   The next segment will show the same workload resistance level as the previously adjusted segment. Repeat the
...
     Semi - Recumbent Bike Warranty - Effective February 4, 2021

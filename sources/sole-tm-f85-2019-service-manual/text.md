...
3.Electrical Configurations
             ...
             28               Service Manual
SAFETY KEY:
The safety key fits into the Console to activate all functions and treadmill. Without safety key, console cannot be controlled and treadmill will not
 be activated.
...
TREADMILL MOTOR:
This is a variable speed for DC motor. Control the 0 –90 (or 0-180) voltages from the main controller to increase or decrease speed of the running belt.
...
GENERAL INFORMATION
CONSOLE
  Contains keys、 TFT-LCD Display、Speaker、Fan、. Hand Pulse Grip、Safety key, etc.
...
INCLINE MOTOR
 ...
 If there is AC voltage on the Black wire (DOWN), the incline motor will decrease the incline. The White wire (COM) is neutral.
...
Function
   SPEED
        ...
        WORK range is 1.0~22.0KM or 0.5~12Mile.
...
Function Button Locations                                                               FAN
        ...
        Incline quick keys
        1, 3, 5, 7, 9, 12, 15                                                                                        Speed quick keys
                                                                                                                     2, 3, 4, 5, 7, 9, 12
...
Function Button In Main Mode
  READY MODE
     ...
     SPEED RAPID button: 5 preset buttons for rapid speed: 2，3，4，5，7，9，12 ( For metric is 3，6，9，12，15，18，20)
     ...
     PROGRAM KEY： Press PROGRAM keys (▲/▼) to choose whichever you want. And then confirm the every setting by pressing ENTER key press,
                         finally, press START key to do exercise.
                        The program function has 6 programs (Manual, Hill, fat burn, Cardio, Strength and Interval), and also has USER1, USER2, TH60
                        PCT, and THR80 PCT.
...
RUN MODE
     ...
     SPEED RAPID button: Speed will set to 2，3，4，5，7，9，12 etc, total 7 buttons.
     (for metric is 3,6,9,12,15,18,20)
     INCLINE RAPID button: Incline will set to 1，3，5，7，9，12，15 etc, total 7 buttons.
     Fan button: It can to control ON/OFF for the fan.
     DISPLAY KEY：
...
6. ST538 Treadmill Basic Connections and Wiring
                       ...
                       40                 Service Manual
6.1 Display Board wire Connections                      TFT-LCD display wire         Connection the USB
                                                                                     wire
                              Mulitmedia processor IC


                                                                                            Bluetooth Module

                       Connection the
                       amplifier wire                                                        Connection with
                                                                                             Wireless heart
                                                                                             receiver

                                                                                            Connection the
                                                                                            Bluetooth speaker wire

                 Main IC
                                                                                            Heart Module

          Connection with
          FAN                                                                           Connection with Quick
                                                                                        speed and incline key
   ...
   6-pin Main control wire                                                                           Handrail Pulse
                                 ...
                                 Quick incline
                                                         41                    handrail buttons
                                 handrail buttons                                                                      Service Manual
6.2 Display Board PCB Component Locations
  PCB Board Top
...
6.4 Driver Board Wire Connections
         ...
         AC POWER INPUT
              ...
              (110V or 220v)
                                                                                     ...
                                                                                     with red wire of
                                                                                     motor
  JK80 are Incline power
output socket, respectively:
Com: This is a commons                                                               JK60 is Incline VR

power, and connected with                                                             socket connected

white incline power wire.                                                            with incline one of

UP: This is able to incline                                                             3-pin VR wire

“UP”, and connected with
red incline power wire.
DOWN: This is able to                    JK90 is MAIN socket connected
incline “DOWN”, and                         with 6-pin of control wire   JK50 is Speed sensor socket
connected with black incline                                             connected with 2-pin of speed
power wire.                                                                      sensor wire
...
POWER      Controller power       If DC voltage is normal, it would be       Voltage is not correct.    Check the supply voltage is 110VAC
                                  always ON. If off, fault condition exists. Fuse is blown.             or 230VAC
                                                                             Transformer is no good.    Replace Fuse.
                                                                                                        Replace controller.
LIMIT      Over current Protection When lower board detect over current,                                Replace controller.
                                                                           Protection lower board and
current    warning light.          the LED will be light.                                               Replace motor.
                                                                           motor.                       Do not block belt running.
                                                                                                        Between belt and running board need
                                                                                                        to smear Silicone oil.
...
7.3 Important Grounding Instructions
     - This product must be grounded. If the treadmill should malfunction or breakdown, grounding provides a path of least resistance for electric
   current, reducing the risk of electric shock. This product is equipped with a cord having an equipment-grounding plug. The plug must be plugged
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   fit the outlet; have a proper outlet installed by a qualified electrician. This product is for use on a nominal 230-volt (on 120Vac electronic power
   ...
   rigid earplug, or the like, extending from the adapter, must be connected to a permanent ground such as a properly grounded outlet box cover.
...
Test Procedure：
  ...
  5.   If the motor moves, is there a sensor reading on console?
       ...
       ◆ If there is no count then check the voltage at the potentiometer. There should be 5vdc between the black
            ...
            between the red and white wire. This voltage will be about 4.5~4.7 Vdc when the motor is at the lowest position (the number isn’t too critical, as long as it’s somewhere in this
            neighborhood). If there is a voltage at the white wire, and the voltage changes as the motor moves, but the counter still does not register then there may be a bad wire
...
Troubleshooting
 Part                       Troubleshooting
 Lower controller           Replace Lower controller board.
...
board is broken.
 ...
 Troubleshooting
 Part         Troubleshooting
 Wall outlet Use Multi-meter transform into AC 1000V to check wall outlet volt whether 110ACV or 220AC or not. And the voltage whether stable or
              not.
...
2. Press and hold down the START and FAST (Speed ▲) buttons and at the same time replace the Safety Key. Continue to hold the START and
   Speed ▲ keys until the window displays “Factory settings”, then press the ENTER key.
3. You will now be able to set the display to show Metric or English settings (Miles vs. Kilometers). To do this, press the incline UP/DOWN (▲/▼) key to
   show which you want, then press ENTER.(The maximum speed value is displayed in the speed window, and the maximum elevation value is
   displayed in the incline window.)
...
B. DISPLAY MODE - Tests all the display functions.
...
When turn on power, ON/OFF switch isn’t         1 Power cord isn’t plugged into outlet.               1 Plug the power cord into outlet.
lit.                                            2 Power cord isn’t plug into unit.                    2 Plug the power cord into unit.
                                                ...
                                                7 Breaker tripped.                                    7 Press the small red button to return to original
                                                8 Breaker is broken.                                   status.
                                                9 ON/OFF switch is broken.                            8 Replace breakers.
                                                                                                      9 Replace AC switch.
After turning on power, treadmill has a          1 Incorrect input power, varistor is blown broken on 1 Check the voltage of power is 110V or 230V. Replace
popping sound.                                                         controller.                    controller.
When insert safe key, no display on              1 Haven’t   switch ON/OFF   switch.                  1 Switch the AC switch.
monitor.                                         2 Insert  the Safe key on  wrong  position.          2 Insert the safe key on right position.
                                                 3 6-PIN Main control wire not plugged in properly. 3 Please check the wire and connect again.
                                                 4 6- PIN Main control wire is broken.                4 Replace 6-PIN Main control wire.
                                                 ...
                                                 7 Safety device is broken. (open circuit)            7 Replace safety key device.
 ...
 With no safe key but treadmill could display or 1 Safety device is broken. (short)                   1 Replace the safety key device or console.
                     operate
  When press “START”, treadmill doesn’t start. 1 Motor M+ or M- wire isn’t connected into right       1 Please check and plug again.
                                                    position.
                                                 2 Motor is broken.                                   2 Replace motor or check the wire and connector if it
                                                 3 Treadmill controller shut down.                      was broken.
...
LCD displays not bright, incomplete or imperfect. 1. LCD displays are broken.                     1. Replace with new console.
 ...
 INCLINE ERR, INCLINE window displays “E3”. 1 Position sensor value of incline motor is wrong.    1 Turn off the AC switch and turn on power again.
                                                                                                  2. Calibrate the monitor.
  After pressing “START” button, the treadmill   1 Controller is broken.                          1 Turn off the AC switch and turn on power again.
               stops immediately.                                                                 2 Replace controller and calibrate it.
  ...
  After pressing “START” button, the treadmill   Controller was broken.                           Replace with new controller and calibrate it.
               stops immediately.
 FAST/SLOW button of SPEED ADJUSTMENT            1. Maybe keys stuck.                             1. Replace key board.
                                                 2. Maybe upper control is broken.
              SWITCH can’t be used.              3. Maybe lower control is broken.                2. Replace upper Controller.
  Speed button just can press FAST, can’t press                                                   3. Replace lower Controller.
                       SLOW.
  Speed button just can press SLOW, can’t press
                        FAST.
                UP/DOWN button of                1.   The incline VR or incline power wires not   1 Connect the wires again.
INCLINE ADJUSTMENT SWITCH can’t be used.              connected properly.                         2. Replace the cable.
   Incline button just can press UP, can’t press 2.   The incline VR or incline power wire is     3. Replace buttons.
                       DOWN.                          damaged.                                    4. Replace the Incline.
                                                 3.   Maybe keys stuck.
 Incline button just can press DOWN, can’t press 4.   Inspect whether the incline motor is        5. Replace the Incline.
                         UP.                          stuck.
                                                 5.   Inspect whether the incline gears are
                                                      cracked.
...
(No pulse displayed on monitor)
                                                 only one hand on sensor.                       2. Connect the cable again.
...
(No pulse displayed on monitor)
                                               2. Distance is too far and exceeds range of        oriented correctly.
                                                receiver.                                       2. User chest belt in front of console within 3 feet.
                                               3. Chest belt battery is weak or dead.           Replace with new lithium battery type is CR2032.
...
2. Remove motor grounding wire (greenish yellow), motor wire (+) red and motor wire (-) black.
                                                               ...
                                                               95                                        Service Manual
3. Use 14mm T-shaped socket wrench to loosen 4 screws, use 14mm T-shaped socket wrench to loosen a side tension screw as
   well as a rear drive belt tension screw , remove motor and replace with new.
...
4. Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws.Connect grounding wires and motor wires
(red M+, black M-)

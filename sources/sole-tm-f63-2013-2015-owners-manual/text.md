...
5   HARDWARE STEP 5
             ...
             #113. Ø10 x 1.5T                      #139. 3/8” x 1-3/4”
...
5   ASSEMBLY STEP 5                                                                      HARDWARE STEP 5
    ...
    1.   Insert the Console Assembly (52) into the Upright Tubes (4 & 5) and
         ...
         Tighten using the M6 L Allen Wrench (132).
...
6   ASSEMBLY STEP 6                                                                      HARDWARE STEP 6
    ...
    1.   Attach the Left (141 & 142) and Right (143 & 144) Upper and Lower
         Handlebar Covers to the top of the Upright Tubes (4 & 5) with six Sheet Metal
         Screws (175). Tighten with the Combination M5 Allen Wrench & Phillips Head
         Screw Driver (131).
...
8   ASSEMBLY STEP 8                                                                             HARDWARE STEP 8
    ...
    2.   Attach the Console mast covers (62 & 63) to the Frame Base (2) with six
...
INCLINE FEATURE
 ...
  Press and hold the Incline 5/6 keys (console or handgrip) to achieve desired level of
    effort. You may also choose a more rapid increase / decrease by selecting desired key,
    1, 3, 6, 9, 12, 14 and 15, on left hand side of console (incline).
...
DOT MATRIX CENTER DISPLAY
 ...
 workout for the F63. The dots are only to show an approximate
 level (speed/incline) of effort. They do not necessarily indicate a
...
PROGRAMMABLE FEATURES
 The F63 has ten built-in programs: one Manual program, five preset profiles (P1-P5), two user
 ...
 in heart rate recovery from intense activities.
              SPEED                      INCLINE
                                                    ...
                                                    17                                            F63 TREADMILL
SELECTING A PROGRAM
1. Press the Program 5/6 keys to view the programs on the screen then press the Enter key
...
F63 TREADMILL                               18
USER PROGRAMS
1. Select User 1 or User 2 via the Program 5/6 keys then
...
1. Select HR1 or HR2 via the Program 5/6keys then press Enter.
...
3. The Message Window will be blinking, showing the default user’s bodyweight for this pro-
...
4. Now you are asked to adjust the HR1 or HR2 value. The default is 60% (HR1); (220 - age x
   ...
   the number by pressing the Speed5/6 keys (console or handrails) and press Enter to
   continue.

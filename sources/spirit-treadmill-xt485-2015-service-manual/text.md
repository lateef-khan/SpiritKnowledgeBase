<!-- Source: XT485 (485815) Service Manual.pdf. Text is pdftotext -layout; pages a 300 dpi render knows more about than the text layer are appended below under '=== OCR SUPPLEMENT, PDF PAGE n ===' headers. -->
...
12. Disassembling and assembling of Parts
    ...
    12.9 Incline Motor Replacement
                                    ...
                                    3                           Service Manual
Special Note on XT485 CE version:
     Besides normal version, XT485 treadmill is with a CE version. Both versions are with exactly the same in functions and outlines except
...
INCLINE MOTOR
 ...
 The green wire is ground.
                                                                        ...
                                                                        13                               Service Manual
4. XT485 Treadmill Product Operation
...
Function
   ...
   INCLINE
      ...
      INCLINE preset value is 0 to 15.0
...
PULSE
    ...
    In RUN Mode, if the treadmill doesn’t have a signal for 8 seconds then display value will become “- - - ”.
...
Function Button Locations
                                                         ...
                                                         Function Key
       Quick SPEED & INCLINE                            Set data function
              BOTTONS
...
Function Button In Main Mode
  READY MODE
     ...
     Before running a program, press this button that can to setting personal profile. (ex. Age …)
     After choice a program, press this key will to show speed or incline profile in dot-matrix
     ...
     HANDRAIL CONTROL BUTTON：It can turn the handrail switch off.
...
RUN MODE
  ...
  Quick SPEED & INCLINE BUTTON：You are able to set your speed and incline settings quickly by using the quick keys on the console. Just
  press either Speed or Incline, then select either 2 or 3 digits and the treadmill will automatically adjust to that value. This saves time because
  you don’t have to press and hold or hold a button down until reaching the desired value.
  FAN button: It can to control ON/OFF for the fan.
  ENTER BUTTON：
  Press ENTER to switch the exercise data shown on the message window when you are workout. During SCAN MODE, the data will to display
  automatically every four seconds. The information as below,
      SEG TIME X：XX (only in HRC MODE will not show this string)
      ALTITUDE XXXX M ( UNIT：METER)
      SPEED      XX.X MAX XX.X（ACTUAL SPEED AND MAX SPEED TO DISPLAY）
      SCAN
     During SCAN MODE, the system will scan and display automatically every four seconds.
  HANDRAIL CONTROL BUTTON：It can turn the handrail switch off.
                                                                      ...
                                                                      20                                                            Service Manual
5.XT485 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                          ...
                          22   Service Manual
6. XT485 Treadmill Basic Connections and Wiring
...
POWER      Controller power         If DC voltage is normal, it would be       Voltage is not correct.            Check the supply voltage is 220Vac.
                                    always ON. If off, fault condition exists. Fuse is blown.                     (on 120Vac electronic power system
                                                                               Transformer is no good.              need 110Vac)
                                                                                                                  Replace Fuse.
                                                                                                                  Replace controller.
LIMIT      Limit the current of DC When current of motor exceed 15A, the Loading is too high on belt.             Belt/deck lubrication
           ...
           Controller shut down. power system)                                  Operation is not correct, motor   locked or jammed.
                                   When current of motor exceed 25A, the lock.                                    Replace controller.
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           34                                                              Service Manual
8.XT485 Treadmill Error Messages /
         Troubleshooting
...
LCD not bright, incomplete or imperfect.           1. Connector fall off.                     1. Check connector again.
                                                   2. LCD light is broken.                    2. Replace with new LCD or console.
...
SWITCH can’t be used.                    CONSOLE not connected properly.                      2. Check the wire of SPEED ADJUSTMENT SWITCH.
                                         2 The connector of SPEED CABLE and
                                           SPEED ADJUSTMENT SWITCH                            2. Replace with new cable.
UP/DOWN button of                                                                             3. Replace new SPEED ADJUSTMENT SWITCH.
...
12-3 Motor Replacement
  ...
  2. Remove motor grounding wire (greenish yellow), motor
...
3. Use 14mm T-shaped socket wrench to loosen 4 screws, use 14mm open end wrench to loosen 1 belt tension screw,
  remove motor and replace with new.
...
2.   Use M6 L Allen wrench to loosen 2 screws on the rear roller.
                                                            ...
                                                            80                       Service Manual
3.   Remove motor cover, use 14mm T-shaped socket wrench to loosen 4 screws. Use 14mm open end wrench to loosen 1
     belt tension screw and loosen drive belt.
...
6.   Use 14mm open end wrench to adjust belt tension using tension measuring device. Adjust to white LBS area between
     70-75LBS. Use 14mm T-shaped socket wrench to secure and tighten 4 securing screws.
                                                          ...
                                                          81                                               Service Manual
12-7 Running Deck/ Belt & Cushion Replacement(Please take the gas spring apart before replacement)
1.   After running board has been folded, use M5 L Allen wrench and 12m/m wrench to remove securing screws on cylinder
...
3.   Use Phillips head screwdriver to remove 6 Tapping Screw s from the front and back of the foot rail according to the
     indicating arrows.
                                                             ...
                                                             82                                                  Service Manual
4.   User Phillips head screwdriver to remove the 8 Tapping Screw the running board. Remove the running board and replace
     running board or running belt. If cushions need to be replaced, remove 6 cushions and replace. Reassemble in the reverse
     order as disassembly. When reassembled, center and adjust running belt tension. Belt tension also needs to be adjusted.
...
saddry Nid 9 CC SIPPIW Nid 9 CC | 5 z

© a1av0 HALNdWOS S189 HSLNAWIOO 8 @
Zz
...
ADALIG PUP J9]JO1}UOD JBMO'] Z'Z
...
JO JO UO YO'IMS Ue} HuljooD
NOLLOd ues

aaads dOls AYVLS 3NTIDNI
- s < +

IVD WAYTLN) HLONSHIS O}GYVD Nungiv) TH
=

sl618IZIIOISIVIElZ
SAIN NINO

3 RIA IAI RA NT INA IN BN) Bid NT Id
com (4 AVIV IY IY IY TAY [AY TAY IY A oo

SNOLLOG
ANIMONI 8 GaAdS 9!NO

Gasds SAV ‘Sav asind SAY

UO!}OUNY Byep 18S
Agy uonouny

suo!}e007] uojINg UO!}OUN
...
pos} [aus [oar] Jaw f | sox |] ve] | oso P] sor || es

[x] rar [soo

SUOIJD9UUOY) a4IM pseog Aeldsig 1°9
...
SUOIOIBUUOND DIM PALCOgG JIANG p'9
...
SUO!]E907] 10}B9IPU] G37] Pueog JeALIG 9°9
...
Definition: Display board CPU did not receive the RPM signal. (Only happen in the Calibration. In generally, it does not necessary soeed RPM sensor,
but when the Calibration which it is a necessary.)
...
Send and receive speed t
i j RPM SENSOR MOTOR SPEED
signal via TX/RX of ec irmea piecasraty
6-pin Main wire. | |
...
EI showing up H———>} Reset porer ~--—+> Press start again
...
Adjust sensor gap distance to 2mm,
...
Replace Motor > Solve the problen
...
DRIVER BOARD <= VR VOLTAGE | INCLINE WR SET
...
pps ppras rP ¥ 9020 €C0OM OTA (GOST IT

aa =a =e) . a 2. | a

bIIO9I-0"In-SzIOWy 5*( bag .

UO!I}OUNJ BUIJEP UId 10}09UUOD PueOg JBALIP 0} BJOSUOD aU] "UO!}eINGIJUOD JSEL_
...
DISPLAY BOARD . UPDOWNKEYS | j pannwaeeys

4m

cLINE INCLINE Signal —
ye || Via TAIRK of GrDown
VOLTAGE wire sent and SIGNAL
receive.
...
>> SD w
seddry Nid 9 CC apo Nida CG 5 E
318V9 ¥3LNdWOO S18V9 HSLNdNWo5 s iv
z
=
am =
e -
...
, broken on controller. controller. (on 120Vac electronic power system need
sound. 110V)
ines ienla : 1 Haven’t switch ON/OFF switch. 1 Switch the AC switch.
When insert safe key, no display on monitor. 2 Insert the Safe key on wrong position. (2 Insert the safe key on right position.
3 12 PIN Computer connector not 3 Please check the wire and connect again.
plugged in properly. 4 Replace 12 PIN computer cable.
412 BIN contputer cable is broken. 5 Replace fuse or controller. —
5 Fuse on controller is blown. 6 Replace varistor or controller.
6 Varistor on controller is blown. 7 Replace safety key device.
7 Safety device is broken. (open) 8 Replace console.
8 Other components are faulty.
With no safe key but treadmill could display or 1 Safety device is broken. (short) 1 Replace the safety key device or console.
operate
When press “START”, treadmill doesn’t start. 1 Motor M+ or M- wire isn’t connected into]! Please check and plug again. “es
right position. 2 Replace motor or check the wire and connector if it
2 Motor is broken. was broken.
3 Treadmill controller shut down and LED /8 Turn off the ON/OFFswitch and turn on power again.
would be ON.
Treadmill stops or shuts off by itself. } rouse Oe es 4 1. Reset it.
readmill breaker tripped.
3 Treadmill controller Hui down and LED 2. Reset treadmill breaker.
would be ON. 3. Belt / deck lubrication.
4. Turn off the ON/OFF switch and turn on power
again.
After removing safety key, treadmill can’t stop. 1. The safety key device is broken. 1. Replace with new safety key device.
...
Jo}OW ‘(Moj|JaA ysiuees6) asim Bulpunos6 JoJOW SAOW SY *Z
...
"J9AOD JOJOW By} HulNdes mesOS Huldde| G SAOWA O} JOALPMOJOS PREY SAIj|IYd 8S * |}

JUBWdDP|GSY JOLO/\ €-Z4b

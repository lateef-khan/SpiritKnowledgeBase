...
INCLINE MOTOR
 ...
 The green/yellow wire is grounding wire.
                                                                          ...
                                                                          30                                                      Service Manual
4. ST528 Treadmill Product Operation
...
Function
   SPEED
        ...
        WORK range is 1.0~20.0 km (0.5 ~ 12.0 mile)
...
Function Button In Main Mode
  READY MODE
     ...
     PROGRAM KEY：
     Press PROGRAM keys (▲/▼) to choose whichever you want. And then confirm the every setting by pressing ENTER key press, finally, press
      START key to do exercise.
     The program function has 6 programs (Manual, Hill, fat burn, Cardio, Strength and Interval), and also has USER1, USER2, TH60 PCT, and THR80
      PCT.
...
RUN MODE
  ...
  PROGRAM KEY: Non-functional.
                                                              ...
                                                              20                                                         Service Manual
5.ST528 Treadmill Unit Block Diagrams
...
Treadmill Configuration
                      ...
                      BULETOOTH
                                  ...
                                  22   Service Manual
6. ST528 Treadmill Basic Connections and Wiring
...
7.3 Important Grounding Instructions
 ...
 - DANGER - Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified electrician
   ...
   a metal screw.
                                                                           ...
                                                                           34                                                              Service Manual
8.ST528 Treadmill Error Messages /
         Troubleshooting
...
Part                    Troubleshooting
  ...
  Incline power cable   1. Inspect the wire connections.
    ...
    incline VR cable
       ...
       Driver board     3. 3. Replace
                        Replace        the wires
                                  the driver     and test again.
                                             board.
...
Test Configuration. Incline motor control function relate parts location
                                                                                     ...
                                                                                     Incline
                   Com-white                                                One of 3-pin VR wire
                    UP-Red                                                  (It is a position wire)
                  DOWN-black
                                                                                GND
                                                                           SENSOR PIN (AD)
                                                                              +5V VCC
...
Cause of E4: Power wire of Motor does not insert lower controller.
...
3. You will now be able to set the display to show Metric or English settings (Miles vs. Kilometers). To do this, press the incline▲/▼ key to show which
   you want, then press Enter. (The maximum speed value is displayed in the speed window, and the maximum elevation value is displayed in the
   incline window.)
...
12-1 Lower Controller Replacement
    ...
    2.   Disconnect all lower controller wirings, Use Phillips head Screwdriver to remove, replace with new lower controller and
         reconnect all wirings.
                                                              ...
                                                              74                                                  Service Manual
12-2 Console Replacement
    1. Upright Cover Use M5 L Allen wrench to remove 4 sheet metal screws from the upright cover.
...
to this replacement procedure)
     1. Step 1: After folding the treadmill, use M5L Allen wrench and 13mm wrench to release the screw which secure the cylinder and take it apart.
     ...
     2. Remove the left and right foot rail cap. Use a Phillips head screwdriver to remove 6 screws and bracket from back of foot rail. Remove the
        foot rail in the direction of the indicating arrows.
                                                                      ...
                                                                      82                                                           Service Manual
3. Use M5 L Allen wrench to remove the 8 screws securing the running board. Remove the running board and replace running board or
running belt. If cushions need to be replaced, remove 6 cushions and replace. Reassemble in the reverse order as disassembly.

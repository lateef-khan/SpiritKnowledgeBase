...
7       CU800ENT ASSEMBLY INSTRUCTIONS
...
    Congratulations on your new Upright Bike and welcome to the Spirit Fitness family!
    ...
    Thank you for your purchase of this quality Upright Bike from Spirit Fitness. Your new Upright Bike
    ...
    purchased direct from Spirit Fitness, the local dealership where you purchased this Upright Bike is
...
register online.
                                                                                                ...
                                                                                                3
                                           www.spiritfitness.com
    IMPORTANT SAFETY                                              •       Keep children away from the upright bike. There are
                                                                          obvious pinch points and other caution areas that
    INSTRUCTIONS                                                          can cause harm.
                                                                          Keep hands away from all moving parts.
        WARNING                                                   •

                                                                  •       Never operate the upright bike if it has a damaged
    When using an electrical appliance, basic                             cord or plug. If the upright bike is not working
    precautions should always be followed, including                      properly, call your dealer.
    the following:
                                                                  •       Keep the cord away from heated surfaces.
    Read all instructions before using this appliance.            •       Do not operate where aerosol spray products are
    DANGER – To reduce the risk of electric shock:                        being used or where oxygen is being administered.
    Always unplug this appliance from the electrical                      Sparks from the motor may ignite a highly gaseous
                                                                          environment.
    outlet immediately after using and before cleaning.
                                                                  •       Never drop or insert any object into any openings.
    WARNING – To reduce the risk of burns, fire,                  •       Do not use outdoors.
    electric shock, or injury to persons, install the upright
                                                                  •       To disconnect, turn all controls to the off position,
    bike on a flat level surface with access to a 110-                    then remove the plug from the outlet.
    volt, 5-amp grounded outlet with only the upright
    bike plugged into the circuit.                                •       Do not attempt to use your upright bike for any
                                                                          purpose other than for the purpose it is intended.
    DO NOT USE AN EXTENSION CORD UNLESS                           •       The hand pulse sensors are not medical devices.
    IT IS A 14AWG OR BETTER, WITH ONLY ONE                                Their purpose is to provide you with an approximate
    OUTLET ON THE END:                                                    measurement in relation to your target heart rate.
                                                                          Use of a chest transmitter strap (sold separately) is a
    •   Do not operate upright bike on deeply padded,                     much more accurate method of heart rate analysis.
        plush or shag carpet. Damage to both carpet and                   Various factors, including the user’s movement, may
        upright bike may result.
4
                                                         Spirit Fitness
    affect the accuracy of heart rate readings. The         the performance of your Upright bike may be affected.
    pulse sensors are intended only as exercise aids in     Such conditions are not covered under your warranty. If
    determining heart rate trends in general.               you suspect the voltage is low, contact your local power
                                                            company or a licensed electrician for proper testing.
•   Wear proper shoes. High heels, dress shoes,
                                                            NEVER expose this upright bike to rain or moisture.
    sandals or bare feet are not suitable for use on
                                                            This product is NOT designed for use outdoors, near a
    your upright bike. Quality athletic shoes are
                                                            pool or spa, or in any other high humidity environment.
    recommended to avoid leg fatigue.
                                                            The operating temperature specification is 40 to 120
•   This appliance is not intended for use by               degrees Fahrenheit, and humidity is 95% non-condensing
    persons with reduced physical, sensory or               (no water drops forming on surfaces).
    metal capabilities, or lack of experience and
    knowledge, unless they have been given                  Circuit Breakers: Some circuit breakers used in homes
    supervision or instruction concerning use of the        are not rated for high inrush currents that can occur
    appliance by a person responsible for their safety.     when a upright bike is first turned on or even during use.
                                                            If your upright bike is tripping the house circuit breaker
•   Keep children under the age of 13 away from             (even though it is the proper current rating) but the circuit
    this machine.                                           breaker on the upright bike itself does not trip, you will
•   Weight Limit: 450lb                                     need to replace the home breaker with a high inrush
                                                            type. This is not a warranty defect. This is a condition
SAVE THESE INSTRUCTIONS - THINK SAFETY!                     we as a manufacture have no ability to control. This
                                                            part is available through most electrical supply stores.
                                                            Examples: Grainger part # 1D237, or available online at
IMPORTANT ELECTRICAL                                        www.squared.com part #QO120HM. The electrical outlet
                                                            used should have a dedicated 5 amp circuit breaker.
INSTRUCTIONS
                                                            IMPORTANT OPERATION
    WARNING
NEVER remove any cover without first disconnecting AC       INSTRUCTIONS
power. If voltage varies by ten percent (10%) or more,      •    NEVER operate this upright bike without reading
                                                                                                                            5
                                                www.spiritfitness.com
        and completely understanding the results of any
    ...
    •   Use caution while participating in other activities
        while pedaling on your upright bike; such as
...
2. Locate the hardware package. The hardware is separated into four
   ...
   needed to avoid confusion. The numbers in the instructions that are         PARTS INCLUDED:
   in parenthesis (#) are the item number from the assembly drawing for         1 Main Frame
...
CU800ENT STEP ONE
                                ...
                                PART        TYPE                DESCRIPTION       QTY
                                 50     Hex Head Bolt          3/8” x 135mm        2
                                 151    Curved Washer         Ø3/8” x 23 x 2.0T    2



                               1. Install the Rear Stabilizer (No.5) onto the Main
                                  Frame with 2 Bolts (No.50) and 2 Washers
                                  (No.151).
                                                                                        ...
                                                                                        9
              www.spiritfitness.com
     CU800ENT STEP TWO                PART        TYPE
                                                         HARDWARE FOR STEP 2
                                                                      DESCRIPTION        QTY
                                      51      Hex Head Bolt       5/16” x UNC18 x 5/8”    7
                                      72       Flat Washer          Ø8 x Ø19 x 5/8”       6
                                      99      Curved Washer        Ø5/16” x 19 x 1.5T     1



                                     1. Slide the Console Mast Cover (No.38) through
                                        the Console Mast (No.2).
                                     2. Making sure not to pinch the wires, run them
                                        through the Console Mast (No.2) and Console
                                        Mast Cover (No.38). The wires are: Computer
                                        Cable (No.29), CSAFE Connecting Wire
                                        (No.33), Network Connecting Cable (No.144),
                                        and HDMI Connecting Wire (No.147).
                                     3. Secure the Console Mast (No.2) to the Main
                                        Frame (No.1) using 6 Bolts (No.51) and 6 Flat
                                        Washers (No.72) on the sides of the Mast. On
                                        the back of the Mast, use1Bolt (No.51) and 1
                                        Curved Washer (No.99).
...
CU800ENT STEP THREE
                                                         HARDWARE FOR STEP 3
                              PART                TYPE                  DESCRIPTION        QTY
                                 51           Hex Head Bolt         5/16” x UNC18 x 5/8”    2
                                 72            Flat Washer             Ø8 x Ø19 x 1.5T      2
                              103              Split Washer             Ø5/16” x 1.5T       2



                            1.        Thread the Handpulse w/Cable (No.26) and Handpulse
                                      w/Cable (No.28) and Computer Cable (No.29) through
                                      the Console Mast (No.2).
                            2.        Secure the Handlebar (No.3) to the Console Mast (No.2)
                                      using 2 Bolts (No.51), 2 Split Washers (No.103), and 2
                                      Flat Washers (No.72).
...
     CU800ENT STEP FOUR
                                                               HARDWARE FOR STEP 4
                                           PART         TYPE                DESCRIPTION        QTY
                                           58     Philips Head Screw         M5 x 12mm          6


                                      1.     Connect the Wires on the back of the console to
                                             their respective places: Computer Cable (No.29),
                                             Handpulse Wires (No.26 & 28), CSAFE Connecting
                                             Wire (No.33), Network Connecting Cable (No.144),
                                             HDMI Connecting Wire (No.147). Tuck excess cable
                                             into the Console Mast (No.2) being careful not to
                                             pinch the wires.
                                      2.     Secure the Console (No.34) to the Console Mast
                                             (No.2) using 4 Screws (No.58) using the Screwdriver
                                             (No.93).
                                      3.     Fasten the Beverage Holder (No.116) to the Console
                                             Mast (No.2) using 2 Screws (No.58).
                                      4.     Install the Pedals (No.45L/R) onto the Crank Arms
                                             (No. 16L/16R) carefully using the Wrench (No.92)
                                             to hold the Pedal pivot then firmly fasten the pivot
                                             clockwise.
                                      5.     Install the Seat (No.19) onto the Sliding Seat Mount
                                             (No.7) then fasten the attached nut using the Wrench
                                             (No.100).


12
                     Spirit Fitness
CU800ENT CONSOLE OPERATION
...
•   When the power is turned ON, the screen will show a brief loading screen and then display the
    Home Screen which indicates that the machine is ready to operate.
     ...
     Home Screen: Begin operation by touching the icons.             Quick operating buttons are conveniently located
                                                                     for basic Upright Bike functions.
CSAFE FEATURE
...
at the back of the console. The Communication port (COMM) can be used to interact with fitness
...
     FUNCTIONS OF THIS UPRIGHT BIKE
     ...
     through quick button on the bottom to control functions. On the lower portion of the console there is the
     Start button to begin the workout, Stop button to pause/stop programs, Level button to change workload.
     ...
     Heart Rate Control. The CU800ENT will also pick up wireless heart rate transmitters that are Polar and
...
     ENTERTAINMENT OPTIONS
     ...
     • Tap the “⛶” button to display the media in full screen
        ...
        back to normal size.
     • Use the on-screen or physical Level controls to make
        updates to your workout while in TV mode.
...
touchscreen of the Upright Bike. Please note that your
device must be running iOS 8 or higher.
...
     SCREEN MIRRORING
     ...
     Android
     Screen Mirroring displays your phone's screen on the
     touchscreen of the Upright Bike.
...
Press the Time Tab to select workout duration; enter a range between 5 and 99
minutes, Repeat for Age and Weight. Press Start to begin.

Time: 1
Weight: /
Enter
Input 4 value between:5-99 Time mins

Start

a) ENTERTAINMENT PROGRAM DISPLAY INTERNET

200 * 35:45 ” 30

Calories Time Elapsed Age

[ Simple J Track Dashboard
...
workout, an overview of the Resistance level profile,
...
     EXERCISE PROGRAM
     ...
     a typical Upright Bike display with information that
...
workout. lvl ean me dug Your wort
...
Press Enter to begin workout or use the arrows to view other Program Profiles.
...
fibers which are used when performing tasks that
...
1. Select the Custom program then press the
   ...
   default settings.
2. The window will show the corresponding level profile, use the on-screen interface to achieve
   desired workout profiles. Once complete, press Next to save and continue.
...
     HIIT PROGRAM
     ...
     3. You may now press Start to begin the HIIT program after to adjust the level. The program starts with a
        3-minute warm-up period with the resistance level set to 50% of the sprint level selected previously. You
        can manually adjust the resistance level during warm-up if you wish.
...
This choice determines which test parameters will be used during the test as shown in the charts below.
...
HR <90 90 - 105 >105
HR HR <120 HR 120-135 HR >135
3rd stage 1050 kgm/min | 900 kgm/min | 750 kgm/min

Workload Chart For Female Or De-Conditioned Male

1st Stage 150 kgmv/min

2nd Stage 750 kgm/min 600 kgm/min 450 kgm/min 300 kgm/min
3rd Stage 900 kgm/min 750 kgm/min 600 kgm/min 450 kgm/min
4th Stage 1050 kgm/min 900 kgm/min 700 kgm/min 600 kgm/min

Spirit Fitness

Before the Test:                                              •    The Message Window will always display
...
•   Make sure you are in good health; check with your
    ...
    over the age of 35 or persons with pre-existing health    •    The data shown during the test is:
    conditions.
•   Make sure you have warmed up and stretched before         1. Work in KGM is actually an abbreviated form
    taking the test.                                             of kg-m/min. which is a work measurement of
•   Do not take in caffeine before the test.                     kilogram-force meter/minute
•   Hold the hand grips gently, do not tense up.              2. Work in Watts (1 watt is equal to
                                                                 6.11829727787 kg-m/min.)
During the Test                                               3. HR is your actual heart rate; TGT is the target heart
•   The console must be receiving a steady heart rate             rate to reach to end the test.
    for the test to begin. You may use the hand pulse         4. Time is the total elapsed time of the test.
    sensors or wear a heart rate chest strap transmitter.
•   You must maintain a steady 50 rpm pedal speed.
    If your pedal speed drops below 48 rpm or goes            After The Test:
...
•   You may scroll through the various data readings              automatically return to the start-up mode after a few
    by pressing the Display button under the Message              minutes.
    Window.
...
     What Your Score Means:
     ...
     VO2MAX CHART FOR MALES AND VERY FIT FEMALES           VO2MAX CHART FOR FEMALES AND DECONDITIONED MALES
...
excellent | 760 | 756 | 754 | 45 | rat | 37 good | 47-56 | 45-52 | 38-45 | 34-40 | 32-37 | 28-32
...
below
average | 37-41 | 35-39 | 31-34 | 29-31 | 26-29 | 22-25 poor 28-32 | 26-30 | 22-26 | 20-24 | 18-21 | 17-18
poor 30-36 | 30-34 | 26-30 | 25-28 | 22-25 | 20-21 verypoor| <28 | <26 | <22 | <20 | <18 | <17
...
With all Spirit Fitness Upright Bikes you may use the heart rate monitor feature without using the Heart Rate
program. However, when using the heart rate monitor feature in conjunction with the Heart Rate programs,
the machine will automatically adjust resistance level to maintain the desired heart rate.
...
38
                                                          Spirit Fitness
ERRATIC OPERATION
Caution! Do not use this Upright Bike for Heart Rate programs unless a steady, solid Actual Heart
Rate value is being displayed. High, wild, random numbers being displayed indicate a problem.
Areas to look for interference which may cause erratic heart rate:
1. Upright Bike is not properly grounded.
...
     GENERAL MAINTENANCE
     ...
     1. The hardware was not sufficiently tightened during assembly. All bolts that were installed
        ...
        larger wrench than the one provided if you cannot tighten the bolts sufficiently. It is important
...
40
                                                              Spirit Fitness
UPRIGHT BIKE WARRANTY EFFECTIVE FEBRUARY 08, 2022
Spirit Fitness warrants all its Upright Bike parts for a period of time listed below from the date of retail sale,
as determined by sale receipt, or in the absence of a sales receipt eighteen (18) months from the original
factory shipping date. Spirit Fitness’ responsibilities include providing new or remanufactured parts, at Spirit
Fitness’ option, and technical support to our independent dealers and servicing organizations. In the ab-
sence of a dealer or service organization, these warranties will be administered by Spirit Fitness directly to a
facility. The warranty period applies to the following components:

WARRANTY                                         FRAME        EMS BRAKE      PARTS      LABOR     CONSOLE PARTS   CONSOLE LABOR
Commercial (Non-Dues Paying Facilities)          Lifetime     5 Years        5 Years    2 Years   3 Years         1 Year
Residential                                      Lifetime     10 Years       10 Years   2 Years   3 Years         1 Year
...
46
     Spirit Fitness
CU800ENT Part List_SPIRIT                                     34-13   Wind Duct                                        1
1     Main Frame                                 1            34-14   End Cap                                          1
2     Console Mast                               1            34-15   Deflector Fan Grill                              1
3     Handle Bar                                 1            34-16   Fan Grill Anchor                                 2
5     Rear Stabilizer                            1            34-17   Press plate                                      1
6     Seat Slider                                1            35      Ø35 × 10m/m_Rubber Foot                          4
7     Sliding Seat Mount                         1            36      Side Case (L)                                    1
8     Fix Plate                                  1            37      Sider Case (R)                                   1
9     Idler Wheel Assembly                       1            38      Console Mast Cover                               1
11    Crank Axle                                 1            40      Front Stabilizer Cover                           1
13    Chain Cover Bracket                        1            41      Rear Stabilizer Cover                            1
14    Drive Belt                                 1            42      Handgrip Side Cap (Top)                          2
15    Drive Pulley                               1            43      Handgrip Side Cap (Bottom)                       2
016L  Crank Arm(L)                               1            45      Pedal                                            1
016R Crank Arm®                                  1            47      Transportation Wheel                             2
17    6004_Bearing                               2            49      Ø32(1.8T)_Button Head Plug                       4
18    6203_Bearing                               2            50      3/8" × 135m/m_Hex Head Bolt                      2
19    Seat                                       1            51      5/16" × UNC18 × 5/8"_Hex Head Bolt               9
20    Induction Brake                            1            52      5 × 19m/m_Tapping Screw                          7
21    EMS Controller                             1            53      5/16" × UNC18 × 1-3/4"_Button Head Socket Bolt   2
22    Magnet                                     1            54      1/4" × UNC20 × 3/4"_Hex Head Bolt                8
23    500m/m_Sensor W/Cable                      1            55      M8 × 170m/m_J Bolt                               1
24    Ø31.8 × 5T × 255m/m_Handgrip Foam          2            56      M6 × 15m/m_Phillips Head Screw                   3
25    Ø31.8 × 5T × 215m/m_Handgrip Foam          2            58      M5 × 12m/m_Phillips Head Screw                   13
26    850m/m_Handpulse W/Cable Assembly(XHP-3)   1            59      3/8" × 2"_Flat Head Socket Bolt                  4
27    AC Electronic Module                       1            60      M4 × 12m/m_Phillips Head Screw                   2
28    850m/m_Handpulse W/Cable Assembly(XHP-4)   1            61      Ø5 × 16L_Tapping Screw                           8
29    2500m/m_Computer Cable                     1            62      3 × 20m/m_Tapping Screw                          4
30    200m/m_Wire Brake Coil Harness(Red)        1            63      3.5 × 16m/m_Sheet Metal Screw                    7
31    Power Adaptor                              1            65      3 × 10m/m_Tapping Screw                          4
32    Control Power Board                        1            66      Ø17_C Ring                                       1
33    1500m/m_Connecting Wire                    1            67      Ø20_C Ring                                       2
34    Console Assembly                           1            68      4 × 12m/m_Sheet Metal Screw                      2
34-01 Console Top Cover                          1            69      Ø1/4" × 13 × 1.0T_Flat Washer                    7
34-02 Console Bottom Cover                       1            70      Ø3/8" × Ø19 × 1.5T_Flat Washer                   4
34-03 Console Inner Cover                        1            71      Ø3/8" × Ø25 × 2.0T_Flat Washer                   1
34-04 500m/m_Fan Assembly                        1            72      Ø8 × Ø19 × 1.5T_Flat Washer                      9
34-12 Console Key Board                          1            73      Ø17 × Ø23.5 × 1.0T_Flat Washer                   1
                                                              76      Ø1/4"_Split Washer                               7

                                                                                                                            47
                                                     www.spiritfitness.com
     77    M8 × 7T_Nylon Nut-Blacking          1            144    1500m/m_Network Connecting Cable   1
     78    3/8" × 7T_Cap Nut                   1            145    150m/m_Connecting Wire(Black)      1
     79    1/4" × 8T_Nylon Nut                 4            146    150m/m_Connecting Wire(White)      1
     80    5/16" × 6T_Nylon Nut                4            147    1600m/m_HDMI Connecting Wire       1
     81    M4 × P0.7 × 5T_Nylon Nut            2            148    1200m/m_Connecting Wire(Black)     1
     82    3/8" × 7T_Nut                       8            149    1200m/m_Connecting Wire(White)     1
     83    M10 × P1.25 × 10T_Nut               2            150    Rubber Pad                         1
     86    Seat Fore/Aft Adjustment Knob       1            151    Ø3/8" × 23 × 2.0T_Curved Washer    2
     92    13/15m/m_Wrench                     1            200710
     93    Phillips Head Screw Driver          1
     96    Crank Arm End Cap                   2
     99    Ø5/16" × 19 × 1.5T_Curved Washer    1
     100   12/14m/m_Wrench                     1
     102   Ø5/16" × 16 × 1.0T_Flat Washer      2
     103   Ø5/16" × 1.5T_Split Washer          2
     104   150m/m_Connecting Wire,Power Cord   1
     105   Handle Bar Cover                    1
     106   Seat Up/Down Adjustment Knob        1
     106~1 Knob Nut                            1
     106~2 M4 × 5m/m_Phillips Head Screw       2
     107   Slider Sleeve                       1
     114   Slide Spacer                        1
     116   Beverage Holder                     1
     118   5/16" × 2-1/4"_Hex Head Bolt        2
     120   TVC Cover                           1
     122   Controller Back Plate               1
     124   Electronic Module                   1
     126   Chain Cover Attaching Plate         1
     127   End Cap                             4
     132   M3 × 10m/m_Phillips Head Screw      7
     135   Power Cord                          1
     138   80m/m_Connecting Wire (Black)       1
     139   80m/m_Connecting Wire (White)       1
     140   Transfer board                      1
     141   400m/m_Computer Cable               1
     142   200m/m_Ground Wire                  1
     143   board                               1
...
www.spiritfitness.com             Jonesboro, AR 72401
                                  ...
                                  CU800ENT Owners Manual
                                  © 2022 All Rights Reserved
                                  Revision 4: 02.08.2022


...
Service Manual
-------------------------------------------Table of Contents----------------------------
                       1. ST158 Treadmill Outlines
                       2. Electronic Parts
                           2.1 Upper Controllers
                           2.2 Lower Controller and driver
                       3. Electrical Configuration
                       4. ST158Treadmill Operation
                       5. ST158 Treadmill Unit Block Diagrams
                       6. ST158 Treadmill Basic Connections and Wiring
                       ...
                       8. ST158 Treadmill Error Messages / Troubleshooting for Electronic Issues
...
Function Button Locations Function Button Locations
                                ...
                                Incline     Incline   Program      Program   Enter   Speed      Speed
        ...
        1, 3, 5, 7, 9, 12, 15                                                                                     2, 3, 4, 5, 7, 9, 12
                                     ...
                                     Display key                                                 Fan key
                                                           ...
                                                           Start              Stop
                                           Audio in        Key                Key    Earphone out          Hand Pulse
                         Hand Pulse


                                                                    Safety
                                Incline adjustment                   Key                     Speed adjustment
...
6.1 Display Board wire Connections
   ...
   Wireless heart           KEY BOARD
   receiver                                          Connection with
                                                     Quick speed key
                                                     board
         ...
         Connection with
         Quick speed                                                                                 Connection with
         handrail buttons          Connection with       Connection with                             Quick incline
                                   Safety key            6-pin Main control wire                     handrail buttons
  ...
  - This product must be grounded. If the treadmill should malfunction or breakdown, grounding provides a path of least resistance for electric current,
    ...
    - DANGER – Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified
      ...
      must be held in place by a metal screw.
                                                                                 ...
                                                                                 34                                                                 Service Manual
  8.ST158 Treadmill Error Messages /
...
Test Procedure：
  ...
  8.   If there is voltage at the output connector to the console then check the voltage at the console. If there is no
       ...
       or bad connection at the in wire connectors.
...
Configuration:
                           ...
                           The signal        Send
                 RPM or
                           via TX/ RX        command of
                  Motor
                           of Main           start or speed
                  signal
                           control wire      signal.
                 return.
...
3.   Disconnect console wirings and replace with new console.
                                                   ...
                                                   71           Service Manual
12-3 Motor Replacement
     1.   Use the Phillips Head Screw Driver to loosen the 5 tapping screws on motor cover, and then remove the motor
          cover

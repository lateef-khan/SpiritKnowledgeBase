TABLE OF CONTENTS
 ...
 SB900 Assembly Instructions                                                                 4

 Operation of Your New Indoor Cycle                                                          8
...
IMPORTANT SAFETY INSTRUCTIONS
   ...
   5. Do not attempt to turn the pedal cranks by hand. Do not touch any driving mechanism while it is in motion as
       possible injury could occur.
   6. In a home setting, keep children away from the bike when it is not in use. Keep children and pets away from
...
3   HARDWARE STEP 3
              ...
              #49. ø8                 #48. ø8 x 16mm            #88. M8 × P1.25 × 20L
...
     ASSEMBLY TOOLS
               ...
               #85.14/15m/m_Wrench                             #86. M5_Combination M5 Allen Wrench
...
1   STABILIZER TUBES                                                                         HARDWARE STEP 1
                                                                                              #82. 3/8’’ Nut (4 pcs)
                                                                                              #81. 3/8’’ x 3-1/2’’
                                                                                              Button Head Socket
                                                                                              Bolt (4 pcs)
    ...
    1.    Install the front and rear stabilizers with four Button Head Socket Bolts (81),
          four Curved Washers (83) and four Nuts (82). The front and rear stabilizer are
...
2   REAR STABILIZER COVER                                                                    HARDWARE STEP 2
         ...
         1. Install the rear stabilizer cover with two Phillips Head Screws (91).
...
3    HANDLEBAR                                                                              HARDWARE STEP 3
     ...
     1. Install the handlebars with four Button Head Socket Bolts (88), Split Washers(49)
        and Flat Washers (48). Tighten the bolts securely.
...
5   TABLET HOLDER                                                                    HARDWARE STEP 5
                                                                                      #93. M5 × 12L_
                                                                                      Tapping Screw (2 pcs)
                                                                                      #101. 4 × 16L_
                                                                                      Sheet Metal Screw
    ...
    1. Install the Tablet Holder (138) on the Handlebar (6) with 3pcs of 4 x 16m/m
...
   MODE SELECT
   ...
   2. To clear exercise TIME, AVG SPEED, AVG PULSE, DISTANCE, and
      ...
      the right key until data is reset.
   ...
   1. Press the left hand key until ‘SPEED’ is
      ...
      3 seconds. The TIME will be flashing; press
      the left hand key to select the heart rate
      target zone settings.
   2. Press the right hand key to increase maxi-
      mum heart rate limit. After setting the max-
      imum heart rate, press the left hand key to
...
   TROUBLESHOOTING
   ...
   Flywheel     Wipe down by spraying on a       Weekly             WD-40                 N/A
     ...
     Brake     Inspect    forexcessive
                 Inspectfor   excessivewear
                                        wearor   Weekly               N/A           SiliconeOil
                                                                                 3-IN-ONE      Spray
                                                                                                or 10W
      Pad          a dry or
                         leather brake
                            squealing   pad                                         oil. Do not use
                                                                                    silicone-based
                                                                                        lubricants
...
REPLACING SENSOR TRANSMITTER BATTERIES




1. Remove the left cover (112) by removing four screws (30) and two screws (93).
2. Without removing the transmitter from the left cover (112), remove the Battery Cover from
   the transmitter.
...
5. After synchronizing, make sure the wire from transmitter is wrapped around the plastic as in
   the above image.
...
1. Press and hold the two keys on the front of the console for about 3 seconds until the display
    shows ID - -
2. Now press and hold the blue button on the transmitter for 3 seconds and release. The con-
    sole display should show ID 0. NOTE: You must press the blue button within 10 seconds after
    the console is showing ID - - otherwise the console will show: ID ER. If the console shows this
    error then restart the procedure again.
...
When the ‘‘Low Battery’’ indicator shows up on the display it is time to change the batteries.

...
The green wire is ground.
                                                                               ...
                                                                               14              Service Manual
4. SE855-YE029-01 Product Operation
...
Window Display Mode
  ...
  3.2 The message window will display “CONSOLE LOCKED” after twice will show” CHILD LOCK-ON PRESS START AND ENTER TO ENABLE
      ...
      more than two seconds. After that it will enter to IDEL MODE.
...
RUN MODE
  ...
  ENTER button: 切換 LEVEL 和 INCLINE PROFILE
  ...
  DISPLAY KEY：Press DISPLAY key to display the exercise data 5 seconds when you are workout.
                                                                        ...
                                                                        23                                             Service Manual
5. SE855-YE029-01 Unit Block Diagrams
...
Elliptical Configuration
                           ...
                           25   Service Manual
6. SE855-YE029 Basic Connections and Wiring
...
   Prepare：
                                        ...
                                        Picture                               Tool name
                                                            ...
                                                            38                                                             Service Manual
 Error Message：E1
 Definition: All screens are off, and outputs are stop when EEPROM damaged or malfunction.
             Display message will show “E1”.
...
Incline button just can press UP, can’t press DOWN.   W/CABLE not connected properly.                 3. Replace the cable.
Incline button just can press DOWN, can’t press UP.
                                                      3 The connector of INCLINE CABLE or       4. Replace buttons.
                                                      INCLINE ADJUSTMENT SWITCH CABLE
                                                      got damage.                               5. Replace the cable.
                                                      4. Button of INCLINE ADJUSTMENT
                                                      SWITCH is broken.                         6. Replace the cable.
...
9-5    Swing Arm Problem
  1. There are 0.05mm~0.07 mm tolerances with the parts for the concern of easy assembly by the user and it is normal with
     ...
     or thick lubricant on Ø 25x296L console mast shaft for the handle bar. If noises come from 6005 bearing, replace the
     bearing.
...
11. Disassembling and assembling
            of Parts
               ...
               68             Service Manual
11-1. Console Replacement
 1. Use Phillips head screwdriver to remove Phillips Head Screws M5x10mm (4pcs) securing the console. Unfasten all connected
...
11-4. Pedal Arm Replacement
 ...
 3. Use #12 hex wrench to remove hex head bolt 5/16”x15mm and flat washer 5/16”x35x1.5T, to remove Bushing Housing,
    Pedal Arm.
                                                              ...
                                                              75                                                  Service Manual
4. Use circlip pliers to remove circlip Ø 17 and remove sliding wheels.
...
11-5. Console Mast Replacement
      ...
      3.   Follow the assembly instructions by owner’s manual of reverse steps, remove the console mast.
                                                            ...
                                                            77                                                Service Manual
4. Use Phillips head screw driver to release twoψ 3x20 Tapping Screws which secure Hand Pulse Assembly and pull out,
     disconnect cables. (As shown in Figure 3 and 4)




5.    Unplug the Round Cap under hand pulse tube and pull out hand pulse cables to take Hand pulse Sensor Assembly
...
11-6. Side Case Replacement
     ...
     2.    Use Phillips head screw driver to release M5x15mm Phillips Head Screws to take apart Front Stabilizer Cover. (As
          shown in Figure 1)




    3. Use Phillips head screwdriver to release 9pcs of 3.5x16 self tapping screws and 3pcs of 5x16 x 3 tapping screws to take
...
4. To take the Left Side Case apart, release 3.5x16 self tapping screws with 1/4"x19 flat washers on the main frame and
 3pcs of 5x16 Tapping Screws. Then to release left Side Case. (As shown in Figure 4 and 5 )
...
8. Reverse above procedures to resume Pedal Arm and Connecting Arm.
                                                      ...
                                                      81                                                Service Manual
11-7. Cross Bar Replacement
    1. Follow procedures 11-3, 11-4 and 11-6 to take apart Connecting Arm, Pedal Arm and both Side Cases. Take off the
...
11-10. Rear Frame Replacement
    1. Use Phillips head screw driver to release M5x15mm Phillips Head Screws and disconnect incline motor power
       connecting wire and incline motor connecting wire. (As shown in Figure 1 and 2)




    2. Use two 14mm and a 12mm wrenches to release 3/8"x1-1/2" Hex Head Bolts, 3/8"x19x1.5T Flat Washers, 3/8x7T Nyloc
      Nuts, 5/16x2-1/4 Hex Head Bolts, 5/16"x1.5T Split Washers, 5/16" x20x1.5T Flat Washers and ψ 5/16 Star Washer,
      which secure Rail Base Assembly and pull it apart.(As shown in Figure 3 and 4)
...
11-11. Incline Motor Replacement
    1. Follow procedures 11-2 and 11-3 to take apart Connecting Arm, Pedal Arm, left and right Side Cases, Cross Bar and the
       Belt.
    2. Use Phillips head screwdriver to remove Phillips Head Screws M5x15mm from Incline Cover, then remove parts.
       (As shown in Figure1,2 and 3)




   3. Use two 14mm wrenches to remove hex head bolt 3/8”x2-1/2” together with flat washer 3/8"x19x1.5T, nylon nut
     3/8"x7T and two Nylon Washers Ø 3/8'' x Ø 35 x5T which secure Incline tube and Incline Motor.(As shown in Figure 4)




                                                            88                                                Service Manual
4. Use two 17mm Open End Wrench to remove hex head bolt 3/8 x2-1/2 , flat washer 3/8 x 19 x1.5T and nylon nut M10 x
...
6. Use 12mm wrench to remove from Rail Assembly hex head bolt 5/16"x1, flat washer 5/16"x 35x2T and pull out locking tube
   assembly and remove rail assembly.(As shown in Figure 8)

...
DO NOT USE AN EXTENSION CORD UNLESS IT IS A 18AWG OR               being use or where oxygen is being administered.
...
    SAVE THESE INSTRUCTIONS - THINK SAFETY!                      effectiveness of the exercise experience, expose yourself
    Fitness Equipment Safety Instruc-                            (and possibly others) to injury, and reduce the longevity of
    tions                                                        the equipment.
    •    Do not operate equipment on deeply padded,              Important Electrical Instructions
         plush or shag carpet. Damage to both carpet and
         equipment may result.                                       WARNING
    • Before beginning this or any exercise program,             Route the power cord away from any moving part of the
         consult a physician. This is especially important for   treadmill including the elevation mechanism and transport
         persons over the age of 35 or persons with pre-         wheels.
         existing health conditions.                             NEVER remove any cover without first disconnecting
    ...
    • Wear proper shoes. High heels, dress shoes, sandals        if possible. These breakers may trip occasionally during
         ...
         equipment. Quality athletic shoes are recommended       treadmill drive electronics and motor. This is an issue
         to avoid leg fatigue.                                   that affects all treadmill brands. New laws in your
    Failure to follow all guidelines may compromise the          area may require these breakers. If you do have these
6
breakers and outlets in your home, and are experiencing        Check with a qualified electrician or serviceman if you are
nuisance tripping, you should check if there are any other     in doubt as to whether the product is properly grounded.
devices plugged into the same circuit. Some examples           Do not modify the plug provided with the product if it
of devices that may also cause tripping are fluorescent        will not fit the outlet; have a proper outlet installed by a
lights with electronic ballasts, coffee maker, space heater,   qualified electrician.
hair drier. Optimally the treadmill should be the only
device plugged into the circuit. Our treadmills have surge     This product is for use on a nominal 110-volt/15 amp
suppressors built in to help avoid nuisance tripping. We       dedicated circuit, and has a grounding plug that looks
have tested several AFCI/GFCI breakers and outlets with        like the plug illustrated below. A temporary adapter that
our products. Brands we have tested are: Eaton (Cutler         looks like the adapter illustrated below may be used
Hammer Series), Leviton (Smart lock pro) and Schneider         to connect this plug to a 2-pole receptacle as shown
Electric (Canadian home series). These breakers do not         below if a properly grounded outlet is not available. The
trip in our testing, when connected to our treadmills, as      temporary adapter should be used only until a properly
long as no other devices are plugged into the same circuit.    grounded outlet, (shown below) can be installed by a
                                                               qualified electrician. The green colored rigid ear-lug, or the
Grounding Instructions                                         like, extending from the adapter, must be connected to
                                                               a permanent ground such as a properly grounded outlet
This product must be grounded. If the your                     box cover. Whenever the adapter is used, it must be held
equipment should malfunction or breakdown, grounding           in place by a metal screw.
...
     XT385 STEP THREE
                        ...
                        2. Install FRAME BASE COVER RIGHT
                           ...
                           BASE (2) using 6 Tapping Screws (120).
                           Tighten with the PHILLIPS HEAD
                           SCREW DRIVER (122).
...
XT385 STEP FOUR
                  ...
                  6. Insert the CONSOLE ASSEMBLY (52)
                     ...
                     WRENCH (132) to tighten.
                                                                       ...
                                                                       15
     XT385 STEP FIVE                HARDWARE FOR STEP 5
                        PART         TYPE      DESCRIPTION       QTY
...
16
XT385 STEP SIX             HARDWARE FOR STEP 6
                  PART      TYPE      DESCRIPTION       QTY
                   150      BOLTS        5/16” X 3/4”    4



                 1. Gather HARDWARE FOR STEP 6.
                 2. Place the HANDRAIL SUPPORT
                    (119) between the LEFT AND
                    RIGHT UPRIGHTS (5, 4) and use the
                    COMBINATION ALLEN WRENCH
                    & PHILLIPS HEAD SCREW DRIVER
                    (131) to tighten 4 BUTTON HEAD
                    SOCKET BOLTS (150).
...
The XT385 treadmill allows you to make speed and incline changes on the side handrails.You can
...
You are able to set your speed and incline settings quickly by using the Select Keys on the console.
Just press either Speed or Incline, then select either 2 or 3 digits and the treadmill will automatically
adjust to that value. This saves time because you don’t have to press and hold or hold a button
down until reaching the desired value. The maximum value you may input for speed is 12.0 mph and
incline level 15. Speed values can be entered in .1 mph increments and Incline in .5 level increment.
...
which muscles are activated by changing the incline and swinging your arms. The pre-set programs             19
...
Note: Refer to Important Safety Instructions (page 5) concerning Pulse Grip operation.
...
22   1. When the treadmill is running the pause feature may be utilized by pressing the Stop key once.
...
•   Press and hold the Incline + / – or Up/Down keys (console or hand rail) to achieve desired level of effort.You may also
    choose a more rapid increase / decrease by selecting the Select Incline key, then 0 through 9.
...
24
Selecting a Program
The XT385 offers seven factory preset-programs, two user defined programs and one Manual
...
2. If Enter was pressed, the Message center will now be blinking a value, indicating your Age
   ...
   Heart Rate programs. Use the + or – keys to adjust, then press Enter.Your age determines your
...
4. The Message Center will be blinking a value, indicating Time (the default value is 30 minutes).
   You may use any of the + or - keys to adjust the time. After adjusting, or to accept the default,                     25
        press Enter.
     ...
     1.   Select User 1 or User 2 program key then press Enter. Note that the dot matrix display portion will have a single
          row of segments at the bottom (Unless there is a previously stored program).
...
26
6.   The first column (segment) will now be blinking. Using the + / - keys, adjust the speed level to your desired effort for
     the first segment then press Enter. The second column will now be blinking. Repeat the above process until all 18
     segments have been programmed. The first column will be blinking again. This is for the incline programming. Repeat the
     above process to program all 18 segments for incline.
...
HILL
This program follows a triangle or pyramid type of gradual progression from approximately 10% of maximum effort (the
level that you chose before starting this program) up to a
maximum effort which lasts for 10% of the total workout
time, then a gradual regression of resistance back to
...
     zone to stay in for maximum benefit.
     ...
     used for the Heart Rate programs. After calculating your MHR you can decide upon which goal you
...
30   using the Heart Rate program. This function can be used during manual mode or during any of the
...
your pace will feel harder. Again, this will show up in your RPE and you will train at the proper level for that day.        31
...
*Note:Your device will need to be running on a minimum operating system of iOs 7 or Android 4.4 for the Spirit Fit App to operate   33
properly.
     Erratic Operation
     ...
     heart rate. They both are programmed the same way. To start an HR program follow the instructions below or just


34
select the HR1 or HR2 program, then the Enter button and follow the directions in the Message Center.
...
     possible. Use a soft, damp cloth, or paper towel, wipe the edge of the belt and the area between the belt edge and the
     ...
     dry before using.
     This occurs during normal break-in or until the belt stabilizes. Sometimes the black dust from the belt will appear on
     the floor behind the treadmill, this is normal.
...
     garment.
     ...
     •  To enter the Engineering Mode Menu press and hold down the Start, Stop and Enter
     •  keys, then at the same time insert the safety key. Keep holding the keys down until the Message Center displays
        Engineering Mode Menu. Press the Enter button to access
     •  Press the Speed + button (or Speed – button to go backwards) until “Functions” appears; press Enter
     •  Press the Speed + button until “Maintenance”; press Enter, then the message center shows “LUBE MESSAGE RESET”
38      press Enter
...
Engineering Mode Menu, press and hold down the Start, Stop and Enter keys. Keep holding the keys down for about                    39
     5 seconds and the Message Center will display Engineering Mode Menu. Press the Enter key to access the menu
     ...
     3.   Functions (Press Enter to access settings and Up arrow to scroll)
          ...
          III. Maintenance (Allows you to reset the lube message time)
...
Circuit breaker trips, but not the treadmill circuit breaker   Check that the treadmill is the only appliance in the circuit. See “Important Electri-
                                                               cal Information” in the front of this manual for more details.                              41

...
one of the leading fitness manufacturers in the world and is backed by one of the most comprehensive warranties available.
...
Spirit Fitness
                                                       ...
                                                       DEALER PHONE #______________________________________
                                                         ...
                                                         PURCHASE DATE______________________________________
                                                                                                                                      ...
                                                                                                                                      3
    Important Safety Instructions                                                      •   Do not operate where aerosol (spray) products are
                                                                                           being use or where oxygen is being administered.
          WARNING                                                                      •   The appliance is intended for household use.
    When using an electrical appliance, basic precautions should                       •   This exercise equipment is not intended for use by
    always be followed, including the following:                                           persons with reduced physical, sensory or mental
    Read all instructions before using this appliance.                                     capabilities, or lack of experience and knowledge.
    DANGER - To reduce the risk of electric shock:                                     •   Keep children under the age of 13 away from this
    Always unplug this appliance from the electrical outlet                                machine.
    immediately after using and before cleaning.
                                                                                       WARNING: This product can expose you to chemicals
    WARNING - To reduce the risk of burns, fire, electric shock, or injury
    to persons, install the elliptical on a flat level surface with access to a 110-   including Toluene and Acrylamide which are known to the
    volt, 15-amp grounded outlet with only the elliptical plugged into the circuit.    State of California to cause cancer and birth defects or
    DO NOT USE AN EXTENSION CORD UNLESS IT IS A 14AWG OR
                                                                                       other reproductive harm.
    BETTER, WITH ONLY ONE OUTLET ON THE END:                                           For more information go to www.P65Warnings.ca.gov
    •     Do not operate under blanket or pillow. Excessive
          heating can occur and cause fire, electric shock, or                         SAVE THESE INSTRUCTIONS - THINK SAFETY!
          injury to persons.                                                           Fitness Equipment Safety
...
Z\WARNING ¢ The appliance is intended for household use.
...
immediately after using and before cleaning. ; ;
WARNING: This product can expose you to chemicals
WARNING - To reduce the risk of burns, fire, electric shock, or injury P P ”

to persons, install the elliptical on a flat level surface with access to a | |0- including Toluene and Acrylamide which are known to the
volt, |5-amp grounded outlet with only the elliptical plugged into the circuit. State of California to cause cancer and birth defects or

DO NOT USE AN EXTENSION CORD UNLESS IT ISA 14AWG OR other reproductive harm.
...
e Never operate the appliance with the air openings
blocked. Keep the air openings free of lint, hair, and the
like.
...
Important Electrical Instructions
    WARNING
Be aware that the generator is producing A.C. power while the elliptical trainer is being used. Do not
service the elliptical trainer while the generator is spinning; serious electric shock could occur.

NEVER expose this elliptical to rain or moisture. This product is NOT designed for use outdoors, near
a pool or spa, or in any other high humidity environment. The operating temperature specification is 40
to 120 degrees Fahrenheit, and humidity is 95% non-condensing (no water drops forming on surfaces).
...
    Important Operation Instructions
    ...
    Record Your Serial Number                                                                        Serial Number Location
    ...
    You can also go to https://www.spiritfitness.com/residentialwarrantyregistration.html under the Support
...
3. Locate the hardware package. Remove the tools first. Remove the hard-    PARTS INCLUDED:
   ware for each step as needed to avoid confusion. The numbers in the       1 Main Frame
   instructions that are in parenthesis (#) are the item number from the     1 Console Mast
   assembly drawing for reference.                                           1 Console Mast Cover
                                                                             2 Swing Arms
                                                                             2 Connecting Arms
                                                                             6 Levelers
                                                                             1 Console
...
XMEZ795 PRE ASSEMBLY

UNPACKING TOOLS INCLUDED:

|. Cut the straps, then lift the box over the unit and unpack. Q) 13/14mm Wrench

UO) Phillips Head Screwdriver

QO) 12/l4mm Wrench

QO) Combination M5 Allen Wrench
...
ware for each step as needed to avoid confusion. The numbers in the Q) | Main Frame

instructions that are in parenthesis (#) are the item number from the Q) | Console Mast

assembly drawing for reference. QO) | Console Mast Cover

QO) 2 Swing Arms

QO) 2 Connecting Arms
U 6 Levelers
...
XE795 STEP ONE
                 ...
                 2. Tilt the elliptical trainer to one side (you may want
                    ...
                    unit for support). Install the 3 LEVELERS (81) to the
                    underside of the unit. Repeat this lever assembly on
                    opposite side of the unit.
                 3. Press the 6 END CAPS (82) into the oval stabilizer
                    tubes.
                 ...
                 5. Attach the ROLLER WHEEL COVERS (45) with 4
                    SCREWS (55). Tighten with the screw driver..
...
     XE795 STEP TWO
                      ...
                      2. Feed the twist tie wire and COMPUTER CABLE
                         ...
                         careful not to pinch the cables between the tubing. If
                         the cable gets pinched, this may affect the electrical
                      ...
                      4. Bring UPRIGHT COVER LEFT (43) and
                         UPRIGHT COVER RIGHT (56) together at the
                         CONSOLE MAST (2). Secure the covers together
                         with 3 SHEET METAL SCREWS (56).
...
XE795 STEP THREE
                   ...
                   2. Remove the foam from the console mast axles
                      and the plastic ties from the swing arm tube.
                   3. The swing arms will be labeled “L” for left and
                      “R” for right. Slide the WAVE WASHER (110)
                      and LEFT SWING ARM (5) onto the left
                      console mast axle. The swing arms have been
                      preassembled at the factory to assure a proper
                      fit. The fit will be snug. Please do not force the
                      arm on the axle or use a hammer, as damage
                      to the bearings could occur.
                   4. Secure the swing arm to the mast with the
                      BUSHING WASHER (51) and the SOCKET
                      HEAD CAP BOLT (89). Tighten with the
                      8MM L WRENCH.
...
     XE795 STEP FOUR
                       ...
                       2. Take the LEFT CONNECTING ARM (9)
                          and slide the axle through the rotation tube on
                          the left pedal arm.
                       3. Secure the LEFT CONNECTION ARM
                          (9) in place with the LEFT CONNECTION
                          BRACKET (15) and 3 KEY HEAD
                          SOCKET BOLTS (91).Tighten with the 5MM
                          L WRENCH.
                       4. Line up the socket joint at the end of the
                          pedal arm to the bracket on the bottom of the
                          swing arm. Secure together with the BOLT
                          (90) WASHER (106) and NUT (87). Tighten
                          with the 13/14 WRENCH and the 12/14
                          WRENCH.
...
XE795 STEP FIVE
                  ...
                  3. Secure the WATER BOTTLE CAGE
                     (83) to the CONSOLE MAST with 2
                     SCREWS (55). Tighten with the SCREW
                     DRIVER.
...
keys, phone, or MANUAL HILL FATBURN CARDIO STRENGTH INTERVAL CALORIES FUSION USERT2 HRI-2
...
Control Keys
     ...
     POWER
     The console power is created by a built in generator. When you begin pedaling the Elliptical trainer, the
     console will automatically power up. If there is no movement at the flywheel, the console will go to stand-
     by mode. In stand-by mode the console display will turn off. To turn the console on, begin pedaling.
     ...
     distance window shows the distance in miles or kilometers and the time window shows the total hours
     of use.
...
There is an anatomical figure located at the top of the console. This figure will light all areas that are               17
     activated when using the elliptical trainer. These will light up during any of the programs. You can control
     ...
     determined by your age that you entered during the programming phase of any of the 10 programs. The significance of the
...
18   the workload may be adjusted manually by pressing the Level Up/Down keys. The dot matrix display
will have only the bottom row lit at first. As you increase the work load more rows will light indicating a
...
small. Levels 11-15 start getting tough as the levels jump more dramatically. Levels 30-40 are extremely
difficult and are good for short interval peaks and elite athletic training.
...
segment function. This allows you to go back to change programming data.                                      19
     Program Keys
...
be saved as the new default settings. If you enter your Age and Weight the first time you use the elliptical trainer, you will
not have to enter it every time you work out unless either your Age or Weight changes, or someone else enters a different
Age and Weight.
...
3.   The Message Center will now be blinking a value, indicating your Body Weight (default is100). Entering the correct body
     weight will affect the calorie count. Use the Level Up/Down keys to adjust, then press Enter.
...
7.   The Message Center displays the Program Time (a value that was determined by the data you entered in steps 3-6);
     ...
     •   When the Start key is pressed, the program begins with a 3:00 warm up (1:00 @ Level 1, 1:00 @ Level 2, and 1:00 @ Level 3)
         or you have the option of pressing the Enter key again to bypass and begin the workout.
     •   When the program begins both the Calorie and Time windows will count down to 0. If the Time expires before calories burned
         reaches 0, the Time window will begin accumulated time, until Calories reach 0.
     •   After the program has ended, there will be a 3:00 cool down (1:00 @ Level 3, 1:00 @ Level 2, and 1:00 @ Level 1) or you have
         the option of pressing the Enter key to end the workout.
                                                                                                                                        23
     Fusion Program
     In this interval program you will alternate between mid-high intensity cardiovascular intervals on the
     elliptical trainer, strength exercises off of the elliptical trainer, and low intensity recovery intervals on the
     elliptical trainer. You will need a pair of objects that can be comfortably held in your hands (dumbbells,
     water jugs, soup cans, etc.) for 4 of the 5 strength exercises performed in this program
     ...
     3.   The Message Center will now be blinking a value, indicating your Body Weight (default is 150 lbs). Entering the correct
          ...
          factors which determine exact calorie burn for a particular person. Even if someone is the exact same body weight, age and height,
          their calorie burn may be very different than yours. The Calorie display is to be used as a reference only to monitor improvement
          from workout to workout. The calorie count displayed in this program won’t be accurate because the machine can’t calculate
          calories expended while strength training.
     ...
     6.   The Message Center will be blinking the desired Interval time (default is 2:00). The time you select will be the duration
          of each cardio interval.
24
     Note: As a general rule, the longer the interval, the less resistance (elliptical trainer) is required and the more repetitions
     you perform, the less weight (dumbbells) you need to use; use the Level Up/Down keys to adjust, then press Enter.
...
     Programming Preset Programs
     ...
     7.   If you want to increase or decrease the resistance at any time during the program, press the Level Up/Down keys on
          the
          console or above the heart rate sensor grips of the stationary handlebars. This will change the resistance settings of the
          entire profile, although the profile picture on the screen will not change. The reason for this is so that you can see the
          entire profile at all times. If the profile picture is changed, it also would be distorted and not a true representation of
          the actual profile. When you make a change to the resistance, the Message Center will show the current column and
...
1.   Select the User program (U1 or U2) then press Enter. If you have already saved a program to either U1 or U2, it will be
     displayed and you are ready to begin. If not, you will have the option of inputing a username. In the Message Window, the
     letter “A” will be blinking. Use the Level Up/Down buttons to select the appropriate first letter of your name (pressing the
     Level Up/Down button will switch to the letter “B”; pressing the Down button will switch to letter “Z”). Press Enter when
     the desired letter is displayed. Repeat this process until all of the characters of your name have been programmed (maximum
...
2.   If there is a program already stored in User when you press the key, you will have an option to run the program as it is
     ...
     prompted: Run Program? Use the Level Up/Down to select Yes or No. If you select No, you will then be asked if you want
     to delete the currently saved program. It is necessary to delete the current program if you want to build a new one. The
     Message Center will ask you to enter your Age. You may enter your age, using the Level Up/Down keys, then press the
...
3.   If there is a program already stored in User when you press the key, you will have an option to run the program as it is
     or delete the program and build a new one. At the welcome message screen, when pressing Start or Enter you will be
     prompted: Run Program? Use the Level Up/Down to select Yes or No. If you select No, you will then be asked if you want
     to delete the currently saved program. It is necessary to delete the current program if you want to build a new one.
4.   The Message Center will ask you to enter your Age. You may enter your age, using the Level Up/Down keys, then press the
     Enter key to accept the new value and proceed on to the next screen.
5.   You are now asked to enter your Weight. You may adjust the weight value using the Level Up/Down keys or the numeric
     key pad, then press Enter to continue.
6.   Next is Time. You may adjust the time and press Enter to continue.
7.   Now you are asked to adjust the Max Resistance Level of the program, press Enter when resistance has been selected.            27
     8.  Now the first column will be blinking and you are asked to adjust the resistance level for the first segment(SEGMENT > 1) of
         the workout by using the Level Up key. When you finish adjusting the first segment, or if you don’t want to change, then press
     ...
     10. The Message Center will then tell you to press Enter to save the program. After saving the program the Message Center says
         “PROG SAVED” then will give you the option to start or modify the program. Pressing Stop will exit to the start up screen.
...
28
CARDIO
This program presents a quick progression up to near maximum resistance level (default or
user input level). It has slight fluctuations up and down to allow your heart rate to elevate,
and then recover repeatedly, before beginning a quick cool down. This will build up your heart
...
sustained for 25% of workout duration. This will help build strength and muscular endurance
...
when performing tasks that are intense and short in duration. These deplete your oxygen
level and spike your heart rate, followed by periods of recovery and heart rate drop to
replenish oxygen. Your cardiovascular system gets programmed to use oxygen more efficiently.
...
INTERVAL Work Profile
     ...
     and short in duration. These deplete your oxygen level and spike your heart rate,
...
CALORIES Work Profile
CALORIES Poe tet
PPT rry rey yyy ry rr
This program follows a quick progression up to the maximum resistance level
...
If you enter your age during programming the console will 190 TRAINING CHART

perform this calculation automatically, Entering your age is 180

. ~= 170 May,
used for the Heart Rate programs. After calculating your z i Hea
. : ° = Rate
MHR you can decide upon which goal you would like to E150
pursue. g 140
The two most popular reasons for, or goals, of exercise = 130
are cardiovascular fitness (training for the heart and lungs) E _
and weight control. The black columns on the chart above 100
represent the MHR for a person whose age is listed at the 90

soe . 20 25 30 35 40 45 50 55 60 65
bottom of each column. The training heart rate, for either

eoccescce Det] Age of User
...
6 Minimal |OVery light + 14 Somewhat hard + 18 Very hard +
7Very,very light || Fairly light 15 Hard 19 Very,very hard
8 Very,very light + |2 Comfortable 16 Hard + 20 Maximal
9Very light | 3 Somewhat hard |7 Very hard

You can get an approximate heart rate level for each rating by simply adding a zero to each rating. For example a
rating of 12 will result in an approximate heart rate of |20 beats per minute. Your RPE will vary depending up the
factors discussed earlier That is the major benefit of this type of training. If your body is strong and rested, you will feel
strong and your pace will feel easier When your body is in this condition, you are able to train harder and the RPE will
support this. If you are feeling tired and sluggish, it is because your body needs a break. In this condition, your pace will
feel harder Again, this will show up in your RPE and you will train at the proper level for that day.
     ...
     5. Sweat is the best conductor to measure very minute heart beat electrical signals.
          ...
          your work out. Some users, because of body chemistry, have a more difficult time in achieving a strong, steady signal at
...
2. Ifa squeak, thump, clicking or rough feeling develops the main cause is most likely one of two reasons:
|. The hardware was not sufficiently tightened during assembly. All bolts that were installed
during assembly need to be tightened as much as possible. It may be necessary to use a larger wrench than the
one provided if you cannot tighten the bolts sufficiently. | cannot stress this point enough; 90% of calls to the
service department for noise issues can be traced to loose hardware.
ll. The crank arm nut needs to be retightened
Ill. If squeaks or other noises persist, check that the unit is properly leveled. There are 2 leveling pads on the bottom
of the rear stabilizer, use a |4mm wrench (or adjustable wrench) to adjust the levelers.
...
2. LCD Test (Tests all the display functions)
3. Functions (Press Enter to access settings and Up arrow to scroll)
|. Display Mode (Turn on to have the console power down automatically after 20 minutes of inactivity)
Il. | Pause Mode (Turn on allow 5 minutes of pause, turn off to have the console pause indefinitely)
II. ODO Reset (Resets the odometer)
lV. Units (Sets the display to readout in English or Metric display measurements)
V. Beep (Turns off the speaker so no beeping sound is heard)
VI. DA Test (Tests the brake resistance)
4. Security (Allows the keypad to be locked to prevent unauthorized use)

     Elliptical Trainer Warranty - Effective August 22, 2018

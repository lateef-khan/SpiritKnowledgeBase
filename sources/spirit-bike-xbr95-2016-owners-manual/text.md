...
A Heritage of Quality | The Spirit 0

XBRSS5 SEM! - RECUMBENT BIKE
...
Please take a moment at this time to record the name of the dealer, their telephone number, and the date of purchase
below to make any future, needed contact easy. Ve appreciate your support and we will always remember that you are the
reason that we are in business.
...
When using an electrical appliance, basic precautions should          or plug, if it is not working properly, if it has been
always be followed, including the following:                          dropped or damaged, or dropped into water. Return
...
Always unplug this appliance from the electrical outlet           •   Do not carry this appliance by supply cord or use cord
immediately after using and before cleaning.                          as a handle.
...
surface with access to a 115-volt, 15-amp grounded outlet             blocked. Keep the air openings free of lint, hair, and the
with only the bike plugged into the circuit.                          like.
...
•   To reduce the risk of burns, fire electric shock, or injury       being use or where oxygen is being administered.
    to persons:                                                   •   Connect this appliance to a properly grounded outlet
•   An appliance should never be left unattended when                 only.
    ...
    before putting on or taking off parts.                        •   This appliance is not intended for use by persons with
•   Do not operate under blanket or pillow. Excessive                 reduced physical, sensory or metal capabilities, or lack
    heating can occur and cause fire, electric shock, or              of experience and knowledge, unless they have been
    injury to persons.                                                given supervision or instruction concerning use of the
•   Close super vision is necessary when this appliance               appliance by a person responsible for their safety.
    is used by, on, or near children, invalids, or disabled       •   Keep children under the age of 13 away from this
    persons.                                                          machine.
...
ZAWARNING * Never operate this appliance if it has a damaged cord
...
WARNING - To reduce the risk of burns, fire, electric * Keep the cord away from heated surfaces.
shock, or injury to persons, install the bike on a flat level * Never operate the appliance with the air openings
surface with access to a | |5-volt, |5-amp grounded outlet blocked. Keep the air openings free of lint, hair, and the
with only the bike plugged into the circuit. like.
¢ Never drop or insert any object into any opening.
DO NOT USE AN EXTENSION CORD UNLESS IT IS A I|8AVWG OR
...
is used by, on, or near children, invalids, or disabled ¢ — Keep children under the age of |3 away from this

persons. machine.

e Use this appliance only for its intended use as SAVE THESE INSTRUCTIONS - THINK SAFETY!
...
    XBR95 PRE ASSEMBLY
    ...
    1. Cut the straps, then along the dotted line on the bottom of the box; lift    12/14mm Wrench
       the box over the unit and unpack.                                            14/15mm Wrench
...
XBR9YS5 PRE ASSEMBLY

UNPACKING TOOLS INCLUDED:
|. Cut the straps, then along the dotted line on the bottom of the box lift Q) 12/l4mm Wrench
the box over the unit and unpack. Q) 14/15mm Wrench

2. Locate the hardware package. The hardware is separated into four steps. U1 Phillips Screwdriver

Remove the tools first. Remove the hardware for each step as needed to PARTS INCLUDED:
avoid confusion. The numbers in the instructions that are in parenthesis Q) | Main Frame
...
LU) | Console Mast Cover
QU) | Front Stabilizer Cover
...
89 NYLOC NUT 3/8°X7T 2
191 CAP NUT 3/8" XUNC1 6X1 2.5T 2
...
2 CARRIAGE (4) of the main frame. Slide |
BOLT (67) through each side, then attach a
NYLOC NUT (89) to each bolt. Tighten the
bolts just enough so there is no side to side
play, but freedom of movement front to back.
...
of the Front Stabilizer Tube. You may need
130 to tap them in with a rubber mallet if they are
tight.
...
PART TYPE DESCRIPTION QTY
7\ BOLT 3/8" X 1-3/4" 4
77 FLAT WASHER 3/8" X O19 X |.5T 4
89 NYLOC NUT 3/8°X7T 4
98 PHILLIPS HEAD SCREW Mé6X15MM 4
...
9
7 450 * SCREWS (98). Tighten with the PHILLIPS
ey HA HEAD SCREW DRIVER (114).
2800 as
SO, 3. Attach the SEAT HANDLE BAR (6) to
CEERI the SEAT CARRIAGE (4) with the 4 Hex
...
3. Attach the PEDALS (1 16L, 117R) to the
CRANK ARMS (51L, 51R). Tighten with
the WRENCH (113). Remember that the
LEFT PEDAL has a reverse thread and
will be threaded onto the Crank arm in a
...
be necessary to re-tighten the pedals if you feel a
thumping while pedaling the bike.A thumping or
114 112 113 clicking noise is usually caused by loose pedals.
...
Control Buttons
     ...
     how many hours the Semi - Recumbent Bike has been used and how many virtual miles the Semi -
     Recumbent Bike has gone. The display shows: ODO 123 MI 123 HRS.
...
perform a complete Reset. During data entry for a program the Stop key performs a previous screen
                                                                                                           17
     or segment function. This allows you to go back to change programming data.
...
18   low for you; entering your Weight aides in calculating a more correct Calorie reading. Although we
...
7.   The Message Center displays the Program Time (a value that that was determined by the data you entered in steps
     ...
     recalculate the Program Time.
          ...
          • After the program has ended, there will be a 3:00 cool down (1:00 @ Level 3, 1:00 @ Level 2, and 1:00 @
               Level 1) or you have the option of pressing the Enter key to end the workout.                                                     21
     Fusion Program
...
22
     more repetitions you perform, the less weight (dumbbells) you need to use; use the Level Up/Down keys to adjust,
     then press Enter.
...
CAUTION: The shorter the recovery time, the longer your heart rate will stay elevated; if you are new to
...
by periods of recovery and heart rate drop to replenish oxygen. Your cardiovascular         25
...
system. This 60% to 80% is the zone to stay in for maximum er ee thG euARY
benefit. a Ming
For someone who Is 40 years old their = 160 1° Ra
target heart rate zone is calculated: : *0
220 — 40 = 180 (maximum heart rate) H “ |
180 x .6 = 108 beats per minute (60% of maximum) e 420
180 X .8 = 144 beats per minute (80% of maximum) 2 40
...
6 Minimal lO Very light + 14 Somewhat hard + 18 Very hard +
7Veryvery light || Fairly light 15 Hard 19 Very,very hard
8 Veryvery light + |2 Comfortable 16 Hard + 20 Maximal
...
4.   Security (Allows the keypad to be locked to prevent unauthorized use)
                                                                                                                                    35
     Semi - Recumbent Bike Warranty - Effective January 25, 2016
     ...
     the absence of a sales receipt eighteen (18) months from the original factory shipping date. Spirit Fitness’ responsibilities include providing new or remanu-
     factured parts, at Spirit Fitness’ option, and technical support to our independent dealers and servicing organizations. In the absence of a dealer or service
...
800.258.4555 Spirit Fitness
WY spiritservice@spiritfitness.com 9 3000 Nestle Road

www.spiritfitness.com Jonesboro,AR 72401

(

XBR9I5 Owners Manual
Si Fer FITNESS © 2016All Ri Reserved
A Her he Spitit of Innovation

...
A TTE N T/ O . Before returning your Sole product to any retailer, or if you require any istance with ably or
...
<!-- render-vs-extraction: 230 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
M Keep children under the age of 13 away from this machine. There are obvious pinch points
...
H Donot attempt to use your treadmill for any purpose other than for the purpose it is
intended.
...
<!-- render-vs-extraction: 241 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
IMPORTANT ELECTRICAL INSTRUCTIONS

WARNING!

NEVER use a ground fault circuit interrupt (GFCI) wall outlet with this treadmill. As with any ap-
pliance with a large motor, the GFCI will trip often. Route the power cord away from any moving
...
(ARC fault breakers are one example) that can occur when a treadmill is first turned on or even
during use. If your treadmill is tripping the house circuit breaker (even though it is the proper
current rating) but the circuit breaker on the treadmill itself does not trip, you will need to replace
the home breaker with a high inrush type. This is not a warranty defect. This is a condition we as a
...
from the adapter, must be Grounded Outlet
connected to a permanent

ground such as a properly (1) a
grounded outlet box cover. s Tab of
Whenever the adapter is Oo (I) Metal Screw eee
used, it must be held in /
place by a metal screw. Grounding Pin Grounded Outlet Box
...
M@ NEVER mount or dismount the treadmill while the belt is moving. SOLE treadmills start at a
...
There is aVelcro strap installed around the treadmill base that prevents the treadmill from
...
F63 /F65 ASSEMBLY PACK CHECKLIST
HARDWARE STEP 2

io

#128. M5
Speed Nuts Clip (6 pcs)
...
#159. 5/16"x 3/4”
Button Head Socket Bolt (4 pcs) #75. Safety Key
...
1. Install the six Soeed Nut Clips (128) on the Frame Base left and right side.

2. Slide the lower handlebar covers (64 & 65) onto the console masts (notice
orientation).

3. Slide the Frame Base Caps (62L & 63R) over the Upright tubes (4 & 5).
Connect the Lower Computer Cable (50) to the Middle Computer Cable (49)
...
something to rest the console on at the appropriate height or
...
1. Attach the Left (64) and Right (65) Handlebar Covers to the top
of the Upright Tubes (4 & 5) with six Sheet Metal Screws (175).
Tighten with the Combination M5 Allen Wrench & Phillips Head
Screw Driver (131).

F63 / F65 TREADMILL 10
...
1. Attach the Support tube (26) between the upright tubes (4 & 5)
with four Button Head Socket Bolts (159). Tighten bolts firmly.

2. Place the Beverage Holder (158) on top of the Support tube (26)
...
D
A Mie a: HARDWARE STEP 8

a) 120 63 #120. 5x 16mm
...
1. Finish tightening the button head bolts (from Step 2 above) that
secure the console masts to the frame.

2. Attach the Console mast covers (62 & 63) to the Frame Base (2)
with six Tapping Screws (120). Tighten screws using the
Combination M5 Allen Wrench & Phillips Head Screw Driver
(131).

11 F63 / F65 TREADMILL
...
current software version. Then the Time and Distance Windows will display Odometer read-
ings for a short time, Time Window will show how many hours the treadmill has been in use
and the Distance Window will show how many miles (or Kilometers if the treadmill is set to
metric readings) the treadmill has gone. The treadmill will then enter idle mode, which is the
...
Speed A/V keys (console or handgrip). You may also use the speed keys 2, 3, 4,5, 7,9 or 12
to adjust the speed.

3. To slow tread-belt press and hold the Speed w key (console or handgrip) to the desired
...
The Time, Distance and Calorie readings will hold while the unit is in the pause mode. After
5 minutes the display will reset and return to the start up screen.
...
= Press and hold the Incline a/v keys (console or handgrip) to achieve desired level of effort.
You may also choose a more rapid increase / decrease by selecting desired key, 1, 3, 5, 7, 9,
12 and 15, on left hand side of console (incline).

= The Incline Window display will indicate incline position as adjustments are made.

15 F63 / F65 TREADMILL


=== OCR SUPPLEMENT, PDF PAGE 18 ===
<!-- render-vs-extraction: 169 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
DOT MATRIX CENTER DISPLAY

Eighteen columns of dots (8 high) indicate each segment of a
workout for the F63 and eighteen columns of dots (8 high)
indicate each segment of a workout for the F65. The dots are
only to show an approximate level (speed/incline) of effort.
They do not necessarily indicate a specific value - only an
approximate percent to compare levels of intensity. In
operation, the speed/incline dot matrix window will build a
profile “picture” as values are changed during a workout.
When the word “Speed” is lit above the dot matrix it indicates
that the Speed profile is being displayed and when the word
“Incline” is lit above the dot matrix it indicates the Incline
...
button. After pressing Enter to view the two profiles, pressing it a third time will automatically
...
There is an Audio Input Jack (2) on the front of the console and built-in speakers. You may
...
to and also a headphone jack (3) for private listening.

F63 / F65 TREADMILL 16
...
or wear the wireless chest strap. The pulse value will display anytime the upper display is
...
Your new console comes configured in an in-store ‘Display Mode’ of operation, where the console
...
show: Display mode - On. Use any of the Program, Incline or Speed A keys to change the
setting to Off then press Enter.

17 F63 / F65 TREADMILL


=== OCR SUPPLEMENT, PDF PAGE 20 ===
<!-- render-vs-extraction: 157 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
laximum possible User Profiles:6

aaa Mi i
Add New User } Create soace for a new orolile bv selectina the profile vou wish to delete
...
F63 / F65 TREADMILL 18


=== OCR SUPPLEMENT, PDF PAGE 21 ===
<!-- render-vs-extraction: 158 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
PROGRAMMABLE FEATURES

The F63 / F65 have ten built-in programs: one Manual program, five preset profiles (P1-P5), two
...
1. Press the Program A/V keys to view the programs on the screen then press the Enter key
to select the program you would like to perform. The display will prompt you through the
programming steps or you can just press the Start key to begin the program using the
preset program values for age, weight and other program specific information.

2. If Enter was pressed, the Message Window will display Age. You may use any of the 4/¥
...
3. The Message Window will now be displaying a value, which is your body weight. Entering
the correct body weight will affect the calorie count. Use any of the 4/V¥ keys to adjust, then
press Enter.
™ Calorie Display Note: No exercise machine can give you an exact calorie count because there

are too many factors which determine exact calorie burn for a particular person. Even if
someone is the exact same body weight, age and height, their calorie burn may be very differ-
ent than yours. The Calorie display is to be used as a reference only to monitor improvement
from workout to workout.

4. The Time Window and Message Window will now be displaying a value, which is total
workout time desired. Use any of the 4/V¥ keys to adjust, and then press Enter. After
adjusting, press the Enter key.

5. The Message Window will display the preset max speed of the selected program. Use any
of the 4/¥ keys to adjust, and then press Enter. Each program has various speed changes
throughout; this allows you to limit the highest speed the program will reach at it’s peak.

6. Press Start to begin the program. The program will begin with a 3 minute warm-up. If you
want to bypass this and go directly to the beginning of the program, press Start again.

F63
a 4 an =~ T 155
|_——_ =

vn CuuU Mink J HH Ju
dit = att
...
=~ fi LULL fem ~ @ CLI
i) CHD) | i) CE
TIME Coo MAX SPEED ai MPH
USER PROGRAMS
1. Select User 1 or User 2 via the Program 4/V¥ keys then press Moco lst ICCA ~
Enter. Note that the dot matrix display portion will have a UIER 1 / UocR C

single row of dots at the bottom (Unless there is a previously
stored program). If there is a program stored under the
button that is pressed, it will be retrieved. If not, you have the
option of programming in your first name. The Message

Window will display and flash the letter “A”. To change it, (a EEOD i y.
press the any a key, then“B” will be displayed; if the any V ee

key is pressed, the letter “Z” will be displayed. After selecting
the appropriate letter, press Enter. The letter “A” will again be F63
displayed and blinking. Repeat the procedure until all letters

ww, ew, ew, (LE Hat ME AMC
of your first name are programmed (7 characters maximum). | |. | ie uu eH
When your name is displayed, press Stop and it will be I {I || a
stored under either User 1 or User 2.

2. Next the Message Window is flashing Age. Use the Incline fifi iii —~
A/V keys to adjust. Press Enter. This is a must to continue WH LL i
even if age is not adjusted.

3. The Message Window will now be blinking a body weight F65
value. Enter your body weight and press Enter. mye ni 7

4. The Time Window and Message Window will now be (=4 im a 1 it | u\
blinking a Time value. Adjust the “ “
Time and press Enter. an cri

5. The first column (segment) will now be blinking. Using the NAME Fy

Speed 4/V or keys, adjust the speed level to your desired
effort for the first segment then press Enter. The second column will now be blinking.
Repeat the above process until all segments have been programmed. The first column will
be blinking again. This is for the incline programming. Repeat the above process to program
all segments for incline.

6. Press the Start button to begin the workout and also save the program to memory.

F65 Note: While in a User program, if you change the speed, all segment speeds from there on will also change.
...
180 x .6 = 108 beats per minute © +30
(60% of maximum) = 120
...
23 F63 / F65 TREADMILL


=== OCR SUPPLEMENT, PDF PAGE 27 ===
<!-- render-vs-extraction: 265 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
1. Select HR1 or HR2 via the Program A/V keys then press Enter.

2. The Message Window will now be blinking showing user’s age. Adjust and press Enter or
press Enter to accept the default value. Adjusting Age will change the Target HR value.

3. The Message Window will be blinking, showing the default user’s bodyweight for this
program. You may adjust it and press Enter if you want or just press Enter to accept the
default value.
...
number by pressing the Speed 4/¥ keys (console or handrails) and press Enter to continue.
...
Speed 4/¥ (console or handrail) keys.

8. During the HR program you will be able to scroll through the data in the Message Window
by pressing the Display key. When the program ends the Message Window will show a
summary of your workout. The summary will be displayed for a short time then the console
will return to the start-up display.
...
difference which may not be apparent right away. f- O)
...
27 F63 / F65 TREADMILL


=== OCR SUPPLEMENT, PDF PAGE 31 ===
<!-- render-vs-extraction: 216 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
authorized Sole Fitness dealer. You may also use a Lube-n-Walk kit that can be purchased
...
2. Press the Speed 4 button (or Speed Vv button to go backwards) until “Functions”
appears; press Enter.

3. Press the Speed A button until “Maintenance” message appears; press Enter to reset
the lube message.

4. Press Stop to exit Engineering Mode and resume use of your treadmill.

F63 / F65 TREADMILL 28
...
approximately 7 mph but shows operate. Low AC voltage to treadmi Do not use an
...
House circuit breaker trips, but not Need to replace the house breaker with a“High
the treadmill circuit breaker In-rush current” type breaker (see page 3 for details)

29 F63 / F65 TREADMILL
...
2. Press and hold down the Start and Speed 4 buttons and at the same time replace the Safety
...
do this, press the incline A/V key to show which you want, then press Enter. (The maximum
...
the front roller pulley (the pulley will have a belt around it that also
goes to the motor). The speed sensor is small and black with a wire
connected to it.
...
D. Security - Allows you to lock the keypad so no unauthorized use of the machine is allowed. When the child lock is
...
F63 / F65 TREADMILL 30


=== OCR SUPPLEMENT, PDF PAGE 34 ===
<!-- render-vs-extraction: 324 words the text layer does not have; tesseract --psm 4 at 300 dpi -->

...
A TTE N T/ O . Before returning your Sole product to any retailer, or if you require any assistance with assembly or
...
the treadmill on a flat level surface with access to a 110-volt, 15-amp grounded outlet with only
...
lug, or the like, extending from the adapter, must be connected to a permanent ground
...
#113.@10 x 1.5T_ #139. 3/8" x 1-3/4"_ #175. 3.5 X 16m/m_
Split Washer (4pcs) Button Head Socket Bolt Sheet Metal Screw
(4pcs) (2pcs)
...
(4 pcs) (2 pcs)
ASSEMBLY TOOLS
#132. M6 L Allen Wrench #131. Combination M5 Allen Wrench
...
Right Upright (4) through Frame Base Cover (R) (65) and connect 6P
Computer Cable (Middle) (141) with 6P Computer Cable(Lower)
(142).

2. Insert the Right and Left Uprights (4) and (5) into Frame Base (2) and
then use M5 Allen Wrench Head Screw Wrench (131) to tighten 8
pcs of Button Head Socket Bolt (130).
...
1. Connect 6P Computer Cable (Middle) (141) with 6P Computer
Cable (Upper) (53-34), and connect Speed Adjustment Switch
W/Cable (54) with Speed Cable (Upper) (53-37), and connect
Incline Adjustment Switch W/Cable(55) with Incline Cable (Upper)
(53-38) then insert console Assembly(Bottom) (53) into the Right
and Left Uprights (4) and (5) and use L Allen Wrench (132) to
tighten 4 pcs of Button Head Socket Bolt (139) and 4 pcs of Split
Washer (113).

2. Install Fan Plate Assembly (61) on the Console Assembly Bottom)
(53) and use Allen Wrench Head Screw Wrench (131) to tighten 2
pcs of Sheet Metal Screw(175).

NOTE: Please DON'T Tighten All Screws.

ASSEMBLY STEP 4 AAROWARE STEP

Ve 52 #137.M5 x 30m/m_
) Phillips Head Screw
(4pcs)

1. Connect 11P Computer Cable (Upper) (52-09) with 11P Computer

Cable (Lower)(53-16), and connect 4P Computer Cable (Upper)

(52-10) with 4P Computer Cable (Lower) (53-17), and connect 9P

Computer Cable (Upper) (52-11) with 9P Computer Cable (Lower)

(53-18), and connect 6P Computer Cable (52-16) with 6P

Computer Cable (Upper) (53-34). Place Console Assembly(Top) (52)

to Console Assembly (Bottom) (53) and use Allen Wrench Head

Screw Wrench (131) to tighten 4 pcs of Phillips Head Screw (137).
...
1. Install Handrail Support (26) between Left and Right Uprights (5)
and (4) and use Allen Wrench Head Screw Wrench (131) to tighten
4 pcs of Button Head Socket Bolt (159).

2. Install Console Mast Cover Outer (L) (148), Console Mast Cover
Inner (L) (149), Console Mast Cover Outer (R) (151) and Console
Mast Cover Inner (R) (150) in Left and Right Uprights (5) and (4).
...
1. Allen Wrench Head Screw Wrench (131) to tighten 6 pcs of Sheet
Metal Screw (175).
...
ASSEMBLY STEP 7 _ HARDWARE STEP 7

el C—O #175. 3.5 x 16m/m_
CS \— Sheet Metal Screw

1. Place Tablet Holder (177) on Console Assembly(Top) (52) and
use M5_ Allen Wrench Head Screw Wrench (131) to tighten 4
pcs of Sheet Metal Screw (175).
2. Install Beverage Holder (158) on Handrail Support (26).
...
1. Install Frame Base Cover left (64) and right (65) in Left and
Right Uprights (5) and (4) and use Allen Wrench Head Screw
Wrench (131) to tighten 4 pcs of Phillips Head Screw (128) and
2 pcs of Phillips Head Screw (95) into Frame Base (2).
...
@ TOFOLDTHE TREADMILL
Make certain that the treadmill is at minimum incline. Lift
the treadmill’s running deck until it is secured by the locking
telescoping tube assembly in the center back of the base.

@ TOUNFOLDTHE TREADMILL
...
When the power is turned on, the message window displays the current version of the software. Then
the Time and Pace Windows will display Odometer readings for a short time. Time Window will show
how many hours the treadmill has been in use and the Pace Window will show how many miles (or
Kilometers if the treadmill is set to metric readings) the treadmill has gone. The treadmill will then
enter idle mode, which is the starting point for operation.
...
To stop the tread- belt, press Stop Key ¢ or pull away Safety Key.

PAUSEISTOPY RESET FEATURE
...
m Press and hold the Incline 4/¥ keys on the console to achieve your desired level of effort.
...
Eighteen columns of dots — each 8 units high -
indicate each segment of a workout for the F65 and
eighteen columns of dots - each 8 units high -
indicate each segment of a workout for the . The
dots are only to show an approximate level of effort
in speed or incline. They do not necessarily indicate a
specific value - only an approximate percent to
compare levels of intensity. In operation, the
speed/incline dot matrix window will build a profile
“picture” as values are changed during a workout.
When the word “Speed” is lit above the dot matrix, it
indicates that the Speed profile is being displayed.
When the word “Incline” is lit above the dot matrix, it
indicates the Incline profile is being displayed.

You may change the Dot Matrix profile view between Speed and Incline by pressing the Enter
button. After pressing Enter to view the two profiles, pressing it for the twice time will
...
Vertical, Segment Time, Max Speed, (in mph), and Data Scan mode. In Data Scan mode, the
...
1. In idle mode, press and hold the DISPLAY button for 5 seconds to enter the

brightness adjustment function.

2. TheLCD does not display all of them, only displays the moving string
"BRIGHTNESS LEVEL" in the message bar, and displays the numbers 1~10 in Dot
matrix.

3. Press SPEED+/- or INCLINE+/- button to adjust the brightness, adjust the
number range 1~10.
...
<!-- render-vs-extraction: 126 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
the workout. You must use both stainless steel sensors on the front cross bar to display your pulse
or wear the wireless chest strap. The pulse value will display anytime the upper display is receiving
a pulse signal.

TURNING OFF TREADMILL

1. The display will automatically turn off, by going into sleep, after 15 minutes of inactivity
when in the Pause / Stop mode. Almost all power for the treadmill will be off except for some
circuits that are needed to detect if any key is pressed, indicating the console should “wake
up”. When the console is “asleep” the treadmill draws very little power, for about as much as a
...
equipment (shown right). earn 2 Download on the
quip g Google Play Kop Store

4. Under the Bluetooth scan result list, select the machine for
connect. When the App and equipment are synced, the Bluetooth® icon on the equipment’s
console display will light up. Click “DISPLAY”, you may now start using your Sole + App.
...
Note: Your device will need to be running ona minimum operating system of IOS 13.1 or
...
: : , ‘7-8 0000
To charge your mobile electronics make sure the fitness 9 OI

equipment power is on. HO = i

Step 1: Connect your USB charging cable (not included)
...
The F65 have ten built-in programs: one Manual program, five preset profiles (P1-P5), two
...
2. If Enter was pressed, the Message Window will display Age. You may use any of the 4/V¥ keys
...
wn ~ al YUU tn vom Hi YUU
TIME Shon MAX SPEED su viet
...
press Enter. Note that the dot matrix display portion will Mirco ' / ilero a |
; ; MEN t 2 LIEN LE

have a single row of dots at the bottom (Unless there is a i) LYLPLILD Bll

previously stored program). If there is a program stored (=a WLLL eee ~\

under the button that is pressed, it will be retrieved. If not,
you have the option of programming in your first name.
The Message Window will display and flash the letter “A”.
To change it, press the any a key, then “B” will be displayed; wAG 6 So
if the any V key is pressed, the letter “Z” will be displayed.
After selecting the appropriate letter, press Enter. The letter
“A’ will again be displayed and blinking. Repeat the
procedure until all letters of your first name are am

programmed (7 characters maximum). When your name is incine Af i NET T AAA Sytet =
displayed, press Stop and it will be stored under either Tareel an on

User 1 or User 2. woe HEH I tT [| AAA balrts

2. Next the Message Window is flashing Age. Use the Incline 1 <= Gata (OnonO.
A/Y keys to adjust. Press Enter. This is a must to continue HHA | HE \ oats

even if age is not adjusted. BLO BX BX BX BKB BX BX BM BLOX OX BX BXL:EK. OI
...
<!-- render-vs-extraction: 259 words the text layer does not have; tesseract --psm 4 at 300 dpi -->
...
GENERAL CLEANING (Use the chart on Pg. 7 to record your maintenance)
...
A 6mm Allen wrench (132) is provided for this
...
your treadmill. or every 90 days, regardless of usage as it can dry out, or If the lubricant dries out,
the friction between the belt and deck rises and places undue stress on the drive motor, drive belt
and electronic motor control board, which could result in catastrophic failure of these expensive
...
any lubrication present, follow the procedure below even though the “Lube” indicator isn’t lit on
the console. Otherwise, lubricate when the console’s lubrication reminder lights after 90 hours of
...
b. Press the Speed a button (or Speed v button to go backwards) until “Functions”
appears; press Enter.
c. Press the Speed a button until “Maintenance” message appears; press Enter to
...
2. Press and hold down the Start and Speed a buttons and at the same time replace the Safety
...
<!-- render-vs-extraction: 354 words the text layer does not have; tesseract --psm 4 at 300 dpi -->

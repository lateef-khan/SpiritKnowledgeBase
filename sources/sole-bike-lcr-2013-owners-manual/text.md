...
LCR Fitness Bike
 ...
 before operating your new fitness bike.
TABLE OF CONTENTS
...
IMPORTANT OPERATION INSTRUCTIONS
  NEVER expose this fitness bike to rain or moisture. This product is NOT designed for
    use outdoors, near a pool or spa, or in any other high humidity environment. The oper-
    ating temperature specification is 40 to 120 degrees Fahrenheit, and humidity is 95%
...
1     HARDWARE STEP 1
           ...
           #84. 3/8” x 25 x 2T                #176. 3/8” x 3/4”            #136. M5 x 15mm
...
4   HARDWARE STEP 4
           ...
           #98. M6 x 15mm                #99. M5 x 12mm                #105. Ø4 x 16mm
...
1   REAR STABILIZER & SEAT BACK                                                               HARDWARE STEP 1
    ...
    3.   Install Seat Back Bracket (5) onto the Seat Carriage (4) with six Hex Head Bolts
         (176) and six Flat Washers (77) using the 12/14mm Wrench (112).
...
2   SEAT HANDLE BAR                                                                           HARDWARE STEP 2
    ...
    3.   Be sure the connectors are plugged into the correct ports. Each connector has
         a tag that indicates either L for Left, which plugs into port (42) in the drawing,
         and R for right, plugs into port (26).
...
OPERATION OF YOUR FITNESS BIKE
 ...
 POWER UP
 The console power is created by a built in generator. When you begin pedaling the fitness bike, the console will
 automatically power up. If there is no movement at the flywheel, the console will go to stand-by mode. In stand-by
 mode the console display will turn off. To turn the console on, begin pedaling.

 When it is first powered on, the console will perform an internal self-test. During this time all the lights will turn on.
 When the lights go off, the Message window will show a software version (i.e.: VER 1.0) and the Distance window
 will display an odometer reading. The odometer reading displays how many virtual miles the fitness bike has gone.
...
CONSOLE OPERATION
   ...
   buttons or pressing one of the Quick Level Keys 1, 4, 8, 12,
   16, 20, 21, 24, 28, 32, 36, or 40 on the left or right side of the
   console. The dot matrix display will be showing a track with
   ...
   will be displayed sequentially for 4 seconds each. The Dot Matrix will show the Resistance profile
   of the program and a Lap Track that is a ¼ mile long.
...
DOT MATRIX CENTER DISPLAY
   ...
   flywheel. If you are in a program and have to stop pedaling, your information will be saved for
   up to 5 minutes. When you resume pedaling, the program will continue at that point and data
   will continue to accumulate from where you left off. If more than 5 minutes has elapsed, the
   console will return to the start up screen and all data from that workout will be lost.



LCR FITNESS BIKE                                 12
The Stop button actually has several functions. Pressing the Stop key once during a program
will Pause the program. If the Stop button is pressed twice during a workout the program
will end and a Workout Summary is displayed. If the Stop key is held down for 3 seconds the
console will perform a complete Reset. During data entry for a program the Stop key performs
a Previous Screen function. This allows you to go back one step in the programming each time
...
PROGRAMMABLE FEATURES
   ...
   workload yourself and not the computer.
      ...
      6. Once the program starts the fitness bike will be set to level one. This is the easiest level
         ...
         You can also press any of the Quick Level keys.
...
   PROGRAMMING PRESET BUTTONS
   ...
   instructions below.
      ...
      2. If there is a program already stored in Custom when you press the key, you will have an option to run the program as it
          ...
          one.
      3. The message window will ask you to enter your Age. You may enter your age using the Up and Down keys, then press
...
2.   The message window will display Gender Male. The word Male will be blinking. Use the up and down arrows if you need to
     change to Female, then press Enter. The choice of Gender determines which workload chart will be used for the test.
3.   The message window will ask you to enter your Age. You may adjust the age setting, using the Up and Down keys then
     press the Enter key to accept the new number and proceed on to the next screen.
4.   You are now asked to enter your Weight. You may adjust the weight number using the Up and Down keys then press enter
     to continue.
...
           Do not take in caffeine before the test.
     ...
      You must maintain a steady 50 RPM pedal speed. If your pedal speed drops below 48 RPM or goes above 52 RPM the
                                                                                                ...
                                                                                                old theold
                                                                                                         Display old
                                                                                                                  button old
                                                                                                                         under the old
         Message Window.
       6. The message window will always display your pedal speed excellent
                                                                         on the right side
                                                                                        >60 to help you maintain
                                                                                                  >56     >51     50RPM.
                                                                                                                   >45     >41       >37
       7. The data shown during the test is:
          a. Work in KGM is actually an abbreviated form of kg-m/min.    good
                                                                            which is a52-60
                                                                                       work 49-56
                                                                                             measurement 43-51
                                                                                                           of      39-45   36-41
                                                                                                              kilogram-force       33-37
             meter/minute                                                above
          b. Work in Watts (1 watt is equal to 6.11829727787 kg-m/min.)  average       47-51     43-48   39-42     35-38   32-35    29-32
          ...
          d. Time is the total elapsed time of the test.                 average       42-46     40-42   35-38     32-35   30-31    26-28
                                                                       ...
                                                                       below
     After the test                                                    average      37-41    35-39    31-34     29-31    26-29    22-25
      Cool down for about one to three minutes.                    poor          30-36    30-34   26-30     25-28  22-25       20-21
...
VO2max Chart for males and very fit females                            VO2max Chart for females and de-conditioned males
 ...
 average       33-37     31-34   27-30    25-27    22-24    19-22
LCR
 poor FITNESS  BIKE26-30
           28-32                 22-26     20-24    18-21       18
                                                            17-18
 very poor      <28      <26      <22      <20      <18      <17
HEART RATE PROGRAMS
...
GENERAL MAINTENANCE
 ...
 2. If a squeak, thump, clicking or rough feeling develops the main cause is most likely one of
    two reasons:
      ...
      III. If squeaks or other noises persist, check that the unit is properly leveled. There are 2
 ...
 “Engineering Mode”. Press the Enter key.
...
3.   Expenses for making the fitness bike accessible for servicing, including any item that was not part of the fitness bike at the time it was shipped
     from the factory.

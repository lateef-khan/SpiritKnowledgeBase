...
    Congratulations on your new recumbent bike and welcome to the Spirit Fitness family!

    Thank you for your purchase of this quality recumbent bike from Spirit Fitness. Your new recumbent bike was manufactured
    by one of the leading fitness manufacturers in the world and is backed by one of the most comprehensive warranties
    available. Through your dealer, Spirit Fitness will do all we can to make your ownership experience as pleasant as possible for
    many years to come. If not purchased direct from Spirit Fitness, the local dealership where you purchased this recumbent
    bike is your administrator for all Spirit Fitness warranty and service needs. Their responsibility is to provide you with the
    technical knowledge and service personnel to make your experience more informed and any difficulties easier to remedy.
...
surface with access to a 115-volt, 15-amp grounded outlet         •   Never drop or insert any object into any opening.
...
•   To reduce the risk of burns, fire electric shock, or injury       only.
    to persons:                                                   •   The appliance is intended for household use.
•   An appliance should never be left unattended when             •   This exercise equipment is not intended for use by
    plugged in. Unplug from outlet when not in use, and               persons with reduced physical, sensory or mental
    before putting on or taking off parts.                            capabilities, or lack of experience and knowledge.
•   Do not operate under blanket or pillow. Excessive             •   Keep children under the age of 13 away from this
    heating can occur and cause fire, electric shock, or              machine.
    injury to persons.
...
•   Use this appliance only for its intended use as               defects or other reproductive harm.
    ...
    recommended by the manufacturer.                              SAVE THESE INSTRUCTIONS - THINK SAFETY!                          3

...
surface with access to a | |5-volt, |5-amp grounded outlet * Never drop or insert any object into any opening.
with only the bike plugged into the circuit. * Do not use outdoors.
* Do not operate where aerosol (spray) products are

DO NOT USE AN EXTENSION CORD UNLESS IT ISA |14AWG OR ; . . a
...
* — An appliance should never be left unattended when e This exercise equipment is not intended for use by
plugged in. Unplug from outlet when not in use, and persons with reduced physical, sensory or mental
before putting on or taking off parts. capabilities, or lack of experience and knowledge.

* Do not operate under blanket or pillow. Excessive ¢ Keep children under the age of |3 away from this
heating can occur and cause fire, electric shock, or machine.
injury to persons.
...
recommended by the manufacturer SAVE THESE INSTRUCTIONS - THINK SAFETY!
    ...
    Important Electrical Instructions
        WARNING
    NEVER remove any cover without first disconnecting D.C. power. If voltage varies by ten percent (10%) or more, the
    ...
    NEVER expose this Recumbent Bike to rain or moisture. This product is NOT designed for use outdoors, near a pool or
...
    Important Operation Instructions
    •   NEVER operate this Recumbent Bike without reading and completely understanding the results of any operational
    ...
    •   NEVER use your fitness bike during an electrical storm. Surges may occur in your household power supply that could
        damage fitness bike components. Unplug the fitness bike during an electrical storm as a precaution.
    •   Use caution while participating in other activities while pedaling on your Recumbent Bike; such as watching television,
...
e NEVER operate this Recumbent Bike without reading and completely understanding the results of any operational
change you request from the computer.

e Understand that changes in resistance do not occur immediately. Set your desired resistance level on the computer
console and release the adjustment key. The computer will obey the command gradually.

e NEVER use your fitness bike during an electrical storm. Surges may occur in your household power supply that could
damage fitness bike components. Unplug the fitness bike during an electrical storm as a precaution.

e — Use caution while participating in other activities while pedaling on your Recumbent Bike; such as watching television,
reading, etc. These distractions may cause you to lose balance which may result in serious injury.
...
The self-addressed product registration card must be completed in full and returned to Spirit Fitness.
You can also go to http://wwwspiritfitness.com/residentialwarrantyregistration.html under the Support
tab to register online.


XBR55 PRE ASSEMBLY
UNPACKING                                                                      TOOLS INCLUDED:
1. Cut the straps, then along the dotted line on the bottom of the box; lift    12/14mm Wrench
   the box over the unit and unpack.                                            13/15mm Wrench
...
2. Locate the hardware package. The hardware is separated into four steps.
   ...
   avoid confusion. The numbers in the instructions that are in parenthesis    PARTS INCLUDED:
   (#) are the item number from the assembly drawing for reference.             1 Main Frame
                                                                                1 Console Mast
                                                                                1 Rear Stabilizer
                                                                                1 Seat Back Frame
                                                                                1 Front Handle Bar
...
|. Cut the straps, then along the dotted line on the bottom of the box< lift Q) 12/14mm Wrench
the box over the unit and unpack. Q) 13/15mm Wrench

2. Locate the hardware package. The hardware is separated into four steps. 5 mes screwdriver

mm Wrench

Remove the tools first. Remove the hardware for each step as needed to
avoid confusion. The numbers in the instructions that are in parenthesis PARTS INCLUDED:
(#) are the item number from the assembly drawing for reference. Q) | Main Frame
...
PART TYPE DESCRIPTION QTY
65 BOLT 3/8"X53mm 2
67 BOLT 3/8" XUNCI 6X4” 2
84 FLAT WASHER 3/8" x O@25 x 27 2
89 NYLOC NUT 3/8°X7T 2
191 CAP NUT 3/8" XUNC16X12.5T 2
...
PART TYPE DESCRIPTION QTY
68 BOLT 5/16"XUNC18X5/8" 8
76 FLAT WASHER O5/16" x O18 x |.5T 6
82 SPLIT WASHER 5S/16"X1.5T 2
83 CURVED WASHER @5/16" x 19 x |.5T 2
...
XBR55 STEP FOUR
                  ...
                  3. Attach the PEDALS (116) to the CRANK
                     ARMS (51L, 51R). Tighten with the WRENCH
                     (113). Remember that the LEFT PEDAL has
                     a reverse thread and will be threaded onto the
                     Crank arm in a COUNTERCLOCKWISE
                     motion. There is an “L” stamped in the end of the
                     threaded post of the left pedal and an “R” in the
                     right. Make sure to tighten the pedals as firmly
                     as you can. It may be necessary to re-tighten
                     the pedals if you feel a thumping while pedaling
...
PART TYPE DESCRIPTION QTY
70 BOLT 5/16"XUNCI8X1-1/4" |
76 FLAT WASHER @5/16" x O18 x |.5T |
9I NYLOC NUT 5/16°X6T |
105 SHEET METAL SCREW 4X16MM 4

|. Gather HARDWARE FOR STEP 4.

2. Install the GAS CYLINDER (57) on the SEAT
BACK FRAME (5) with | BOLT (70), | FLAT
WASHER (76) and | NYLOC NUT (91) by
using the WRENCHES provided (112 & 113).

3. Attach the PEDALS (116) to the CRANK
ARMS (SIL, 51R). Tighten with the WRENCH
(113). Remember that the LEFT PEDAL has
a reverse thread and will be threaded onto the
Crank arm ina COUNTERCLOCKWISE
motion. There is an “'L’ stamped in the end of the
threaded post of the left pedal and an “'R” in the
right. Make sure to tighten the pedals as firmly
as you can. It may be necessary to re-tighten
...
114. 112 114 caused by loose pedals.

105 4. Attach the DRINK BOTTLE HOLDERS (39L
& 38R) to the sides of the SEAT HANDLE
BAR (6) with 4 SHEET METAL SCREWS
(105). Tighten with the PHILLIPS HEAD
SCREW DRIVER (114)
...
MUSCLE PROFILE Heart Rate % Profile
...
MANUAL HILL FATBURN CARDIO. STRENGTH INTERVAL USER USER-2 HRA HR-1 variety of work-outs

\ \ * 5 = = . © Easy-Touch
\ wa FAN Ji START LEVEL STOP Control Buttons
...
will turn on. When the lights go off, the Message Center will show the software version. The distance
window shows the distance in miles and the time window shows the total hours of use.
...
     1/4 Mile Track
     ...
     Lap track will move in a counterclockwise direction.
...
18
the Start key. If the Stop button is pressed twice during a workout, the program will end and the
...
needs. Some of the information asked for is necessary to ensure the readouts are correct. You will be     19
     asked for your Age and Weight. Entering your Age is necessary during the Heart Rate programs to
     ...
     Weight entered will be saved as the new default settings. If you enter your Age and Weight the first



20
time you use the fitness bike, you will not have to enter it every time you work out unless either your
...
8.   When the program ends you may press Start to begin the same program again or Stop to exit the program or
     ...
     instructions in the Message Center                                                                                             21
     Preset Programs
     The Recumbent Bike has five different programs that have been designed for a variety of workouts.
...
maximum effort that is sustained for 25% of workout duration. This will help build
strength and muscular endurance in the lower body and glutes. A brief cool down
follows.
...
6.   Now you are finished editing the settings and can begin your workout by pressing the Start key. You can also go back
     and modify your settings by pressing the Enter key to go back one level, or screen.                                    23

...
| N T E RVA L INTERVAL Work Profile
...
and modify your settings by pressing the Enter key to go back one level, or screen. 23
     ...
     7.   If you want to increase or decrease the workload at any time during the program press the Up or Down key. This
          will change the resistance settings of the entire profile, although the profile picture on the screen will not change. The
          reason for this is so that you can see the entire profile at all times. If the profile picture is changed, it also would be
          distorted and not a true representation of the actual profile. When you make a change to the resistance, the Message
     ...
     1.   Select the User program (U1 or U2) then press Enter. If you have already saved a program to either U1 or U2, it
          ...
          Center, the letter “A” will be blinking. Use the Level Up/Down buttons to select the appropriate first letter of your
          name (pressing the Level Up/Down button will switch to the letter “B”; pressing the Down button will switch to letter
...
7. \f you want to increase or decrease the workload at any time during the program press the Up or Down key. This
will change the resistance settings of the entire profile, although the profile picture on the screen will not change. The
reason for this is so that you can see the entire profile at all times. If the profile picture is changed, tt also would be
distorted and not a true representation of the actual profile. VWWhen you make a change to the resistance, the Message
Center will show the current column and program maximum levels of work.
...
There are two customizable User programs that allow you to build and save your own workout. The
two programs, User | and User 2, operate exactly the same way so there Is no reason to describe
them separately. You can build your own custom program by following the instructions below or you
can save any other preset program you complete as a custom program. Both programs allow you to
further personalize it by adding your name.

|. Select the User program (UI or U2) then press Enter. If you have already saved a program to either UI or U2, it
will be displayed and you are ready to begin. If not, you will have the option of inputing a username. In the Message
Center, the letter “A” will be blinking. Use the Level Up/Down buttons to select the appropriate first letter of your
name (pressing the Level Up/Down button will switch to the letter '‘B’’; pressing the Down button will switch to letter
“Z’). Press Enter when the desired letter is displayed. Repeat this process until all of the characters of your name have
been programmed (maximum 7 characters).VVhen finished press Stop.
...
3.   The Message Center will ask you to enter your Age. You may enter your age, using the Level Up/Down keys, then
     press the Enter key to accept the new value and proceed on to the next screen.
4.   You are now asked to enter your Weight. You may adjust the weight value using the Level Up/Down keys or the
     numeric key pad, then press Enter to continue.
5.   Next is Time. You may adjust the time and press Enter to continue.
6.   Now you are asked to adjust the Max Resistance Level of the program, press Enter when resistance has been selected.
7.   Now the first column will be blinking and you are asked to adjust the resistance level for the first segment (SEGMENT
...
8.   The next segment will show the same workload resistance level as the previously adjusted segment. Repeat the same
     process as the last segment then press Enter. Continue this process until all twenty segments have been set.
9.   The Message Center will then tell you to press Enter to save the program. After saving the program the Message
     Center says “program saved” then will give you the option to start or modify the program. Pressing Stop will exit to the
     start up screen.
...
     Using the Spirit F IT App
     ...
     5. When you workout is finished, the data is automatically saved and you will be prompted to sync your data with each
         available fitness cloud site. Please note you will have to download the applicable compatible fitness App, such as iHealth,
...
30   properly.
Erratic Operation
Caution! Do not use this Recumbent Bike for Heart Rate programs unless a steady, solid Actual Heart
...
3.   Functions (Press Enter to access settings and Up arrow to scroll)
     ...
     VI. Motor Test
     VII. Safety
4.   Security (Allows the keypad to be locked to prevent unauthorized use)                                                       33

...
4. Security (Allows the keypad to be locked to prevent unauthorized use)
     ...
     Recumbent Bike Warranty - Effective February 4, 2019
     Spirit Fitness warrants all its Recumbent Bike parts for a period of time listed below from the date of retail sale, as determined by sale receipt, or in
...
12. Spirit Fitness’ obligation under this warranty is limited to repairing or replacing, at Spirit Fitness’ option, the product through one of our authorized
...
13. The owner is responsible for adequate packaging upon return to Spirit Fitness. Spirit Fitness is not responsible for damages in shipping. Make all freight

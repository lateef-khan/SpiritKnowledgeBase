...
PRODUCT REGISTRATION
    ...
    You can also go to www.soletreadmills.com under the support tab to register online.
                                                                              ...
                                                                              F80_F83_F85_20111222

                                               1                        F80 / F83 / F85 TREADMILL
...
6     HARDWARE STEP 6
                  ...
                  #134. M5 x 10mm                     #122. 3.5 x 12 mm
             Phillips Head Screw (8 pcs)           Sheet Metal Screws (4 pcs)




F80 / F83 / F85 TREADMILL                    6
7   HARDWARE STEP 7
...
8   HARDWARE STEP 8
    ...
    ASSEMBLY TOOLS
      ...
      #131. Combination M5 Allen Wrench           #30. Lubricant
...
6     ASSEMBLY STEP 6                                                                          HARDWARE STEP 6
        ...
        1.   Attach the Left (63 & 65) and Right (66 & 67)Side Caps to the top of the Up-
             right Tubes (4 & 5) with eight Phillips Head Screws (134) and four Sheet Metal
             Screws (122). Tighten with the Combination M5 Allen Wrench & Phillips Head
             Screw Driver (131). See illustration to determine the specific screw locations.




F80 / F83 / F85 TREADMILL                             10
...
F80 / F83 / F85 TREADMILL                              12
OPERATION OF YOUR TREADMILL
 GETTING FAMILIAR WITH THE CONTROL PANEL


 F80 CONSOLE                                            COOLING FANS
    ...
    DISPLAY BUTTON                                      DOT MATRIX DISPLAY
      ...
      AUDIO IN JACK
       ...
       SMARTPHONE)
                                                        ...
                                                        COOLING FANS
 F83 / 85 CONSOLE                                       SPEED QUICK KEYS
  INCLINE QUICK KEYS
    ...
    DISPLAY BUTTON                                      DOT MATRIX DISPLAY
      ...
      AUDIO IN JACK
       ...
       SMARTPHONE)
                                  ...
                                  13       F80 / F83 / F85 TREADMILL
GETTING STARTED
   F80 / F83 / F85 CONSOLES
...
INCLINE FEATURE
 ...
  The message window display will indicate incline position as adjustments are made.
                                            ...
                                            15                           F80 / F83 / F85 TREADMILL
DOT MATRIX CENTER DISPLAY
   Twenty columns of dots (8 high) (F80) or 24 columns of dots
   (10 high) (F83/85) indicate each segment of a workout. The
   dots are only to show an approximate level (speed/incline)
   of effort. They do not necessarily indicate a specific value -
...
then press Enter.
                                          ...
                                          17                          F80 / F83 / F85 TREADMILL
PROGRAMMABLE FEATURES
   The F80 / F83 / F85 have ten built-in programs: one Manual program (PO), five preset profiles,
   ...
   PRESET PROGRAMS
     Hill
      ...
      steadily increase and then decrease during the program.
              F80 SPEED                 F80 INCLINE                     F83/85 SPEED                F83/85 INCLINE
...
F80 / F83 / F85 TREADMILL                             18
SELECTING A PROGRAM
1. Press the Up5/6Down keys to view the programs on the screen then press the Enter key
...
2. If enter was pressed, the Message window will display Age. You may use any of the Up/
   Down or the Fast/Slow keys to adjust your age. After adjusting press the Enter key. (Note:
   You may press start at any time during the programming to start the program with the informa-
   tion you’ve already input.)
3. The Message window will now be displaying a value, which is your Body Weight. Entering
   the correct body weight will affect the calorie count. Use the Up/Down keys or the Fast/
   Slow to adjust, then press enter.
...
4. The Time window will now be displaying a value, which is total workout time desired. Use
   ...
   the Enter key.
5. The Speed window will display the preset top speed of the selected program. Use the Up/
   Down or the Fast/Slow keys to adjust, and then press enter. Each program has various
   speed changes throughout; this allows you to limit the highest speed the program will reach
   at it’s peak.
...
   USER PROGRAMS
   ...
   2. Next the Message window is flashing Age. Use the Adjust
      Up/Down keys to adjust. Press Enter. This is a must to
...
   HEART RATE PROGRAMMING
   ...
   Heart Rate Transmitter section for
   ...
   2. The Message window will be blinking, showing the default user’s bodyweight for this pro-
      gram. You may adjust it and press enter if you want or just press enter to accept the default
      value.

...
Service Manual
-------------------------------------------Table of Contents----------------------------
                       1. ST128 Treadmill Outlines
                       2. Electronic Parts
                           2.1 Upper Controllers
                           2.2 Lower Controller and driver
                       3. Electrical Configuration
                       4. ST128 Treadmill Operation
                       5. ST128 Treadmill Unit Block Diagrams
                       6. ST128 Treadmill Basic Connections and Wiring
                       ...
                       8. ST128 Treadmill Error Messages / Troubleshooting for Electronic Issues
...
Function Button Locations Function Button Locations
             ...
             Speaker             Incline        Incline   Program      Program   Enter    Speed        Speed
                                 Up             Down      Up           Down               Slow         Fast              Speaker




        Incline quick keys                                                                                           Speed quick keys
        1, 3, 5, 7, 9, 12, 15                                                                                        2, 3, 4, 5, 7, 9, 12
                                           ...
                                           Display key                                                   Fan key
                                                                                                                ...
                                                                                                                Hand Pulse
                          Hand Pulse                           Start              Stop
                                               Audio in        Key                Key     Earphone out

                                Incline adjustment                                             Speed adjustment
                                Rapid Key handrail                      Safety                 Rapid Key handrail
                                                                         Key
...
6.1 Display Board wire Connections
                    ...
                    with FAN        Handrail Pulse
                                    ...
                                    Main IC
                                                                                        Connection the
           Bluetooth Module                                                             USB wire




                        Connection with
                        Quick speed key            Connection with
                                                   6-pin Main control wire       Connection with                 Connection the
                        board                                                                                    amplifier wire
                                                                                 Wireless heart
                                                                                 receiver
                                                             Connection with
                                 Connection with             KEY BOARD
 Connection with                 Safety key                                             Connection the
 Quick speed                                                                            Bluetooth speaker wire
 handrail buttons
...
7.1 Important Safety Instructions
   ...
   - To reduce the risk of burns, fire, electric shock, or injury to persons, install the treadmill on a flat level surface with access to a 230-volt, 10-amp
     (110-volt, 15-amp) grounded outlet with only the treadmill plugged into the circuit.
 ...
 7.3 Important Grounding Instructions
  - This product must be grounded. If the treadmill should malfunction or breakdown, grounding provides a path of least resistance for electric current,
    ...
    - DANGER – Improper connection of the equipment-grounding conductor can result in a risk of electric shock. Check with a qualified
      ...
      it will not fit the outlet; have a proper outlet installed by a qualified electrician. This product is for use on a nominal 230-volt circuit, and has a
      ...
      grounded outlet, (shown below) can be installed by a qualified electrician. The green colored rigid earplug, or the like, extending from the adapter,
      ...
      must be held in place by a metal screw.
                                                                                 ...
                                                                                 34                                                                 Service Manual
  8.ST128 Treadmill Error Messages /
...
Test Procedure：
  ...
  8.   If there is voltage at the output connector to the console then check the voltage at the console. If there is no
       ...
       or bad connection at the inwire connectors.
...
almost it is bad on a main control wire, but also possible bad at console board or lower controller.
Configuration:
...
12-1 Lower Controller Replacement
     ...
     2.   Disconnect all lower controller wirings, Use Phillips head Screwdriver to remove, replace with new lower controller
          and reconnect all wirings.
                                                          ...
                                                          69                                                  Service Manual
12-2 Console Replacement
     1.   Use the M5 L Allen Wrench to loosen the four Sheet Metal Screws then remove the console mast cover.




     2.   Use the M6 L Allen wrench to remove 4 button head socket bolts from the console support

...
Fitness at 1-866-780-SOLE (7653). If you have a technical problem with your new treadmill contact
...
SAFETY TETHER CORD
   A safety tether cord is provided with this unit. (See Step 6 of Assembly Guide, #63) It is a simple
   ...
   far back on the tread-belt. Pulling this safety tether cord will stop tread-belt movement.
     To Use:
     1. Place the magnet into position on the red portion of the console control head. Your tread-
...
3   HARDWARE STEP 3
          ...
          #85. 3/8” x 2T            #100. 3/8” x 1”            #101. 3/8” x 3/4”
       Split Washer (8 pcs)         Hex Head Bolt         Hex Head Socket Bolt (4 pcs)
                                       (4 pcs)




               #102. 3/8” x 2”                         #131. 3/8” x 23 x 1.5T
            Hex Head Bolt (4 pcs)                      Curved Washer (4 pcs)
...
7     HARDWARE STEP 7
               ...
               #92. 5 x 16mm                  #87. 5 x 16mm              #84. M5 Speed
           Sheet Metal Screw (6 pcs)    Self-Tapping Screw (2 pcs)       Nut Clip (4 pcs)
...
8     HARDWARE STEP 8
                ...
                #89. 3.5 x 12mm                               #126. M5 x 10mm
            Sheet Metal Screw (4 pcs)                    Phillips Head Screw (8 pcs)
     ...
     ASSEMBLY TOOLS
         ...
         #104. Combination M5 Allen Wrench                 #108. 12/14mm Wrench
            & Phillips Head Screw Driver




                #105. M6 Allen Wrench                            #63. Safety Key
...
2   ASSEMBLY STEP 2
     ...
     1.   Remove the four Phillips Head Screws (129) of the motor cover (43) with the
          M5 Allen Wrench & Phillips Head Screw Driver (104) and set it aside.
     2.   Connect the Computer Cable (32) of the main frame with the Computer
          Cable (33) at the bottom of the right upright tube (4).
...
3     ASSEMBLY STEP 3
            ...
            101 131                                                        85                Hex Head Bolt (4 pcs)
                                                                                             #131. 3/8” x 23 x 1.5T
                                                                                             Curved Washer (4 pcs)
                             85
            100
      ...
      102
                 85
       1.   Attach the Left and Right
            upright tubes (5 & 4) to the                           4
            Main Frame (1). Be careful
            installing the right upright
            so that the wire harness                      5
            doesn’t get pinched or cut.
            Only hand-tighten all the
            bolts in this step. The bolts
            will need to be completely
            tightened after the console
            is installed. Insert two Split
            washers (85) and two Hex Head Bolts (102) into the bottom set of holes in
            each tube and two Split washers (85) and two Hex Head bolts (100) into the
            upper set of holes in each tube. Place two Curved washers (131) onto two
            Hex Head bolts (101) and insert in the two front holes of each tube. Partially
            tighten with the 12/14mm wrench (108).
...
5   ASSEMBLY STEP 5                          36
     ...
     1.   Carefully attach the Console Assembly (36) to the top of the upright tubes (5
          & 4) with the four Button Head Socket bolts (125) and four Split Washers (85).
          Make sure the cables don’t get pinched between the joint or by the bolts.
          Tighten the bolts completely using the M6 Allen Wrench (105).




6   ASSEMBLY STEP 6                                                                        HARDWARE STEP 6
                                                                                           #99. 5/16” x 3/4” Button
                     ...
                     104
                       ...
                       5
                                                  3 99
                                     99
     1.   Install the Handrail Support (3)
          between the upright tubes (5
          & 4) with the four Button Head
          Socket bolts (99). Tighten the
          bolts completely using the
          Combination M5 Allen Wrench                             63
                                                                  63
          and Phillips Head Screw Driver                                 48
          (104).
     2.   Place the Beverage Holder (48)
          on the Handrail Support (3).
...
7     ASSEMBLY STEP 7
      ...
      40                                                                                         92
       ...
       1.   Completely tighten the bolts that attach the console mast tubes (5 & 4) to
            the main frame (1) using the 12/14mm wrench (108).
       2.   Attach the Motor Cover (43) with four Phillips Head Screws (129). Tighten
            with the Combination M5 Allen Wrench & Phillips Head Screw Driver (104).
       3.   Install the four speed Nuts (84) on the motor cover (43).
       4.   Attach the Console mast covers (40 & 41) with the six Sheet Metal Screws
            (92) and two Self Tapping Screws (87). Tighten with the Combination M5
...
8     ASSEMBLY STEP 8
       ...
       1.   Install the Left Handbar covers (117 & 118) and Right Handlebar covers (119
            & 120) on the top of the upright tubes (5 & 4) with the eight Phillips Head
            Screws (126) and four Sheet Metal Screws (89) using the Combination M5
            Allen Wrench & Phillips Head Screw Driver (104).
...
OPERATION OF YOUR TREADMILL
   ...
   TT8 CONSOLE                                                                         COOLING FANS
    ...
    INCLINE QUICK KEYS
      ...
      DISPLAY BUTTON                                                                   DOT MATRIX DISPLAY
...
GETTING STARTED
   ...
   installed, as the treadmill will not power on without it (see assembly step 6 for reference).
...
QUICK-START OPERATION
 ...
 2. Press the Start key to begin belt movement then adjust to the desired speed using the Fast
    / Slow keys. You may also use the Quick speed keys 2, 4, 6, 8, 10 or 12 to adjust the speed.
...
INCLINE FEATURE
   ...
    Press and hold the Up5/6Down keys to achieve desired level of incline. You may also
      choose a more rapid increase / decrease by selecting the desired Quick Incline key, 1, 3, 6, 9,
      12, 15, on left hand side of console (incline).
    The message window display will indicate incline position as adjustments are made.
...
DOT MATRIX CENTER DISPLAY
 ...
 divided into 1/20th of the total time of the program. The
 Dot Matrix window will show either speed or incline. When
 Speed is lit the Dot matrix displays the Speed profile and
 when Incline is lit the Dot Matrix displays the Incline profile.

 You may change the Dot Matrix profile view by pressing the
 Enter button. After scrolling through the two profiles the Dot matrix will automatically scroll
 through the two displays showing each one for four seconds. The icon associated with each
 profile will light while that view is displayed. Pressing the Enter button a third time will
 alternate the display view between the Speed and Incline profiles.
 1/4 MILE TRACK
...
PROGRAMMABLE FEATURES
 ...
 PRESET PROGRAMS
   ...
   increase in speed to a high level and forces you to sustain it. This is designed to strengthen and tone your legs
   ...
   in heart rate recovery from intense activities.
           TT8 SPEED                   TT8 INCLINE
                                                     ...
                                                     17                                          TT8 TREADMILL
     Fit Test Program
     The fit test program is designed to determine your estimated VO2 max or how well your body utilizes oxy-
     gen. The test follows a progression in both speed and elevation and lasts a maximum of 11 minutes. If your
     actual heart rate reaches 85% of projected maximum before the end of the test, the program will end and
     your score will be based on the stage you ended at. The higher your estimated VO2, the more fit you are.
     ...
     1.   When the Fit Test button is pressed, the Message Window         3.3      2:45      5.0mph    2%      41.3
          will display GERKIN PROTOCOL PRESS ENTER TO BEGIN               3.4      3:00      5.0mph    2%      43.4
     2.   The Message Window will now be showing a value,                 4.1      3:15      5.0mph    4%      44.1
          indicating your Age. Use the Up/Down keys to adjust,            4.2      3:30      5.0mph    4%      45.15
          and then press Enter.                                           4.3      3:45      5.0mph    4%      46.2
     3.   The Message Window will now be showing a value,                 4.4      4:00      5.0mph    4%      46.5
          indicating your Body Weight. Use the Up/Down keys to
                                                                          5.1      4:15      5.5mph    4%      48.6
          adjust, and then press Enter.
                                                                          5.2      4:30      5.5mph    4%       50
     4.   The Message Window will display PRESS START TO BEGIN
          OR ENTER TO MODIFY                                              5.3      4:45      5.5mph    4%      51.4
     5.   The test starts with a three minute warm-up. Speed              5.4      5:00      5.5mph    4%      52.8
          will be set at 3 mph, grade at 0%. The Message Window           6.1      5:15      5.5mph    6%      53.9
          will display 3 MINUTE WARM-UP And alternate every 5             6.2      5:30      5.5mph    6%      54.9
          seconds with actual HR888 & Target Heart Rate. The time         6.3      5:45      5.5mph    6%       56
          window will start at three minutes and count down to            6.4      6:00      5.5mph    6%       57
          zero. All other data windows will accrue.
                                                                          7.1      6:15      6.0mph    6%      57.7
     6.   The speed and incline will follow the changes shown in
                                                                          7.2      6:30      6.0mph    6%      58.8
          the chart to the right.
     7.   When the user reaches the target the test will continue         7.3      6:45      6.0mph    6%      60.2
          for 15 seconds. A cool down period will start. The incline      7.4      7:00      6.0mph    6%      61.2
          will be set to 0 percent. The speed will be 3.0 MPH.            8.1      7:15      6.0mph    8%      62.3
          The cool down time will be based on the total time to           8.2      7:30      6.0mph    8%      63.3
          complete the test. If the test took 5 min. or less, then the    8.3      7:45      6.0mph    8%       64
          cool down is 1 minute. If the test took between 5 min. to       8.4      8:00      6.0mph    8%       65
          12 min., the cool down will be 3 minutes. The Message
                                                                          9.1      8:15      6.5mph    8%      66.5
          Window will display for 5 seconds: 1 (or 3 min) MIN COOL
                                                                          9.2      8:30      6.5mph    8%      68.2
          DOWN and alternate every 5 seconds with YOUR SCORE.
          The time window will start at 1 (or 3 min) minute and           9.3      8:45      6.5mph    8%       69
          count down to zero.                                             9.4      9:00      6.5mph    8%      70.7
     8.   The score is taken from the table based on the final stage     10.1      9:15      6.5mph   10%      72.1
          completed. After the cool down the Message Window              10.2      9:30      6.5mph   10%      73.1
          will display TEST OVER PRESS STOP TO END OR ENTER              10.3      9:45      6.5mph   10%      73.8
          TO SEE SCORE. If no button is pressed for 20 seconds,          10.4     10:00      6.5mph   10%      74.9
          the screen goes to the idle mode. If Enter is pressed, the
                                                                         11.1     10:15      7.0mph   10%      76.3
          score will be displayed for 10 seconds then go to TEST
...
VO2max Chart for females and de-conditioned males
 ...
 very poor    <28        <26      <22          <20      <18      <17
                                         ...
                                         19                             TT8 TREADMILL
SELECTING A PROGRAM
1. Press the desired program from the 10 available program keys. Then press the Enter key to
   begin customizing the program with your personal data, or just press the Start key to begin
   the program with the default settings.




2. The Message window will now be showing a value, indicating your Age. Entering your cor-
   rect age affects the heart rate Bar Graph Display and the Heart Rate programs. Use the Up/
   Down keys to adjust, and then press Enter. Your age determines the maximum heart rate
   you may achieve. Since the Bar Graph Display and the Heart Rate features are based on
   a percentage of your maximum heart rate, it is important to enter the correct age for these
   features to work properly.
3. The Message window will now be showing a value, indicating your Body Weight. Entering
   the correct body weight will affect the Calorie count. Use the Up/Down keys to adjust, and
   then press enter. * A note about the Calorie display: No exercise machine can give you an exact calorie count
    because there are too many factors which determine exact calorie burn for a particular person. Even if someone is
    the exact same body weight, age and height, their calorie burn may be very different than yours. The Calorie display
    is to be used as a reference only to monitor improvement from workout to workout.
4. After selecting a program and pressing Enter to set your personal data, the Time window
   will show the default value of 20 minutes. Use the Up/Down keys to adjust, then press enter.
5. The Message window will now be blinking, showing the preset top speed of the selected
...
TT8 TREADMILL                                            20
CUSTOM PROGRAM
1. Select Custom on the Program keypad, then press Enter.
   Note that the dot matrix display portion will light a single row
   of dots at the bottom (Unless there is a previously saved pro-
   gram). If there is a program stored under the
   button that is pressed, it will be retrieved. If not, you have the
   option of programming in your first name. The message
   window will display and flash the letter ”A” . To change it, press the arrow 5 key, then “B” will
   be displayed; if the arrow 6 key is pressed, the letter “Z” will be displayed. After selecting the
   appropriate letter, press enter. The letter “A” will again be displayed and blinking. Repeat the
...
2. The Time window will be flashing. Use the Up/Down
   adjustment keys to set the program for the desired time. Press the Enter key. This is a must
   to continue even if the time is not adjusted.
...
4. The Message window will now show an Age value. Adjust the age with the Up/Down keys
   and press Enter.
5. The first speed setting column (segment) will now be blinking. Using the Fast/Slow keys,
   adjust the speed to your desired effort level for the first segment then press Enter. The
   ...
   Note: While in a User program, if you manually change the speed, all segment speeds from there on will also
   change.
...
HEART RATE PROGRAMS
   ...
   With all SOLE treadmills you may use the heart rate monitor feature without using the Heart
   Rate program. This function can be used during manual mode or during any of the nine
   different programs.
...
the proper level for that day.
                                            ...
                                            23                                       TT8 TREADMILL
USING HEART RATE TRANSMITTER (NOT INCLUDED)
   ...
   ERRATIC OPERATION
   Caution! Do not use this treadmill for a Heart Rate Program unless a steady, solid Actual Heart
...
CAUTION!
You may use either the pulse grip sensors or a wireless heart rate chest strap (sold separately)
for either heart rate program. You must receive a strong/steady value in the heart rate window
...
2. The Message window will be blinking, showing the default user’s bodyweight for this
   program. You may adjust it and press enter if you want or just press enter to accept the
   default value.
3. The Message window will now be blinking showing user’s age. Adjust and press enter or
   press enter to accept the default value. Adjusting Age will change the Target HR value.
4. The Time window will now be blinking. Adjust the time and press enter.
5. Now you are asked to adjust the HR1 or HR2 value. The default is 60% (HR1); (220 - age x
   .60); or 80% (HR2); (220 – age x .80). You may select a higher or lower number also. Adjust
   the number by pressing the Speed Up or Down keys and press Enter to continue.
6. Now you are finished editing the settings and can begin your workout by pressing the Start
   ...
   level, or screen.
7. If you want to increase or decrease the speed at any time during the program press the Fast
   or Slow keys.
...
The program will now control the treadmill Incline to steadily increase your heart rate to the
target value. This process is automatic and could take upwards of five minutes, depending on
how far your HR needs to go and what kind of physical shape you are in. People who are more
fit will take longer to reach the target. You can make manual adjustments to the speed
throughout the program. The message window will give you prompts on reducing or increasing
speed, depending on where your heart rate is in relation to the selected heart rate %.
...
GENERAL MAINTENANCE
   ...
   Adjustment must be made from the rear roller with the 6 mm Allen wrench (105) provided in
...
TREAD-BELT TRACKING ADJUSTMENT
 ...
 A 6 mm Allen wrench (105) is provided for this
 ...
 DECK MAINTENANCE
 The deck has a wax coating that generally withstands up to 20,000 miles of use on the original
 side. If either of these two scenarios continues to occur: belt stops very quickly after the safety
 key is dislodged or the 15 amp fuse continues to blow, you may have an issue with the wax be-
 tween the belt and the deck. Follow this procedure in order:
 ...
 3. Call your service provider to have the deck flipped if it is on the original side. The other side
     will have a fresh wax coating.
...
SERVICE CHECKLIST - DIAGNOSIS GUIDE
   ...
   treadmill’s warranty.
     ...
     Display does not light                         1.   Safety key not in position.
                                                    ...
                                                    3.   Plug is disconnected. Make sure plug is firmly
                                                         pushed into an AC wall outlet.
                                                    4.   Facility or Home circuit breaker may be tripped.
     ...
     walked/run on                                  off-center to the side opposite from the belt
     ...
     pressing start                                      thedisplay shows “LS”, run calibration.
     ...
     approximately 7 mph but shows                  operate. Low AC voltage to treadmill. Do not use an
     ...
     higher speed on display                        should be as short as possible and heavy duty 16
                                                    gauge minimum. Low facility or household voltage.
                                                    Contact an electrician or your SOLE dealer. A minimum
                                                    of 110 volt AC current is required.


     Tread-belt stops quickly/suddenly              High belt/deck friction. See General Maintenance
     when tether cord is pulled                     section.
     ...
     House circuit breaker trips, but not           Need to replace the facility or home breaker with a
     the treadmill circuit breaker                  “High In-rush current” type breaker (see page 3 for
                                                    details)
...
2. Press and hold down the Start and Fast (speed up) buttons and replace the safety key.
   Continue to hold the Start and Fast key until the window displays “Factory settings”, then
   press the enter key.
...
2. You can now scroll through the menu using the Fast/Slow keys. Use the Stop key to return to
   previous menu selection. The menu selections are:
   A. Key Test
   B. Display Test
   C. Security - Allows you to lock the keypad so no unauthorized use of the machine is allowed. When the child
   ...
   D. Functions - Press Enter to access settings, use Fast/Slow keys to scroll
      I. Sleep Mode - Turn on to have the console power down automatically after 30 minutes of inactivity
      II. Pause Mode - Turned on to allow 5 minutes of pause, turn off to have console pause indefinitely)
      III. Maintenance - Odometer readings
      IV. Units - Choose from English or Metric display readings
      V. Key Tone – Turns beep sound off or on when a button is pressed
   E. Exit
...
ranties will be administered by SOLE directly to a consumer. The warranty period applies to the following components:
      ...
      Drive Motor                                5 Years                     Drive Motor                                5 Years
      Parts                                      5 Years                     Parts                                      3 Years
      Labor                                      2 Years                     Labor                                      1 Year

NORMAL RESPONSIBILITIES OF THE CONSUMER
This warranty applies only to products in ordinary household use or in a non-dues paying, light commercial facility with 5 hours treadmill use or less
...
8.   Product used more than 5 hrs per day and/or in a dues paying facility

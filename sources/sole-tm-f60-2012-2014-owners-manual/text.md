...
TABLE OF CONTENTS
 ...
 Using Heart Rate Transmitter                                                        21
...
IMPORTANT ELECTRICAL INSTRUCTIONS
 ...
 the house circuit breaker (even though it is the proper current rating) but the fuse on the
 treadmill itself does not trip, you will need to replace the home breaker with a high inrush type.
 This is not a warranty defect. This is a condition we as a manufacture have no ability to control.
 This part is available through most electrical supply stores. Examples:
...
Motor Cover & Clean & Inspect Deck        Lubricate Deck      Inspect Belt Tracking
 ...
 (Every Other (Every Other Month)         or sooner if dry)        necessary
    Month)
                                              ...
                                              5                                       F60 TREADMILL
F60 ASSEMBLY PACK CHECKLIST

2   HARDWARE STEP 2

        #76. Ø5/16” x Ø18mm x 1.5T             #97. 5/16” x 1/2”
             Flat Washer (8 pcs)             Hex Head Bolt (8 pcs)
...
ASSEMBLY TOOLS
  ...
  #98. Combination M5 Allen Wrench
     & Phillips Head Screw Driver    #99. M6 L Allen Wrench
...
2   ASSEMBLY STEP 2
    ...
    97                      76
     ...
     1.        Connect Computer Cable (Upper/Lower) (44) with Computer Cable (Middle)
               (43) then insert Right and Left Uprights (4) and (5) into the Frame Base (2)
               and use the Wrench (100) to tighten eight Hex Head Bolts (97) and eight Flat
               Washers (76).
...
3       ASSEMBLY STEP 3                                       34    95
         ...
         1.   Install Frame Base Cover (L-33 & R-34), on the Frame Base (2) and secure with
              six Phillips Head Screws (95) by using Combination M5 Allen Wrench &
              Phillips Head Screw Driver (98).
...
5   ASSEMBLY STEP 5                                                                     HARDWARE STEP 5
    ...
    1.   Insert Console Assembly (19) into Uprights (R-4 & L-5) and secure with four
         Button Head Socket Bolts (94) with four Split Washers (93) by using M6 Allen
         Wrench (99).
...
6   ASSEMBLY STEP 6
                           ...
                           96                 9           96
                       5                                4
    1.   Install Handrail Support (9) between Uprights (R-4 & L-5) and use
         Combination M5 Allen Wrench & Phillips Head Screw Driver (98) to tighten
         four Button Head Socket Bolts (96).
...
7   ASSEMBLY STEP 7
     ...
     19-3
      ...
      1.   Put left and right Drink Bottle Holders (19-3) and (19-4) in their places on the
           Console Assembly (19). Press in until they snap in place.
...
QUICK-START OPERATION
 ...
 2. Press the Start key to begin belt movement then adjust to the desired speed using the
    Speed 5/6 keys on the console. You may also use the Quick speed keys 1, 2, 4, 6, 8, or 10
    to adjust the speed.
 3. To slow tread-belt press and hold the Speed 6 key on the console to the desired speed. You
    may also press the Quick speed adjust keys, 1 through 10.
...
INCLINE FEATURE
 ...
  Press and hold the Incline 5/6 keys on the console to achieve desired level of
    incline. You may also choose a more rapid increase / decrease by selecting desired key,
    2, 4, 6, 8, 10, or 12 on the left hand side of console.
...
DOT MATRIX CENTER DISPLAY
 ...
 workout. When the word “Speed” is lit above the dot matrix it
 indicates that the Speed profile is being displayed and when
 the word “Incline” is lit above the dot matrix it indicates the
 Incline profile is being displayed.
...
PROGRAMMABLE FEATURES
 The F60 has ten built-in programs: one Manual program, five preset profiles, two user defined
 ...
 F60 TREADMILL                                      16
SELECTING A PROGRAM
1. Press the Speed 5/6 keys to view the programs on the screen then press the Enter key
...
2. If Enter was pressed, the Message Window will display Age. You may use any of the 5/6
...
3. The Message Window will now be displaying a value, which is your body weight. Entering
   the correct body weight will affect the calorie count. Use any of the 5/6 keys to adjust,
   then press Enter.
...
4. The Time Window and Message Window will now be displaying a value, which is total
   workout time desired. Use any of the 5/6 keys to adjust, and then press Enter. After
   adjusting, press the Enter key.
5. The Message Window will display the preset max speed of the selected program. Use any
   of the 5/6 keys to adjust, and then press Enter. Each program has various speed changes
...
6. Press Start to begin the program. The program will begin with a 3 minute warm-up. If you
   want to bypass this and go directly to the beginning of the program, press Start again.
                                            ...
                                            17                                      F60 TREADMILL
USER PROGRAMS
1. Select User 1 or User 2 via the Speed 5/6 keys then press
   ...
   you have the option of programming in your first name. The
   Message Window will display and flash the letter ”A” . To
   change it, press the any 5 key, then “B” will be displayed; if
   the any 6 key is pressed, the letter “Z” will be displayed.
   After selecting the appropriate letter, press Enter. The letter
   “A” will again be displayed and blinking. Repeat the
   procedure until all letters of your first name are programmed
   (7 characters maximum). When your name is displayed, press
   Stop and it will be stored under either User 1 or User 2.
2. Next the Message Window is flashing Age. Use the Incline
   5/6 keys to adjust. Press Enter. This is a must to continue even if age is not adjusted.
...
1. Select HR1 or HR2 via the Speed 5/6keys then press Enter.
...
4. Now you are asked to adjust the HR1 or HR2 value. The default is 60% (HR1); (220 - age x
   ...
   the number by pressing the Speed5/6 keys and press Enter to
   continue.
...
GENERAL MAINTENANCE
 ...
 Adjustment must be made from the rear roller with the M6 L Allen wrench (99) provided in the
...
TREAD-BELT TRACKING ADJUSTMENT
 ...
 A 6 mm Allen wrench (99) is provided for this
...
SERVICE CHECKLIST - DIAGNOSIS GUIDE
 ...
 treadmill’s warranty.
   ...
   pressing Start                                      the display shows “LS”, run calibration.
   ...
   the treadmill fuse                             In-rush current” type breaker (see page 3 for details)
...
3. You will now be able to set the display to show Metric or English settings (Miles vs.
   Kilometers). To do this, press the 5/6 key to show which you want, then press Enter.
4. Make sure the wheel size diameter is 1.84 then press Enter.
...
1. Press and hold the Start, Stop and Enter key at the same time, until the display shows
   ...
   Press the Enter key.
2. You can now scroll through the menu using the Speed 5/6 keys. Use the Stop key to
...
3.   If you have any questions about your new product or questions about the warranty contact SOLE Fitness at 1-866-780-SOLE (7653). If you have a
     technical problem with your new treadmill contact SOLE technical service at 866-MYSOLE1 (697-6531). If purchased at Sears: 1-800-469-4663.

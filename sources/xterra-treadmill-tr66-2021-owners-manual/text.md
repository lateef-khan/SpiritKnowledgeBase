<!-- Source: TR66_OM_20210413.pdf. Text is pdftotext -layout; pages a 300 dpi render knows more about than the text layer are appended below under '=== OCR SUPPLEMENT, PDF PAGE n ===' headers. -->
...
Product Registration
    ...
    XTERRA Fitness. You can also go to www.xterrafitness.com/warranty to register on-
    line.
...
any other high humidity environment. The temperature specification is 40 degrees C, and humidity is 95%, non-condensing (no
...
also cause tripping are fluorescent lights with electronic ballasts, coffee maker, space heater, hair drier. Optimally the treadmill
...
TR6.6 Assembly Pack Checklist
   Hardware Step 3
     ...
     #93. 5/16” x 15mm           #94. 5/16”                #132. M5
     Button Head Socket        Curved Washer            Speed Nut Clips
         Bolt (8 pcs)              (2 pcs)                  (4 pcs)
   ...
   Hardware Step 6
        ...
        #88. 5 x 16mm          #95. M5 x 10mm
        Tapping Screw         Phillips Head Screw
           (4 pcs)                    (2 pcs)
   ...
   Assembly Tools
         ...
         #96. Combination M5 Allen                    #97. M6 L Allen Wrench
...
5     Console Assembly                                                               Hardware Step 5
                                                                                      #148. Ø8mm x 1.5T
                                                                                      Split Washer (4 pcs)
                                                                                      #90. 3/8” x 3/4”
                                                                                      Button Head Socket
...
The TR6.6 Treadmill has six factory preset programs, three user defined programs, two heart
...
3. The Display will now be blinking a value, indicating your Body Weight (default is 150 lbs.). Entering the
   correct body weight will affect the calorie count. Use the 5/6 keys to adjust, then press Enter.
...
in elevation affect heart rate much more efficiently than changes in speed. Additionally, changes in incline keep
...
Fitness directly to a consumer. The warranty period applies to the following components:
     ...
     Lifetime         5 Years                 2 Years         1 Year
...
asscear =. as cnanamanauncenire pony oat a, = © i a ee
...
IMPORTANT: Do not operate the product if the power supply, its plug, TROG6_20210413
or its cord has been damaged. 4 TR6.6 Treadmill
...
DO NOT USE AN EXTENSION CORD UNLESS IT IS 14AWG OR BETTER, WITH ONLY ONE OUTLET ON
THE END. THE TREADMILL SHOULD BE THE ONLY APPLIANCE IN THE CIRCUIT IN WHICH IT IS CON-
NECTED. DO NOTATTEMPT TO DISABLE THE GROUNDED PLUG BY USING IMPROPERADAPTERS, OR
INANY WAY MODIFY THE CORD SET.ASERIOUS SHOCK OR FIRE HAZARD MAY RESULT ALONG WITH
COMPUTER MALFUNCTIONS.
...
(60% of maximum) 5 450 te
180 X .8 = 144 beats per minute E 140
(80% of maximum) a
3 130
So for a 40 year old the training zone would be g 10
108 to 144 beats per minute. * 10
100
90

If you enter your age during programming the 50 25 30 35 40 45 50 55 60 65

console will perform this calculation automatically. cccccsccs EEE mE Age of User

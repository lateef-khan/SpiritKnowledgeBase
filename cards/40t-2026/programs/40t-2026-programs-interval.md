...
- does interval training help endurance
keywords:
- interval program
- high intensity
- low intensity
...
intensity**. This program increases your endurance by depleting your oxygen level, followed by periods
of recovery to replenish oxygen. Your cardiovascular system gets programmed to use oxygen more
efficiently this way.

The manual prints a profile picture only. It gives **no numeric speed or grade values** for the
individual segments, so none are recorded here; the 7.0T manual does print a numeric chart for its own
Interval program.

---
id: s77-2016-e6-lower-controller-fault
title: 'E6: a component inside the lower controller has failed'
kind: troubleshooting
question: What does E6 mean on a Sole S77-2016 treadmill?
asked_as:
...
source:
  ...
  locator: 'Section 8.6 Error Message: E6, page 56'
...
**The lower controller row does not match the fault.** E6 is defined as a failed component inside the lower controller, but the troubleshooting table answers it with "Insert power wire of motor", which is the E4 remedy. The later ST728 manual for this machine family corrects the same row to "Replace Lower controller board", which is what the fault calls for.

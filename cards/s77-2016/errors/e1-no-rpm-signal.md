---
id: s77-2016-e1-no-rpm-signal
title: 'E1: the console received no speed signal'
kind: troubleshooting
question: What does E1 mean on a Sole S77-2016 treadmill?
asked_as:
...
source:
  ...
  locator: 'Section 8.2 Error Message: E1, pages 39-44'
...
The step-by-step sensor check is on the card `s77-2016-speed-sensor-check`.

---
id: s77-2016-e3-incline-vr
title: 'E3: the console cannot read the incline position sensor'
kind: troubleshooting
question: What does E3 mean on a Sole S77-2016 treadmill?
asked_as:
...
- s77-2016-incline-sensor-pinout
...
| Incline power cable and incline VR cable | Inspect the wire connections. Inspect whether the wires are broken or crimped. |
...
The nine-step measurement procedure that goes with this is on the card `s77-2016-incline-position-sensor-test`.

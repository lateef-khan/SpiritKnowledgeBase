...
title: 'Updating the console software from a blank USB stick in the port underneath the console'
kind: procedure
question: 'How do I update the console software on a Spirit jb950-2022 Johnny G Spirit Bike?'
asked_as:
...
source:
  ...
  locator: JB950-2022 printed p. 57 UPDATE SOFTWARE

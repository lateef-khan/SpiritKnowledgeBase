...
- does the bike wording void my warranty
keywords:
- fitness bike
- wrong wording
- copy paste
...
| Where | The phrase |
|---|---|
| Responsibilities item 2 | Proper use of the **fitness bike** in accordance with the instructions provided in this manual |
| Responsibilities item 3 | Proper installation in accordance with instructions provided with the **fitness bike** |
| Responsibilities item 5 | Expenses for making the **fitness bike** accessible for servicing, including any item that was not part of the **fitness bike** when it shipped |
| Responsibilities item 6 | Damages to the **fitness bike** finish during shipping, installation or following installation |
| Exclusions, item 1 as numbered | ...for **fitness bike** not requiring component replacement, or **fitness bike** not in ordinary household use |
...
The rules themselves are in `spirit-xe-warranty-exclusions-residential-setting-only` and `spirit-xe-warranty-consumer-responsibilities-electrical-duty`; the periods are in `xe195-2021-warranty-residential-periods-five-year-parts` and are unaffected.

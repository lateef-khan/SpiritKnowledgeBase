---
id: sc200-2019-maintenance-menu
title: Maintenance menu, also called Engineering Mode
kind: procedure
question: How do I get into the engineering or maintenance menu on a Sole sc200-2019?
asked_as:
- how do i get into engineering mode on a sole climber
- change my climber from miles to km
- reset the odometer on a sole sc200
- turn off the key beep on my climber
keywords:
- engineering mode
- maintenance menu
- odo reset
...
source:
  ...
  locator: Maintenance menu in console software, page 41

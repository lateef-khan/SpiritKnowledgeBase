...
- sole sc200 keeps tripping the circuit breaker
...
source:
  ...
  locator: Section 7-2 Important Electrical Instructions, page 30
  extracted_at: '2026-09-04'
---

Some circuit breakers used in homes are not rated for the high inrush currents that occur when the machine is first turned on or even during use.

...
- do i have to take the machine apart to run the cable
- how do i route the power line through the frame
keywords:
- power line
- powerline
- cable
...
**The power line has to be threaded through the holes in the frame before the door frame
is joined to the connecting frame. If this is not done first, the machine will have to be
disassembled.**

That is the whole warning, and it is printed as a note beside the step 1 drawing, in
small type, not in the step text itself. It is the single most expensive thing to get
wrong in these builds.

**The dual stations word it "Cable" rather than "Powerline"** and name the main frame
rather than the connect frame: *"Cable needs to be threaded through the holes before Door

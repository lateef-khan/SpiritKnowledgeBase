---
id: spirit-cr900-assembly-front-handlebar-replacement
...
- front handlebar bolts spirit commercial recumbent
keywords:
- front handlebar
- handle bar
- m8 socket screw
...
see_also:
- spirit-cr900-assembly-console-replacement
- spirit-cr900-assembly-rear-handlebar-replacement
- cu900ent-armrest-group-replacement
source:
...
**6.2.1** Refer to figure 6.1.1 for the removal of the rear console cover. As shown in figures 6.2.1 and 6.2.2, remove the **M8 socket screws** and the handle bar.

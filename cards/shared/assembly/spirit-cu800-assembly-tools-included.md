...
source:
  ...
  locator: p. 7, CU800 PRE-ASSEMBLY, TOOLS INCLUDED panel; the same three lines at p. 7
    of the CU800ENT 2022 manual (`spirit-bike-cu800ent-2022-owners-manual`), p. 7 of
...
Three tools, printed as a TOOLS INCLUDED list beside the unpacking steps:

- **13/15mm Wrench**
- **12/14mm Wrench**
- **Phillips Screwdriver**

All four printings list the same three, and **no Allen key of any size**. This build
uses hex-head and Phillips heads throughout; nothing in it takes a hex key.

**The CU800 2012 manual prints the same three** under the heading Assembly Tools,
drawn rather than tabulated, and both OCR scans of that page agree on all three sizes.
It is the only one of the four with no carton parts list beside the tools - it prints
tools and nothing else on that page.

## The recumbent carton reads 14/15mm, not 13/15mm

The CR800, CR800ENT and CR800 2023 cartons hold a **14/15mm** wrench where this holds
a 13/15mm; the 12/14mm and the screwdriver are the same. See
[the recumbent tools card](spirit-cr800-assembly-tools-included.md).

## The steps name tools by item number, not by size

The CU800 2021 steps call for "the Wrench (No.100)"; the CU800ENT steps add "the
Screwdriver (No.93)" and "the Wrench (No.92)". Those are parts-list numbers for the
packed tools, not sizes, and the manuals never say which of the three each one is.

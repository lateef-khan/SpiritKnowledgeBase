---
id: spirit-cr900-assembly-foot-pad-and-transport-wheel-replacement
title: 'Replacing the commercial recumbent transport wheel and foot pads: screw and
...
- foot pad lock nut spirit commercial recumbent
keywords:
- transport wheel
- foot pad
- leveler
...
**6.11.1 Remove the transport wheel.** As shown in figure 6.11.1, loosen the **screw and nut** and remove the wheel.

**6.11.2 Remove the foot pad.** As shown in figure 6.11.2, loosen the **locking nuts with a 15 mm wrench** and **turn the footpad counterclockwise** to remove it.

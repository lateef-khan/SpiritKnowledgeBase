...
- cleaning dust out of a spirit treadmill
keywords:
- vacuum
- motor cover
- air inlets
...
- **Vacuum underneath the treadmill on a monthly basis** to prevent excess build-up of dirt
  that can get sucked up into the inner workings under the motor cover.
- **Every other month, remove the motor cover** and carefully vacuum out dirt and hair that

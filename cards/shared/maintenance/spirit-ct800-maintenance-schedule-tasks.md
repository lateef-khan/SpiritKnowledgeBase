...
- what do i need to check on my treadmill
- how do i clean under the belt
keywords:
- maintenance schedule
- maintenance table
- wipe down unit
- clean under belt
- clean under motor cover
- check hardware
- deck wear
- drive belt
...
range for the same seven tasks. The CT900ENT ticks *Clean Under Motor Cover* **monthly** and prints
no Annually column (`ct900ent-general-maintenance-schedule`); the 2026 4.0T prints the Annually

---
id: xt-2023-maintenance-treadbelt-tension
title: Tightening the tread belt when it slips
kind: procedure
question: How do I tighten the running belt on a Spirit XT treadmill?
asked_as:
- my treadmill belt slips when i step on it
...
Adjustment is made **from the rear roller** with the **6mm Allen wrench** provided in the parts package. The adjustment bolts are **at the end of the step rails**.
...
4. **Turn the bolts on both sides evenly**, or the belt could start tracking to one side instead of running in the middle of the deck. Keeping the tension balanced matters because **the belt shifts from the higher tension end to the other**.

---
id: spirit-ct800-maintenance-belt-deck-cleaning-4000-hours
...
- do i need to lubricate or wax this treadmill
- how long does the deck last
- when do i flip the deck over
keywords:
- belt cleaning
- deck cleaning
- monthly cleaning
...
Performance is maximized when the deck is kept as clean as possible.
...
3. Do this **once a month** to extend belt and deck life.
4. A mild soap and water solution along with a **nylon scrub brush** will clean the top of the
   textured belt. Allow to dry before using.

## Deck life and flipping

The low maintenance (routine monthly cleaning), dual sided deck is designed to withstand up to
**4,000 hrs on each side**. If the original side of the deck use is over 4,000 hrs, then it needs
to be flipped. Contact your service technician for assistance.

## The deck takes no lubricant and no wax

**Do not apply any type of lubricant or wax to the surface.** Neither manual names a lubricant, a
quantity or an interval, and neither maintenance chapter lists a lubrication task. Spirit prints
the same instruction for the 2026 treadmill line

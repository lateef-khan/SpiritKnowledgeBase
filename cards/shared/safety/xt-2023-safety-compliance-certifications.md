...
- what bluetooth version is the treadmill
...
The manual lists three standards:
...
**The Bluetooth entry is not printed the same way in all four manuals.** The XT285 manual
prints `Bluetooth 4.0 (with FTMS)`. The XT385, XT485 and XT685 manuals print
`Bluetooth (with FTMS)` with no version number. Only the XT285 manual states a Bluetooth
version.

The Part 15 declaration, as printed:

> This device complies with part 15 of the FCC Rules. Operation is subject to the following
> two conditions: (1) this device must not cause harmful interference, and (2) this device
> must not accept any interference received, including interference that may cause
> undesired operation.

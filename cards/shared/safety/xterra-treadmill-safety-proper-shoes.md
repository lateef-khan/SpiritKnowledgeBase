...
source:
  ...
  locator: 'the Wear proper shoes bullet or item 20/21 of the safety page: TR150 OM
    PDF p. 5 (lines 102-164); TR200 OM PDF p. 5 (lines 108-170); TR260 OM PDF p. 4
    (lines 98-158); TR300 OM PDF p. 4 (lines 88-145); TR6.4 OM PDF p. 4 (lines 81-139);
    TR65 OM PDF p. 6 (lines 125-161); TR6.6 OM PDF p. 4 (lines 83-140); TR75 OM PDF
    p. 6 (lines 126-162); TR75H OM PDF p. 6 (lines 132-171); TR85 OM PDF p. 6 (lines
    126-162); TR95H OM PDF p. 6 (lines 125-161); TRX1000 OM PDF p. 4 (lines 98-158);
...
**All nineteen manuals print the same bullet.**
...
| | |
|---|---|
| Wear | quality athletic shoes |
| Never | high heels, dress shoes, sandals, bare feet |
| Reason the manual gives | leg fatigue |

It is a Fitness Equipment Safety Instructions bullet on the older-layout and 2024 TRX books, item 20
of the 21-item list, and item 21 on the two Hiker books whose list has an extra tablet rule. The
manuals give no other clothing rule beyond the sticker's `Keep body, clothing, and fitness

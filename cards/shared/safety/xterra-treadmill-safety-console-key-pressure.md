...
- am i pressing the treadmill buttons too hard
keywords:
- console keys
- finger pressure
- excessive pressure
...
- xterra-treadmill-safety-never-mount-or-dismount-a-moving-belt
see_also:
...
source:
  ...
  locator: 'the last operation bullet on the electrical page: TRX2500 OM PDF p. 6
    (lines 177-227); TRX3500 OM PDF p. 6 (lines 175-225); TRX4500 OM PDF p. 6 (lines
...
A light press is the designed touch. A key that needs force is a fault to raise with service, not a
technique to adopt - and a key that seems slow to act is usually the ramp delay
(`xterra-treadmill-safety-speed-and-incline-changes-are-gradual`), not a missed press.

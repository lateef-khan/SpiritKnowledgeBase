...
- is the treadmill covered in a health club
...
|---|---|---|---|---|
| Unregistered product excluded outright | item 6, **yes** | no | yes | no |
| Dues-paying facility | item 8, **excluded** | not mentioned | not mentioned | not mentioned |
| Prisons | item 9 | item 8 | item 8 | not in the list |
| Outside the US | item 10 | item 9 | unnumbered | item 9 |

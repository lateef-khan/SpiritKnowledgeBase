...
As a footnote directly under the Commercial Warranty table:

> \*Prisons and correctional facilities are excluded from warranty coverage

And again as exclusion 8, in the EXCLUSIONS list on the next page:
...
**The CE800 2013 and the CE850 2016 manuals state this exclusion nowhere.** The words *prison* and *correctional* appear at no point in either document - no footnote under the warranty table, no numbered item in the exclusion list. **Do not quote it to the owner of one.** On a CE800 the exclusion first appears in the warranty effective November 08, 2021; on a CE850 in the same one.

The other eight print both halves, footnote and numbered item, but the item number moves:

| Manual | Footnote under the table | Exclusion item |
|---|---|---|
| CE800 2013, CE850 2016 | **none** | **none** |
| CE800 2021, CE800 2023, CE800ENT | yes, with a leading asterisk | item **9** of ten |
| CE850 2020, CE850 2022 | yes, with a leading asterisk | item **9** of ten, worded "Prisons and correctional facilities are excluded from warranty coverage." rather than "Product used in prisons and correctional facilities" |
| CE900 2021 | yes, with a leading asterisk | item **8** of eight |
| CE900 2025, CES880 2025 | yes, **no** leading asterisk | item **8** of nine |

...
- why am i being charged a trip fee
keywords:
- trip charge
- service call
- freight charges
...
source:
  ...
  locator: >-
    ...
    1016-1021), ce800ent p. 41 (spirit-elliptical-ce800ent-owners-manual text.md lines 943-946
...
|---|---|
| Freight **to and from** a service center, if the product is shipped to one | SERVICE step 4 |
...
**The manual prints no figure for any of these charges** and no way to get them waived. It also does not say who sets the trip charge.
...
**Seven Spirit elliptical manuals charge all five as well.** The CE800 2013, 2021 and 2023, the CE800ENT and the CE850 2016, 2020 and 2022 print the same SERVICE step 4 - freight both ways, shipping and handling on parts, a trip charge for in-home service, and an additional one beyond 100 miles - and the same exclusion 2. Their accessibility duty is item **5** of the responsibilities list in the three CE800 manuals that share the CT800 list, item **4** in the three CE850 manuals, and item **3** in the CE800 2013 manual, whose list runs to four items. The CE800 2013 prints step 4's trip-charge sentence as "Forin-home service", the same conversion artefact the CT800 2012 manual shows.

**Three Spirit ellipticals do not belong on this card, and that is worth checking before quoting it.** The **CE900 2025** and the **CES880** stop at shipping and handling on replacement parts and charge no trip charge (`spirit-2026t-warranty-owner-costs`). The **CE900 2021** step 4 ends at "All repairs must be preauthorized by Spirit Fitness" and prints **neither** the freight sentence nor the shipping-and-handling sentence nor a trip charge - three of the five charges above are simply not stated in that manual. Quoting them to a CE900 2021 owner would invent a cost the source does not impose.

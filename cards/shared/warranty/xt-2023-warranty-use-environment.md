---
id: xt-2023-warranty-use-environment
title: The kind of use the warranty covers
kind: policy
question: Can a Spirit XT treadmill be used in a gym or a workplace and stay under
  warranty?
asked_as:
- can i use this treadmill in my apartment gym
- is the treadmill covered in a hotel
- does the warranty still work in a business
...
The responsibilities paragraph, on the first warranty page: the warranty "applies only to products in **ordinary household use**".

Exclusion 8, on the second: the warranty does not cover
...
The XT685's light commercial footnote adds one flat exclusion: **prisons and correctional facilities are excluded from warranty coverage.** The other four manuals say nothing about prisons.

The full exclusion list is in `xt-2023-warranty-exclusions`; the responsibilities list in `xt-2023-warranty-consumer-responsibilities`.

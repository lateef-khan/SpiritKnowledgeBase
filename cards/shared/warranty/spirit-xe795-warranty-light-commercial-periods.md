---
id: spirit-xe795-warranty-light-commercial-periods
...
- is it covered in an apartment or hotel gym
...
**Light commercial is shorter than residential on two of the four components.** The brake drops from Lifetime to **5 Years** and parts from 10 Years to **3 Years**. Frame stays Lifetime and labor stays 1 Year.
...
**The 2023 manual drops that parenthetical.** It prints the row as a second table headed *Light Commercial Warranty\** under the residential one, labels the row plain **Light Commercial**, and defines the term nowhere. Its exclusion 8 still limits use to "a residential setting or non-dues paying facility with 5 hours use or less per day", so the envelope is the same - but do not tell a 2023 owner the table states it, because it does not. See `spirit-xe-warranty-use-environment`.

## Prisons

The footnote printed with the table in the **November 2021** printing and in the **2023** manual:

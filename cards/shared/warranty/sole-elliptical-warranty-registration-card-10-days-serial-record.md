---
id: sole-elliptical-warranty-registration-card-10-days-serial-record
title: 'Registering the elliptical: card within 10 days, online registration, serial record'
kind: procedure
question: How do I register a Sole elliptical?
asked_as:
- register my sole elliptical
- sole elliptical registration card 10 days
- sole elliptical serial number record
- register sole elliptical online
keywords:
- registration
- registration card
- 10 days
...
Every book in the wave carries the same Product Registration page:

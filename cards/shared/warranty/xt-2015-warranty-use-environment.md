---
id: xt-2015-warranty-use-environment
title: The kind of use the warranty covers
kind: policy
question: Can a Spirit XT treadmill from the 2015 manuals be used in a gym or a workplace
  and stay under warranty?
asked_as:
...
The manual states this in two places, and in the 2015 manuals the two places disagree with each other.

**Exclusion 8 is identical in all five.** The warranty does not cover
...
**The responsibilities lead sentence is not identical.** Each manual words it differently:

| Manual | "This warranty applies only to products in..." |
|---|---|
| XT185 | ordinary household or Light Commercial use (see restrictions above) |

...
- how do i save a workout to strava
keywords:
- xterra+ app
- bluetooth
- pairing
...
The machine has a Bluetooth transceiver that lets it interact with selected phones or tablets through the free **XTERRA+ App** (Apple Store or Google Play; the new-layout books print a QR code). Press the app's "DISPLAY" button to view the current workout data; when the exercise is complete choose "END & SAVE WORKOUT".

1. Download the App (scan the QR code in the book).
2. Open it on your phone or tablet and make sure Bluetooth is enabled.
3. In the App, click the Bluetooth icon to search for your XTERRA+ equipment.
4. In the Bluetooth scan result list, select the machine to connect. When they are synced, the **Bluetooth icon on the console display lights up**. Click "DISPLAY".
5. When the exercise is complete, choose "END & SAVE WORKOUT". You will be prompted to sync with each available fitness cloud site after installing that site's app: the books name Strava, MapMyFitness and Fitbit, and the TR75 and TR85 add Apple Health and Google Fit. The "About Your Machine" page shows export to and import from Garmin Connect, iHealth and Google Fit.

---
id: e95-2016-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the display ranges for the console readings on a Sole elliptical?
asked_as:
- what is the max incline on a sole e95
...
| INCLINE | 0 to 99 | 1 to 20 | position shown 1 to 20, preset value 1 to 20, each press changes by 1 |
...
Note the work range: this manual gives incline and level as **1 to 20**. The E25, E35 and E55 manuals of the same year print 0 to 20 for the same two rows.

The LEVEL entry is printed with the INCLINE wording: "Display the incline position from 1 to 20". That is how the source reads.

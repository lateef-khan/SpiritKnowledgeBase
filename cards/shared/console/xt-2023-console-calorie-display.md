---
id: xt-2023-console-calorie-display
title: How the calorie readout should be read
kind: fact
question: How accurate is the calorie count on a Spirit XT treadmill, 2015 or 2023, or an XE795 or
  XE395-2023 elliptical?
asked_as:
- are the calories on my treadmill accurate
- why does my treadmill calorie count differ from my watch
- what does the calorie window show
- can i trust the calorie reading
keywords:
- calorie display
- calories burned
- cumulative
...
The calorie window **displays the cumulative calories burned at any given time during your
workout.**

**Note: this is only a rough guide used for comparison of different exercise sessions, and is not to
be used for medical purposes.**

Entering your weight when you program a workout is what makes the reading closer to correct; that
...
**Five residential XE elliptical printings print them word for word too** - the **XE795-2018**
(p. 17), the **XE895-2018** (p. 19), the **XE795-2021** (both the February and the November
printing), the **XE395-2023** and the **XE795-2023** - so this card is no longer treadmill-only.
**These are the only XE ellipticals with a Calorie Display paragraph at all**; the XE195, XE295,
XG400 and XE395 name the calorie window nowhere but in their program instructions.

**A longer and blunter calorie warning is printed elsewhere in most XE manuals**, and it is not the

...
- do i have to hold the handles for the heart rate
keywords:
- heart icon
- blinking
- hand pulse sensors
...
**The machine has a built-in heart rate monitoring system.** Simply **grasping the hand pulse sensors
on the stationary handle bars**, or **wearing the heart rate transmitter**, starts the **Heart Icon

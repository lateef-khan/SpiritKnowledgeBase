...
**Pedal the elliptical, then press and hold Start, Stop and Enter together for about 5 seconds.**
The Dot Matrix Message Center displays **Maintenance Mode**. Press **Enter** to open the menu.

**You have to be pedalling.** The console is generator powered, so it is not live standing still.

---
id: sole-e6-error
title: 'E6 error: motor controller fault'
kind: troubleshooting
question: What does an E6 error mean on a Sole treadmill?
asked_as:
...
source:
  ref: sole-tm-e6-error-treadmill
  locator: whole document
  extracted_at: '2026-09-03'
---

**Meaning**: a part inside the motor controller has failed.

A pinched computer cable can make the machine misread signals and raise this error, so if the machine was recently assembled, replace the computer cables first.

If the cables are good, the motor controller has to be replaced. Work through the wear checks as well, because they show what wore the controller out.

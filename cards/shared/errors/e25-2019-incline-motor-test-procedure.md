---
id: e25-2019-incline-motor-test-procedure
title: Incline motor and position sensor test procedure
kind: procedure
question: How do I test the incline motor and its position sensor on a Sole elliptical?
asked_as:
...
source:
  ...
  locator: Test Procedure, page 49
...
The position sensor wires are **red = ground, white = position signal, black = 5vdc (0~5v depending on incline position)**.

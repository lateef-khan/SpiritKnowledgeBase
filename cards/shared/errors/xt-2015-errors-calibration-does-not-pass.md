...
question: What do I check when calibration will not pass on a Spirit CT800, CT800ENT,
  CT850 (2013 or 2018) or XT treadmill?
asked_as:
...
source:
  ...
  locator: ADJUSTING THE SPEED SENSOR, page 30; the same section is page 38 of the
    ...
    XT685; all four CT800 owner's manuals print the same sentence under Adjusting
    The Speed Sensor - printed page 24 of the 2012 manual (text.md lines 1053-1054),
    printed page 36 of the 2016 manual (text.md lines 938-939), printed page 38 of
    the 2020 manual (text.md lines 976-977) and printed page 51 of the CT800ENT 2022
    manual (text.md lines 1154-1155); the CT850 2018 owner's manual prints the same
    sentence under ADJUSTING THE SPEED SENSOR on printed page 40 (text.md lines 1020-1021);
    the XT685 2010 owner's manual prints the same sentence under Adjusting The Speed
    Sensor on printed page 32 (PDF page 36, text.md lines 1464-1465); CT850 2013 owner's
    manual (spirit-treadmill-ct850-2013-owners-manual) Adjusting The Speed Sensor,
    PDF p. 29 (printed 25); OCR supplement for page 29, text.md lines 1161-1217; XT485
    2013 owner's manual (spirit-treadmill-xt485-2013-owners-manual) ADJUSTING THE
    SPEED SENSOR, PDF p. 34 (printed 33), text.md lines 1346-1401
...
**Both 2013 owner's manuals print the one-line answer word for word** - *If the calibration does not pass you may need to check the speed sensor alignment* - and each prints the alignment procedure of its own family (added 2026-09-11). The **XT485 2013** has the XT wording: 4 hood screws, a small black sensor set *as close as possible to the pulley without touching it*, aligned with the magnet on the face of the pulley, one screw. The **CT850 2013** has the CT800 wording: *eight* motor-cover screws, a *small rectangular shaped black box*, the magnet on the *outside edge* of the pulley, the sensor *aligned with the center of the magnet when it passes by*, and *two* screws. Neither prints a gap figure.

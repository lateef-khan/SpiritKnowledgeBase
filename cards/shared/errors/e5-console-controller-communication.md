---
id: sole-e5-error
title: 'E5 error: console and controller not talking'
kind: troubleshooting
question: What does an E5 error mean on a Sole treadmill?
asked_as:
- e5 error on my treadmill
- console not communicating with controller
keywords:
- e5
- e5 error
- communication error
...
- sole-e6-error
source:
  ref: sole-tm-e5-error-treadmill
  locator: whole document
  extracted_at: '2026-09-03'
---

**Meaning**: the console and the motor controller cannot talk to each other. The usual cause is a pinched computer cable or a cable that is not plugged in correctly. A damaged motor controller or console display board can also cause it.

If the machine was recently assembled, replace the computer cables first.

1. Ask whether the machine was recently assembled, taken apart or moved.
   - Yes: replace the computer cables.
   - No: the motor controller is the likely damage. Go to the wear checks.

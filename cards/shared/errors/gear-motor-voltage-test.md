---
id: b94-2023-gear-motor-voltage-test
title: Gear motor voltage test procedure
kind: procedure
question: How do I voltage test the gear motor on a Sole bike?
asked_as:
- how to test the resistance motor on my 2023 sole bike
- what voltage should the gear motor read on a b94
- multimeter test tension motor upright bike
keywords:
- gear motor
- voltage test
- multimeter
...
source:
  ...
  locator: Section 8.2, Gear Motor Voltage Test Procedure, page 18
...
The caption under the photo repeats the probe placement in the same words, so the wire colours are stated twice and agree.

...
- what does fat burn do on the bike
keywords:
- fat burn
- fatburn
- weight loss program
...
Fat Burn follows a quick progression up to the **maximum resistance level** - the default level, or
the level you entered - and sustains it for **2/3 of the workout**. The manual says the program will

...
- what console does the sb1200 use
- how does resistance work on the sb1200
keywords:
- model number
- sku
- factory code
...
| Resistance | Magnetic control brake assembly moved by a Bluetooth wireless resistance knob and a push rod axle. Level is read by a G-sensor and calibrated from Engineer Mode. |
| Family | Spin bike, belt driven flywheel with an idler wheel assembly. |

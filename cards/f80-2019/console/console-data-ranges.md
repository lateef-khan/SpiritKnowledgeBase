---
id: f80-2019-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the speed, incline and pulse ranges on a Sole f80-2019 treadmill
  console?
asked_as:
...
|---|---|---|---|
| SPEED | 0.0 to 99.9 | 1.0~20.0 km (0.5 ~ 12.0 mile) | FAST/SLOW change it by 0.1 km/h (mph) per press |

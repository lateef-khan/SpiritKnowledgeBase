...
- can it get wet
- what if my house voltage is low
keywords:
...
**All four Spirit CT800 owner's manuals print both paragraphs**, with the same figures: 40 to 120
degrees Fahrenheit, 95% non-condensing, and the ten percent voltage variation that is not covered
under warranty.

- Every manual prints **one Fahrenheit range and no Celsius conversion**, no minimum humidity and
  no storage or transport figure.
- The CT800ENT-2022 manual writes `manufacturer` where the other three write `manufacture` in the
  circuit-breaker paragraph that follows. No figure changes.

**Do not answer a CT800 or a CT900ENT from the XT cards.** The 2015 and 2023 XT manuals print a
...
card carries the XT, MT200 and 2026 machines; this one carries the CT900ENT and the four CT800s,
because in these manuals the two paragraphs are one printed block on one page.

The nominal circuit the CT800 manuals name is **110 volt** in the 2012 and 2016 manuals and
**120 volt** in the 2020 and ENT-2022 manuals, at 15 amps throughout:
`spirit-ct800-safety-outlet-110-volt-15-amp` and `spirit-ct800-safety-outlet-120-volt-15-amp`.

**All four Spirit CT850 owner's manuals print both paragraphs too**, with the same figures: 40 to
120 degrees Fahrenheit, 95% non-condensing, and the ten percent voltage variation that is not
covered under warranty. One Fahrenheit range, no Celsius conversion, no minimum humidity and no
storage or transport figure, in every one of them. The CT850ENT-2022 manual writes `manufacturer`
where the other three write `manufacture` in the circuit-breaker paragraph that follows, exactly as
the CT800ENT manual does. No figure changes.

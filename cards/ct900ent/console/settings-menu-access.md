---
id: ct900ent-settings-menu-access
title: Accessing the Settings menu (engineering, security, diagnostics)
kind: procedure
question: How do I open the Settings menu on a CT900ENT?
asked_as:
- how do i get to the hidden settings menu

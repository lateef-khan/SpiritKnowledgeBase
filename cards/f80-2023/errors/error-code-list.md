---
id: f80-2023-error-code-list
title: Error codes the service manual lists
kind: spec
question: What error codes can a Sole f80-2023 treadmill show and what does each one
  mean?
asked_as:
- list of error codes for the f80
...
source:
  ...
  locator: Section 8 Error Code List, page 31
...
EEPROM failure, and names the F80 as a machine that uses that controller. This manual does not print it.

---
id: e95s-2019-e2-tension-motor-failure
title: E2 tension motor failure
kind: troubleshooting
question: What does error E2 mean on a Sole e95s-2019 elliptical and how is it diagnosed?
asked_as:
...
source:
  ...
  locator: Section 8-2, pages 40-41
  extracted_at: '2026-09-04'
---

**This is E2, not E1 (EEPROM) and not E3 (stride VR).**
...
The numbered voltage test that confirms this is in a separate card. Section 9-4 adds a mechanical cause for the same complaint: a worn or damaged steel cable at the gear motor.

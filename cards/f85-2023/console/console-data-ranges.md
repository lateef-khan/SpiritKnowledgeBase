---
id: f85-2023-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the speed, incline and pulse ranges on a Sole f85-2023 treadmill
  console?
asked_as:
...
**The incline figures in this manual disagree with each other.** This table gives a work range of 0 to 15, but the quick incline keys in section 4.4 include -4 and -2, and section 9.10 describes a rear incline motor. This machine declines.

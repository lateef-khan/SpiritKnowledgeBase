---
id: 70t-2026-errors-e2-over-volt
title: 'E2 Over Volt: check the AC line voltage'
kind: troubleshooting
question: What does error code E2 (Over Volt) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e2 mean on my treadmill
- treadmill display says e2
- over voltage error on the running machine
keywords:
- e2
- over volt
- over voltage
...
- 70t-2026-errors-e20-inrush-fault
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 1 of 5, lines 1479-1480; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E2 (Over Volt) - not E3 (Over V Decel), not E20 (Inrush Fault), not the CT900 E2 (Over Voltage), not Spirit CVC800 E-2 (tension motor) and not the Sole E2 (motor overcurrent).**

| Field | Value |
|---|---|
| Code | E2 |
| Name, as printed | Over Volt |

**The one cause or remedy the table lists under it:** Check AC line V
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E2 Over-Voltage: The DC voltage inside Inverter exceeded the maximum allowable value.** and gives, in order:

1) Check the AC line voltage.
2) Replace Inverter.

**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E2 Over Voltage` with one line: *Check AC line voltage.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

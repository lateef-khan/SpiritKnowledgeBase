---
id: 70t-2026-errors-e34-thrm-ovrld-2
title: 'E34 Thrm Ovrld 2: brake locked, deck lube, bad drive or motor'
kind: troubleshooting
question: What does error code E34 (Thrm Ovrld 2) mean on a Spirit treadmill, and
  what does the manual say to check?
asked_as:
- what does e34 mean on my treadmill
- treadmill display says e34
- thermal overload 2 error on the running machine
keywords:
- e34
- thrm ovrld 2
- thermal overload 2
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 4 of 5, lines 1488-1492; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E34 (Thrm Ovrld 2) - not E7 (Thrm Ovrload), not E6 (Drive Ovrload) and not the CT900 E34 (CONSOLE EE ER).**

| Field | Value |
|---|---|
| Code | E34 |
| Name, as printed | Thrm Ovrld 2 |
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E34 Thrm Ovrld 2: Motor overload.** and gives, in order:

...
question: What does error code E5 (IGBT Fault) mean on a Spirit treadmill, and what
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 1 of 5, lines 1487-1489; the same row is printed word for word in both
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E5 IGBT Fault: IGBT module of Inverter failure.** and gives, in order:

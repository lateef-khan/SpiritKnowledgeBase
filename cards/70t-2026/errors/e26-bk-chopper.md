---
id: 70t-2026-errors-e26-bk-chopper
title: 'E26 Bk Chopper: reset power, bad drive'
kind: troubleshooting
question: What does error code E26 (Bk Chopper) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e26 mean on my treadmill
- treadmill display says e26
- braking chopper error on the running machine
keywords:
- e26
- bk chopper
- braking chopper
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 3 of 5, lines 1496-1498; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E26 (Bk Chopper) - not E3 (Over V Decel), not E2 (Over Volt) and not the CT900 E26 (Encoder ERR).**

| Field | Value |
|---|---|
| Code | E26 |
| Name, as printed | Bk Chopper |
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E26 Bk Chopper: Braking chopper fault.** and gives, in order:

1) Reset the power.
2) Replace Inverter.

**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E26 Brake Chopper` with one line: *Reset power, check inverter.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

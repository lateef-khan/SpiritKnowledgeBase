---
id: 70t-2026-errors-e9-over-i-speed
title: 'E9 Over I Speed: check brake, deck lube, bad drive or motor'
kind: troubleshooting
question: What does error code E9 (Over I Speed) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e9 mean on my treadmill
- treadmill display says e9
- over current at speed error on the running machine
keywords:
- e9
- over i speed
- over current at speed
- error code
- fault code
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 2 of 5, lines 1474-1478; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E9 (Over I Speed) - not E1 (Over Current), not E10 (Over I Accel) and not the CT900 E9 (HW INTERUPT ERR).**

| Field | Value |
|---|---|
| Code | E9 |
| Name, as printed | Over I Speed |
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E9 Over-I Speed: Over-current during constant speed.** and gives, in order:
...
**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E9 Over Speed Current` with one line: *Check motor brake, the running deck and running belt lubrication, inverter, drive motor.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

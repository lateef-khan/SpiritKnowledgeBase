---
id: 70t-2026-errors-e23-pid-error
title: 'E23 PID Error: check wiring, check the parameter setting'
kind: troubleshooting
question: What does error code E23 (PID Error) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e23 mean on my treadmill
- treadmill display says e23
- pid error error on the running machine
keywords:
- e23
- pid error
- error code
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 3 of 5, lines 1488-1490; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E23 (PID Error) - not E25 (Auto Tune), not E38 (Ext BB) and not the CT900 E23 (Over Slip).**

| Field | Value |
|---|---|
| Code | E23 |
| Name, as printed | PID Error |
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E23 PID Error: PID feedback error.** and gives, in order:

1) Check Wiring.
2) Replace Inverter.

**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E23 PID Error` with one line: *Check wiring, check parameter settings.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

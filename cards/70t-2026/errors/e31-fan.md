---
id: 70t-2026-errors-e31-fan
title: 'E31 Fan: the drive fan is bad'
kind: troubleshooting
question: What does error code E31 (Fan) mean on a Spirit treadmill, and what does
  the manual say to check?
asked_as:
- what does e31 mean on my treadmill
- treadmill display says e31
- fan error on the running machine
keywords:
- e31
- fan
- error code
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 4 of 5, lines 1477-1478; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E31 (Fan) - not E18 (IGBT O-Heat), not E19 (Ambient Temp), not the CT900 E31 (COMM TIMEOUT) and not Sole E31 (overtemperature).**
...
**The one cause or remedy the table lists under it:** Drive Fan Bad
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E31 Fan: Fan fault.** and gives, in order:

1) Check the cooling fan of Inverter.

**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E31 Fan Error` with one line: *Check inverter fan.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

---
id: 70t-2026-errors-e12-eprom-rd
title: 'E12 EPROM RD: check AC line voltage, reset power, bad drive'
kind: troubleshooting
question: What does error code E12 (EPROM RD) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e12 mean on my treadmill
- treadmill display says e12
- eprom read error on the running machine
keywords:
- e12
- eprom rd
- eprom read
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 2 of 5, lines 1487-1490; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E12 (EPROM RD) - not E13 (EPROM WR) and not the CT900 E12 (Over Current).**

| Field | Value |
|---|---|
| Code | E12 |
| Name, as printed | EPROM RD |

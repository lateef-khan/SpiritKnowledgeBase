---
id: 70t-2026-errors-e35-motor-sel
title: 'E35 Motor Sel: motor wiring'
kind: troubleshooting
question: What does error code E35 (Motor Sel) mean on a Spirit treadmill, and what
  does the manual say to check?
asked_as:
- what does e35 mean on my treadmill
- treadmill display says e35
- motor selection error on the running machine
keywords:
- e35
- motor sel
- motor selection
...
source:
  ...
  locator: 'Error Codes table, ERROR MESSAGE & TROUBLESHOOTING, printed page 46; text.md
    column 4 of 5, lines 1493-1494; the same row is printed word for word in both
...
**This is the 7.0T and MT200 E35 (Motor Sel) - not E25 (Auto Tune).**

| Field | Value |
|---|---|
| Code | E35 |
| Name, as printed | Motor Sel |

**The one cause or remedy the table lists under it:** Motor Wiring
...
**Service manual remedy.** The 7.0T (MT8000-ST021-02) service manual, section 4.2.3 *Error Codes: Messages, Cause and Solution*, prints this code as **E35 Motor Sel: Motor select error.** and gives, in order:

1) Check Motor wiring.

**The 2024 MT200 error-codes leaflet (`spirit-treadmill-mt200-error-codes-list`) prints it as `E35 Motor Selection` with one line: *Check motor wiring.*** The leaflet is titled for the MT200 with no year and is carried for both MT200 revisions; it is a summary of the list above in fewer words, and where it names parts it names the same ones.

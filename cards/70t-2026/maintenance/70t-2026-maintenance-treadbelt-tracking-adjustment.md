...
1. Use a **10mm Allen wrench** to adjust the rear roller.
2. Make tracking adjustments **from the left side only**.
3. Set belt speed at approximately **2 to 3 mph**.
4. **Turn the bolt clockwise to move the belt to the right.** Turn the bolt only a **1/4 turn** and
   wait a few minutes for the belt to adjust itself.
5. Continue to make 1/4 rotation turns until the belt stabilizes in the center of the running deck.

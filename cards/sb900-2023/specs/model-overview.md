...
- what console does the sb900 2023 use
- how does resistance work on the 2023 spin bike
keywords:
- model number
- sku
- factory code
...
| Resistance | Magnetic control brake assembly moved by a **Smart Tension** Bluetooth wireless knob. The knob pairs to the console and is calibrated against it. |
| Family | Indoor cycle, belt driven flywheel with an idler wheel assembly. |

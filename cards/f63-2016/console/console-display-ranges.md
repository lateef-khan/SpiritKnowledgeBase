---
id: f63-2016-console-display-ranges
title: Display and working ranges for each readout
kind: spec
question: What are the display ranges on a Sole F63-2016 console?
asked_as:
...
|---|---|---|
| SPEED | 0.0 to 99.9 | 1.0~16.0KM or 0.5~12Mile. Each press of FAST or SLOW changes it by 0.1 km/h (mph) |
| INCLINE | 0 to 99 | 0 to 15. Preset value 0 to 15. Each press of UP or DOWN changes it by 1 |

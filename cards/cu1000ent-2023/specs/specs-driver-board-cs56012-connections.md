...
kind: spec
question: Which connector on the cu1000ent-2023 driver board takes which cable, and
...
source:
  ...
  locator: Section 6.2 Driver Board PCB Component Locations, PDF p. 10, and 6.3 Driver
    Board function, PDF p. 11 (printed 10-11), text.md lines 203-228; both photographs
    read from a 300 dpi render (OCR supplement lines 867-896)

---
id: f63-2026-e05-error-code
title: 'E05 error: undervoltage'
kind: troubleshooting
question: What does an E05 error mean on a Sole F63-2026?
asked_as:
- e05 error on my treadmill
- undervoltage error on my sole
- what is error e05 on my treadmill
keywords:
- e05
- e05 error
- undervoltage
...
**This is E05, two digits. It is not E5, and it is the opposite of E06 (overvoltage).**

**Defect reason**: undervoltage.

1. Check whether the **input voltage** is normal.
2. Check whether the **power plug connection** is loose.

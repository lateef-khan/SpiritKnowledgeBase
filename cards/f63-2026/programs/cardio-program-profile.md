---
id: f63-2026-cardio-program-profile
title: 'Cardio program: printed speed and incline profile'
kind: spec
question: What is the speed and incline profile of the Cardio program on a Sole F63-2026?
asked_as:
- what does the cardio program do on my treadmill
- p4 profile on my sole treadmill
- how steep does the cardio program get
keywords:
- cardio
- p4 program
- program profile
...
**One printed speed value carries a decimal**, `87.5`. Every other value in the table is a whole number.

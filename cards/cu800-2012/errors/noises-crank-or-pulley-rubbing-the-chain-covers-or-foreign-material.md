---
id: cu800-2012-errors-noises-crank-or-pulley-rubbing-the-chain-covers-or-foreign-material
...
- something rattling inside the cu800 chain cover
- spirit upright bike rubbing noise
keywords:
- noise
- chain cover
- crank
...
The XU878 book answers noise in two places.

**8-10 Left and Right Chain Covers**:

1. Noises caused by rubbing between parts are the most frequently seen problems such as the **crank rubbing one of the chain covers**. Since every unit passes testing in a quiet room, out-of-box noise is rare.
2. If the crank is rubbing either chain cover, disassemble both chain covers and set them in the middle.
3. If the **drive pulley is rubbing the right chain cover**, disassemble the right chain cover to fix it: release the 5/16" x 19 mm x 1.5T flat washer on the left chain cover, return both covers, and turn the crank to see if the rubbing still exists.

**8-13 Noises**:

1. Check the drive pulley and chain covers, or the crank and chain covers, to determine if they are rubbing each other.

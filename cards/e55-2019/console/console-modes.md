---
id: e55-2019-console-modes
title: Console display, sleep, child lock, pause, end and reset modes
kind: fact
question: What are the console modes on a Sole e55-2019 elliptical and how do I leave
  them?
asked_as:
...
see_also:
- e55-2019-maintenance-menu
- e55-2019-console-buttons
source:
...
Note on the source: the END MODE block is numbered 5.5, 6.1 and 6.2 rather than 6.1, 6.2 and 6.3. The content is unaffected.

---
id: f63-2019-drive-motor-spec
title: Drive motor voltage and wiring
kind: spec
question: What are the drive motor specifications for a Sole F63-2019?
asked_as:
...
- The **black** wire goes into **M-** in the general information section on page 11.
- The **green** wire is the grounding wire.

**The manual is inconsistent about M-.** Page 11 says the black wire goes to M-, while the motor replacement steps say to connect **red M+, black M-** and to remove "motor wire (+) red and motor wire (-) black". The motor itself has red, black and green leads.

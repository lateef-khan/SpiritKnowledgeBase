...
source:
  ...
  locator: TROUBLESHOOTING, row 4 of the No./Problem/Causes/Solution table, printed
    ...
    electrical malfunction Troubleshooting" table row 4, PDF p. 8 - the page is a
...
**The CSC880 service manual prints this row word for word**, as row 4 of the eleven-row table on its page 8. Owner's manual and service manual carry the same table; the service manual adds nothing to this row.

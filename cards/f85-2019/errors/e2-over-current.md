---
id: f85-2019-e2-over-current
title: 'E2: over current on the lower board'
kind: troubleshooting
question: What does E2 mean on a Sole F85-2019 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.2 Error Message: E2 / OVER CURRENT, printed page 61'
...
The **LIMIT** over current protection warning light on the driver board lights for the same condition, and the LED table gives the same four fixes.

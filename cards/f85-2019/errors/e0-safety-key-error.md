---
id: f85-2019-e0-safety-key-error
title: 'E0: the safety switch loop is open'
kind: troubleshooting
question: What does E0 mean on a Sole F85-2019 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.1 Error Message: E0, printed pages 54 to 55, and the error code
    table on page 53'
...
The S/W line is **pin 5 of the 6 pin main control cable**.

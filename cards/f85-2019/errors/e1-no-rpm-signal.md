---
id: f85-2019-e1-no-rpm-signal
title: 'E1: no RPM signal reached the display board'
kind: troubleshooting
question: What does E1 mean on a Sole F85-2019 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.2 Error Message: E1, printed pages 56 to 61, and section 10.2
    diagnosis guide, printed page 87'
...
The speed sensor plugs into **JK50** on the driver board, on a 2 pin wire.

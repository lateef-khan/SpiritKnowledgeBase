---
id: f85-2019-e4-motor-power-wire-error
title: 'E4: the motor power wire is not in the lower controller'
kind: troubleshooting
question: What does E4 mean on a Sole F85-2019 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.4 Error Message: E4, printed page 71'
...
The red motor wire lands on **M+** and the black on **M-** on the driver board.

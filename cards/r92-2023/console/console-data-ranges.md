---
id: r92-2023-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the display ranges for RPM, level, time and pulse on a Sole R92-2023
  bike?
asked_as:
- how many resistance levels does the 2023 r92 have
- what heart rate range does the recumbent console read
- what is the max time on the r92 console
keywords:
- display range
- work range
- rpm

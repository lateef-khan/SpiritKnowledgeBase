---
id: r92-2023-e2-gear-motor-failure
title: E2 gear motor failure
kind: troubleshooting
question: What does error E2 mean on a Sole R92-2023 bike and how is it diagnosed?
asked_as:
- e2 on my 2023 sole recumbent
- resistance wont change and it shows e2
- level up does nothing e2 error r92
keywords:
- e2
- gear motor
- resistance
...
- r92-2023-e1-eeprom-failure
see_also:
- r92-2023-gear-motor-voltage-test
- sole-bike-tension-motor-error
source:
  ref: sole-bike-r92-2023-service-manual
  locator: 'Section 8 Error Code List and Section 8.2 Error Message: E2, page 17'

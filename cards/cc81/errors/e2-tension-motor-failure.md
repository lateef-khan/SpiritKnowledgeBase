---
id: cc81-e2-tension-motor-failure
title: "Tension motor failure error on the climber console"
kind: troubleshooting
question: "What does E2 mean on a Sole CC81 climber, and how do I fix it?"
asked_as:
...
Step 2 is worked through in two more places: check what the console puts out (card `cc81-tension-motor-console-output-check`), then measure it at the drive board (card `cc81-tension-motor-voltage-test`).

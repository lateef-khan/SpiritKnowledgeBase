---
id: cc81-tension-motor-voltage-test
title: "Tension motor voltage test at the drive board"
kind: procedure
question: "How do I voltage test the tension motor on a Sole CC81 climber?"
asked_as:
...
- The manual prints **5 to 6 VDC** here and **4 to 5 VDC** in section 7-4-1/7-4-2 for the same measurement. See the card `cc81-tension-motor-console-output-check`. It never says how they relate.

---
id: e25-2019-e3-ramp-error
title: E3 ramp error, incline VR not read
kind: troubleshooting
question: What does error E3 or RAMP ERROR mean on a Sole e25-2019 elliptical?
asked_as:
...
- e25-2019-incline-position-mismatch
source:
  ref: sole-elliptical-e25-2019-service-manual
  locator: Sections 8.3 and its repeat, pages 44-46 and 50-52
...
**Case 1 - VR value out of range (page 44).** The incline motor is not operating up or down, so the VR value goes outside its range. After turning the unit on, the display board detects that the incline VR voltage exceeds the range, so E3 appears.
...
**Case 2 - no VR change during incline action (page 50).** During incline action the display board CPU cannot read the VR value, so E3 appears. Press the incline UP/DOWN key, the incline does not operate, E3 appears.

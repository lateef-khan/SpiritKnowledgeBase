---
id: f65-2026-fat-burn-program-profile
title: 'Fat Burn program: printed speed and incline profile'
kind: spec
question: What is the speed and incline profile of the Fat Burn program on a Sole
  F65-2026 treadmill?
asked_as:
- what is the fat burn program on a treadmill
- p3 profile on my sole treadmill
- how fast does the fat burn program go
keywords:
- fat burn
- p3 program
- program profile
...
The console shows this program as **P3**.
...
```
0 0 0 0 1 2 4 5 3 4 4 3 2 3 4 5 6 4 2 1 0 0 0 0
```

**This profile spends eleven consecutive segments at 100% speed** - more than any other preset in this manual.

---
id: f65-2026-cardio-program-profile
title: 'Cardio program: printed speed and incline profile'
kind: spec
question: What is the speed and incline profile of the Cardio program on a Sole F65-2026
  treadmill?
asked_as:
- what is the cardio program on a treadmill
- p4 profile on my sole treadmill
...
The console shows this program as **P4**.
...
```
0 0 0 0 1 2 3 2 2 3 1 2 3 2 2 4 2 3 1 1 0 0 0 0
```

**87.5 is the only non-integer value in the whole table.** It is printed that way and is reproduced unchanged.

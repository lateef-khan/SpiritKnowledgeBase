---
id: f65-2026-strength-program-profile
...
question: What is the speed and incline profile of the Strength program on a Sole
  F65-2026 treadmill?
asked_as:
- what is the strength program on a treadmill
...
**This is the only profile whose speed row does not open 20 30 40 50.** It opens **20 30 40 63**, and it is the only one whose incline reaches **8**. Both are printed that way and are reproduced unchanged.

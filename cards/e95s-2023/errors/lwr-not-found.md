---
id: e95s-2023-lwr-not-found
title: LWR not found message
kind: troubleshooting
question: What does LWR not found mean on a Sole e95s-2023 elliptical?
asked_as:
- console says lwr not found
- lwr not found on my sole elliptical
- e95s display shows lwr not found
keywords:
- lwr not found
- driver board
- lower controller
...
source:
  ...
  locator: Error code list and section 8.2, pages 19-20

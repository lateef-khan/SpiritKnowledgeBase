---
id: e95s-2016-console-to-driver-board-pinout
title: Console to driver board connector pin definition
kind: spec
question: What is the console to driver board connector pinout on a Sole e95s-2016
  elliptical?
asked_as:
...
The position sensor plug is **1. Red = ground, 2. White = position signal, 3. Black = 5vdc**, with the signal running 0~5v depending on position.

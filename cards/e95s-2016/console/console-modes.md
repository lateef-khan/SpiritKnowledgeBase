---
id: e95s-2016-console-modes
title: Console display, sleep, child lock, pause, end and reset modes
kind: fact
question: What are the console modes on a Sole e95s-2016 elliptical and how do I leave
  them?
asked_as:
...
**IDLE MODE** - the console displays each program name.
...
**PAUSE MODE** - press STOP. Exercise parameters are recorded and the window shows "PAUSE". It returns to idle after **five minutes** with no key press. **The STRIDE should return to "18" when the resistance level is "1"**; the tension motor and stride positions return to the pre-pause level when START is pressed.

**END MODE** - the message window shows "WORKOUT SUMMARY" and displays the finished message. The system enters idle mode after **3 minutes** with no key press.

---
id: f65-2016-driver-board-connectors
title: Driver board sockets and what plugs into each
kind: spec
question: What are the sockets on the driver board of a Sole f65-2016 treadmill?
asked_as:
...
see_also:
- f65-2016-console-to-driver-board-pinout

---
id: f65-2016-e3-incline-error
title: 'E3 error: incline VR value not read'
kind: troubleshooting
question: What does an E3 or INCLINE ERR error mean on a Sole f65-2016 treadmill?
asked_as:
...
**Printing error in this manual**: the explanation of case 2 ends "the incline is not operating, and then appear E2 appears on the display." Every heading, definition and table around it says E3, and the 2019 manual for the same machine prints E3 here. Read it as E3.

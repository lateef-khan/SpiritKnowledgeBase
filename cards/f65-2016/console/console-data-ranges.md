---
id: f65-2016-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the speed, incline and pulse ranges on a Sole f65-2016 treadmill
  console?
asked_as:
...
The console has a **7.5" LCD display**.

| Reading | Display range | Work range | Notes |
|---|---|---|---|
| SPEED | 0.0 to 99.9 | 1.0~16.0KM or 0.5~12Mile | FAST/SLOW change it by 0.1 km/h (mph) per press |

---
id: tt8-2019-ac-error-code-list
title: Inverter error code list
kind: spec
question: What are the error codes on a Sole tt8-2019-ac treadmill?
asked_as:
...
- tt8-2019-ac-e-02h-error-code
- tt8-2019-ac-e-04h-error-code
- tt8-2019-ac-e-06h-error-code
- tt8-2019-ac-e-07h-error-code
- tt8-2019-ac-e-08h-error-code
- tt8-2019-ac-e-09h-error-code
- tt8-2019-ac-e-0ah-error-code
- tt8-2019-ac-e-0bh-error-code
- tt8-2019-ac-e-0ch-error-code
- tt8-2019-ac-e-21h-error-code
- tt8-2019-ac-e-22h-error-code
- tt8-2019-ac-e-23h-error-code
- tt8-2019-ac-e-25h-error-code
- tt8-2019-ac-e-26h-error-code
- tt8-2019-ac-e-27h-error-code
- tt8-2019-ac-e-28h-error-code
- tt8-2019-ac-e-29h-error-code
- tt8-2019-ac-e-41h-error-code
- tt8-2019-ac-e-42h-error-code
...
**The bare E3 is the odd one out.** On this machine E3 is the rear incline motor. On the DC-motor TT8 2019
(ST928-YT035) E3 means the incline VR voltage is out of range. Same two characters, different

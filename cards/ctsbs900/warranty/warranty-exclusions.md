---
id: ctsbs900-warranty-exclusions
title: Warranty exclusions — what is not covered
kind: policy
question: What is not covered by the CTSBS900 warranty?
asked_as:
- what voids my warranty
- is water damage covered
- is misuse covered under warranty
keywords:
- warranty exclusions
- not covered
...
source:
  ref: ctsbs900-om
  locator: 'p. 55. The same nine items and the same note are printed in the CTSBS900
    owner''s manual PDF, spirit-treadmill-ctsbs900-owners-manual text.md lines 1704-1726,
    p. 55'
...
Product features or specifications as described or illustrated are subject to change without notice. All warranties are made by Spirit Fitness, Inc. This warranty applies only in the 48 contiguous United States. **This does not include Alaska or Hawaii.**

**These nine items are the CT900 list, word for word.** Every item, the order, and the note below them are identical to the nine printed in the CT900 owner's manual, held here as `ct900-warranty-exclusions`. The two cards state one fact about two machines; either answers a CTSBS900 question correctly.

**Item 2 does not match the only warranty row this machine has.** The table prints one row, Commercial (Dues Paying Facilities), while item 2 refuses service call reimbursement for "units not in ordinary household or light commercial use" and the opening paragraph warrants "home use" parts. Three sentences, three different pictures of what this machine is for, none of them reconciled in the source - see [warranty/warranty-use-environment.md](warranty-use-environment.md).

**The CT900ENT list is not this list**: eight items, a different item 2, an outright exclusion of an unregistered product, and no numbered item 9 (`ct900ent-exclusions`).

See [warranty/warranty-coverage-commercial.md](warranty-coverage-commercial.md) for what *is* covered.

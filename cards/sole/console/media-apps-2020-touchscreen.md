---
id: sole-media-apps-2020-touchscreen
title: Netflix, YouTube and Chrome on a first generation touchscreen
kind: fact
question: Why do Netflix, YouTube and Chrome not work on my 2020 Sole touchscreen
  treadmill?
asked_as:
- netflix will not open on my treadmill
- youtube stopped working on the console
keywords:
- netflix
- youtube
- google chrome
...
The machines are the 2019 F85, the ST90 that is called both 2020 and 2021, and the TT8 that is called both 2019 and 2020. Their model numbers are on the F85, ST90 and TT8 model cards.
...
- **Google Chrome**: in late 2025 Google dropped support for Google Play Services on these consoles, so Chrome no longer works. There is no workaround.

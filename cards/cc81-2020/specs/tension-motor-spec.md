---
id: cc81-2020-tension-motor-spec
title: "Tension motor rating and what it does"
kind: spec
question: "What is the tension motor spec on a Sole CC81-2020 climber?"
asked_as:
...
The console drives the motor directly. **The drive voltage the console puts out is a different figure from the working voltage above** — see [`cc81-2020-tension-motor-console-output-check`](../errors/tension-motor-console-output-check.md).

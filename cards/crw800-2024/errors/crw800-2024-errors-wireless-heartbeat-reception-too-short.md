...
title: The strap only reads very close to the console, and the single cause is a low battery
kind: troubleshooting
question: Why does the chest strap on a Spirit CRW800-2024 rower only read when it is

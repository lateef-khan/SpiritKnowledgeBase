...
title: E2 on the rower is a cable tension communication error, and the manual prints nothing else about it
kind: troubleshooting
question: What does E2 mean on a Spirit CRW800-2024 rower?
asked_as:
...
source:
  ...
  locator: ERROR CODES, printed page 34. That page is a flat picture with no text layer

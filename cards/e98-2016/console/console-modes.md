---
id: e98-2016-console-modes
title: Console display, sleep, child lock, pause, end and reset modes
kind: fact
question: What are the console modes on a Sole e98-2016 elliptical and how do I leave
  them?
asked_as:
...
**RESET MODE** - in idle, hold STOP for **more than three seconds**. You must leave console lock mode first. The window then finishes the reset and the system is in idle mode.

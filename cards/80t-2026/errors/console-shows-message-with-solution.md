...
title: The console states the fault in words with a suggested fix, instead of a numbered code
kind: fact
question: What does the console of a Spirit 80t-2026 treadmill show when something goes wrong?
asked_as:
...
source:
  ...
  locator: 'POWER ON & CONSOLE OPERATION, the NOTE box, printed page 24; text.md lines 825-828'

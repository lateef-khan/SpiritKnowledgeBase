---
id: f63-2023-e0-error-code
title: 'E0 error: safety key or safety module'
kind: troubleshooting
question: What does an E0 error mean on a Sole F63-2023?
asked_as:
...
source:
  ...
  locator: page 20, 8.1 Error Message E0
  extracted_at: '2026-09-04'
---

**This is E0, not E1 (no RPM signal) and not E7 (input power).**

**Definition**: the console is not inserted safety, or the safety module may be broken. It can also be a broken component on the upper control board or the lower controller.

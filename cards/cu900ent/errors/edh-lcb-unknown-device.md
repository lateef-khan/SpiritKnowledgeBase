---
id: cu900ent-edh-lcb-unknown-device
title: 'EDH: the lower board is an unknown device'
kind: troubleshooting
question: What does error code EDH mean on a Spirit CU900ENT or CR900ENT-2021 bike,
  CT900ENT treadmill or CE900ENT elliptical?
asked_as:
- what does edh mean on my spirit bike
- bike console showing edh
- spirit upright bike error edh
keywords:
- edh
- '0xed'
- lcb
...
source:
  ...
  locator: Error Code Messages table, page 22; CT900ENT service manual Error Code
    ...
    Code Messages table, PDF p. 21, text.md lines 222-239 (the EDH row); CE900ENT
    service manual Error Code Messages table, PDF p. 22, text.md lines 301-318
  extracted_at: '2026-09-08'
---

**This is EDH, and it is not any other code in the same table.** LCB is the lower control board. The console can see it but does not recognise what it is.

| Field | Value |
|---|---|
| Error Code | EDH |
| Description, word for word | LCB Unknown Device |

...
question: What does error code 40H mean on a Spirit CU900ENT or CR900ENT-2021 bike,
...
source:
  ...
  locator: Error Code Messages table, page 22; CT900ENT service manual Error Code
    ...
    Code Messages table, PDF p. 21, text.md lines 222-239 (the 40H row); CE900ENT

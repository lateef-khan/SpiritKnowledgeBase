...
- what languages does the treadmill have
keywords:
- language
- change language
- languages available
...
1. Tap your desired language on the screen. The system returns to the Home Screen, now using the new
   language.
2. To return to the Home Screen **without** selecting a new language, press the **Home** button in
   the upper left corner of the screen.

**The manual does not print which 13 languages they are**, and it does not say whether the choice

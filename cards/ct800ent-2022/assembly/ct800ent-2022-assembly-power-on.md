...
1. Plug in the power cord and switch on the **main power switch located at the
   front of the treadmill**.
2. **Make sure the safety key is inserted** - the machine will not operate without
   the presence of the safety key.

When the power is turned ON, the screen shows a **brief loading screen** and then
the **Home Screen**, which indicates that the machine is ready to operate. You

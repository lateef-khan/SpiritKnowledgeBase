---
id: f85-2016-display-mode-setting
title: The setting that decides whether the console shows a code when the key is pulled
kind: procedure
question: Why does my Sole F85-2016 treadmill show an error when I remove the safety
...
**The same setting has a second effect, listed on a different page.** In the engineering mode menu, DISPLAY MODE turned off makes the console power down automatically after 30 minutes of inactivity. That page lists DISPLAY MODE as a top level item, while this page reaches it through a "functions" submenu.

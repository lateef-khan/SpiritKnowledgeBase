---
id: f85-2016-e1-no-rpm-signal
title: 'E1: no RPM signal reached the display board'
kind: troubleshooting
question: What does E1 mean on a Sole F85-2016 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.2 Error Message: E1, printed pages 39 to 44, and section 10.2
    diagnosis guide, page 70'
...
The speed signal travels on the **TX/RX pair of the 6-pin main wire**. The manual's own explanation of the fault is that the drive board sent no voltage to the motor, so the motor did not turn and the display board never saw an RPM pulse.

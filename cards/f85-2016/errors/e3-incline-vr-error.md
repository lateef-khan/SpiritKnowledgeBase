---
id: f85-2016-e3-incline-vr-error
title: 'E3: the incline VR value is missing or out of range'
kind: troubleshooting
question: What does E3 mean on a Sole F85-2016 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'sections 8.3 Error Message: E3 and Error Message: E3 / INCLINE ERR, printed
    pages 45 to 53, and the section 8.10 matrix on page 61'
...
| Incline power cable and incline VR cable | Inspect the wire connections. Inspect whether wires are broken or crimped. |
...
The section 8.10 matrix adds a third short answer for **INCLINE ERR with E3 in the incline window**: a connector has fallen off, or the position sensor value of the incline motor is wrong. Check the cable connector, then calibrate the console.

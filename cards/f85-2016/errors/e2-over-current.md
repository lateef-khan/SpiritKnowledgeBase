---
id: f85-2016-e2-over-current
title: 'E2: over current on the lower board'
kind: troubleshooting
question: What does E2 mean on a Sole F85-2016 treadmill and how do I fix it?
asked_as:
...
source:
  ...
  locator: 'section 8.2 Error Message: E2 / OVER CURRENT, printed page 45'
...
The **LIMIT** LED on the driver board lights for the same condition. See the driver board LED card for the current thresholds.

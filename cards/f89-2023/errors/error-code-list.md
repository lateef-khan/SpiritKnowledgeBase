---
id: f89-2023-error-code-list
title: Error codes the service manual lists
kind: spec
question: What error codes can a Sole f89-2023 treadmill show and what does each one
  mean?
asked_as:
- list of error codes for the f89
...
- f89-2023-e6-lower-controller-fault
...
EEPROM failure, and names the F89 as a machine that uses that controller. This manual does not print it.

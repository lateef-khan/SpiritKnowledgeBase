---
id: f89-2023-console-data-ranges
title: Display and work ranges for each console reading
kind: spec
question: What are the speed, incline and pulse ranges on a Sole f89-2023 treadmill
  console?
asked_as:
...
|---|---|---|---|
| SPEED | 1.0 to 22.0 km MAX, or 0.5 to 12.0 for MILE | 1.0~22.0 km/h (0.5~12.0 mph) | each FAST or SLOW press changes it by 0.1 km/h (mph) |
| GRADE (INCLINE & DECLINE) | 0 to 99 | -6 to 15 | position shown 0 to 15, preset value -6 to 15, each press changes by 1 |
...
**Read the GRADE row carefully.** The first line says "Display the incline position from 0 to 15" and the work range on the next line is -6 to 15. The quick incline keys reach -4 at the low end.

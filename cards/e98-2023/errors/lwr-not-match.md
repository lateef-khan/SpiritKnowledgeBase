---
id: e98-2023-lwr-not-match
title: LWR not match message
kind: troubleshooting
question: What does LWR not match mean on a Sole e98-2023 elliptical?
asked_as:
- console says lwr not match
- lwr not match on my sole elliptical
- how do i clear lwr not match on a e98
keywords:
- lwr not match
- driver board
- controller number
...
source:
  ...
  locator: Error code list and section 8.3, pages 16-17
